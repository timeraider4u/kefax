...
\title{Project in software engineering\\ECCO KeFaX (ECCO Linux KErnel FeAture eXtraction) - documentation}
...
%\input{chapters/cdesc}
%\input{chapters/parsertools}
%\input{chapters/ast}
%\input{chapters/emf}
%\input{chapters/modisco}
