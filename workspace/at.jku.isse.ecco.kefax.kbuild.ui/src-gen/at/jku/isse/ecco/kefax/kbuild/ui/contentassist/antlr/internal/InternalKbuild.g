...
{ before(grammarAccess.getValuesAccess().getValuesValueParserRuleCall_1_0()); }
	ruleValue{ after(grammarAccess.getValuesAccess().getValuesValueParserRuleCall_1_0()); }
)
...
{ before(grammarAccess.getValuesAccess().getValuesValueParserRuleCall_2_3_0()); }
	ruleValue{ after(grammarAccess.getValuesAccess().getValuesValueParserRuleCall_2_3_0()); }
)
