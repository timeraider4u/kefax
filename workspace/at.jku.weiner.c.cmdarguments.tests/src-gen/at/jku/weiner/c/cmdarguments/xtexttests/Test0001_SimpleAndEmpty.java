...
public class Test0001_SimpleAndEmpty {
	@Inject
	...
	public void checkLexerTokens() throws Exception{
		final String text = this.getTextFromFile(
			"res/Test0001_SimpleAndEmpty.cmd");
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("my.o", CmdLine_1_Var
		.getStart());
		...
		Assert.assertEquals("/usr/bin/gcc", Argument_2_Var
		.getIn());
		//2
		...
		Assert.assertEquals("my.c", Argument_3_Var
		.getIn());
	}
