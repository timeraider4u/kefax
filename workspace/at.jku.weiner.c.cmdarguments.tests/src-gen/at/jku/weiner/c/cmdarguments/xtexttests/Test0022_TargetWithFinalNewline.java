...
public class Test0022_TargetWithFinalNewline {
	@Inject
	...
	public void checkLexerTokens() throws Exception{
		final String text = this.getTextFromFile(
			"res/Test0022_TargetWithFinalNewline.cmd");
	...
	public void checkParserResult() throws Exception {
		...
		//0
		final Target Target_1_Var
		 = (Target)Lines_0_list.get(0);
		Assert.assertNotNull(Target_1_Var
		);
		Assert.assertEquals("baz.o", Target_1_Var
		.getStart());
		Assert.assertTrue(Target_1_Var
