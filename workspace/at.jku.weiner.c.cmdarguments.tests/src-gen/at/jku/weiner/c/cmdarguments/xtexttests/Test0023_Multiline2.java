...
public class Test0023_Multiline2 {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("Wall", Argument_2_Var
		.getOption());
		//2
		...
		Assert.assertEquals("a", CmdLine_3_Var
		.getStart());
		...
		Assert.assertEquals("b", Argument_4_Var
		.getIn());
	}
