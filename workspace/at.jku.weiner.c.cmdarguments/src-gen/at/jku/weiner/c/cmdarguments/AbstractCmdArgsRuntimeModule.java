...
import at.jku.weiner.c.cmdarguments.formatting2.CmdArgsFormatter;
...
import at.jku.weiner.c.cmdarguments.validation.CmdArgsValidator;
...
/**
 * Manual modifications go to {@link CmdArgsRuntimeModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractCmdArgsRuntimeModule extends DefaultCommonTypesRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "at/jku/weiner/c/cmdarguments/CmdArgs.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("at.jku.weiner.c.cmdarguments.CmdArgs");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("cmd");
	}
	...
	public Class<? extends IGrammarAccess> bindIGrammarAccess() {
		return CmdArgsGrammarAccess.class;
	}
	
	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends ISemanticSequencer> bindISemanticSequencer() {
		return CmdArgsSemanticSequencer.class;
	}
	
	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends ISyntacticSequencer> bindISyntacticSequencer() {
		return CmdArgsSyntacticSequencer.class;
	}
	...
	public Class<? extends CmdArgsValidator> bindCmdArgsValidator() {
		return CmdArgsValidator.class;
	}
	
	// contributed by org.eclipse.xtext.generator.scoping.AbstractScopingFragment
	public Class<? extends IScopeProvider> bindIScopeProvider() {
		return CmdArgsScopeProvider.class;
	}
	...
	public Class<? extends IGenerator> bindIGenerator() {
		return CmdArgsGenerator.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.formatting.Formatter2Fragment2
	public Class<? extends IFormatter2> bindIFormatter2() {
		return CmdArgsFormatter.class;
	}
