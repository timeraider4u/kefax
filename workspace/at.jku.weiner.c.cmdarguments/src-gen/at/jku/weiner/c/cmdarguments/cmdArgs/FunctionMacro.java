 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.cmdarguments.cmdArgs.FunctionMacro#getName <em>Name</em>}</li>
...
public interface FunctionMacro extends Macro
{
   ...
   * @see #setName(String)
   * @see at.jku.weiner.c.cmdarguments.cmdArgs.CmdArgsPackage#getFunctionMacro_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link at.jku.weiner.c.cmdarguments.cmdArgs.FunctionMacro#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
