 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.c.cmdarguments.cmdArgs.impl.MacroImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MacroImpl extends MinimalEObjectImpl.Container implements Macro
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CmdArgsPackage.MACRO__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CmdArgsPackage.MACRO__NAME:
        return getName();
    }
