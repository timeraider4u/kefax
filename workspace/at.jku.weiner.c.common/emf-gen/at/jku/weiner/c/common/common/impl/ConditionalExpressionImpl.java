...
public class ConditionalExpressionImpl extends ExpressionImpl implements ConditionalExpression
{
	...
	public void setExpr(Expression newExpr)
	{
		if (newExpr != expr)
		{
			...
			if (newExpr != null)
				msgs = ((InternalEObject)newExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CommonPackage.CONDITIONAL_EXPRESSION__EXPR, null, msgs);
			msgs = basicSetExpr(newExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonPackage.CONDITIONAL_EXPRESSION__EXPR, newExpr, newExpr));
	}
	...
	public void setQExpr(Expression newQExpr)
	{
		if (newQExpr != qExpr)
		{
			...
			if (newQExpr != null)
				msgs = ((InternalEObject)newQExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CommonPackage.CONDITIONAL_EXPRESSION__QEXPR, null, msgs);
			msgs = basicSetQExpr(newQExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonPackage.CONDITIONAL_EXPRESSION__QEXPR, newQExpr, newQExpr));
	}
	...
	public void setCExpr(Expression newCExpr)
	{
		if (newCExpr != cExpr)
		{
			...
			if (newCExpr != null)
				msgs = ((InternalEObject)newCExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CommonPackage.CONDITIONAL_EXPRESSION__CEXPR, null, msgs);
			msgs = basicSetCExpr(newCExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonPackage.CONDITIONAL_EXPRESSION__CEXPR, newCExpr, newCExpr));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			...
			case CommonPackage.CONDITIONAL_EXPRESSION__CEXPR:
