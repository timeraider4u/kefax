 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.c.common.common.impl.ExpressionImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public void setExpression(Expression newExpression)
	{
		if (newExpression != expression) {
			...
			if (newExpression != null)
				msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CommonPackage.EXPRESSION__EXPRESSION, null, msgs);
			msgs = basicSetExpression(newExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonPackage.EXPRESSION__EXPRESSION, newExpression, newExpression));
	}
