 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.c.common.common.impl.LogicalAndExpressionImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogicalAndExpressionImpl extends ExpressionImpl implements LogicalAndExpression
{
	...
	{
		if (expr == null) {
			expr = new EObjectContainmentEList<Expression>(Expression.class, this, CommonPackage.LOGICAL_AND_EXPRESSION__EXPR);
		}
		return expr;
	}
	...
	{
		switch (featureID) {
			case CommonPackage.LOGICAL_AND_EXPRESSION__EXPR:
