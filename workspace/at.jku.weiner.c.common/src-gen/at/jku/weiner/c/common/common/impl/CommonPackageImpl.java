...
public class CommonPackageImpl extends EPackageImpl implements CommonPackage
{
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getConstant2_Hex(), ecorePackage.getEString(), "hex", null, 0, 1, Constant2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getConstant2_Oct(), ecorePackage.getEString(), "oct", null, 0, 1, Constant2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getConstant2_Dec(), ecorePackage.getEString(), "dec", null, 0, 1, Constant2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getConstant2_Ch(), ecorePackage.getEString(), "ch", null, 0, 1, Constant2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getConstant2_Str(), ecorePackage.getEString(), "str", null, 0, 1, Constant2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getConstant2_Float(), ecorePackage.getEString(), "float", null, 0, 1, Constant2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getConstant2_Bin(), ecorePackage.getEString(), "bin", null, 0, 1, Constant2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
