...
public class ConstantExpressionImpl extends ExpressionImpl implements ConstantExpression
{
  ...
  {
    return CommonPackage.Literals.CONSTANT_EXPRESSION;
  }
  ...
  public void setExpr(Expression newExpr)
  {
    if (newExpr != expr)
    {
      ...
      if (newExpr != null)
        msgs = ((InternalEObject)newExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CommonPackage.CONSTANT_EXPRESSION__EXPR, null, msgs);
      msgs = basicSetExpr(newExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CommonPackage.CONSTANT_EXPRESSION__EXPR, newExpr, newExpr));
  }
