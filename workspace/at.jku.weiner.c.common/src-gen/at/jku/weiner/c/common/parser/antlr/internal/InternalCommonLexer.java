...
public class InternalCommonLexer extends Lexer {
	...
	public final void mRULE_SKW_AND() throws RecognitionException {
		try {
			...
			// InternalCommon.g:2160:14: ( '&' )
			// InternalCommon.g:2160:16: '&'
			{
			match('&'); 
			}
	...
	public final void mRULE_SKW_ANDAND() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalCommon.g:2162:17: ( RULE_SKW_AND RULE_SKW_AND )
			// InternalCommon.g:2162:19: RULE_SKW_AND RULE_SKW_AND
			{
			mRULE_SKW_AND(); 
	...
	public final void mRULE_SKW_ASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalCommon.g:2164:17: ( '=' )
			// InternalCommon.g:2164:19: '='
			{
			match('='); 
			}
	...
	public final void mRULE_SKW_DIV() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalCommon.g:2174:14: ( '/' )
			// InternalCommon.g:2174:16: '/'
			{
			match('/'); 
			}
	...
	public final void mRULE_SKW_DOLLAR() throws RecognitionException {
		try {
			// InternalCommon.g:2176:26: ( '$' )
			// InternalCommon.g:2176:28: '$'
			{
			match('$'); 
			}
	...
	public final void mRULE_SKW_DOT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalCommon.g:2178:14: ( '.' )
			// InternalCommon.g:2178:16: '.'
			{
			match('.'); 
			}
	...
	public final void mRULE_SKW_DOUBLEQUOTE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalCommon.g:2180:22: ( '\"' )
			// InternalCommon.g:2180:24: '\"'
			{
			match('\"'); 
			}
	...
	public final void mRULE_INTEGER_TYPE_SUFFIX() throws RecognitionException {
		try {
			// InternalCommon.g:2258:35: ( ( RULE_UNSIGNED_SUFFIX ( RULE_LONG_SUFFIX )? | RULE_UNSIGNED_SUFFIX RULE_LONG_LONG_SUFFIX | RULE_LONG_SUFFIX ( RULE_UNSIGNED_SUFFIX )? | RULE_LONG_LONG_SUFFIX ( RULE_UNSIGNED_SUFFIX )? ) )
			// InternalCommon.g:2258:37: ( RULE_UNSIGNED_SUFFIX ( RULE_LONG_SUFFIX )? | RULE_UNSIGNED_SUFFIX RULE_LONG_LONG_SUFFIX | RULE_LONG_SUFFIX ( RULE_UNSIGNED_SUFFIX )? | RULE_LONG_LONG_SUFFIX ( RULE_UNSIGNED_SUFFIX )? )
			{
			// InternalCommon.g:2258:37: ( RULE_UNSIGNED_SUFFIX ( RULE_LONG_SUFFIX )? | RULE_UNSIGNED_SUFFIX RULE_LONG_LONG_SUFFIX | RULE_LONG_SUFFIX ( RULE_UNSIGNED_SUFFIX )? | RULE_LONG_LONG_SUFFIX ( RULE_UNSIGNED_SUFFIX )? )
			int alt16=4;
			switch ( input.LA(1) ) {
			...
			switch (alt16) {
				case 1 :
					// InternalCommon.g:2258:38: RULE_UNSIGNED_SUFFIX ( RULE_LONG_SUFFIX )?
					{
					mRULE_UNSIGNED_SUFFIX(); 

					// InternalCommon.g:2258:59: ( RULE_LONG_SUFFIX )?
					int alt13=2;
					...
					break;
				case 2 :
					// InternalCommon.g:2258:77: RULE_UNSIGNED_SUFFIX RULE_LONG_LONG_SUFFIX
					{
					mRULE_UNSIGNED_SUFFIX(); 
					...
					break;
				case 3 :
					// InternalCommon.g:2258:120: RULE_LONG_SUFFIX ( RULE_UNSIGNED_SUFFIX )?
					{
					mRULE_LONG_SUFFIX(); 

					// InternalCommon.g:2258:137: ( RULE_UNSIGNED_SUFFIX )?
					int alt14=2;
					...
					break;
				case 4 :
					// InternalCommon.g:2258:159: RULE_LONG_LONG_SUFFIX ( RULE_UNSIGNED_SUFFIX )?
					{
					mRULE_LONG_LONG_SUFFIX(); 

					// InternalCommon.g:2258:181: ( RULE_UNSIGNED_SUFFIX )?
					int alt15=2;
	...
	public final void mRULE_LONG_LONG_SUFFIX() throws RecognitionException {
		try {
			// InternalCommon.g:2264:32: ( ( 'll' | 'LL' ) )
			// InternalCommon.g:2264:34: ( 'll' | 'LL' )
			{
			// InternalCommon.g:2264:34: ( 'll' | 'LL' )
			int alt17=2;
	...
	public final void mRULE_FLOAT_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalCommon.g:2266:20: ( ( ( '0' .. '9' )+ RULE_SKW_DOT ( '0' .. '9' )* ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | RULE_SKW_DOT ( '0' .. '9' )+ ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ RULE_EXPONENT ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ ( RULE_EXPONENT )? RULE_FLOAT_TYPE_SUFFIX ) )
			// InternalCommon.g:2266:22: ( ( '0' .. '9' )+ RULE_SKW_DOT ( '0' .. '9' )* ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | RULE_SKW_DOT ( '0' .. '9' )+ ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ RULE_EXPONENT ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ ( RULE_EXPONENT )? RULE_FLOAT_TYPE_SUFFIX )
			{
			// InternalCommon.g:2266:22: ( ( '0' .. '9' )+ RULE_SKW_DOT ( '0' .. '9' )* ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | RULE_SKW_DOT ( '0' .. '9' )+ ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ RULE_EXPONENT ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ ( RULE_EXPONENT )? RULE_FLOAT_TYPE_SUFFIX )
			int alt29=4;
			...
			switch (alt29) {
				case 1 :
					// InternalCommon.g:2266:23: ( '0' .. '9' )+ RULE_SKW_DOT ( '0' .. '9' )* ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )?
					{
					// InternalCommon.g:2266:23: ( '0' .. '9' )+
					int cnt18=0;
					loop18:
					while (true) {
						int alt18=2;
					...
					// InternalCommon.g:2266:60: ( RULE_EXPONENT )?
					int alt20=2;
					...
					// InternalCommon.g:2266:75: ( RULE_FLOAT_TYPE_SUFFIX )?
					int alt21=2;
					...
					break;
				case 2 :
					// InternalCommon.g:2266:99: RULE_SKW_DOT ( '0' .. '9' )+ ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )?
					{
					mRULE_SKW_DOT(); 

					// InternalCommon.g:2266:112: ( '0' .. '9' )+
					int cnt22=0;
					loop22:
					while (true) {
						int alt22=2;
					...
					// InternalCommon.g:2266:124: ( RULE_EXPONENT )?
					int alt23=2;
					...
					// InternalCommon.g:2266:139: ( RULE_FLOAT_TYPE_SUFFIX )?
					int alt24=2;
					...
					break;
				case 3 :
					// InternalCommon.g:2266:163: ( '0' .. '9' )+ RULE_EXPONENT ( RULE_FLOAT_TYPE_SUFFIX )?
					{
					// InternalCommon.g:2266:163: ( '0' .. '9' )+
					int cnt25=0;
					loop25:
					while (true) {
						int alt25=2;
					...
					// InternalCommon.g:2266:189: ( RULE_FLOAT_TYPE_SUFFIX )?
					int alt26=2;
					...
					break;
				case 4 :
					// InternalCommon.g:2266:213: ( '0' .. '9' )+ ( RULE_EXPONENT )? RULE_FLOAT_TYPE_SUFFIX
					{
					// InternalCommon.g:2266:213: ( '0' .. '9' )+
					int cnt27=0;
					loop27:
					while (true) {
						int alt27=2;
					...
					// InternalCommon.g:2266:225: ( RULE_EXPONENT )?
					int alt28=2;
	...
	public final void mRULE_EXPONENT() throws RecognitionException {
		try {
			// InternalCommon.g:2268:24: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
			// InternalCommon.g:2268:26: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
			{
	...
	public final void mRULE_FLOAT_TYPE_SUFFIX() throws RecognitionException {
		try {
			// InternalCommon.g:2270:33: ( ( 'f' | 'F' | 'd' | 'D' ) )
			// InternalCommon.g:
			{
			if ( input.LA(1)=='D'||input.LA(1)=='F'||input.LA(1)=='d'||input.LA(1)=='f' ) {
				input.consume();
	...
	public final void mRULE_ESCAPE_SEQUENCE() throws RecognitionException {
		try {
			// InternalCommon.g:2272:31: ( ( RULE_SKW_BACKSLASH ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | RULE_SKW_SINGLEQUOTE | RULE_SKW_BACKSLASH ) | RULE_OCTAL_ESCAPE | RULE_HEX_ESCAPE ) )
			// InternalCommon.g:2272:33: ( RULE_SKW_BACKSLASH ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | RULE_SKW_SINGLEQUOTE | RULE_SKW_BACKSLASH ) | RULE_OCTAL_ESCAPE | RULE_HEX_ESCAPE )
			{
			// InternalCommon.g:2272:33: ( RULE_SKW_BACKSLASH ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | RULE_SKW_SINGLEQUOTE | RULE_SKW_BACKSLASH ) | RULE_OCTAL_ESCAPE | RULE_HEX_ESCAPE )
			int alt32=3;
			...
			switch (alt32) {
				case 1 :
					// InternalCommon.g:2272:34: RULE_SKW_BACKSLASH ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | RULE_SKW_SINGLEQUOTE | RULE_SKW_BACKSLASH )
					{
					mRULE_SKW_BACKSLASH(); 
					...
					break;
				case 2 :
					// InternalCommon.g:2272:119: RULE_OCTAL_ESCAPE
					{
					mRULE_OCTAL_ESCAPE(); 
					...
					break;
				case 3 :
					// InternalCommon.g:2272:137: RULE_HEX_ESCAPE
					{
					mRULE_HEX_ESCAPE(); 
	...
	public final void mRULE_OCTAL_ESCAPE() throws RecognitionException {
		try {
			// InternalCommon.g:2274:28: ( ( RULE_SKW_BACKSLASH '0' .. '3' '0' .. '7' '0' .. '7' | RULE_SKW_BACKSLASH '0' .. '7' '0' .. '7' | RULE_SKW_BACKSLASH '0' .. '7' ) )
			// InternalCommon.g:2274:30: ( RULE_SKW_BACKSLASH '0' .. '3' '0' .. '7' '0' .. '7' | RULE_SKW_BACKSLASH '0' .. '7' '0' .. '7' | RULE_SKW_BACKSLASH '0' .. '7' )
			{
			// InternalCommon.g:2274:30: ( RULE_SKW_BACKSLASH '0' .. '3' '0' .. '7' '0' .. '7' | RULE_SKW_BACKSLASH '0' .. '7' '0' .. '7' | RULE_SKW_BACKSLASH '0' .. '7' )
			int alt33=3;
			...
			switch (alt33) {
				case 1 :
					// InternalCommon.g:2274:31: RULE_SKW_BACKSLASH '0' .. '3' '0' .. '7' '0' .. '7'
					{
					mRULE_SKW_BACKSLASH(); 
					...
					break;
				case 2 :
					// InternalCommon.g:2274:77: RULE_SKW_BACKSLASH '0' .. '7' '0' .. '7'
					{
					mRULE_SKW_BACKSLASH(); 
					...
					break;
				case 3 :
					// InternalCommon.g:2274:114: RULE_SKW_BACKSLASH '0' .. '7'
					{
					mRULE_SKW_BACKSLASH(); 
	...
	public final void mRULE_HEX_ESCAPE() throws RecognitionException {
		try {
			// InternalCommon.g:2276:26: ( RULE_SKW_BACKSLASH 'x' ( RULE_HEX_DIGIT )+ )
			// InternalCommon.g:2276:28: RULE_SKW_BACKSLASH 'x' ( RULE_HEX_DIGIT )+
			{
			mRULE_SKW_BACKSLASH(); 

			match('x'); 
			// InternalCommon.g:2276:51: ( RULE_HEX_DIGIT )+
			int cnt34=0;
			loop34:
			while (true) {
				int alt34=2;
	...
	public final void mRULE_LINEFEED() throws RecognitionException {
		try {
			// InternalCommon.g:2278:24: ( '\\n' )
			// InternalCommon.g:2278:26: '\\n'
			{
			match('\n'); 
			}
	...
	public final void mRULE_CARRIAGERETURN() throws RecognitionException {
		try {
			// InternalCommon.g:2280:30: ( '\\r' )
			// InternalCommon.g:2280:32: '\\r'
			{
			match('\r'); 
			}
	...
	public final void mRULE_LINE_END() throws RecognitionException {
		try {
			// InternalCommon.g:2282:24: ( ( RULE_CARRIAGERETURN | RULE_LINEFEED ) )
			// InternalCommon.g:
			{
			if ( input.LA(1)=='\n'||input.LA(1)=='\r' ) {
				input.consume();
	...
	public final void mRULE_LINEBREAK() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalCommon.g:2284:16: ( RULE_SKW_BACKSLASH RULE_LINE_END )
			// InternalCommon.g:2284:18: RULE_SKW_BACKSLASH RULE_LINE_END
			{
			mRULE_SKW_BACKSLASH(); 
	...
	public final void mRULE_NEWLINE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalCommon.g:2286:14: ( RULE_LINE_END )
			// InternalCommon.g:
			{
			if ( input.LA(1)=='\n'||input.LA(1)=='\r' ) {
				input.consume();
	...
	public final void mRULE_SPACE() throws RecognitionException {
		try {
			// InternalCommon.g:2288:21: ( ' ' )
			// InternalCommon.g:2288:23: ' '
			{
			match(' '); 
			}
	...
	public final void mRULE_TAB() throws RecognitionException {
		try {
			// InternalCommon.g:2290:19: ( '\\t' )
			// InternalCommon.g:2290:21: '\\t'
			{
			match('\t'); 
			}
	...
	public final void mRULE_WHITESPACE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalCommon.g:2292:17: ( ( RULE_SPACE | RULE_TAB ) )
			// InternalCommon.g:
			{
			if ( input.LA(1)=='\t'||input.LA(1)==' ' ) {
				input.consume();
	...
	public final void mRULE_BLOCK_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalCommon.g:2294:20: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// InternalCommon.g:2294:22: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// InternalCommon.g:2294:27: ( options {greedy=false; } : . )*
			loop35:
			while (true) {
				int alt35=2;
	...
	public final void mRULE_LINE_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalCommon.g:2296:19: ( '//' (~ ( RULE_LINE_END ) )* )
			// InternalCommon.g:2296:21: '//' (~ ( RULE_LINE_END ) )*
			{
			match("//"); 

			// InternalCommon.g:2296:26: (~ ( RULE_LINE_END ) )*
			loop36:
			while (true) {
				int alt36=2;
	...
	public final void mRULE_SPECIAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalCommon.g:2298:14: ( . )
			// InternalCommon.g:2298:16: .
			{
			matchAny(); 
			}
	...
	protected class DFA29 extends DFA {
		...
		public String getDescription() {
			return "2266:22: ( ( '0' .. '9' )+ RULE_SKW_DOT ( '0' .. '9' )* ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | RULE_SKW_DOT ( '0' .. '9' )+ ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ RULE_EXPONENT ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ ( RULE_EXPONENT )? RULE_FLOAT_TYPE_SUFFIX )";
		}
	}
