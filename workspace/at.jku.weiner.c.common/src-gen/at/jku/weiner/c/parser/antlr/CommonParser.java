...
public class CommonParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected at.jku.weiner.c.parser.antlr.internal.InternalCommonParser createParser(XtextTokenStream stream) {
		return new at.jku.weiner.c.parser.antlr.internal.InternalCommonParser(stream, getGrammarAccess());
	}
