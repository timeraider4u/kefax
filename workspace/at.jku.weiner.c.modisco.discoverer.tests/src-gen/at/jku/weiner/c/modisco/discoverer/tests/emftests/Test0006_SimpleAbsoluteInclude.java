...
public class Test0006_SimpleAbsoluteInclude {
	...
	public Test0006_SimpleAbsoluteInclude(final Boolean use) {
		this.use = use;
	}
	...
	public void initialize(){
		...
		at.jku.weiner.c.modisco.discoverer.tests.EMFTest.test0006_before();
	}
	
	@After
	public void cleanUp() {
		at.jku.weiner.c.modisco.discoverer.tests.EMFTest.test0006_after();
	}
