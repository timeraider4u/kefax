...
public class Test0011_SimpleIncludeInternal {
	...
	private final String pureJavaClassFileName = "Test0011_SimpleIncludeInternal";
	private final String sourceFile = "res/Test0011_SimpleIncludeInternal/SimpleInclude.c";
	private Map<String,Object> options;
	private final Boolean use;
	
	public Test0011_SimpleIncludeInternal(final Boolean use) {
		this.use = use;
	}
	...
	public void initialize(){
		...
		at.jku.weiner.c.modisco.discoverer.tests.EMFTest.test0011_before();
	}
	
	@After
	public void cleanUp() {
		at.jku.weiner.c.modisco.discoverer.tests.EMFTest.test0011_after();
	}
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("\"SimpleInclude.h\"", IncludeDirective_7_Var
		.getString());
		//7
		...
		.getReturn());
		Assert.assertEquals("" + options.get("path") + "/" + options.get("plugin_id") + "/" + options.get("sourceFile") + "", TranslationUnit_3_Var
		.getPath());
		//44
		...
		Assert.assertEquals("" + options.get("path") + "/" + options.get("plugin_id") + "/res/Test0011_SimpleIncludeInternal/SimpleInclude.h", TranslationUnit_45_Var
		.getPath());
		//45
