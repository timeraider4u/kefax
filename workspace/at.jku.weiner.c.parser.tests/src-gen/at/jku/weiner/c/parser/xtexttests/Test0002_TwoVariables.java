...
public class Test0002_TwoVariables {
	...
	public void checkLexerTokens() throws Exception {
		final String text = this.getTextFromFile("res/Test0002_TwoVariables.c");
		// System.out.println(text);
		final String[] expected = new String[] { "RULE_KW_INT",
				"RULE_WHITESPACE", "RULE_ID", "RULE_SKW_SEMI", "RULE_NEWLINE",
				"RULE_KW_INT", "RULE_WHITESPACE", "RULE_ID", "RULE_SKW_SEMI", };
	...
	public void checkParserResult() throws Exception {
		...
		// 9
		final ExternalDeclaration ExternalDeclaration_10_Var = (ExternalDeclaration) External_1_list
				.get(1);
		Assert.assertNotNull(ExternalDeclaration_10_Var);
		// 10
		final Declaration Declaration_11_Var = (Declaration) ExternalDeclaration_10_Var
				.getDeclaration();
		Assert.assertNotNull(Declaration_11_Var);
		// 11
		final DeclarationSpecifiers DeclarationSpecifiers_12_Var = (DeclarationSpecifiers) Declaration_11_Var
				.getSpecifiers();
		...
		// 13
		final InitDeclaratorList InitDeclaratorList_14_Var = (InitDeclaratorList) InitDeclaratorList_13_list
				.get(0);
		...
		// 14
		final InitDeclarator InitDeclarator_15_Var = (InitDeclarator) InitDeclarator_14_list
				.get(0);
		Assert.assertNotNull(InitDeclarator_15_Var);
		// 15
		final Declarator Declarator_16_Var = (Declarator) InitDeclarator_15_Var
				.getDeclarator();
		Assert.assertNotNull(Declarator_16_Var);
		// 16
		final DirectDeclarator DirectDeclarator_17_Var = (DirectDeclarator) Declarator_16_Var
				.getDeclarator();
	...
	public void testGenerator() throws Exception {
		...
		final URI uri = URI.createURI("res/Test0002_TwoVariables.c");
		...
		final String actual = this
				.getTextFromFile("bin/Test0002_TwoVariables.c");
		final String expected = this
				.getTextFromFile("res/Test0002_TwoVariables.c");
