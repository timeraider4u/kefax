...
public class Test0010_SimpleExpr {
	...
	public void checkParserResult() throws Exception {
		...
		final MultiplicativeExpression MultiplicativeExpression_32_Var
		 = (MultiplicativeExpression)Expr_25_list.get(1);
		...
		.getDec());
		Assert.assertEquals("[+]", AdditiveExpression_25_Var
		.getOp().toString());
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0010_SimpleExpr.c");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0010_SimpleExpr.c");
