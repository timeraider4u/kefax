...
public class Test0015_CastExpr {
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("0.8", Constant2_14_Var
		.getFloat());
		//14
		final TypeName TypeName_15_Var
		 = (TypeName)CastExpression_12_Var
		.getType();
