...
public class Test0026_Block {
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("my", DirectDeclarator_8_Var
		.getId());
		//8
		...
		//12
		final CompoundStatement CompoundStatement_13_Var
		 = (CompoundStatement)Statement_12_Var
		.getStmt();
		Assert.assertNotNull(CompoundStatement_13_Var
		);
		//13
		final BodyStatement BodyStatement_14_Var
		 = (BodyStatement)CompoundStatement_13_Var
		.getBody();
		Assert.assertNotNull(BodyStatement_14_Var
		);
		final EList<? extends EObject> BlockList_14_list = BodyStatement_14_Var
		.getBlockList();
		Assert.assertNotNull(BlockList_14_list);
		Assert.assertEquals(1, BlockList_14_list.size());
		//14
		final BlockList BlockList_15_Var
		 = (BlockList)BlockList_14_list.get(0);
		Assert.assertNotNull(BlockList_15_Var
		);
		final EList<? extends EObject> Statement_15_list = BlockList_15_Var
		.getStatement();
		Assert.assertNotNull(Statement_15_list);
		Assert.assertEquals(1, Statement_15_list.size());
		//15
		final Statement Statement_16_Var
		 = (Statement)Statement_15_list.get(0);
		Assert.assertNotNull(Statement_16_Var
		);
		//16
		final CompoundStatement CompoundStatement_17_Var
		 = (CompoundStatement)Statement_16_Var
		.getStmt();
		Assert.assertNotNull(CompoundStatement_17_Var
		);
		//17
		final BodyStatement BodyStatement_18_Var
		 = (BodyStatement)CompoundStatement_17_Var
		.getBody();
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0026_Block.c");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0026_Block.c");
