...
public class Test0050_Extension {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("__extension__", TypeSpecifier_4_Var
		.getName());
		Assert.assertNull(TypeSpecifier_4_Var
		.getExtType());
		//4
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0050_Extension.c");
			}
