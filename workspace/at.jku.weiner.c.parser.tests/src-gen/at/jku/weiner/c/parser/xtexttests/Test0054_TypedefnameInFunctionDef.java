...
public class Test0054_TypedefnameInFunctionDef {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		final PrimaryExpression PrimaryExpression_22_Var
		 = (PrimaryExpression)JumpStatement_21_Var
		.getExpr();
		...
		Assert.assertEquals("0", Constant2_23_Var
		.getDec());
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0054_TypedefnameInFunctionDef.c");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0054_TypedefnameInFunctionDef.c");
