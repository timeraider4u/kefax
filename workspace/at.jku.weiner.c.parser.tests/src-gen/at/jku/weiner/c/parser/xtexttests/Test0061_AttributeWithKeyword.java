...
public class Test0061_AttributeWithKeyword {
	@Inject
	...
	public void checkLexerTokens() throws Exception{
		final String text = this.getTextFromFile(
			"res/Test0061_AttributeWithKeyword.c");
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("const", GccAttribute_9_Var
		.getKeyword());
		//9
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0061_AttributeWithKeyword.c");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0061_AttributeWithKeyword.c");
