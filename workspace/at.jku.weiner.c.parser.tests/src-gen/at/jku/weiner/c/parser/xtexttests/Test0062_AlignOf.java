...
public class Test0062_AlignOf {
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("__alignof__", UnaryExpression_23_Var
		.getAlignOf());
		//23
		final TypeName TypeName_24_Var
		 = (TypeName)UnaryExpression_23_Var
		.getTypeName();
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0062_AlignOf.c");
			}
