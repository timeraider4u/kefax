...
public class Test0084_EmptyStructAssign {
	@Inject
	...
	public void checkLexerTokens() throws Exception{
		final String text = this.getTextFromFile(
			"res/Test0084_EmptyStructAssign.c");
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertNull(Initializer_25_Var
		.getExpr());
		Assert.assertNull(Initializer_25_Var
		.getList());
		Assert.assertFalse(Initializer_25_Var
		.isLastComma());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0013_Assign.c");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0013_Assign.c");
