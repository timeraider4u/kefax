...
public class Test0089_ExtensionTypeNameInCastExpr {
	@Inject
	...
	public void checkLexerTokens() throws Exception{
		final String text = this.getTextFromFile(
			"res/Test0089_ExtensionTypeNameInCastExpr.c");
	...
	public void checkParserResult() throws Exception {
		...
		//9
		final CastExpression CastExpression_10_Var
		 = (CastExpression)Initializer_9_Var
		.getExpr();
		Assert.assertNotNull(CastExpression_10_Var
		);
		Assert.assertTrue(CastExpression_10_Var
		.isExtension());
		//10
		final TypeName TypeName_11_Var
		 = (TypeName)CastExpression_10_Var
		.getType();
		...
		final PrimaryExpression PrimaryExpression_14_Var
		 = (PrimaryExpression)CastExpression_10_Var
		.getExpr();
		...
		final PrimaryExpression PrimaryExpression_15_Var
		 = (PrimaryExpression)PrimaryExpression_14_Var
		.getExpr();
		...
		Assert.assertEquals("5", Constant2_16_Var
		.getDec());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0089_ExtensionTypeNameInCastExpr.c");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0089_ExtensionTypeNameInCastExpr.c");
