...
public class Test0092_CaseRangeExpr {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("bar", PrimaryExpression_21_Var
		.getIdent());
		//21
		...
		Assert.assertTrue(PrimaryExpression_28_Var
		.isParentheses());
		//28
		final AdditiveExpression AdditiveExpression_29_Var
		 = (AdditiveExpression)PrimaryExpression_28_Var
		.getExpr();
		Assert.assertNotNull(AdditiveExpression_29_Var
		);
		Assert.assertEquals("-", AdditiveExpression_29_Var
		.getOp());
		//29
		final PrimaryExpression PrimaryExpression_30_Var
		 = (PrimaryExpression)AdditiveExpression_29_Var
		.getLeft();
		...
		Assert.assertEquals("8", Constant2_31_Var
		.getDec());
		//31
		...
		Assert.assertEquals("2", Constant2_33_Var
		.getDec());
		//33
		...
		final AdditiveExpression AdditiveExpression_35_Var
		 = (AdditiveExpression)PrimaryExpression_34_Var
		.getExpr();
		Assert.assertNotNull(AdditiveExpression_35_Var
		);
		Assert.assertEquals("+", AdditiveExpression_35_Var
		.getOp());
		//35
		final PrimaryExpression PrimaryExpression_36_Var
		 = (PrimaryExpression)AdditiveExpression_35_Var
		.getLeft();
		...
		final PrimaryExpression PrimaryExpression_42_Var
		 = (PrimaryExpression)JumpStatement_41_Var
		.getExpr();
		...
		Assert.assertEquals("1", Constant2_43_Var
		.getDec());
		//43
		...
		final PrimaryExpression PrimaryExpression_46_Var
		 = (PrimaryExpression)JumpStatement_45_Var
		.getExpr();
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0092_CaseRangeExpr.c");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0092_CaseRangeExpr.c");
