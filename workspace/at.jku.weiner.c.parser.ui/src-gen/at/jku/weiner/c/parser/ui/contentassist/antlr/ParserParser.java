		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAbstractDeclaratorAccess().getAlternatives_1(), "rule__AbstractDeclarator__Alternatives_1");
					put(grammarAccess.getDirectAbstractDeclaratorAccess().getAlternatives_1(), "rule__DirectAbstractDeclarator__Alternatives_1");
					put(grammarAccess.getAbstractDeclaratorSuffixAccess().getAlternatives_1(), "rule__AbstractDeclaratorSuffix__Alternatives_1");
					...
					put(grammarAccess.getAbstractDeclaratorAccess().getGroup_1_1(), "rule__AbstractDeclarator__Group_1_1__0");
					put(grammarAccess.getDirectAbstractDeclaratorAccess().getGroup(), "rule__DirectAbstractDeclarator__Group__0");
					put(grammarAccess.getDirectAbstractDeclaratorAccess().getGroup_1_0(), "rule__DirectAbstractDeclarator__Group_1_0__0");
					put(grammarAccess.getAbstractDeclaratorSuffixAccess().getGroup(), "rule__AbstractDeclaratorSuffix__Group__0");
					put(grammarAccess.getAbstractDeclaratorSuffixAccess().getGroup_1_0(), "rule__AbstractDeclaratorSuffix__Group_1_0__0");
					put(grammarAccess.getAbstractDeclaratorSuffixAccess().getGroup_1_1(), "rule__AbstractDeclaratorSuffix__Group_1_1__0");
					put(grammarAccess.getAbstractDeclaratorSuffixAccess().getGroup_1_2(), "rule__AbstractDeclaratorSuffix__Group_1_2__0");
					put(grammarAccess.getAbstractDeclaratorSuffixAccess().getGroup_1_3(), "rule__AbstractDeclaratorSuffix__Group_1_3__0");
					put(grammarAccess.getAbstractDeclaratorSuffixAccess().getGroup_1_4(), "rule__AbstractDeclaratorSuffix__Group_1_4__0");
					...
					put(grammarAccess.getDesignatorAccess().getGroup_1_0_2(), "rule__Designator__Group_1_0_2__0");
					...
					put(grammarAccess.getStructOrUnionSpecifierAccess().getBracesAssignment_2_0_1(), "rule__StructOrUnionSpecifier__BracesAssignment_2_0_1");
					...
					put(grammarAccess.getAbstractDeclaratorAccess().getPointerAssignment_1_0(), "rule__AbstractDeclarator__PointerAssignment_1_0");
					put(grammarAccess.getAbstractDeclaratorAccess().getPointerAssignment_1_1_0(), "rule__AbstractDeclarator__PointerAssignment_1_1_0");
					put(grammarAccess.getAbstractDeclaratorAccess().getDirectAbstractDeclaratorAssignment_1_1_1(), "rule__AbstractDeclarator__DirectAbstractDeclaratorAssignment_1_1_1");
					put(grammarAccess.getAbstractDeclaratorAccess().getGccDeclExtAbstractAssignment_1_1_2(), "rule__AbstractDeclarator__GccDeclExtAbstractAssignment_1_1_2");
					put(grammarAccess.getDirectAbstractDeclaratorAccess().getDeclaratorAssignment_1_0_1(), "rule__DirectAbstractDeclarator__DeclaratorAssignment_1_0_1");
					put(grammarAccess.getDirectAbstractDeclaratorAccess().getGccDeclExtAssignment_1_0_3(), "rule__DirectAbstractDeclarator__GccDeclExtAssignment_1_0_3");
					put(grammarAccess.getDirectAbstractDeclaratorAccess().getAbstractDeclaratorSuffixAssignment_1_1(), "rule__DirectAbstractDeclarator__AbstractDeclaratorSuffixAssignment_1_1");
					put(grammarAccess.getDirectAbstractDeclaratorAccess().getAbstractDeclaratorSuffixAssignment_2(), "rule__DirectAbstractDeclarator__AbstractDeclaratorSuffixAssignment_2");
					put(grammarAccess.getAbstractDeclaratorSuffixAccess().getTypeQualifierListAssignment_1_0_1(), "rule__AbstractDeclaratorSuffix__TypeQualifierListAssignment_1_0_1");
					put(grammarAccess.getAbstractDeclaratorSuffixAccess().getAssignmentExprAssignment_1_0_2(), "rule__AbstractDeclaratorSuffix__AssignmentExprAssignment_1_0_2");
					put(grammarAccess.getAbstractDeclaratorSuffixAccess().getTypeQualifierListAssignment_1_1_2(), "rule__AbstractDeclaratorSuffix__TypeQualifierListAssignment_1_1_2");
					put(grammarAccess.getAbstractDeclaratorSuffixAccess().getAssignmentExprAssignment_1_1_3(), "rule__AbstractDeclaratorSuffix__AssignmentExprAssignment_1_1_3");
					put(grammarAccess.getAbstractDeclaratorSuffixAccess().getTypeQualifierListOrigAssignment_1_2_1(), "rule__AbstractDeclaratorSuffix__TypeQualifierListOrigAssignment_1_2_1");
					put(grammarAccess.getAbstractDeclaratorSuffixAccess().getAssignmentExprAssignment_1_2_3(), "rule__AbstractDeclaratorSuffix__AssignmentExprAssignment_1_2_3");
					put(grammarAccess.getAbstractDeclaratorSuffixAccess().getParameterTypeListAssignment_1_4_1(), "rule__AbstractDeclaratorSuffix__ParameterTypeListAssignment_1_4_1");
					put(grammarAccess.getAbstractDeclaratorSuffixAccess().getGccDeclExtAssignment_1_4_3(), "rule__AbstractDeclaratorSuffix__GccDeclExtAssignment_1_4_3");
					...
					put(grammarAccess.getInitializerAccess().getLastCommaAssignment_1_1_2(), "rule__Initializer__LastCommaAssignment_1_1_2");
					put(grammarAccess.getInitializerListAccess().getInitAssignment_1(), "rule__InitializerList__InitAssignment_1");
					put(grammarAccess.getInitializerListAccess().getInitAssignment_2_1(), "rule__InitializerList__InitAssignment_2_1");
					put(grammarAccess.getInitAccess().getDesignationAssignment_1(), "rule__Init__DesignationAssignment_1");
					put(grammarAccess.getInitAccess().getInitializerAssignment_2(), "rule__Init__InitializerAssignment_2");
					...
					put(grammarAccess.getDesignatorAccess().getToAssignment_1_0_2_1(), "rule__Designator__ToAssignment_1_0_2_1");
