...
public class InternalParserLexer extends Lexer {
	...
	public final void mRULE_KW_AUTO() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21961:14: ( 'auto' )
			// InternalParser.g:21961:16: 'auto'
			{
			match("auto"); 
	...
	public final void mRULE_KW_BREAK() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21963:15: ( 'break' )
			// InternalParser.g:21963:17: 'break'
			{
			match("break"); 
	...
	public final void mRULE_KW_CASE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21965:14: ( 'case' )
			// InternalParser.g:21965:16: 'case'
			{
			match("case"); 
	...
	public final void mRULE_KW_CHAR() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21967:14: ( 'char' )
			// InternalParser.g:21967:16: 'char'
			{
			match("char"); 
	...
	public final void mRULE_KW_CONST() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21969:15: ( 'const' )
			// InternalParser.g:21969:17: 'const'
			{
			match("const"); 
	...
	public final void mRULE_KW_CONTINUE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21971:18: ( 'continue' )
			// InternalParser.g:21971:20: 'continue'
			{
			match("continue"); 
	...
	public final void mRULE_KW_DEFAULT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21973:17: ( 'default' )
			// InternalParser.g:21973:19: 'default'
			{
			match("default"); 
	...
	public final void mRULE_KW_DO() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21975:12: ( 'do' )
			// InternalParser.g:21975:14: 'do'
			{
			match("do"); 
	...
	public final void mRULE_KW_DOUBLE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21977:16: ( 'double' )
			// InternalParser.g:21977:18: 'double'
			{
			match("double"); 
	...
	public final void mRULE_KW_ELSE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21979:14: ( 'else' )
			// InternalParser.g:21979:16: 'else'
			{
			match("else"); 
	...
	public final void mRULE_KW_ENUM() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21981:14: ( 'enum' )
			// InternalParser.g:21981:16: 'enum'
			{
			match("enum"); 
	...
	public final void mRULE_KW_EXTERN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21983:16: ( 'extern' )
			// InternalParser.g:21983:18: 'extern'
			{
			match("extern"); 
	...
	public final void mRULE_KW_FLOAT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21985:15: ( 'float' )
			// InternalParser.g:21985:17: 'float'
			{
			match("float"); 
	...
	public final void mRULE_KW_FOR() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21987:13: ( 'for' )
			// InternalParser.g:21987:15: 'for'
			{
			match("for"); 
	...
	public final void mRULE_KW_GOTO() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21989:14: ( 'goto' )
			// InternalParser.g:21989:16: 'goto'
			{
			match("goto"); 
	...
	public final void mRULE_KW_IF() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21991:12: ( 'if' )
			// InternalParser.g:21991:14: 'if'
			{
			match("if"); 
	...
	public final void mRULE_KW_INLINE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21993:16: ( 'inline' )
			// InternalParser.g:21993:18: 'inline'
			{
			match("inline"); 
	...
	public final void mRULE_KW_INT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21995:13: ( 'int' )
			// InternalParser.g:21995:15: 'int'
			{
			match("int"); 
	...
	public final void mRULE_KW_LONG() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21997:14: ( 'long' )
			// InternalParser.g:21997:16: 'long'
			{
			match("long"); 
	...
	public final void mRULE_KW_REGISTER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:21999:18: ( 'register' )
			// InternalParser.g:21999:20: 'register'
			{
			match("register"); 
	...
	public final void mRULE_KW_RESTRICT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22001:18: ( 'restrict' )
			// InternalParser.g:22001:20: 'restrict'
			{
			match("restrict"); 
	...
	public final void mRULE_KW_RETURN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22003:16: ( 'return' )
			// InternalParser.g:22003:18: 'return'
			{
			match("return"); 
	...
	public final void mRULE_KW_SHORT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22005:15: ( 'short' )
			// InternalParser.g:22005:17: 'short'
			{
			match("short"); 
	...
	public final void mRULE_KW_SIGNED() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22007:16: ( 'signed' )
			// InternalParser.g:22007:18: 'signed'
			{
			match("signed"); 
	...
	public final void mRULE_KW_SIZEOF() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22009:16: ( 'sizeof' )
			// InternalParser.g:22009:18: 'sizeof'
			{
			match("sizeof"); 
	...
	public final void mRULE_KW_STATIC() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22011:16: ( 'static' )
			// InternalParser.g:22011:18: 'static'
			{
			match("static"); 
	...
	public final void mRULE_KW_STRUCT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22013:16: ( 'struct' )
			// InternalParser.g:22013:18: 'struct'
			{
			match("struct"); 
	...
	public final void mRULE_KW_SWITCH() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22015:16: ( 'switch' )
			// InternalParser.g:22015:18: 'switch'
			{
			match("switch"); 
	...
	public final void mRULE_KW_TYPEDEF() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22017:17: ( 'typedef' )
			// InternalParser.g:22017:19: 'typedef'
			{
			match("typedef"); 
	...
	public final void mRULE_KW_UNION() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22019:15: ( 'union' )
			// InternalParser.g:22019:17: 'union'
			{
			match("union"); 
	...
	public final void mRULE_KW_UNSIGNED() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22021:18: ( 'unsigned' )
			// InternalParser.g:22021:20: 'unsigned'
			{
			match("unsigned"); 
	...
	public final void mRULE_KW_VOID() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22023:14: ( 'void' )
			// InternalParser.g:22023:16: 'void'
			{
			match("void"); 
	...
	public final void mRULE_KW_VOLATILE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22025:18: ( 'volatile' )
			// InternalParser.g:22025:20: 'volatile'
			{
			match("volatile"); 
	...
	public final void mRULE_KW_WHILE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22027:15: ( 'while' )
			// InternalParser.g:22027:17: 'while'
			{
			match("while"); 
	...
	public final void mRULE_KW_ALIGNAS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22029:17: ( '_Alignas' )
			// InternalParser.g:22029:19: '_Alignas'
			{
			match("_Alignas"); 
	...
	public final void mRULE_KW_ALIGNOF() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22031:17: ( '_Alignof' )
			// InternalParser.g:22031:19: '_Alignof'
			{
			match("_Alignof"); 
	...
	public final void mRULE_KW_ASM1() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22033:14: ( RULE_SKW_UNDERSCORE RULE_SKW_UNDERSCORE 'asm' )
			// InternalParser.g:22033:16: RULE_SKW_UNDERSCORE RULE_SKW_UNDERSCORE 'asm'
			{
	...
	public final void mRULE_KW_ASM2() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22035:14: ( RULE_KW_ASM1 RULE_SKW_UNDERSCORE RULE_SKW_UNDERSCORE )
			// InternalParser.g:22035:16: RULE_KW_ASM1 RULE_SKW_UNDERSCORE RULE_SKW_UNDERSCORE
			{
			mRULE_KW_ASM1(); 
	...
	public final void mRULE_KW_ATOMIC() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22037:16: ( '_Atomic' )
			// InternalParser.g:22037:18: '_Atomic'
			{
			match("_Atomic"); 
	...
	public final void mRULE_KW_BOOL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22039:14: ( '_Bool' )
			// InternalParser.g:22039:16: '_Bool'
			{
			match("_Bool"); 
	...
	public final void mRULE_KW_COMPLEX() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22041:17: ( '_Complex' )
			// InternalParser.g:22041:19: '_Complex'
			{
			match("_Complex"); 
	...
	public final void mRULE_KW_GENERIC() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22043:17: ( '_Generic' )
			// InternalParser.g:22043:19: '_Generic'
			{
			match("_Generic"); 
	...
	public final void mRULE_KW_IMAGINARY() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22045:19: ( '_Imaginary' )
			// InternalParser.g:22045:21: '_Imaginary'
			{
			match("_Imaginary"); 
	...
	public final void mRULE_KW_NORETURN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22047:18: ( '_Noreturn' )
			// InternalParser.g:22047:20: '_Noreturn'
			{
			match("_Noreturn"); 
	...
	public final void mRULE_KW_STATICASSERT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22049:22: ( '_Static_assert' )
			// InternalParser.g:22049:24: '_Static_assert'
			{
	...
	public final void mRULE_KW_THREADLOCAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22051:21: ( '_Thread_local' )
			// InternalParser.g:22051:23: '_Thread_local'
			{
			match("_Thread_local"); 
	...
	public final void mRULE_KW_PRAGMA() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22053:16: ( 'pragma' )
			// InternalParser.g:22053:18: 'pragma'
			{
			match("pragma"); 
	...
	public final void mRULE_KW_VOLATILE2() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22055:19: ( RULE_SKW_UNDERSCORE RULE_SKW_UNDERSCORE RULE_KW_VOLATILE RULE_SKW_UNDERSCORE RULE_SKW_UNDERSCORE )
			// InternalParser.g:22055:21: RULE_SKW_UNDERSCORE RULE_SKW_UNDERSCORE RULE_KW_VOLATILE RULE_SKW_UNDERSCORE RULE_SKW_UNDERSCORE
			{
			mRULE_SKW_UNDERSCORE(); 
	...
	public final void mRULE_STARASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22057:17: ( RULE_SKW_STAR RULE_SKW_ASSIGN )
			// InternalParser.g:22057:19: RULE_SKW_STAR RULE_SKW_ASSIGN
			{
			mRULE_SKW_STAR(); 
	...
	public final void mRULE_DIVASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22059:16: ( RULE_SKW_DIV RULE_SKW_ASSIGN )
			// InternalParser.g:22059:18: RULE_SKW_DIV RULE_SKW_ASSIGN
			{
			mRULE_SKW_DIV(); 
	...
	public final void mRULE_MODASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22061:16: ( RULE_SKW_MOD RULE_SKW_ASSIGN )
			// InternalParser.g:22061:18: RULE_SKW_MOD RULE_SKW_ASSIGN
			{
			mRULE_SKW_MOD(); 
	...
	public final void mRULE_PLUSASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22063:17: ( RULE_SKW_PLUS RULE_SKW_ASSIGN )
			// InternalParser.g:22063:19: RULE_SKW_PLUS RULE_SKW_ASSIGN
			{
			mRULE_SKW_PLUS(); 
	...
	public final void mRULE_MINUSASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22065:18: ( RULE_SKW_MINUS RULE_SKW_ASSIGN )
			// InternalParser.g:22065:20: RULE_SKW_MINUS RULE_SKW_ASSIGN
			{
			mRULE_SKW_MINUS(); 
	...
	public final void mRULE_LEFTSHIFTASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22067:22: ( RULE_SKW_LEFTSHIFT RULE_SKW_ASSIGN )
			// InternalParser.g:22067:24: RULE_SKW_LEFTSHIFT RULE_SKW_ASSIGN
			{
			mRULE_SKW_LEFTSHIFT(); 
	...
	public final void mRULE_RIGHTSHIFTASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22069:23: ( RULE_SKW_RIGHTSHIFT RULE_SKW_ASSIGN )
			// InternalParser.g:22069:25: RULE_SKW_RIGHTSHIFT RULE_SKW_ASSIGN
			{
	...
	public final void mRULE_ANDASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22071:16: ( RULE_SKW_AND RULE_SKW_ASSIGN )
			// InternalParser.g:22071:18: RULE_SKW_AND RULE_SKW_ASSIGN
			{
			mRULE_SKW_AND(); 
	...
	public final void mRULE_XORASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22073:16: ( RULE_SKW_CARET RULE_SKW_ASSIGN )
			// InternalParser.g:22073:18: RULE_SKW_CARET RULE_SKW_ASSIGN
			{
			mRULE_SKW_CARET(); 
	...
	public final void mRULE_ORASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22075:15: ( RULE_SKW_OR RULE_SKW_ASSIGN )
			// InternalParser.g:22075:17: RULE_SKW_OR RULE_SKW_ASSIGN
			{
			mRULE_SKW_OR(); 
	...
	public final void mRULE_ARROW() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22077:12: ( RULE_SKW_MINUS RULE_SKW_GREATER )
			// InternalParser.g:22077:14: RULE_SKW_MINUS RULE_SKW_GREATER
			{
			mRULE_SKW_MINUS(); 
	...
	public final void mRULE_ELLIPSIS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22079:15: ( RULE_SKW_DOT RULE_SKW_DOT RULE_SKW_DOT )
			// InternalParser.g:22079:17: RULE_SKW_DOT RULE_SKW_DOT RULE_SKW_DOT
			{
			mRULE_SKW_DOT(); 
	...
	public final void mRULE_SINGLEQUOTE() throws RecognitionException {
		try {
			// InternalParser.g:22081:27: ( '\\'' )
			// InternalParser.g:22081:29: '\\''
			{
			match('\''); 
			}
	...
	public final void mRULE_DOUBLEQUOTE() throws RecognitionException {
		try {
			// InternalParser.g:22083:27: ( '\"' )
			// InternalParser.g:22083:29: '\"'
			{
			match('\"'); 
			}
	...
	public final void mRULE_ID() throws RecognitionException {
		try {
			int _type = RULE_ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22085:9: ( RULE_IDENTIFIER )
			// InternalParser.g:22085:11: RULE_IDENTIFIER
			{
			mRULE_IDENTIFIER(); 
	...
	public final void mRULE_IDENTIFIER() throws RecognitionException {
		try {
			// InternalParser.g:22087:26: ( RULE_LETTER ( RULE_LETTER | '0' .. '9' )* )
			// InternalParser.g:22087:28: RULE_LETTER ( RULE_LETTER | '0' .. '9' )*
			{
			mRULE_LETTER(); 

			// InternalParser.g:22087:40: ( RULE_LETTER | '0' .. '9' )*
			loop1:
			while (true) {
				int alt1=2;
	...
	public final void mRULE_LETTER() throws RecognitionException {
		try {
			// InternalParser.g:22089:22: ( ( '$' | 'A' .. 'Z' | 'a' .. 'z' | RULE_SKW_UNDERSCORE ) )
			// InternalParser.g:
			{
	...
	public final void mRULE_CHAR_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22091:19: ( RULE_SINGLEQUOTE ( RULE_ESCAPE_SEQUENCE |~ ( ( RULE_SINGLEQUOTE | RULE_SKW_BACKSLASH ) ) ) RULE_SINGLEQUOTE )
			// InternalParser.g:22091:21: RULE_SINGLEQUOTE ( RULE_ESCAPE_SEQUENCE |~ ( ( RULE_SINGLEQUOTE | RULE_SKW_BACKSLASH ) ) ) RULE_SINGLEQUOTE
			{
			mRULE_SINGLEQUOTE(); 

			// InternalParser.g:22091:38: ( RULE_ESCAPE_SEQUENCE |~ ( ( RULE_SINGLEQUOTE | RULE_SKW_BACKSLASH ) ) )
			int alt2=2;
			...
			switch (alt2) {
				case 1 :
					// InternalParser.g:22091:39: RULE_ESCAPE_SEQUENCE
					{
					...
					break;
				case 2 :
					// InternalParser.g:22091:60: ~ ( ( RULE_SINGLEQUOTE | RULE_SKW_BACKSLASH ) )
					{
	...
	public final void mRULE_STRING_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22093:21: ( RULE_DOUBLEQUOTE ( RULE_ESCAPE_SEQUENCE |~ ( ( RULE_SKW_BACKSLASH | RULE_DOUBLEQUOTE ) ) )* RULE_DOUBLEQUOTE )
			// InternalParser.g:22093:23: RULE_DOUBLEQUOTE ( RULE_ESCAPE_SEQUENCE |~ ( ( RULE_SKW_BACKSLASH | RULE_DOUBLEQUOTE ) ) )* RULE_DOUBLEQUOTE
			{
			mRULE_DOUBLEQUOTE(); 

			// InternalParser.g:22093:40: ( RULE_ESCAPE_SEQUENCE |~ ( ( RULE_SKW_BACKSLASH | RULE_DOUBLEQUOTE ) ) )*
			loop3:
			while (true) {
				int alt3=3;
				...
				switch (alt3) {
				case 1 :
					// InternalParser.g:22093:41: RULE_ESCAPE_SEQUENCE
					{
					mRULE_ESCAPE_SEQUENCE(); 
					...
					break;
				case 2 :
					// InternalParser.g:22093:62: ~ ( ( RULE_SKW_BACKSLASH | RULE_DOUBLEQUOTE ) )
					{
					if ( (input.LA(1) >= '\u0000' && input.LA(1) <= '!')||(input.LA(1) >= '#' && input.LA(1) <= '[')||(input.LA(1) >= ']' && input.LA(1) <= '\uFFFF') ) {
						input.consume();
					}
	...
	public final void mRULE_HEX_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22095:18: ( '0' ( 'x' | 'X' ) ( RULE_HEX_DIGIT )+ ( RULE_INTEGER_TYPE_SUFFIX )? )
			// InternalParser.g:22095:20: '0' ( 'x' | 'X' ) ( RULE_HEX_DIGIT )+ ( RULE_INTEGER_TYPE_SUFFIX )?
			{
			match('0'); 
			...
			// InternalParser.g:22095:34: ( RULE_HEX_DIGIT )+
			int cnt4=0;
			loop4:
			while (true) {
				int alt4=2;
			...
			// InternalParser.g:22095:50: ( RULE_INTEGER_TYPE_SUFFIX )?
			int alt5=2;
	...
	public final void mRULE_DECIMAL_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22097:22: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( RULE_INTEGER_TYPE_SUFFIX )? )
			// InternalParser.g:22097:24: ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( RULE_INTEGER_TYPE_SUFFIX )?
			{
			// InternalParser.g:22097:24: ( '0' | '1' .. '9' ( '0' .. '9' )* )
			int alt7=2;
			...
			switch (alt7) {
				case 1 :
					// InternalParser.g:22097:25: '0'
					{
					match('0'); 
					}
					break;
				case 2 :
					// InternalParser.g:22097:29: '1' .. '9' ( '0' .. '9' )*
					{
					matchRange('1','9'); 
					// InternalParser.g:22097:38: ( '0' .. '9' )*
					loop6:
					while (true) {
						int alt6=2;
			...
			// InternalParser.g:22097:51: ( RULE_INTEGER_TYPE_SUFFIX )?
			int alt8=2;
	...
	public final void mRULE_OCTAL_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22099:20: ( '0' ( '0' .. '7' )+ ( RULE_INTEGER_TYPE_SUFFIX )? )
			// InternalParser.g:22099:22: '0' ( '0' .. '7' )+ ( RULE_INTEGER_TYPE_SUFFIX )?
			{
			match('0'); 
			// InternalParser.g:22099:26: ( '0' .. '7' )+
			int cnt9=0;
			loop9:
			while (true) {
				int alt9=2;
			...
			// InternalParser.g:22099:38: ( RULE_INTEGER_TYPE_SUFFIX )?
			int alt10=2;
	...
	public final void mRULE_BIN_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22101:18: ( ( '0b' | '0B' ) ( '0' .. '1' )+ )
			// InternalParser.g:22101:20: ( '0b' | '0B' ) ( '0' .. '1' )+
			{
			// InternalParser.g:22101:20: ( '0b' | '0B' )
			int alt11=2;
	...
	public final void mRULE_HEX_DIGIT() throws RecognitionException {
		try {
			// InternalParser.g:22103:25: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
			// InternalParser.g:
			{
			if ( (input.LA(1) >= '0' && input.LA(1) <= '9')||(input.LA(1) >= 'A' && input.LA(1) <= 'F')||(input.LA(1) >= 'a' && input.LA(1) <= 'f') ) {
				input.consume();
	...
	public final void mRULE_INTEGER_TYPE_SUFFIX() throws RecognitionException {
		try {
			// InternalParser.g:22105:35: ( ( ( 'u' | 'U' )? ( 'l' | 'L' ) | ( 'u' | 'U' ) ( 'l' | 'L' )? ) )
			// InternalParser.g:22105:37: ( ( 'u' | 'U' )? ( 'l' | 'L' ) | ( 'u' | 'U' ) ( 'l' | 'L' )? )
			{
			// InternalParser.g:22105:37: ( ( 'u' | 'U' )? ( 'l' | 'L' ) | ( 'u' | 'U' ) ( 'l' | 'L' )? )
			int alt15=2;
			...
			switch (alt15) {
				case 1 :
					// InternalParser.g:22105:38: ( 'u' | 'U' )? ( 'l' | 'L' )
					{
					// InternalParser.g:22105:38: ( 'u' | 'U' )?
					int alt13=2;
					...
					break;
				case 2 :
					// InternalParser.g:22105:59: ( 'u' | 'U' ) ( 'l' | 'L' )?
					{
					if ( input.LA(1)=='U'||input.LA(1)=='u' ) {
						input.consume();
					}
	...
	public final void mRULE_FLOAT_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22107:20: ( ( ( '0' .. '9' )+ RULE_SKW_DOT ( '0' .. '9' )* ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | RULE_SKW_DOT ( '0' .. '9' )+ ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ RULE_EXPONENT ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ ( RULE_EXPONENT )? RULE_FLOAT_TYPE_SUFFIX ) )
			// InternalParser.g:22107:22: ( ( '0' .. '9' )+ RULE_SKW_DOT ( '0' .. '9' )* ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | RULE_SKW_DOT ( '0' .. '9' )+ ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ RULE_EXPONENT ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ ( RULE_EXPONENT )? RULE_FLOAT_TYPE_SUFFIX )
			{
			// InternalParser.g:22107:22: ( ( '0' .. '9' )+ RULE_SKW_DOT ( '0' .. '9' )* ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | RULE_SKW_DOT ( '0' .. '9' )+ ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ RULE_EXPONENT ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ ( RULE_EXPONENT )? RULE_FLOAT_TYPE_SUFFIX )
			int alt27=4;
			...
			switch (alt27) {
				case 1 :
					// InternalParser.g:22107:23: ( '0' .. '9' )+ RULE_SKW_DOT ( '0' .. '9' )* ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )?
					{
					// InternalParser.g:22107:23: ( '0' .. '9' )+
					int cnt16=0;
					loop16:
					while (true) {
						int alt16=2;
					...
					// InternalParser.g:22107:60: ( RULE_EXPONENT )?
					int alt18=2;
					...
					// InternalParser.g:22107:75: ( RULE_FLOAT_TYPE_SUFFIX )?
					int alt19=2;
					...
					break;
				case 2 :
					// InternalParser.g:22107:99: RULE_SKW_DOT ( '0' .. '9' )+ ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )?
					{
					mRULE_SKW_DOT(); 

					// InternalParser.g:22107:112: ( '0' .. '9' )+
					int cnt20=0;
					loop20:
					while (true) {
						int alt20=2;
					...
					// InternalParser.g:22107:124: ( RULE_EXPONENT )?
					int alt21=2;
					...
					// InternalParser.g:22107:139: ( RULE_FLOAT_TYPE_SUFFIX )?
					int alt22=2;
					...
					break;
				case 3 :
					// InternalParser.g:22107:163: ( '0' .. '9' )+ RULE_EXPONENT ( RULE_FLOAT_TYPE_SUFFIX )?
					{
					// InternalParser.g:22107:163: ( '0' .. '9' )+
					int cnt23=0;
					loop23:
					while (true) {
						int alt23=2;
					...
					// InternalParser.g:22107:189: ( RULE_FLOAT_TYPE_SUFFIX )?
					int alt24=2;
					...
					break;
				case 4 :
					// InternalParser.g:22107:213: ( '0' .. '9' )+ ( RULE_EXPONENT )? RULE_FLOAT_TYPE_SUFFIX
					{
					// InternalParser.g:22107:213: ( '0' .. '9' )+
					int cnt25=0;
					loop25:
					while (true) {
						int alt25=2;
					...
					// InternalParser.g:22107:225: ( RULE_EXPONENT )?
					int alt26=2;
	...
	public final void mRULE_EXPONENT() throws RecognitionException {
		try {
			// InternalParser.g:22109:24: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
			// InternalParser.g:22109:26: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
			{
	...
	public final void mRULE_FLOAT_TYPE_SUFFIX() throws RecognitionException {
		try {
			// InternalParser.g:22111:33: ( ( 'f' | 'F' | 'd' | 'D' ) )
			// InternalParser.g:
			{
			if ( input.LA(1)=='D'||input.LA(1)=='F'||input.LA(1)=='d'||input.LA(1)=='f' ) {
				input.consume();
	...
	public final void mRULE_ESCAPE_SEQUENCE() throws RecognitionException {
		try {
			// InternalParser.g:22113:31: ( ( RULE_SKW_BACKSLASH ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | RULE_SINGLEQUOTE | RULE_SKW_BACKSLASH ) | RULE_OCTAL_ESCAPE ) )
			// InternalParser.g:22113:33: ( RULE_SKW_BACKSLASH ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | RULE_SINGLEQUOTE | RULE_SKW_BACKSLASH ) | RULE_OCTAL_ESCAPE )
			{
			// InternalParser.g:22113:33: ( RULE_SKW_BACKSLASH ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | RULE_SINGLEQUOTE | RULE_SKW_BACKSLASH ) | RULE_OCTAL_ESCAPE )
			int alt30=2;
			...
			switch (alt30) {
				case 1 :
					// InternalParser.g:22113:34: RULE_SKW_BACKSLASH ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | RULE_SINGLEQUOTE | RULE_SKW_BACKSLASH )
					{
					mRULE_SKW_BACKSLASH(); 
					...
					break;
				case 2 :
					// InternalParser.g:22113:115: RULE_OCTAL_ESCAPE
					{
					mRULE_OCTAL_ESCAPE(); 
	...
	public final void mRULE_OCTAL_ESCAPE() throws RecognitionException {
		try {
			// InternalParser.g:22115:28: ( ( RULE_SKW_BACKSLASH '0' .. '3' '0' .. '7' '0' .. '7' | RULE_SKW_BACKSLASH '0' .. '7' '0' .. '7' | RULE_SKW_BACKSLASH '0' .. '7' ) )
			// InternalParser.g:22115:30: ( RULE_SKW_BACKSLASH '0' .. '3' '0' .. '7' '0' .. '7' | RULE_SKW_BACKSLASH '0' .. '7' '0' .. '7' | RULE_SKW_BACKSLASH '0' .. '7' )
			{
			// InternalParser.g:22115:30: ( RULE_SKW_BACKSLASH '0' .. '3' '0' .. '7' '0' .. '7' | RULE_SKW_BACKSLASH '0' .. '7' '0' .. '7' | RULE_SKW_BACKSLASH '0' .. '7' )
			int alt31=3;
			...
			switch (alt31) {
				case 1 :
					// InternalParser.g:22115:31: RULE_SKW_BACKSLASH '0' .. '3' '0' .. '7' '0' .. '7'
					{
					mRULE_SKW_BACKSLASH(); 
					...
					break;
				case 2 :
					// InternalParser.g:22115:77: RULE_SKW_BACKSLASH '0' .. '7' '0' .. '7'
					{
					mRULE_SKW_BACKSLASH(); 
					...
					break;
				case 3 :
					// InternalParser.g:22115:114: RULE_SKW_BACKSLASH '0' .. '7'
					{
					mRULE_SKW_BACKSLASH(); 
	...
	public final void mRULE_UNICODE_ESCAPE() throws RecognitionException {
		try {
			// InternalParser.g:22117:30: ( RULE_SKW_BACKSLASH 'u' RULE_HEX_DIGIT RULE_HEX_DIGIT RULE_HEX_DIGIT RULE_HEX_DIGIT )
			// InternalParser.g:22117:32: RULE_SKW_BACKSLASH 'u' RULE_HEX_DIGIT RULE_HEX_DIGIT RULE_HEX_DIGIT RULE_HEX_DIGIT
			{
			mRULE_SKW_BACKSLASH(); 
	...
	public final void mRULE_LINEDIRECTIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22119:20: ( '#' (~ ( RULE_NEWLINE ) | RULE_SKW_BACKSLASH RULE_NEWLINE )* )
			// InternalParser.g:22119:22: '#' (~ ( RULE_NEWLINE ) | RULE_SKW_BACKSLASH RULE_NEWLINE )*
			{
			match('#'); 
			// InternalParser.g:22119:26: (~ ( RULE_NEWLINE ) | RULE_SKW_BACKSLASH RULE_NEWLINE )*
			loop32:
			while (true) {
				int alt32=3;
				...
				switch (alt32) {
				case 1 :
					// InternalParser.g:22119:27: ~ ( RULE_NEWLINE )
					{
					...
					break;
				case 2 :
					// InternalParser.g:22119:43: RULE_SKW_BACKSLASH RULE_NEWLINE
					{
					mRULE_SKW_BACKSLASH(); 
	...
	public final void mRULE_WHITESPACE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22121:17: ( ( ' ' | '\\t' )+ )
			// InternalParser.g:22121:19: ( ' ' | '\\t' )+
			{
			// InternalParser.g:22121:19: ( ' ' | '\\t' )+
			int cnt33=0;
			loop33:
	...
	public final void mRULE_BLOCK_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22123:20: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// InternalParser.g:22123:22: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// InternalParser.g:22123:27: ( options {greedy=false; } : . )*
			loop34:
			while (true) {
				int alt34=2;
	...
	public final void mRULE_LINE_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22125:19: ( '//' (~ ( RULE_NEWLINE ) )* )
			// InternalParser.g:22125:21: '//' (~ ( RULE_NEWLINE ) )*
			{
			match("//"); 

			// InternalParser.g:22125:26: (~ ( RULE_NEWLINE ) )*
			loop35:
			while (true) {
				int alt35=2;
	...
	public final void mRULE_SKW_AND() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22129:14: ( '&' )
			// InternalParser.g:22129:16: '&'
			{
			match('&'); 
			}
	...
	public final void mRULE_SKW_ANDAND() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22131:17: ( RULE_SKW_AND RULE_SKW_AND )
			// InternalParser.g:22131:19: RULE_SKW_AND RULE_SKW_AND
			{
			mRULE_SKW_AND(); 
	...
	public final void mRULE_SKW_ASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22133:17: ( '=' )
			// InternalParser.g:22133:19: '='
			{
			match('='); 
			}
	...
	public final void mRULE_SKW_BACKSLASH() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22135:20: ( '\\\\' )
			// InternalParser.g:22135:22: '\\\\'
			{
			match('\\'); 
			}
	...
	public final void mRULE_SKW_CARET() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22137:16: ( '^' )
			// InternalParser.g:22137:18: '^'
			{
			match('^'); 
			}
	...
	public final void mRULE_SKW_COMMA() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22139:16: ( ',' )
			// InternalParser.g:22139:18: ','
			{
			match(','); 
			}
	...
	public final void mRULE_SKW_COLON() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22141:16: ( ':' )
			// InternalParser.g:22141:18: ':'
			{
			match(':'); 
			}
	...
	public final void mRULE_SKW_DIV() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22143:14: ( '/' )
			// InternalParser.g:22143:16: '/'
			{
			match('/'); 
			}
	...
	public final void mRULE_SKW_DOLLAR() throws RecognitionException {
		try {
			// InternalParser.g:22145:26: ( '$' )
			// InternalParser.g:22145:28: '$'
			{
			match('$'); 
			}
	...
	public final void mRULE_SKW_DOT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22147:14: ( '.' )
			// InternalParser.g:22147:16: '.'
			{
			match('.'); 
			}
	...
	public final void mRULE_SKW_DOUBLEQUOTE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22149:22: ( '\"' )
			// InternalParser.g:22149:24: '\"'
			{
			match('\"'); 
			}
	...
	public final void mRULE_SKW_EQUAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22151:16: ( RULE_SKW_ASSIGN RULE_SKW_ASSIGN )
			// InternalParser.g:22151:18: RULE_SKW_ASSIGN RULE_SKW_ASSIGN
			{
			mRULE_SKW_ASSIGN(); 
	...
	public final void mRULE_SKW_GREATER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22153:18: ( '>' )
			// InternalParser.g:22153:20: '>'
			{
			match('>'); 
			}
	...
	public final void mRULE_SKW_GREATEREQUAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22155:23: ( RULE_SKW_GREATER RULE_SKW_ASSIGN )
			// InternalParser.g:22155:25: RULE_SKW_GREATER RULE_SKW_ASSIGN
			{
			mRULE_SKW_GREATER(); 
	...
	public final void mRULE_SKW_LEFTBRACE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22157:20: ( '{' )
			// InternalParser.g:22157:22: '{'
			{
			match('{'); 
			}
	...
	public final void mRULE_SKW_LEFTBRACKET() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22159:22: ( '[' )
			// InternalParser.g:22159:24: '['
			{
			match('['); 
			}
	...
	public final void mRULE_SKW_LEFTPAREN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22161:20: ( '(' )
			// InternalParser.g:22161:22: '('
			{
			match('('); 
			}
	...
	public final void mRULE_SKW_LEFTSHIFT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22163:20: ( RULE_SKW_LESS RULE_SKW_LESS )
			// InternalParser.g:22163:22: RULE_SKW_LESS RULE_SKW_LESS
			{
			mRULE_SKW_LESS(); 
	...
	public final void mRULE_SKW_LESS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22165:15: ( '<' )
			// InternalParser.g:22165:17: '<'
			{
			match('<'); 
			}
	...
	public final void mRULE_SKW_LESSEQUAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22167:20: ( RULE_SKW_LESS RULE_SKW_ASSIGN )
			// InternalParser.g:22167:22: RULE_SKW_LESS RULE_SKW_ASSIGN
			{
			mRULE_SKW_LESS(); 
	...
	public final void mRULE_SKW_MINUS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22169:16: ( '-' )
			// InternalParser.g:22169:18: '-'
			{
			match('-'); 
			}
	...
	public final void mRULE_SKW_MINUSMINUS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22171:21: ( RULE_SKW_MINUS RULE_SKW_MINUS )
			// InternalParser.g:22171:23: RULE_SKW_MINUS RULE_SKW_MINUS
			{
			mRULE_SKW_MINUS(); 
	...
	public final void mRULE_SKW_MOD() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22173:14: ( '%' )
			// InternalParser.g:22173:16: '%'
			{
			match('%'); 
			}
	...
	public final void mRULE_SKW_NOT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22175:14: ( '!' )
			// InternalParser.g:22175:16: '!'
			{
			match('!'); 
			}
	...
	public final void mRULE_SKW_NOTEQUAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22177:19: ( RULE_SKW_NOT RULE_SKW_ASSIGN )
			// InternalParser.g:22177:21: RULE_SKW_NOT RULE_SKW_ASSIGN
			{
			mRULE_SKW_NOT(); 
	...
	public final void mRULE_SKW_OR() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22179:13: ( '|' )
			// InternalParser.g:22179:15: '|'
			{
			match('|'); 
			}
	...
	public final void mRULE_SKW_OROR() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22181:15: ( RULE_SKW_OR RULE_SKW_OR )
			// InternalParser.g:22181:17: RULE_SKW_OR RULE_SKW_OR
			{
			mRULE_SKW_OR(); 
	...
	public final void mRULE_SKW_PLUS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22183:15: ( '+' )
			// InternalParser.g:22183:17: '+'
			{
			match('+'); 
			}
	...
	public final void mRULE_SKW_PLUSPLUS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22185:19: ( RULE_SKW_PLUS RULE_SKW_PLUS )
			// InternalParser.g:22185:21: RULE_SKW_PLUS RULE_SKW_PLUS
			{
			mRULE_SKW_PLUS(); 
	...
	public final void mRULE_SKW_QUESTION() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22187:19: ( '?' )
			// InternalParser.g:22187:21: '?'
			{
			match('?'); 
			}
	...
	public final void mRULE_SKW_RIGHTBRACE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22189:21: ( '}' )
			// InternalParser.g:22189:23: '}'
			{
			match('}'); 
			}
	...
	public final void mRULE_SKW_RIGHTBRACKET() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22191:23: ( ']' )
			// InternalParser.g:22191:25: ']'
			{
			match(']'); 
			}
	...
	public final void mRULE_SKW_RIGHTPAREN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22193:21: ( ')' )
			// InternalParser.g:22193:23: ')'
			{
			match(')'); 
			}
	...
	public final void mRULE_SKW_RIGHTSHIFT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22195:21: ( RULE_SKW_GREATER RULE_SKW_GREATER )
			// InternalParser.g:22195:23: RULE_SKW_GREATER RULE_SKW_GREATER
			{
			mRULE_SKW_GREATER(); 
	...
	public final void mRULE_SKW_SEMI() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22197:15: ( ';' )
			// InternalParser.g:22197:17: ';'
			{
			match(';'); 
			}
	...
	public final void mRULE_SKW_SINGLEQUOTE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22199:22: ( '\\'' )
			// InternalParser.g:22199:24: '\\''
			{
			match('\''); 
			}
	...
	public final void mRULE_SKW_STAR() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22201:15: ( '*' )
			// InternalParser.g:22201:17: '*'
			{
			match('*'); 
			}
	...
	public final void mRULE_SKW_TILDE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22203:16: ( '~' )
			// InternalParser.g:22203:18: '~'
			{
			match('~'); 
			}
	...
	public final void mRULE_SKW_UNDERSCORE() throws RecognitionException {
		try {
			// InternalParser.g:22205:30: ( '_' )
			// InternalParser.g:22205:32: '_'
			{
			match('_'); 
			}
	...
	public final void mRULE_SPECIAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:22207:14: ( . )
			// InternalParser.g:22207:16: .
			{
			matchAny(); 
			}
	...
	protected class DFA27 extends DFA {
		...
		public String getDescription() {
			return "22107:22: ( ( '0' .. '9' )+ RULE_SKW_DOT ( '0' .. '9' )* ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | RULE_SKW_DOT ( '0' .. '9' )+ ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ RULE_EXPONENT ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ ( RULE_EXPONENT )? RULE_FLOAT_TYPE_SUFFIX )";
		}
	}
