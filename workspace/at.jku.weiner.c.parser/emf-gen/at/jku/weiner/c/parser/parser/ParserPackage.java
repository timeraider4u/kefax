...
public interface ParserPackage extends EPackage
{
	 ...
	 * @ordered
	 */
	int TYPE_SPECIFIER__TYPE_NAME = 5;
	 ...
	 * @ordered
	 */
	int DECLARATOR_SUFFIX__LAST_SUFFIX = 1;
	 ...
	 * @ordered
	 */
	int DECLARATOR_SUFFIX_FEATURE_COUNT = 2;
	 ...
	 * @generated
	 */
	int GCC_DECLARATOR_EXTENSION = 26;
	...
	/**
	 * The feature id for the '<em><b>Gcc Decl Ext Abstract</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ABSTRACT_DECLARATOR__GCC_DECL_EXT_ABSTRACT = 2;
	 ...
	 * @ordered
	 */
	int ABSTRACT_DECLARATOR_FEATURE_COUNT = 3;

	/**
	 * The meta object id for the '{@link at.jku.weiner.c.parser.parser.impl.DirectAbstractDeclaratorImpl <em>Direct Abstract Declarator</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see at.jku.weiner.c.parser.parser.impl.DirectAbstractDeclaratorImpl
	 * @see at.jku.weiner.c.parser.parser.impl.ParserPackageImpl#getDirectAbstractDeclarator()
	 * @generated
	 */
	int DIRECT_ABSTRACT_DECLARATOR = 39;
	 ...
	 * @ordered
	 */
	int DIRECT_ABSTRACT_DECLARATOR__DECLARATOR = 0;
	 ...
	 * @ordered
	 */
	int DIRECT_ABSTRACT_DECLARATOR__GCC_DECL_EXT = 1;

	/**
	 * The feature id for the '<em><b>Abstract Declarator Suffix</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int DIRECT_ABSTRACT_DECLARATOR__ABSTRACT_DECLARATOR_SUFFIX = 2;
	 ...
	 * @ordered
	 */
	int DIRECT_ABSTRACT_DECLARATOR_FEATURE_COUNT = 3;

	/**
	 * The meta object id for the '{@link at.jku.weiner.c.parser.parser.impl.AbstractDeclaratorSuffixImpl <em>Abstract Declarator Suffix</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see at.jku.weiner.c.parser.parser.impl.AbstractDeclaratorSuffixImpl
	 * @see at.jku.weiner.c.parser.parser.impl.ParserPackageImpl#getAbstractDeclaratorSuffix()
	 * @generated
	 */
	int ABSTRACT_DECLARATOR_SUFFIX = 40;
	 ...
	 * @ordered
	 */
	int ABSTRACT_DECLARATOR_SUFFIX__TYPE_QUALIFIER_LIST = 0;
	 ...
	 * @ordered
	 */
	int ABSTRACT_DECLARATOR_SUFFIX__ASSIGNMENT_EXPR = 1;

	/**
	 * The feature id for the '<em><b>Type Qualifier List Orig</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ABSTRACT_DECLARATOR_SUFFIX__TYPE_QUALIFIER_LIST_ORIG = 2;
	 ...
	 * @ordered
	 */
	int ABSTRACT_DECLARATOR_SUFFIX__PARAMETER_TYPE_LIST = 3;
	 ...
	 * @ordered
	 */
	int ABSTRACT_DECLARATOR_SUFFIX__GCC_DECL_EXT = 4;

	/**
	 * The number of structural features of the '<em>Abstract Declarator Suffix</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ABSTRACT_DECLARATOR_SUFFIX_FEATURE_COUNT = 5;
	...
	/**
	 * The meta object id for the '{@link at.jku.weiner.c.parser.parser.impl.InitImpl <em>Init</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see at.jku.weiner.c.parser.parser.impl.InitImpl
	 * @see at.jku.weiner.c.parser.parser.impl.ParserPackageImpl#getInit()
	 * @generated
	 */
	int INIT = 43;
	...
	/**
	 * The meta object id for the '{@link at.jku.weiner.c.parser.parser.impl.AsmSymbolicNameImpl <em>Asm Symbolic Name</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see at.jku.weiner.c.parser.parser.impl.AsmSymbolicNameImpl
	 * @see at.jku.weiner.c.parser.parser.impl.ParserPackageImpl#getAsmSymbolicName()
	 * @generated
	 */
	 ...
	 * @ordered
	 */
	int ASM_SYMBOLIC_NAME_FEATURE_COUNT = 1;
	 ...
	 * @ordered
	 */
	int ASM_LINE_WITHOUT_COLON__ASM_LINES = 0;
	 ...
	 * @ordered
	 */
	int ASM_LINE_WITHOUT_COLON_FEATURE_COUNT = 1;

	/**
	 * The meta object id for the '{@link at.jku.weiner.c.parser.parser.impl.DesignationImpl <em>Designation</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see at.jku.weiner.c.parser.parser.impl.DesignationImpl
	 * @see at.jku.weiner.c.parser.parser.impl.ParserPackageImpl#getDesignation()
	 * @generated
	 */
	int DESIGNATION = 50;
	...
	/**
	 * The meta object id for the '{@link at.jku.weiner.c.parser.parser.impl.DesignatorListImpl <em>Designator List</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see at.jku.weiner.c.parser.parser.impl.DesignatorListImpl
	 * @see at.jku.weiner.c.parser.parser.impl.ParserPackageImpl#getDesignatorList()
	 * @generated
	 */
	int DESIGNATOR_LIST = 51;

	/**
	 * The feature id for the '<em><b>Designator</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 ...
	 * @ordered
	 */
	int DESIGNATOR_LIST_FEATURE_COUNT = 1;

	/**
	 * The meta object id for the '{@link at.jku.weiner.c.parser.parser.impl.DesignatorImpl <em>Designator</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see at.jku.weiner.c.parser.parser.impl.DesignatorImpl
	 * @see at.jku.weiner.c.parser.parser.impl.ParserPackageImpl#getDesignator()
	 * @generated
	 */
	int DESIGNATOR = 52;
	 ...
	 * @ordered
	 */
	int DESIGNATOR_FEATURE_COUNT = 3;
	 ...
	 * @ordered
	 */
	int EXPRESSION__LEFT = CommonPackage.EXPRESSION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int EXPRESSION__RIGHT = CommonPackage.EXPRESSION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int EXPRESSION_FEATURE_COUNT = CommonPackage.EXPRESSION_FEATURE_COUNT + 2;
	 ...
	 * @generated
	 */
	int POSTFIX_EXPRESSION_SUFFIX = 54;
	 ...
	 * @generated
	 */
	int ARGUMENT_EXPRESSION_LIST = 55;
	 ...
	 * @ordered
	 */
	int LABELED_STATEMENT__MYDEFAULT = STATEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int LABELED_STATEMENT__HIGHER = STATEMENT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int LABELED_STATEMENT_FEATURE_COUNT = STATEMENT_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int CONDITIONAL_EXPRESSION__QEXPR = EXPRESSION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int CONDITIONAL_EXPRESSION__CEXPR = EXPRESSION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int LOGICAL_OR_EXPRESSION__LEFT = EXPRESSION__LEFT;
	 ...
	 * @ordered
	 */
	int LOGICAL_OR_EXPRESSION__RIGHT = EXPRESSION__RIGHT;
	 ...
	 * @ordered
	 */
	int LOGICAL_OR_EXPRESSION_FEATURE_COUNT = EXPRESSION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int LOGICAL_AND_EXPRESSION__LEFT = EXPRESSION__LEFT;
	 ...
	 * @ordered
	 */
	int LOGICAL_AND_EXPRESSION__RIGHT = EXPRESSION__RIGHT;
	 ...
	 * @ordered
	 */
	int LOGICAL_AND_EXPRESSION_FEATURE_COUNT = EXPRESSION_FEATURE_COUNT + 0;
	 ...
	 * @generated
	 */
	int INCLUSIVE_OR_EXPRESSION = 71;
	 ...
	 * @ordered
	 */
	int INCLUSIVE_OR_EXPRESSION__LEFT = EXPRESSION__LEFT;
	 ...
	 * @ordered
	 */
	int INCLUSIVE_OR_EXPRESSION__RIGHT = EXPRESSION__RIGHT;
	 ...
	 * @ordered
	 */
	int INCLUSIVE_OR_EXPRESSION_FEATURE_COUNT = EXPRESSION_FEATURE_COUNT + 0;
	 ...
	 * @generated
	 */
	int EXCLUSIVE_OR_EXPRESSION = 72;
	 ...
	 * @ordered
	 */
	int EXCLUSIVE_OR_EXPRESSION__LEFT = EXPRESSION__LEFT;
	 ...
	 * @ordered
	 */
	int EXCLUSIVE_OR_EXPRESSION__RIGHT = EXPRESSION__RIGHT;
	 ...
	 * @ordered
	 */
	int EXCLUSIVE_OR_EXPRESSION_FEATURE_COUNT = EXPRESSION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int EQUALITY_EXPRESSION__LEFT = EXPRESSION__LEFT;
	 ...
	 * @ordered
	 */
	int EQUALITY_EXPRESSION__RIGHT = EXPRESSION__RIGHT;
	 ...
	 * @ordered
	 */
	int EQUALITY_EXPRESSION_FEATURE_COUNT = EXPRESSION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RELATIONAL_EXPRESSION__LEFT = EXPRESSION__LEFT;
	 ...
	 * @ordered
	 */
	int RELATIONAL_EXPRESSION__RIGHT = EXPRESSION__RIGHT;
	 ...
	 * @ordered
	 */
	int RELATIONAL_EXPRESSION_FEATURE_COUNT = EXPRESSION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SHIFT_EXPRESSION__LEFT = EXPRESSION__LEFT;
	 ...
	 * @ordered
	 */
	int SHIFT_EXPRESSION__RIGHT = EXPRESSION__RIGHT;
	 ...
	 * @ordered
	 */
	int SHIFT_EXPRESSION_FEATURE_COUNT = EXPRESSION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ADDITIVE_EXPRESSION__LEFT = EXPRESSION__LEFT;
	 ...
	 * @ordered
	 */
	int ADDITIVE_EXPRESSION__RIGHT = EXPRESSION__RIGHT;
	 ...
	 * @ordered
	 */
	int ADDITIVE_EXPRESSION_FEATURE_COUNT = EXPRESSION_FEATURE_COUNT + 1;
	 ...
	 * @generated
	 */
	int MULTIPLICATIVE_EXPRESSION = 78;
	 ...
	 * @ordered
	 */
	int MULTIPLICATIVE_EXPRESSION__LEFT = EXPRESSION__LEFT;
	 ...
	 * @ordered
	 */
	int MULTIPLICATIVE_EXPRESSION__RIGHT = EXPRESSION__RIGHT;
	 ...
	 * @ordered
	 */
	int MULTIPLICATIVE_EXPRESSION_FEATURE_COUNT = EXPRESSION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int POSTFIX_EXPRESSION__LEFT = EXPRESSION__LEFT;
	 ...
	 * @ordered
	 */
	int POSTFIX_EXPRESSION__RIGHT = EXPRESSION__RIGHT;
	 ...
	 * @generated
	 */
	int POSTFIX_EXPRESSION_SUFFIX_ARRAY = 82;
	 ...
	 * @generated
	 */
	int POSTFIX_EXPRESSION_SUFFIX_ARGUMENT = 83;
	 ...
	 * @generated
	 */
	int POSTFIX_EXPRESSION_SUFFIX_PLUS_PLUS = 86;
	 ...
	 * @generated
	 */
	int POSTFIX_EXPRESSION_SUFFIX_MINUS_MINUS = 87;
	 ...
	 * @ordered
	 */
	int PRIMARY_EXPRESSION__LEFT = EXPRESSION__LEFT;
	 ...
	 * @ordered
	 */
	int PRIMARY_EXPRESSION__EXPR = EXPRESSION_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int PRIMARY_EXPRESSION__COMPOUND_STMT = EXPRESSION_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int PRIMARY_EXPRESSION__BUILTIN_OFFSETOF = EXPRESSION_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int PRIMARY_EXPRESSION__TYPE_NAME = EXPRESSION_FEATURE_COUNT + 8;
	 ...
	 * @ordered
	 */
	int PRIMARY_EXPRESSION__BUILTIN_TYPESCOMPATIBLEP = EXPRESSION_FEATURE_COUNT + 9;
	 ...
	 * @ordered
	 */
	int PRIMARY_EXPRESSION__TYPE_NAME2 = EXPRESSION_FEATURE_COUNT + 10;
	...
	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.TypeSpecifier#getTypeName <em>Type Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Type Name</em>'.
	 * @see at.jku.weiner.c.parser.parser.TypeSpecifier#getTypeName()
	 * @see #getTypeSpecifier()
	 * @generated
	 */
	EReference getTypeSpecifier_TypeName();
	...
	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.AbstractDeclarator#getDirectAbstractDeclarator <em>Direct Abstract Declarator</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Direct Abstract Declarator</em>'.
	 * @see at.jku.weiner.c.parser.parser.AbstractDeclarator#getDirectAbstractDeclarator()
	 * @see #getAbstractDeclarator()
	 * @generated
	 */
	EReference getAbstractDeclarator_DirectAbstractDeclarator();

	/**
	 * Returns the meta object for the containment reference list '{@link at.jku.weiner.c.parser.parser.AbstractDeclarator#getGccDeclExtAbstract <em>Gcc Decl Ext Abstract</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Gcc Decl Ext Abstract</em>'.
	 * @see at.jku.weiner.c.parser.parser.AbstractDeclarator#getGccDeclExtAbstract()
	 * @see #getAbstractDeclarator()
	 * @generated
	 */
	EReference getAbstractDeclarator_GccDeclExtAbstract();

	/**
	 * Returns the meta object for class '{@link at.jku.weiner.c.parser.parser.DirectAbstractDeclarator <em>Direct Abstract Declarator</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.DirectAbstractDeclarator#getDeclarator <em>Declarator</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Declarator</em>'.
	 * @see at.jku.weiner.c.parser.parser.DirectAbstractDeclarator#getDeclarator()
	...
	/**
	 * Returns the meta object for the containment reference list '{@link at.jku.weiner.c.parser.parser.DirectAbstractDeclarator#getGccDeclExt <em>Gcc Decl Ext</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Gcc Decl Ext</em>'.
	 * @see at.jku.weiner.c.parser.parser.DirectAbstractDeclarator#getGccDeclExt()
	 * @see #getDirectAbstractDeclarator()
	 * @generated
	 */
	EReference getDirectAbstractDeclarator_GccDeclExt();

	/**
	 * Returns the meta object for the containment reference list '{@link at.jku.weiner.c.parser.parser.DirectAbstractDeclarator#getAbstractDeclaratorSuffix <em>Abstract Declarator Suffix</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Abstract Declarator Suffix</em>'.
	 * @see at.jku.weiner.c.parser.parser.DirectAbstractDeclarator#getAbstractDeclaratorSuffix()
	 * @see #getDirectAbstractDeclarator()
	 * @generated
	 */
	EReference getDirectAbstractDeclarator_AbstractDeclaratorSuffix();

	/**
	 * Returns the meta object for class '{@link at.jku.weiner.c.parser.parser.AbstractDeclaratorSuffix <em>Abstract Declarator Suffix</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Abstract Declarator Suffix</em>'.
	 * @see at.jku.weiner.c.parser.parser.AbstractDeclaratorSuffix
	 * @generated
	 */
	EClass getAbstractDeclaratorSuffix();

	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.AbstractDeclaratorSuffix#getTypeQualifierList <em>Type Qualifier List</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Type Qualifier List</em>'.
	 * @see at.jku.weiner.c.parser.parser.AbstractDeclaratorSuffix#getTypeQualifierList()
	 * @see #getAbstractDeclaratorSuffix()
	 * @generated
	 */
	EReference getAbstractDeclaratorSuffix_TypeQualifierList();

	/**
	 * Returns the meta object for the containment reference list '{@link at.jku.weiner.c.parser.parser.AbstractDeclaratorSuffix#getAssignmentExpr <em>Assignment Expr</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Assignment Expr</em>'.
	 * @see at.jku.weiner.c.parser.parser.AbstractDeclaratorSuffix#getAssignmentExpr()
	 * @see #getAbstractDeclaratorSuffix()
	 * @generated
	 */
	EReference getAbstractDeclaratorSuffix_AssignmentExpr();

	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.AbstractDeclaratorSuffix#getTypeQualifierListOrig <em>Type Qualifier List Orig</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Type Qualifier List Orig</em>'.
	 * @see at.jku.weiner.c.parser.parser.AbstractDeclaratorSuffix#getTypeQualifierListOrig()
	 * @see #getAbstractDeclaratorSuffix()
	 * @generated
	 */
	EReference getAbstractDeclaratorSuffix_TypeQualifierListOrig();

	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.AbstractDeclaratorSuffix#getParameterTypeList <em>Parameter Type List</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Parameter Type List</em>'.
	 * @see at.jku.weiner.c.parser.parser.AbstractDeclaratorSuffix#getParameterTypeList()
	 * @see #getAbstractDeclaratorSuffix()
	 * @generated
	 */
	EReference getAbstractDeclaratorSuffix_ParameterTypeList();

	/**
	 * Returns the meta object for the containment reference list '{@link at.jku.weiner.c.parser.parser.AbstractDeclaratorSuffix#getGccDeclExt <em>Gcc Decl Ext</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Gcc Decl Ext</em>'.
	 * @see at.jku.weiner.c.parser.parser.AbstractDeclaratorSuffix#getGccDeclExt()
	 * @see #getAbstractDeclaratorSuffix()
	 * @generated
	 */
	EReference getAbstractDeclaratorSuffix_GccDeclExt();
	...
	/**
	 * Returns the meta object for the attribute '{@link at.jku.weiner.c.parser.parser.Initializer#isLastComma <em>Last Comma</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Last Comma</em>'.
	 * @see at.jku.weiner.c.parser.parser.Initializer#isLastComma()
	 * @see #getInitializer()
	 * @generated
	 */
	EAttribute getInitializer_LastComma();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link at.jku.weiner.c.parser.parser.InitializerList#getInit <em>Init</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Init</em>'.
	 * @see at.jku.weiner.c.parser.parser.InitializerList#getInit()
	...
	/**
	 * Returns the meta object for class '{@link at.jku.weiner.c.parser.parser.Init <em>Init</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.Init#getDesignation <em>Designation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Designation</em>'.
	 * @see at.jku.weiner.c.parser.parser.Init#getDesignation()
	 * @see #getInit()
	 * @generated
	 */
	EReference getInit_Designation();

	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.Init#getInitializer <em>Initializer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Initializer</em>'.
	 * @see at.jku.weiner.c.parser.parser.Init#getInitializer()
	 * @see #getInit()
	 * @generated
	 */
	EReference getInit_Initializer();
	...
	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.AsmLine#getSym <em>Sym</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Sym</em>'.
	 * @see at.jku.weiner.c.parser.parser.AsmLine#getSym()
	 * @see #getAsmLine()
	 * @generated
	 */
	EReference getAsmLine_Sym();
	...
	/**
	 * Returns the meta object for class '{@link at.jku.weiner.c.parser.parser.AsmSymbolicName <em>Asm Symbolic Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Asm Symbolic Name</em>'.
	...
	/**
	 * Returns the meta object for class '{@link at.jku.weiner.c.parser.parser.Designation <em>Designation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.Designation#getList <em>List</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>List</em>'.
	 * @see at.jku.weiner.c.parser.parser.Designation#getList()
	 * @see #getDesignation()
	 * @generated
	 */
	EReference getDesignation_List();

	/**
	 * Returns the meta object for class '{@link at.jku.weiner.c.parser.parser.DesignatorList <em>Designator List</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EClass getDesignatorList();

	/**
	 * Returns the meta object for the containment reference list '{@link at.jku.weiner.c.parser.parser.DesignatorList#getDesignator <em>Designator</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Designator</em>'.
	 * @see at.jku.weiner.c.parser.parser.DesignatorList#getDesignator()
	 * @see #getDesignatorList()
	 * @generated
	 */
	EReference getDesignatorList_Designator();

	/**
	 * Returns the meta object for class '{@link at.jku.weiner.c.parser.parser.Designator <em>Designator</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.Designator#getExpr <em>Expr</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Expr</em>'.
	 * @see at.jku.weiner.c.parser.parser.Designator#getExpr()
	 * @see #getDesignator()
	 * @generated
	 */
	EReference getDesignator_Expr();

	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.Designator#getTo <em>To</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>To</em>'.
	 * @see at.jku.weiner.c.parser.parser.Designator#getTo()
	 * @see #getDesignator()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.Expression#getLeft <em>Left</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Left</em>'.
	 * @see at.jku.weiner.c.parser.parser.Expression#getLeft()
	 * @see #getExpression()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.Expression#getRight <em>Right</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Right</em>'.
	 * @see at.jku.weiner.c.parser.parser.Expression#getRight()
	 * @see #getExpression()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.LabeledStatement#getHigher <em>Higher</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EReference getLabeledStatement_Higher();
	...
	/**
	 * Returns the meta object for the attribute '{@link at.jku.weiner.c.parser.parser.AsmStatement#isLastComma <em>Last Comma</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Last Comma</em>'.
	 * @see at.jku.weiner.c.parser.parser.AsmStatement#isLastComma()
	 * @see #getAsmStatement()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link at.jku.weiner.c.parser.parser.AssignmentExpression#getOp <em>Op</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link at.jku.weiner.c.parser.parser.EqualityExpression#getOp <em>Op</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Op</em>'.
	...
	/**
	 * Returns the meta object for the attribute '{@link at.jku.weiner.c.parser.parser.RelationalExpression#getOp <em>Op</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Op</em>'.
	...
	/**
	 * Returns the meta object for the attribute '{@link at.jku.weiner.c.parser.parser.ShiftExpression#getOp <em>Op</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Op</em>'.
	...
	/**
	 * Returns the meta object for the attribute '{@link at.jku.weiner.c.parser.parser.AdditiveExpression#getOp <em>Op</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Op</em>'.
	...
	/**
	 * Returns the meta object for the attribute '{@link at.jku.weiner.c.parser.parser.MultiplicativeExpression#getOp <em>Op</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Op</em>'.
	...
	/**
	 * Returns the meta object for the attribute '{@link at.jku.weiner.c.parser.parser.UnaryExpression#getOp <em>Op</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Op</em>'.
	...
	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.PostfixExpression#getExpr <em>Expr</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Expr</em>'.
	...
	/**
	 * Returns the meta object for the containment reference '{@link at.jku.weiner.c.parser.parser.PostfixExpression#getSuffix <em>Suffix</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link at.jku.weiner.c.parser.parser.PrimaryExpression#isParentheses <em>Parentheses</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Parentheses</em>'.
	 * @see at.jku.weiner.c.parser.parser.PrimaryExpression#isParentheses()
	 * @see #getPrimaryExpression()
	 * @generated
	 */
	...
	interface Literals
	{
		 ...
		 * @generated
		 */
		EReference TYPE_SPECIFIER__TYPE_NAME = eINSTANCE.getTypeSpecifier_TypeName();
		 ...
		 * @generated
		 */
		EReference ABSTRACT_DECLARATOR__DIRECT_ABSTRACT_DECLARATOR = eINSTANCE.getAbstractDeclarator_DirectAbstractDeclarator();

		/**
		 * The meta object literal for the '<em><b>Gcc Decl Ext Abstract</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference ABSTRACT_DECLARATOR__GCC_DECL_EXT_ABSTRACT = eINSTANCE.getAbstractDeclarator_GccDeclExtAbstract();

		/**
		 * The meta object literal for the '{@link at.jku.weiner.c.parser.parser.impl.DirectAbstractDeclaratorImpl <em>Direct Abstract Declarator</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see at.jku.weiner.c.parser.parser.impl.DirectAbstractDeclaratorImpl
		 * @see at.jku.weiner.c.parser.parser.impl.ParserPackageImpl#getDirectAbstractDeclarator()
		 ...
		 * @generated
		 */
		EReference DIRECT_ABSTRACT_DECLARATOR__GCC_DECL_EXT = eINSTANCE.getDirectAbstractDeclarator_GccDeclExt();

		/**
		 * The meta object literal for the '<em><b>Abstract Declarator Suffix</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference DIRECT_ABSTRACT_DECLARATOR__ABSTRACT_DECLARATOR_SUFFIX = eINSTANCE.getDirectAbstractDeclarator_AbstractDeclaratorSuffix();

		/**
		 * The meta object literal for the '{@link at.jku.weiner.c.parser.parser.impl.AbstractDeclaratorSuffixImpl <em>Abstract Declarator Suffix</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see at.jku.weiner.c.parser.parser.impl.AbstractDeclaratorSuffixImpl
		 * @see at.jku.weiner.c.parser.parser.impl.ParserPackageImpl#getAbstractDeclaratorSuffix()
		 * @generated
		 */
		EClass ABSTRACT_DECLARATOR_SUFFIX = eINSTANCE.getAbstractDeclaratorSuffix();
		 ...
		 * @generated
		 */
		EReference ABSTRACT_DECLARATOR_SUFFIX__TYPE_QUALIFIER_LIST = eINSTANCE.getAbstractDeclaratorSuffix_TypeQualifierList();
		 ...
		 * @generated
		 */
		EReference ABSTRACT_DECLARATOR_SUFFIX__ASSIGNMENT_EXPR = eINSTANCE.getAbstractDeclaratorSuffix_AssignmentExpr();

		/**
		 * The meta object literal for the '<em><b>Type Qualifier List Orig</b></em>' containment reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference ABSTRACT_DECLARATOR_SUFFIX__TYPE_QUALIFIER_LIST_ORIG = eINSTANCE.getAbstractDeclaratorSuffix_TypeQualifierListOrig();
		 ...
		 * @generated
		 */
		EReference ABSTRACT_DECLARATOR_SUFFIX__PARAMETER_TYPE_LIST = eINSTANCE.getAbstractDeclaratorSuffix_ParameterTypeList();
		 ...
		 * @generated
		 */
		EReference ABSTRACT_DECLARATOR_SUFFIX__GCC_DECL_EXT = eINSTANCE.getAbstractDeclaratorSuffix_GccDeclExt();
		 ...
		 * @generated
		 */
		EAttribute INITIALIZER__LAST_COMMA = eINSTANCE.getInitializer_LastComma();
		...
		/**
		 * The meta object literal for the '{@link at.jku.weiner.c.parser.parser.impl.InitImpl <em>Init</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see at.jku.weiner.c.parser.parser.impl.InitImpl
		 * @see at.jku.weiner.c.parser.parser.impl.ParserPackageImpl#getInit()
		 ...
		 * @generated
		 */
		EReference INIT__DESIGNATION = eINSTANCE.getInit_Designation();
		 ...
		 * @generated
		 */
		EReference INIT__INITIALIZER = eINSTANCE.getInit_Initializer();
		 ...
		 * @generated
		 */
		EReference ASM_LINE__SYM = eINSTANCE.getAsmLine_Sym();
		...
		/**
		 * The meta object literal for the '{@link at.jku.weiner.c.parser.parser.impl.AsmSymbolicNameImpl <em>Asm Symbolic Name</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see at.jku.weiner.c.parser.parser.impl.AsmSymbolicNameImpl
		 * @see at.jku.weiner.c.parser.parser.impl.ParserPackageImpl#getAsmSymbolicName()
		...
		/**
		 * The meta object literal for the '{@link at.jku.weiner.c.parser.parser.impl.DesignationImpl <em>Designation</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see at.jku.weiner.c.parser.parser.impl.DesignationImpl
		 * @see at.jku.weiner.c.parser.parser.impl.ParserPackageImpl#getDesignation()
		 ...
		 * @generated
		 */
		EReference DESIGNATION__LIST = eINSTANCE.getDesignation_List();

		/**
		 * The meta object literal for the '{@link at.jku.weiner.c.parser.parser.impl.DesignatorListImpl <em>Designator List</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see at.jku.weiner.c.parser.parser.impl.DesignatorListImpl
		 * @see at.jku.weiner.c.parser.parser.impl.ParserPackageImpl#getDesignatorList()
		 * @generated
		 */
		EClass DESIGNATOR_LIST = eINSTANCE.getDesignatorList();

		/**
		 * The meta object literal for the '<em><b>Designator</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference DESIGNATOR_LIST__DESIGNATOR = eINSTANCE.getDesignatorList_Designator();

		/**
		 * The meta object literal for the '{@link at.jku.weiner.c.parser.parser.impl.DesignatorImpl <em>Designator</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see at.jku.weiner.c.parser.parser.impl.DesignatorImpl
		 * @see at.jku.weiner.c.parser.parser.impl.ParserPackageImpl#getDesignator()
		 ...
		 * @generated
		 */
		EReference DESIGNATOR__EXPR = eINSTANCE.getDesignator_Expr();
		 ...
		 * @generated
		 */
		EReference LABELED_STATEMENT__HIGHER = eINSTANCE.getLabeledStatement_Higher();
