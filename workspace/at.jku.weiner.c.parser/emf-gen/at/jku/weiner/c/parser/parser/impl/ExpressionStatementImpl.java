...
public class ExpressionStatementImpl extends StatementImpl implements ExpressionStatement
{
	...
	{
		return (Expression)eGet(ParserPackage.Literals.EXPRESSION_STATEMENT__EXPRESSION, true);
	}
	...
	{
		eSet(ParserPackage.Literals.EXPRESSION_STATEMENT__EXPRESSION, newExpression);
	}
