...
public class InternalParserLexer extends Lexer {
	...
	public final void mRULE_LINEBREAK() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:13554:16: ( RULE_SKW_BACKSLASH RULE_LINE_END )
			// InternalParser.g:13554:18: RULE_SKW_BACKSLASH RULE_LINE_END
			{
			mRULE_SKW_BACKSLASH(); 
	...
	public final void mRULE_BLOCK_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:13562:20: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// InternalParser.g:13562:22: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// InternalParser.g:13562:27: ( options {greedy=false; } : . )*
			loop38:
			while (true) {
				int alt38=2;
	...
	public final void mRULE_LINE_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:13564:19: ( '//' (~ ( RULE_LINE_END ) )* )
			// InternalParser.g:13564:21: '//' (~ ( RULE_LINE_END ) )*
			{
			match("//"); 

			// InternalParser.g:13564:26: (~ ( RULE_LINE_END ) )*
			loop39:
			while (true) {
				int alt39=2;
	...
	public final void mRULE_SPECIAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalParser.g:13566:14: ( . )
			// InternalParser.g:13566:16: .
			{
			matchAny(); 
			}
