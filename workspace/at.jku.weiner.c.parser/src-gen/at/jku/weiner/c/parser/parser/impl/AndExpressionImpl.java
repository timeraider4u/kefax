 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.AndExpressionImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AndExpressionImpl extends ExpressionImpl implements AndExpression
{
  ...
  {
    return ParserPackage.Literals.AND_EXPRESSION;
  }
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, ParserPackage.AND_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.AND_EXPRESSION__EXPR:
