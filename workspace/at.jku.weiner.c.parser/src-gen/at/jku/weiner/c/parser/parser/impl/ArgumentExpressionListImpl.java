 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.ArgumentExpressionListImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArgumentExpressionListImpl extends MinimalEObjectImpl.Container implements ArgumentExpressionList
{
  ...
  {
    return ParserPackage.Literals.ARGUMENT_EXPRESSION_LIST;
  }
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, ParserPackage.ARGUMENT_EXPRESSION_LIST__EXPR);
    }
    return expr;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.ARGUMENT_EXPRESSION_LIST__EXPR:
