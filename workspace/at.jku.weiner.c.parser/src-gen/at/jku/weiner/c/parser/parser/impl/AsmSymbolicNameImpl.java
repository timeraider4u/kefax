 ...
 * @generated
 */
public class AsmSymbolicNameImpl extends MinimalEObjectImpl.Container implements AsmSymbolicName
{
  /**
  ...
  public void setId(String newId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.ASM_SYMBOLIC_NAME__ID, oldId, id));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ParserPackage.ASM_SYMBOLIC_NAME__ID:
        return getId();
    }
