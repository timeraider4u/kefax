 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.ConstantImpl#getHex <em>Hex</em>}</li>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.ConstantImpl#getOct <em>Oct</em>}</li>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.ConstantImpl#getDec <em>Dec</em>}</li>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.ConstantImpl#getCh <em>Ch</em>}</li>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.ConstantImpl#getStr <em>Str</em>}</li>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.ConstantImpl#getFloat <em>Float</em>}</li>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.ConstantImpl#getBin <em>Bin</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstantImpl extends MinimalEObjectImpl.Container implements Constant
{
  ...
  {
    return ParserPackage.Literals.CONSTANT;
  }
  ...
  public void setHex(String newHex)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.CONSTANT__HEX, oldHex, hex));
  }
  ...
  public void setOct(String newOct)
  {
    ...
    oct = newOct;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.CONSTANT__OCT, oldOct, oct));
  }
  ...
  public void setDec(String newDec)
  {
    ...
    dec = newDec;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.CONSTANT__DEC, oldDec, dec));
  }
  ...
  public void setCh(String newCh)
  {
    ...
    ch = newCh;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.CONSTANT__CH, oldCh, ch));
  }
  ...
  public void setStr(String newStr)
  {
    ...
    str = newStr;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.CONSTANT__STR, oldStr, str));
  }
  ...
  public void setFloat(String newFloat)
  {
    ...
    float_ = newFloat;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.CONSTANT__FLOAT, oldFloat, float_));
  }
  ...
  public void setBin(String newBin)
  {
    ...
    bin = newBin;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.CONSTANT__BIN, oldBin, bin));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ParserPackage.CONSTANT__HEX:
        return getHex();
      case ParserPackage.CONSTANT__OCT:
        return getOct();
      case ParserPackage.CONSTANT__DEC:
        return getDec();
      case ParserPackage.CONSTANT__CH:
        return getCh();
      case ParserPackage.CONSTANT__STR:
        return getStr();
      case ParserPackage.CONSTANT__FLOAT:
        return getFloat();
      case ParserPackage.CONSTANT__BIN:
        return getBin();
    }
