...
public class DeclarationImpl extends MinimalEObjectImpl.Container implements Declaration
{
  ...
  public NotificationChain basicSetSpecifiers(DeclarationSpecifiers newSpecifiers, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ParserPackage.DECLARATION__SPECIFIERS, oldSpecifiers, newSpecifiers);
  ...
  public void setSpecifiers(DeclarationSpecifiers newSpecifiers)
  {
    if (newSpecifiers != specifiers)
    {
      ...
      if (specifiers != null)
        msgs = ((InternalEObject)specifiers).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ParserPackage.DECLARATION__SPECIFIERS, null, msgs);
      if (newSpecifiers != null)
        msgs = ((InternalEObject)newSpecifiers).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ParserPackage.DECLARATION__SPECIFIERS, null, msgs);
      msgs = basicSetSpecifiers(newSpecifiers, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.DECLARATION__SPECIFIERS, newSpecifiers, newSpecifiers));
  }
  ...
  public EList<InitDeclaratorList> getInitDeclaratorList()
  {
    ...
    {
      initDeclaratorList = new EObjectContainmentEList<InitDeclaratorList>(InitDeclaratorList.class, this, ParserPackage.DECLARATION__INIT_DECLARATOR_LIST);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.DECLARATION__SPECIFIERS:
