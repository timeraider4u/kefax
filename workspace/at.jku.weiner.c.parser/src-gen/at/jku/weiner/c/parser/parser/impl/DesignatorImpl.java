...
public class DesignatorImpl extends MinimalEObjectImpl.Container implements Designator
{
  ...
  public NotificationChain basicSetExpr(Expression newExpr, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ParserPackage.DESIGNATOR__EXPR, oldExpr, newExpr);
  ...
  public void setExpr(Expression newExpr)
  {
    if (newExpr != expr)
    {
      ...
      if (expr != null)
        msgs = ((InternalEObject)expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ParserPackage.DESIGNATOR__EXPR, null, msgs);
      if (newExpr != null)
        msgs = ((InternalEObject)newExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ParserPackage.DESIGNATOR__EXPR, null, msgs);
      msgs = basicSetExpr(newExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.DESIGNATOR__EXPR, newExpr, newExpr));
  }
  ...
  public void setId(String newId)
  {
    ...
    id = newId;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.DESIGNATOR__ID, oldId, id));
  }
