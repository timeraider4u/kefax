 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.EqualityExpressionImpl#getExpr <em>Expr</em>}</li>
...
public class EqualityExpressionImpl extends ExpressionImpl implements EqualityExpression
{
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, ParserPackage.EQUALITY_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public EList<String> getOp()
  {
    if (op == null)
    {
      op = new EDataTypeEList<String>(String.class, this, ParserPackage.EQUALITY_EXPRESSION__OP);
    }
    return op;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.EQUALITY_EXPRESSION__EXPR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ParserPackage.EQUALITY_EXPRESSION__EXPR:
        return getExpr();
      case ParserPackage.EQUALITY_EXPRESSION__OP:
        return getOp();
    }
