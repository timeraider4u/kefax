 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.ExclusiveOrExpressionImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExclusiveOrExpressionImpl extends ExpressionImpl implements ExclusiveOrExpression
{
  ...
  {
    return ParserPackage.Literals.EXCLUSIVE_OR_EXPRESSION;
  }
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, ParserPackage.EXCLUSIVE_OR_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.EXCLUSIVE_OR_EXPRESSION__EXPR:
