...
public class FunctionDefHeadImpl extends MinimalEObjectImpl.Container implements FunctionDefHead
{
  ...
  public NotificationChain basicSetFunDeclSpecifiers(FunctionDeclarationSpecifiers newFunDeclSpecifiers, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ParserPackage.FUNCTION_DEF_HEAD__FUN_DECL_SPECIFIERS, oldFunDeclSpecifiers, newFunDeclSpecifiers);
  ...
  public void setFunDeclSpecifiers(FunctionDeclarationSpecifiers newFunDeclSpecifiers)
  {
    if (newFunDeclSpecifiers != funDeclSpecifiers)
    {
      ...
      if (funDeclSpecifiers != null)
        msgs = ((InternalEObject)funDeclSpecifiers).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ParserPackage.FUNCTION_DEF_HEAD__FUN_DECL_SPECIFIERS, null, msgs);
      if (newFunDeclSpecifiers != null)
        msgs = ((InternalEObject)newFunDeclSpecifiers).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ParserPackage.FUNCTION_DEF_HEAD__FUN_DECL_SPECIFIERS, null, msgs);
      msgs = basicSetFunDeclSpecifiers(newFunDeclSpecifiers, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.FUNCTION_DEF_HEAD__FUN_DECL_SPECIFIERS, newFunDeclSpecifiers, newFunDeclSpecifiers));
  }
  ...
  public NotificationChain basicSetFunDeclarator(Declarator newFunDeclarator, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ParserPackage.FUNCTION_DEF_HEAD__FUN_DECLARATOR, oldFunDeclarator, newFunDeclarator);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setFunDeclarator(Declarator newFunDeclarator)
  {
    if (newFunDeclarator != funDeclarator)
    {
      ...
      if (funDeclarator != null)
        msgs = ((InternalEObject)funDeclarator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ParserPackage.FUNCTION_DEF_HEAD__FUN_DECLARATOR, null, msgs);
      if (newFunDeclarator != null)
        msgs = ((InternalEObject)newFunDeclarator).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ParserPackage.FUNCTION_DEF_HEAD__FUN_DECLARATOR, null, msgs);
      msgs = basicSetFunDeclarator(newFunDeclarator, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.FUNCTION_DEF_HEAD__FUN_DECLARATOR, newFunDeclarator, newFunDeclarator));
  }
  ...
  public EList<Declaration> getFunDeclaration()
  {
    ...
    {
      funDeclaration = new EObjectContainmentEList<Declaration>(Declaration.class, this, ParserPackage.FUNCTION_DEF_HEAD__FUN_DECLARATION);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.FUNCTION_DEF_HEAD__FUN_DECL_SPECIFIERS:
        return basicSetFunDeclSpecifiers(null, msgs);
      case ParserPackage.FUNCTION_DEF_HEAD__FUN_DECLARATOR:
        return basicSetFunDeclarator(null, msgs);
      case ParserPackage.FUNCTION_DEF_HEAD__FUN_DECLARATION:
