 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.InclusiveOrExpressionImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InclusiveOrExpressionImpl extends ExpressionImpl implements InclusiveOrExpression
{
  ...
  {
    return ParserPackage.Literals.INCLUSIVE_OR_EXPRESSION;
  }
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, ParserPackage.INCLUSIVE_OR_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.INCLUSIVE_OR_EXPRESSION__EXPR:
