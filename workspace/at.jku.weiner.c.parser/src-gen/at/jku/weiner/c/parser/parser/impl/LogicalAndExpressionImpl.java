 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.LogicalAndExpressionImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LogicalAndExpressionImpl extends ExpressionImpl implements LogicalAndExpression
{
  ...
  {
    return ParserPackage.Literals.LOGICAL_AND_EXPRESSION;
  }
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, ParserPackage.LOGICAL_AND_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.LOGICAL_AND_EXPRESSION__EXPR:
