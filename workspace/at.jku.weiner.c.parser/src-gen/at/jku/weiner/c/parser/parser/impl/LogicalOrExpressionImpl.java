 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.LogicalOrExpressionImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogicalOrExpressionImpl extends ExpressionImpl implements LogicalOrExpression
{
  ...
  {
    return ParserPackage.Literals.LOGICAL_OR_EXPRESSION;
  }
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, ParserPackage.LOGICAL_OR_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.LOGICAL_OR_EXPRESSION__EXPR:
