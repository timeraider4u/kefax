 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.ModelImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  public EList<TranslationUnit> getUnit()
  {
    if (unit == null)
    {
      unit = new EObjectContainmentEList<TranslationUnit>(TranslationUnit.class, this, ParserPackage.MODEL__UNIT);
    }
    return unit;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.MODEL__UNIT:
