...
public class ParameterListImpl extends MinimalEObjectImpl.Container implements ParameterList
{
  ...
  public EList<ParameterDeclaration> getParameterDeclaration()
  {
    ...
    {
      parameterDeclaration = new EObjectContainmentEList<ParameterDeclaration>(ParameterDeclaration.class, this, ParserPackage.PARAMETER_LIST__PARAMETER_DECLARATION);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.PARAMETER_LIST__PARAMETER_DECLARATION:
