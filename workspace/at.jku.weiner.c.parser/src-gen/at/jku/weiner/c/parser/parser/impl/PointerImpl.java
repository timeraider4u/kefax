...
public class PointerImpl extends MinimalEObjectImpl.Container implements Pointer
{
  ...
  public EList<String> getStar()
  {
    if (star == null)
    {
      star = new EDataTypeEList<String>(String.class, this, ParserPackage.POINTER__STAR);
    }
    return star;
  }
  ...
  public EList<String> getCaret()
  {
    if (caret == null)
    {
      caret = new EDataTypeEList<String>(String.class, this, ParserPackage.POINTER__CARET);
    }
    return caret;
  }
  ...
  public EList<TypeQualifierList> getTypeQualifierList()
  {
    ...
    {
      typeQualifierList = new EObjectContainmentEList<TypeQualifierList>(TypeQualifierList.class, this, ParserPackage.POINTER__TYPE_QUALIFIER_LIST);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.POINTER__TYPE_QUALIFIER_LIST:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ParserPackage.POINTER__STAR:
        return getStar();
      case ParserPackage.POINTER__CARET:
        return getCaret();
      case ParserPackage.POINTER__TYPE_QUALIFIER_LIST:
