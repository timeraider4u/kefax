...
public class PostfixExpressionSuffixArrowImpl extends PostfixExpressionSuffixImpl implements PostfixExpressionSuffixArrow
{
  ...
  public void setId(String newId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.POSTFIX_EXPRESSION_SUFFIX_ARROW__ID, oldId, id));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ParserPackage.POSTFIX_EXPRESSION_SUFFIX_ARROW__ID:
        return getId();
    }
