...
public class PostfixExpressionSuffixDotImpl extends PostfixExpressionSuffixImpl implements PostfixExpressionSuffixDot
{
  ...
  public void setId(String newId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.POSTFIX_EXPRESSION_SUFFIX_DOT__ID, oldId, id));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ParserPackage.POSTFIX_EXPRESSION_SUFFIX_DOT__ID:
        return getId();
    }
