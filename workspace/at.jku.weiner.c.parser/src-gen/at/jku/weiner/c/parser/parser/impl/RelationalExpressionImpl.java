 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.RelationalExpressionImpl#getExpr <em>Expr</em>}</li>
...
public class RelationalExpressionImpl extends ExpressionImpl implements RelationalExpression
{
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, ParserPackage.RELATIONAL_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public EList<String> getOp()
  {
    if (op == null)
    {
      op = new EDataTypeEList<String>(String.class, this, ParserPackage.RELATIONAL_EXPRESSION__OP);
    }
    return op;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.RELATIONAL_EXPRESSION__EXPR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ParserPackage.RELATIONAL_EXPRESSION__EXPR:
        return getExpr();
      case ParserPackage.RELATIONAL_EXPRESSION__OP:
        return getOp();
    }
