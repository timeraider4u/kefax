 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.c.parser.parser.impl.ShiftExpressionImpl#getExpr <em>Expr</em>}</li>
...
public class ShiftExpressionImpl extends ExpressionImpl implements ShiftExpression
{
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, ParserPackage.SHIFT_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public EList<String> getOp()
  {
    if (op == null)
    {
      op = new EDataTypeEList<String>(String.class, this, ParserPackage.SHIFT_EXPRESSION__OP);
    }
    return op;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.SHIFT_EXPRESSION__EXPR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ParserPackage.SHIFT_EXPRESSION__EXPR:
        return getExpr();
      case ParserPackage.SHIFT_EXPRESSION__OP:
        return getOp();
    }
