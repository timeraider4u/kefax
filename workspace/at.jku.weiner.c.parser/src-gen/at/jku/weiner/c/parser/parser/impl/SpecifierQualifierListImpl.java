...
public class SpecifierQualifierListImpl extends MinimalEObjectImpl.Container implements SpecifierQualifierList
{
  ...
  public EList<TypeSpecifier> getTypeSpecifier()
  {
    ...
    {
      typeSpecifier = new EObjectContainmentEList<TypeSpecifier>(TypeSpecifier.class, this, ParserPackage.SPECIFIER_QUALIFIER_LIST__TYPE_SPECIFIER);
    }
  ...
  public EList<TypeQualifier> getTypeQualifier()
  {
    ...
    {
      typeQualifier = new EObjectContainmentEList<TypeQualifier>(TypeQualifier.class, this, ParserPackage.SPECIFIER_QUALIFIER_LIST__TYPE_QUALIFIER);
    }
  ...
  public EList<DeclarationSpecifier> getStructOrUnionSpecifier()
  {
    ...
    {
      structOrUnionSpecifier = new EObjectContainmentEList<DeclarationSpecifier>(DeclarationSpecifier.class, this, ParserPackage.SPECIFIER_QUALIFIER_LIST__STRUCT_OR_UNION_SPECIFIER);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.SPECIFIER_QUALIFIER_LIST__TYPE_SPECIFIER:
        return ((InternalEList<?>)getTypeSpecifier()).basicRemove(otherEnd, msgs);
      case ParserPackage.SPECIFIER_QUALIFIER_LIST__TYPE_QUALIFIER:
        return ((InternalEList<?>)getTypeQualifier()).basicRemove(otherEnd, msgs);
      case ParserPackage.SPECIFIER_QUALIFIER_LIST__STRUCT_OR_UNION_SPECIFIER:
