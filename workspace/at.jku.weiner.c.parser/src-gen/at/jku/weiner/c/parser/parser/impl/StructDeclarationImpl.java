...
public class StructDeclarationImpl extends MinimalEObjectImpl.Container implements StructDeclaration
{
  ...
  public NotificationChain basicSetList(SpecifierQualifierList newList, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ParserPackage.STRUCT_DECLARATION__LIST, oldList, newList);
  ...
  public void setList(SpecifierQualifierList newList)
  {
    if (newList != list)
    {
      ...
      if (list != null)
        msgs = ((InternalEObject)list).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ParserPackage.STRUCT_DECLARATION__LIST, null, msgs);
      if (newList != null)
        msgs = ((InternalEObject)newList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ParserPackage.STRUCT_DECLARATION__LIST, null, msgs);
      msgs = basicSetList(newList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.STRUCT_DECLARATION__LIST, newList, newList));
  }
  ...
  public NotificationChain basicSetStructDeclarationList(StructDeclaratorList newStructDeclarationList, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ParserPackage.STRUCT_DECLARATION__STRUCT_DECLARATION_LIST, oldStructDeclarationList, newStructDeclarationList);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setStructDeclarationList(StructDeclaratorList newStructDeclarationList)
  {
    if (newStructDeclarationList != structDeclarationList)
    {
      ...
      if (structDeclarationList != null)
        msgs = ((InternalEObject)structDeclarationList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ParserPackage.STRUCT_DECLARATION__STRUCT_DECLARATION_LIST, null, msgs);
      if (newStructDeclarationList != null)
        msgs = ((InternalEObject)newStructDeclarationList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ParserPackage.STRUCT_DECLARATION__STRUCT_DECLARATION_LIST, null, msgs);
      msgs = basicSetStructDeclarationList(newStructDeclarationList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.STRUCT_DECLARATION__STRUCT_DECLARATION_LIST, newStructDeclarationList, newStructDeclarationList));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.STRUCT_DECLARATION__LIST:
        return basicSetList(null, msgs);
      case ParserPackage.STRUCT_DECLARATION__STRUCT_DECLARATION_LIST:
