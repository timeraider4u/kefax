...
public class TypeQualifierListImpl extends MinimalEObjectImpl.Container implements TypeQualifierList
{
  ...
  public EList<TypeQualifier> getTypeQualifier()
  {
    ...
    {
      typeQualifier = new EObjectContainmentEList<TypeQualifier>(TypeQualifier.class, this, ParserPackage.TYPE_QUALIFIER_LIST__TYPE_QUALIFIER);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.TYPE_QUALIFIER_LIST__TYPE_QUALIFIER:
