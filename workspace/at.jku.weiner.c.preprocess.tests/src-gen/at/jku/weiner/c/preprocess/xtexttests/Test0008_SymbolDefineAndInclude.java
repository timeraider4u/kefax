...
public class Test0008_SymbolDefineAndInclude {
	@Inject
	...
	public void checkLexerTokens() throws Exception{
		final String text = this.getTextFromFile(
			"res/Test0008_SymbolDefineAndInclude.c");
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("abc", DefineDirective_5_Var
		.getId());
		Assert.assertEquals("\"Test0002b_Code.c\"", DefineDirective_5_Var
		.getString());
		//5
		...
		Assert.assertEquals("\"Test0007_SymbolInInclude.h\"", IncludeDirective_7_Var
		.getString());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0008_SymbolDefineAndInclude.c.i");
			}
