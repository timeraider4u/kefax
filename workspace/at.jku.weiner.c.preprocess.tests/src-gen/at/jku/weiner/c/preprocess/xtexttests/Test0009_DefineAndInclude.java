...
public class Test0009_DefineAndInclude {
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("MAIN", DefineDirective_7_Var
		.getId());
		Assert.assertEquals("main", DefineDirective_7_Var
		.getString());
		//7
		...
		Assert.assertEquals("\"Test0009_DefineAndInclude.h\"", IncludeDirective_9_Var
		.getString());
		//9
		...
		Assert.assertEquals("DECLARATION;", Code_11_Var
		.getCode());
		//11
		...
		Assert.assertEquals("INT MAIN(void) {", Code_13_Var
		.getCode());
		//13
		...
		Assert.assertEquals("	return x - 2 * Y;", Code_14_Var
		.getCode());
		//14
		...
		Assert.assertEquals("}", Code_15_Var
		.getCode());
	}
