...
public class Test0009_DefineAndInclude_Header {
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("X", DefineDirective_5_Var
		.getId());
		Assert.assertEquals("x", DefineDirective_5_Var
		.getString());
		//5
		...
		Assert.assertEquals("Y", DefineDirective_7_Var
		.getId());
		Assert.assertEquals("y", DefineDirective_7_Var
		.getString());
		//7
		...
		Assert.assertEquals("DECLARATION", DefineDirective_9_Var
		.getId());
		Assert.assertEquals("INT X = 4", DefineDirective_9_Var
		.getString());
		//9
		...
		Assert.assertEquals("Z", DefineDirective_11_Var
		.getId());
		Assert.assertEquals("1 + 1", DefineDirective_11_Var
		.getString());
		//11
		...
		Assert.assertEquals("int Y = Z;", Code_13_Var
		.getCode());
	}
