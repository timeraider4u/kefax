...
public class Test0020_NullDirective {
	...
	public void checkParserResult() throws Exception {
		...
		//4
		final NullDirective NullDirective_5_Var
		 = (NullDirective)PreprocessorDirectives_4_Var
		.getDirective();
		Assert.assertNotNull(NullDirective_5_Var
		);
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0020_NullDirective.c.i");
			}
