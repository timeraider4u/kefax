...
public class Test0024_FunctionMacroTwoArguments {
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("int a = MIN(5,8);", Code_7_Var
		.getCode());
		//7
		...
		Assert.assertEquals("int b = MIN(8, 5);", Code_8_Var
		.getCode());
		//8
		...
		Assert.assertEquals("int c = MIN((5), 5);", Code_9_Var
		.getCode());
		//9
		...
		Assert.assertEquals("int d = MIN(a + 1, 18);", Code_10_Var
		.getCode());
		//10
		...
		Assert.assertEquals("int e = MIN(18, (b*2 + (*c)));", Code_11_Var
		.getCode());
	}
