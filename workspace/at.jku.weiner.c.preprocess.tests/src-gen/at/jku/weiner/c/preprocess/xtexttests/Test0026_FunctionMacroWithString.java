...
public class Test0026_FunctionMacroWithString {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		.getId().toString());
		Assert.assertEquals("x, \"x\", x, \"abc \\\"x def \\\"\", x", DefineFunctionLikeMacro_3_Var
		.getString());
		//4
		...
		Assert.assertEquals("foo(bar)", Code_5_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0026_FunctionMacroWithString.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0026_FunctionMacroWithString.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0026_FunctionMacroWithString.c"
			);
