...
public class Test0029_ObjectLikeMacro {
	@Inject
	...
	public void checkLexerTokens() throws Exception{
		final String text = this.getTextFromFile(
			"res/Test0029_ObjectLikeMacro.c");
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("ARRAY", DefineDirective_3_Var
		.getId());
		Assert.assertEquals("5, 6, 7, 8", DefineDirective_3_Var
		.getString());
		//3
		...
		Assert.assertEquals("int array[] = { ARRAY };", Code_4_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0029_ObjectLikeMacro.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0029_ObjectLikeMacro.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0029_ObjectLikeMacro.c"
			);
