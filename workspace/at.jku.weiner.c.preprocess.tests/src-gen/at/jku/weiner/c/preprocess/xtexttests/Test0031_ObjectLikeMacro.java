...
public class Test0031_ObjectLikeMacro {
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("int foo1 = FOO;", Code_6_Var
		.getCode());
		//6
		...
		Assert.assertEquals("int bar1 = BAR;", Code_7_Var
		.getCode());
		//7
		...
		Assert.assertEquals("int foo2 = FOO;", Code_12_Var
		.getCode());
		//12
		...
		Assert.assertEquals("int bar2 = BAR;", Code_13_Var
		.getCode());
	}
