...
public class Test0033_Misnesting2 {
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("myprintf", DefineFunctionLikeMacro_4_Var
		.getId());
		//4
		...
		Assert.assertEquals("myprintf(3), 5);", Code_6_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0033_Misnesting2.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0033_Misnesting2.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0033_Misnesting2.c"
			);
