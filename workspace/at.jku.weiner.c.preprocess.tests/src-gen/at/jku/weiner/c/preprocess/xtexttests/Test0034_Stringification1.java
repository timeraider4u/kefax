...
public class Test0034_Stringification1 {
	@Inject
	...
	public void checkLexerTokens() throws Exception{
		final String text = this.getTextFromFile(
			"res/Test0034_Stringification1.c");
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("DEBUG", DefineFunctionLikeMacro_4_Var
		.getId());
		//4
		...
		.getId().toString());
		Assert.assertEquals("printf(#X \"=%d\\n\", X)", DefineFunctionLikeMacro_4_Var
		.getString());
		//5
		...
		Assert.assertEquals("DEBUG(5);", Code_6_Var
		.getCode());
		//6
		...
		Assert.assertEquals("int x = 5;", Code_7_Var
		.getCode());
		//7
		...
		Assert.assertEquals("DEBUG(x);", Code_8_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0034Test0034_Stringification1.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0034Test0034_Stringification1.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0034_Stringification1.c"
			);
