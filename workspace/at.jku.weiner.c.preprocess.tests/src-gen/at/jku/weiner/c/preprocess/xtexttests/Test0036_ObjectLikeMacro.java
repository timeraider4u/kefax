...
public class Test0036_ObjectLikeMacro {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("FOO", DefineObjectMacro_4_Var
		.getId());
		...
		Assert.assertEquals("FOO \"FOO\" FOO \"FOO\"", Code_5_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0036_ObjectLikeMacro.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0036_ObjectLikeMacro.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0036_ObjectLikeMacro.c"
			);
