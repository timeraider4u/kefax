...
public class Test0043_IfValueGreater {
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("VERSION", PrimaryExpression_20_Var
		.getId());
		//20
		...
		Assert.assertEquals("200", PrimaryExpression_27_Var
		.getConst());
		//27
		...
		Assert.assertEquals("	void api_version_2();", Code_29_Var
		.getCode());
	}
