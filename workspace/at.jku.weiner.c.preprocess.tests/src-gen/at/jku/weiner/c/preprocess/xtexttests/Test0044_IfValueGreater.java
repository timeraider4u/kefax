...
public class Test0044_IfValueGreater {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("VERSION", DefineObjectMacro_3_Var
		.getId());
		Assert.assertEquals("100", DefineObjectMacro_3_Var
		.getString());
		//3
		...
		final RelationalExpression RelationalExpression_7_Var
		 = (RelationalExpression)IfConditional_6_Var
		.getExpression();
		Assert.assertNotNull(RelationalExpression_7_Var
		);
		Assert.assertEquals(">=", RelationalExpression_7_Var
		.getOp());
		//7
		...
		Assert.assertEquals("VERSION", PrimaryExpression_8_Var
		.getId());
		//8
		...
		Assert.assertEquals("200", PrimaryExpression_9_Var
		.getConst());
		//9
		...
		Assert.assertEquals("	void api_version_2();", Code_11_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0044_IfValueGreater.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0044_IfValueGreater.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0044_IfValueGreater.c"
			);
