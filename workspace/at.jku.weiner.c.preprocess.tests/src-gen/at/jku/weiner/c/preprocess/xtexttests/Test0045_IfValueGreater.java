...
public class Test0045_IfValueGreater {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		.getIdent());
		Assert.assertEquals("290", DefineObjectMacro_3_Var
		.getString());
		//3
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0045_IfValueGreater.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0045_IfValueGreater.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0045_IfValueGreater.c"
			);
