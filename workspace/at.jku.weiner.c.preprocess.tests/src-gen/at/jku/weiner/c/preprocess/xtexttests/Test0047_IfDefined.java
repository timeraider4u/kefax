...
public class Test0047_IfDefined {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		.getId());
		Assert.assertEquals("32", DefineObjectMacro_3_Var
		.getString());
		//3
		...
		//6
		final LogicalAndExpression LogicalAndExpression_7_Var
		 = (LogicalAndExpression)IfConditional_6_Var
		.getExpression();
		Assert.assertNotNull(LogicalAndExpression_7_Var
		);
		//7
		final PrimaryExpression PrimaryExpression_8_Var
		 = (PrimaryExpression)LogicalAndExpression_7_Var
		.getLeft();
		...
		.getRight();
		Assert.assertNotNull(RelationalExpression_9_Var
		);
		Assert.assertEquals(">=", RelationalExpression_9_Var
		.getOp());
		//9
		...
		Assert.assertEquals("64", PrimaryExpression_11_Var
		.getConst());
		//11
		...
		Assert.assertEquals("	void size_64();", Code_13_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0047_IfDefined.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0047_IfDefined.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0047_IfDefined.c"
			);
