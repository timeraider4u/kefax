...
public class Test0049_IfDefined {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		//4
		final RelationalExpression RelationalExpression_5_Var
		 = (RelationalExpression)IfConditional_4_Var
		.getExpression();
		Assert.assertNotNull(RelationalExpression_5_Var
		);
		Assert.assertEquals(">=", RelationalExpression_5_Var
		.getOp());
		//5
		final PrimaryExpression PrimaryExpression_6_Var
		...
		Assert.assertEquals("64", PrimaryExpression_7_Var
		.getConst());
		//7
		...
		Assert.assertEquals("	void size_64();", Code_9_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0049_IfDefined.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0049_IfDefined.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0049_IfDefined.c"
			);
