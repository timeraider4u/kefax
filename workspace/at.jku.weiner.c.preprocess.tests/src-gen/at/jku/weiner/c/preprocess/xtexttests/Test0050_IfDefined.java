...
public class Test0050_IfDefined {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("64", PrimaryExpression_9_Var
		.getConst());
		//9
		...
		Assert.assertEquals("	void size_64();", Code_11_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0050_IfDefined.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0050_IfDefined.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0050_IfDefined.c"
			);
