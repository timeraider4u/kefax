...
public class Test0057_IfNotDefined {
	...
	public void checkParserResult() throws Exception {
		...
		//6
		final UnaryExpression UnaryExpression_7_Var
		 = (UnaryExpression)IfConditional_6_Var
		.getExpression();
		Assert.assertNotNull(UnaryExpression_7_Var
		);
		Assert.assertEquals("!", UnaryExpression_7_Var
		.getOp());
		//7
		final PrimaryExpression PrimaryExpression_8_Var
		 = (PrimaryExpression)UnaryExpression_7_Var
		.getExpr();
		...
		Assert.assertEquals("	void bar();", Code_10_Var
		.getCode());
	}
