...
public class Test0070_Warning {
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals(1, Lines_3_list.size());
		//3
		...
		Assert.assertEquals("\"some warning message!\"", WarningDirective_5_Var
		.getMsg());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0070_Warning.h.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0070_Warning.h.i");
		final String expected = this.getTextFromFile(
			"expected/Test0070_Warning.h"
			);
