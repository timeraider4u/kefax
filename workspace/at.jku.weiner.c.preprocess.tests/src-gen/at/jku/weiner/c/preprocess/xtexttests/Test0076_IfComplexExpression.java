...
public class Test0076_IfComplexExpression {
	...
	public void checkParserResult() throws Exception {
		...
		.getId().toString());
		final EList<? extends EObject> Replacement_14_list = DefineFunctionLikeMacro_13_Var
		.getReplacement();
		Assert.assertNotNull(Replacement_14_list);
		Assert.assertEquals(1, Replacement_14_list.size());
		//14
