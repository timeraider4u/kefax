...
public class Test0080_FunctionMacroSeveralLines {
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("int a = MIN(0, 5) + MIN(", Code_7_Var
		.getCode());
		//7
		...
		Assert.assertEquals("		1 ,", Code_8_Var
		.getCode());
		//8
		...
		Assert.assertEquals("		2 ) + MIN(,", Code_9_Var
		.getCode());
		//9
		...
		Assert.assertEquals("		+ 5;", Code_11_Var
		.getCode());
		//11
		...
		Assert.assertEquals("int b = MIN (MIN", Code_12_Var
		.getCode());
		//12
		...
		Assert.assertEquals("		(1,", Code_13_Var
		.getCode());
		//13
		...
		Assert.assertEquals("			2),", Code_14_Var
		.getCode());
		//14
		...
		Assert.assertEquals("		3) + 5;", Code_15_Var
		.getCode());
	}
