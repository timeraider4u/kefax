...
public class Test0081_Stringification3 {
	...
	public void checkParserResult() throws Exception {
		...
		.getId().toString());
		Assert.assertEquals("#X", DefineFunctionLikeMacro_4_Var
		.getString());
		//5
		...
		Assert.assertEquals("FOOBAR", DefineFunctionLikeMacro_10_Var
		.getId());
		//10
		...
		.getId().toString());
		Assert.assertEquals("#X BAR(#X)", DefineFunctionLikeMacro_10_Var
		.getString());
		//11
