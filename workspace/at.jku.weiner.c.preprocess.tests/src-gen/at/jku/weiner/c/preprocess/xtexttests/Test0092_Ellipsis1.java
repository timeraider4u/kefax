...
public class Test0092_Ellipsis1 {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		.isVariadic());
		Assert.assertEquals("int y", DefineFunctionLikeMacro_3_Var
		.getString());
		//4
		...
		Assert.assertEquals("FOO(foo, bar, foobar, foo_bar);", Code_5_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0092_Ellipsis1.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0092_Ellipsis1.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0092_Ellipsis1.c"
			);
