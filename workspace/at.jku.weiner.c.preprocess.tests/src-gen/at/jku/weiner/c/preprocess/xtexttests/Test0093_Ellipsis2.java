...
public class Test0093_Ellipsis2 {
	@Inject
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0093_Ellipsis2.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0093_Ellipsis2.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0093_Ellipsis2.c"
			);
