...
public class Test0095_Ellipsis4 {
	@Inject
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0095_Ellipsis4.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0095_Ellipsis4.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0095_Ellipsis4.c"
			);
