...
public class Test0096_Ellipsis5 {
	@Inject
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0096_Ellipsis5.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0096_Ellipsis5.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0096_Ellipsis5.c"
			);
