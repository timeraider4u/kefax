...
public class Test0097_Ellipsis6 {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("FOO(foo, bar, foobar, foo_bar, bar);", Code_5_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0097_Ellipsis6.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0097_Ellipsis6.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0097_Ellipsis6.c"
			);
