...
public class Test0099_Ellipsis8 {
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("FOO(fprintf, , );", Code_9_Var
		.getCode());
		//9
		...
		Assert.assertEquals("FOO(printf, \"abc\");", Code_10_Var
		.getCode());
		//10
		...
		Assert.assertEquals("FOO(printf, \"abc\", \"def\");", Code_11_Var
		.getCode());
		//11
		...
		Assert.assertEquals("FOO(printf, \"abc\", \"def\", \"ghi\");", Code_12_Var
		.getCode());
	}
