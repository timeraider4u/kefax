...
public class Test0101_DefSamePattern {
	@Inject
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0101_DefSamePattern.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0101_DefSamePattern.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0101_DefSamePattern.c"
			);
