...
public class Test0102_DefSamePattern {
	@Inject
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0102_DefSamePattern.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0102_DefSamePattern.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0102_DefSamePattern.c"
			);
