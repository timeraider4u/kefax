...
public class Test0103_Ellipsis9 {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertTrue(IdentifierList_4_Var
		.isVariadic());
		Assert.assertEquals("printf(x)", DefineFunctionLikeMacro_3_Var
		.getString());
		//4
		...
		Assert.assertEquals("FOO(\"abc\");", Code_9_Var
		.getCode());
		//9
		...
		Assert.assertEquals("FOO(\"abc\", \"def\");", Code_10_Var
		.getCode());
		//10
		...
		Assert.assertEquals("FOO( \"abc\", \"def\", \"ghi\");", Code_11_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0103_Ellipsis9.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0103_Ellipsis9.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0103_Ellipsis9.c"
			);
