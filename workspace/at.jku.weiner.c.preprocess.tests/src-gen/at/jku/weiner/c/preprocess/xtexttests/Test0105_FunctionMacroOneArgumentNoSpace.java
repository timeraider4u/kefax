...
public class Test0105_FunctionMacroOneArgumentNoSpace {
	@Inject
	...
	public void checkLexerTokens() throws Exception{
		final String text = this.getTextFromFile(
			"res/Test0105_FunctionMacroOneArgumentNoSpace.c");
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("int x = inc(5);", Code_5_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0105_FunctionMacroOneArgumentNoSpace.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0105_FunctionMacroOneArgumentNoSpace.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0105_FunctionMacroOneArgumentNoSpace.c"
			);
