...
public class Test0107_FunctionMacroTwoArgumentsWithSpaces {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("int a = MIN(5,8);", Code_6_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0107_FunctionMacroTwoArgumentsWithSpaces.c.i");
			}
