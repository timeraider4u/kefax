...
public class Test0109_PredefinedNostdinc {
	@Inject
	...
	public void initialize(){
		...
		at.jku.weiner.c.preprocess.xtexttests.TestUtils.setUpTest0109(generator);
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0109_PredefinedNostdinc.c.i");
			}
