...
public class Test0111_RelativeInclude {
	@Inject
	...
	public void checkLexerTokens() throws Exception{
		final String text = this.getTextFromFile(
			"res/Test0111_RelativeInclude.c");
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("\"../myinclude/include/bar.h\"", IncludeDirective_3_Var
		.getString());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0111_RelativeInclude.c");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0111_RelativeInclude.c");
		final String expected = this.getTextFromFile(
			"expected/Test0111_RelativeInclude.c"
			);
