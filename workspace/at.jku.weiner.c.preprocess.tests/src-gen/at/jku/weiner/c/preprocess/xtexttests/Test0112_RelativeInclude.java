...
public class Test0112_RelativeInclude {
	@Inject
	...
	public void initialize(){
		...
		at.jku.weiner.c.preprocess.xtexttests.TestUtils.setUpTest0112(generator);
	}
	...
	public void checkLexerTokens() throws Exception{
		final String text = this.getTextFromFile(
			"res/Test0112_RelativeInclude.c");
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("\"../myinclude/include/test0112/bar.h\"", IncludeDirective_3_Var
		.getString());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0112_RelativeInclude.c");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0112_RelativeInclude.c");
		final String expected = this.getTextFromFile(
			"expected/Test0112_RelativeInclude.c"
			);
