...
public class Test0113_SimpleDefWithWarning {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		.getIdent().toString());
		Assert.assertEquals("warning(X)", DefineFunctionLikeMacro_3_Var
		.getString());
		//4
		...
		Assert.assertEquals("warning(\"foo\")", Code_5_Var
		.getCode());
		//5
		...
		Assert.assertEquals("undef(x)", Code_7_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0113_SimpleDefWithWarning.c.i");
			}
