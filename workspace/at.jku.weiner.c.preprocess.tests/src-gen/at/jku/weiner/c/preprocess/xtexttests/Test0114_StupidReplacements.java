...
public class Test0114_StupidReplacements {
	@Inject
	...
	public void checkLexerTokens() throws Exception{
		final String text = this.getTextFromFile(
			"res/Test0114_StupidReplacements.c");
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("FOO", Code_4_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0114_StupidReplacements.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0114_StupidReplacements.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0114_StupidReplacements.c"
			);
