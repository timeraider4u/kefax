...
public class Test0117_Replacement {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("  	int bar[bax]", ReplaceLine_5_Var
		.getString());
		//5
		...
		Assert.assertEquals("FOO(bax,5);", Code_7_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0117_Replacement.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0117_Replacement.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0117_Replacement.c"
			);
