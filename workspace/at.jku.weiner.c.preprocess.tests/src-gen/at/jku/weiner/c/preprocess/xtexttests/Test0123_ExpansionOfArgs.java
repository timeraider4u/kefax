...
public class Test0123_ExpansionOfArgs {
	@Inject
	...
	public void checkLexerTokens() throws Exception{
		final String text = this.getTextFromFile(
			"res/Test0123_ExpansionOfArgs.c");
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("foo(foo) (2)", Code_5_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0123_ExpansionOfArgs.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0123_ExpansionOfArgs.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0123_ExpansionOfArgs.c"
			);
