...
public class Test0125_ConcatenationWithoutWS {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("__FOO(1,A) __FOO(1,A)", Code_8_Var
		.getCode());
		//8
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0125_ConcatenationWithoutWS.c.i");
			}
