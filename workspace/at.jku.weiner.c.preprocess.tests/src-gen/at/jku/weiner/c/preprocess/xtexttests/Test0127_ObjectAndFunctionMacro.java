...
public class Test0127_ObjectAndFunctionMacro {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("BAR(i)", Code_10_Var
		.getCode());
		//10
		...
		Assert.assertEquals("BAZ(j)", Code_11_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0127_ObjectAndFunctionMacro.c.i");
			}
