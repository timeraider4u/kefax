...
public class Test0130_AbsoluteRelativeInclude {
	@Inject
	...
	public void initialize(){
		...
		at.jku.weiner.c.preprocess.xtexttests.TestUtils.setUpTest0130();
	}
	...
	public void checkLexerTokens() throws Exception{
		final String text = this.getTextFromFile(
			"res/Test0130_AbsoluteRelativeInclude.c");
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0130_AbsoluteRelativeInclude.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0130_AbsoluteRelativeInclude.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0130_AbsoluteRelativeInclude.c"
			);
