...
public class Test0131_IncludeNext {
	@Inject
	...
	public void initialize(){
		...
		at.jku.weiner.c.preprocess.xtexttests.TestUtils.setUpTest0131();
	}
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertTrue(IncludeDirective_3_Var
		.isNext());
		Assert.assertEquals("\"test0131.h\"", IncludeDirective_3_Var
		.getString());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0131_IncludeNext.h.i");
			}
