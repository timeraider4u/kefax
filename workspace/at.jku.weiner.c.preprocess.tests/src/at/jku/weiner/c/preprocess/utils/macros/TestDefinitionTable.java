...
public class TestDefinitionTable {
	...
	public void testContainsAKeyAndResolve1() {
		...
		Assert.assertFalse(DefinitionTable.containsAKey(text, text));
	}
	...
	public void testContainsAKeyAndResolve2() {
		...
		Assert.assertTrue(DefinitionTable.containsAKey(code, code));
		final String resolve = DefinitionTable.resolve(code, code);
		Assert.assertTrue(DefinitionTable.containsAKey(code, code));
		Assert.assertFalse(DefinitionTable.containsAKey(code, resolve));
	}
	...
	public void testContainsAKeyAndResolve3() {
		...
		Assert.assertTrue(DefinitionTable.containsAKey(code, code));
		Assert.assertTrue(DefinitionTable.containsAKey(code, resolve));
		final String resolve2 = DefinitionTable.resolve(code, resolve);
		Assert.assertEquals("a little red cat looks at you!", resolve2);
		Assert.assertTrue(DefinitionTable.containsAKey(code, code));
		Assert.assertTrue(DefinitionTable.containsAKey(code, resolve));
		Assert.assertFalse(DefinitionTable.containsAKey(code, resolve2));
	}
	...
	public void testContainsAKeyAndResolve6() {
		...
		DefinitionTable.addFunctionMacro("penguin", null, this.replaceLines1);
		DefinitionTable.add("fox", "firefox");
		Assert.assertFalse(DefinitionTable.containsAKey(code, code));
		Assert.assertTrue(DefinitionTable.containsAKey(code, code2));
		final String resolve = DefinitionTable.resolve(code, code2);
		Assert.assertFalse(DefinitionTable.containsAKey(code, code));
		Assert.assertTrue(DefinitionTable.containsAKey(code, code2));
		Assert.assertFalse(DefinitionTable.containsAKey(code, resolve));
		final String resolve2 = DefinitionTable.resolve(code, resolve);
	...
	public void testContainsAKeyAndResolve8() {
		...
		Assert.assertFalse(DefinitionTable.containsAKey(code, code));
		Assert.assertTrue(DefinitionTable.containsAKey(code, code2));
		final String resolve0 = DefinitionTable.resolve(code, code);
		Assert.assertEquals("a little penguin looks at you!", resolve0);
		final String resolve1 = DefinitionTable.resolve(code, code2);
		Assert.assertEquals("a little red cat looks at you!", resolve1);
		Assert.assertFalse(DefinitionTable.containsAKey(code, code));
		Assert.assertTrue(DefinitionTable.containsAKey(code, code2));
		Assert.assertFalse(DefinitionTable.containsAKey(code, resolve1));
		final String resolve2 = DefinitionTable.resolve(code, resolve1);
		Assert.assertFalse(DefinitionTable.containsAKey(code, code));
		Assert.assertTrue(DefinitionTable.containsAKey(code, code2));
		Assert.assertFalse(DefinitionTable.containsAKey(code, resolve1));
		Assert.assertFalse(DefinitionTable.containsAKey(code, resolve2));
	...
	public void testContainsAKeyAndResolve9() {
		...
		Assert.assertFalse(DefinitionTable.containsAKey(code, code));
		final String result = DefinitionTable.resolve(code, code);
	...
	public void testContainsAKeyAndResolve10() {
		...
		final String result = DefinitionTable.resolve(code, code);
		Assert.assertFalse(DefinitionTable.containsAKey(code, code));
		Assert.assertFalse(DefinitionTable.containsAKey(code, result));
		Assert.assertEquals(code, result);
	}
