...
public class InternalPreprocessLexer extends Lexer {
    ...
    public final void mRULE_PP_NUMBER() throws RecognitionException {
        try {
            // InternalPreprocess.g:12448:25: ( ( '0' '8' .. '9' ( '0' .. '9' )* | ( '0' .. '9' )+ ( 'a' | 'c' .. 'z' | 'A' | 'C' .. 'Z' ) ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' )* ) )
            // InternalPreprocess.g:12448:27: ( '0' '8' .. '9' ( '0' .. '9' )* | ( '0' .. '9' )+ ( 'a' | 'c' .. 'z' | 'A' | 'C' .. 'Z' ) ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' )* )
            {
            // InternalPreprocess.g:12448:27: ( '0' '8' .. '9' ( '0' .. '9' )* | ( '0' .. '9' )+ ( 'a' | 'c' .. 'z' | 'A' | 'C' .. 'Z' ) ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' )* )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalPreprocess.g:12448:53: ( '0' .. '9' )+ ( 'a' | 'c' .. 'z' | 'A' | 'C' .. 'Z' ) ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' )*
                    {
                    ...
                    // InternalPreprocess.g:12448:93: ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' )*
                    loop8:
                    do {
                        int alt8=2;
    ...
    public final void mRULE_HEX_PREFIX() throws RecognitionException {
        try {
            // InternalPreprocess.g:12540:26: ( ( '0x' | '0X' ) )
            // InternalPreprocess.g:12540:28: ( '0x' | '0X' )
            {
            // InternalPreprocess.g:12540:28: ( '0x' | '0X' )
            int alt14=2;
            ...
            switch (alt14) {
                case 1 :
                    // InternalPreprocess.g:12540:29: '0x'
                    {
                    match("0x"); 
                    ...
                    break;
                case 2 :
                    // InternalPreprocess.g:12540:34: '0X'
                    {
                    match("0X"); 
    ...
    class DFA9 extends DFA {
        ...
        public String getDescription() {
            return "12448:27: ( '0' '8' .. '9' ( '0' .. '9' )* | ( '0' .. '9' )+ ( 'a' | 'c' .. 'z' | 'A' | 'C' .. 'Z' ) ( '0' .. '9' | 'a' .. 'z' | 'A' .. 'Z' )* )";
        }
    }
