 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.c.preprocess.cPreprocess.impl.DefineFunctionLikeMacroImpl#getList <em>List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefineFunctionLikeMacroImpl extends DefineDirectiveImpl implements DefineFunctionLikeMacro
{
  ...
  {
    return CPreprocessPackage.Literals.DEFINE_FUNCTION_LIKE_MACRO;
  }
  ...
  public NotificationChain basicSetList(IdentifierList newList, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPreprocessPackage.DEFINE_FUNCTION_LIKE_MACRO__LIST, oldList, newList);
  ...
  public void setList(IdentifierList newList)
  {
    if (newList != list)
    {
      ...
      if (list != null)
        msgs = ((InternalEObject)list).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CPreprocessPackage.DEFINE_FUNCTION_LIKE_MACRO__LIST, null, msgs);
      if (newList != null)
        msgs = ((InternalEObject)newList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CPreprocessPackage.DEFINE_FUNCTION_LIKE_MACRO__LIST, null, msgs);
      msgs = basicSetList(newList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPreprocessPackage.DEFINE_FUNCTION_LIKE_MACRO__LIST, newList, newList));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CPreprocessPackage.DEFINE_FUNCTION_LIKE_MACRO__LIST:
