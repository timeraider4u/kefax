 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.c.preprocess.cPreprocess.impl.ModelImpl#getUnits <em>Units</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  {
    return CPreprocessPackage.Literals.MODEL;
  }
  ...
  public EList<TranslationUnit> getUnits()
  {
    if (units == null)
    {
      units = new EObjectContainmentEList<TranslationUnit>(TranslationUnit.class, this, CPreprocessPackage.MODEL__UNITS);
    }
    return units;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CPreprocessPackage.MODEL__UNITS:
