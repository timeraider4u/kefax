...
SYNTHETIC_ALL_KEYWORDS :
	...
	(FRAGMENT_RULE_ELIF)=> FRAGMENT_RULE_ELIF {$type = RULE_ELIF; } |
	(FRAGMENT_RULE_ELSE)=> FRAGMENT_RULE_ELSE {$type = RULE_ELSE; } |
...
fragment RULE_ELIF : FRAGMENT_RULE_ELIF;
fragment FRAGMENT_RULE_ELIF : 'elif';

fragment RULE_ELSE : FRAGMENT_RULE_ELSE;
fragment FRAGMENT_RULE_ELSE : 'else';
