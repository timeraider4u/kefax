 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.preprocess.preprocess.impl.AdditiveExpressionImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link at.jku.weiner.c.preprocess.preprocess.impl.AdditiveExpressionImpl#getOp <em>Op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AdditiveExpressionImpl extends ExpressionImpl implements AdditiveExpression
{
  ...
  {
    return PreprocessPackage.Literals.ADDITIVE_EXPRESSION;
  }
  ...
  public EList<String> getOp()
  {
    if (op == null)
    {
      op = new EDataTypeEList<String>(String.class, this, PreprocessPackage.ADDITIVE_EXPRESSION__OP);
    }
    return op;
  }
