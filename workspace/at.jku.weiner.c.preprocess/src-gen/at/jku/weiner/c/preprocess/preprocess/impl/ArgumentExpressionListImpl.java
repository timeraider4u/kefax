 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.preprocess.preprocess.impl.ArgumentExpressionListImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArgumentExpressionListImpl extends MinimalEObjectImpl.Container implements ArgumentExpressionList
{
  ...
  {
    return PreprocessPackage.Literals.ARGUMENT_EXPRESSION_LIST;
  }
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, PreprocessPackage.ARGUMENT_EXPRESSION_LIST__EXPR);
    }
    return expr;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PreprocessPackage.ARGUMENT_EXPRESSION_LIST__EXPR:
