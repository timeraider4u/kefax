 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.preprocess.preprocess.impl.EqualityExpressionImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link at.jku.weiner.c.preprocess.preprocess.impl.EqualityExpressionImpl#getOp <em>Op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EqualityExpressionImpl extends ExpressionImpl implements EqualityExpression
{
  ...
  {
    return PreprocessPackage.Literals.EQUALITY_EXPRESSION;
  }
  ...
  public EList<String> getOp()
  {
    if (op == null)
    {
      op = new EDataTypeEList<String>(String.class, this, PreprocessPackage.EQUALITY_EXPRESSION__OP);
    }
    return op;
  }
