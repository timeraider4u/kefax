 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.c.preprocess.preprocess.impl.MultiplicativeExpressionImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link at.jku.weiner.c.preprocess.preprocess.impl.MultiplicativeExpressionImpl#getOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultiplicativeExpressionImpl extends MinimalEObjectImpl.Container implements MultiplicativeExpression
{
  ...
  {
    return PreprocessPackage.Literals.MULTIPLICATIVE_EXPRESSION;
  }
  ...
  public EList<String> getOp()
  {
    if (op == null)
    {
      op = new EDataTypeEList<String>(String.class, this, PreprocessPackage.MULTIPLICATIVE_EXPRESSION__OP);
    }
    return op;
  }
