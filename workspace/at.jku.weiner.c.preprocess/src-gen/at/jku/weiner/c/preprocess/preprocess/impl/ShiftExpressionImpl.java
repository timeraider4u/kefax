 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.c.preprocess.preprocess.impl.ShiftExpressionImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link at.jku.weiner.c.preprocess.preprocess.impl.ShiftExpressionImpl#getOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ShiftExpressionImpl extends ExpressionImpl implements ShiftExpression
{
  ...
  {
    return PreprocessPackage.Literals.SHIFT_EXPRESSION;
  }
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, PreprocessPackage.SHIFT_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public EList<String> getOp()
  {
    if (op == null)
    {
      op = new EDataTypeEList<String>(String.class, this, PreprocessPackage.SHIFT_EXPRESSION__OP);
    }
    return op;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PreprocessPackage.SHIFT_EXPRESSION__EXPR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PreprocessPackage.SHIFT_EXPRESSION__EXPR:
        return getExpr();
      case PreprocessPackage.SHIFT_EXPRESSION__OP:
        return getOp();
    }
