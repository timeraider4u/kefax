...
public class PreprocessSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_DefineObjectMacro_WHITESPACETerminalRuleCall_5_a;
	...
	protected AbstractElementAlias match_IdentifierList_WHITESPACETerminalRuleCall_1_0_1_0_a;
	protected AbstractElementAlias match_IdentifierList_WHITESPACETerminalRuleCall_1_0_1_2_a;
	...
	protected AbstractElementAlias match_LineDirective_WHITESPACETerminalRuleCall_4_0_p;
	...
	protected void init(IGrammarAccess access) {
		...
		match_DefineObjectMacro_WHITESPACETerminalRuleCall_5_a = new TokenAlias(true, true, grammarAccess.getDefineObjectMacroAccess().getWHITESPACETerminalRuleCall_5());
		...
		match_IdentifierList_WHITESPACETerminalRuleCall_1_0_1_0_a = new TokenAlias(true, true, grammarAccess.getIdentifierListAccess().getWHITESPACETerminalRuleCall_1_0_1_0());
		match_IdentifierList_WHITESPACETerminalRuleCall_1_0_1_2_a = new TokenAlias(true, true, grammarAccess.getIdentifierListAccess().getWHITESPACETerminalRuleCall_1_0_1_2());
		...
		match_LineDirective_WHITESPACETerminalRuleCall_4_0_p = new TokenAlias(true, false, grammarAccess.getLineDirectiveAccess().getWHITESPACETerminalRuleCall_4_0());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_DefineObjectMacro_WHITESPACETerminalRuleCall_5_a.equals(syntax))
				emit_DefineObjectMacro_WHITESPACETerminalRuleCall_5_a(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if(match_IdentifierList_WHITESPACETerminalRuleCall_1_0_1_0_a.equals(syntax))
				emit_IdentifierList_WHITESPACETerminalRuleCall_1_0_1_0_a(semanticObject, getLastNavigableState(), syntaxNodes);
			else if(match_IdentifierList_WHITESPACETerminalRuleCall_1_0_1_2_a.equals(syntax))
				emit_IdentifierList_WHITESPACETerminalRuleCall_1_0_1_2_a(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if(match_LineDirective_WHITESPACETerminalRuleCall_4_0_p.equals(syntax))
				emit_LineDirective_WHITESPACETerminalRuleCall_4_0_p(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) DEFINE (ambiguity) ident=MyCode
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     ident=MyCode SKW_LEFTPAREN (ambiguity) SKW_RIGHTPAREN (rule end)
	 *     ident=MyCode SKW_LEFTPAREN (ambiguity) SKW_RIGHTPAREN string=MyDefineLineFunction
	 *     ident=MyCode SKW_LEFTPAREN (ambiguity) list=IdentifierList
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     ident=MyCode (ambiguity) string=MyDefineLineObject
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     ident=MyCode (ambiguity) (rule end)
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     ident+=PP_ID (ambiguity) SKW_COMMA WHITESPACE* ident+=PP_ID
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     ident+=PP_ID WHITESPACE* SKW_COMMA (ambiguity) ident+=PP_ID
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     ident+=PP_ID (ambiguity) (rule end)
	 *     ident+=PP_ID (ambiguity) SKW_COMMA WHITESPACE* varID=PP_ID
	 *     ident+=PP_ID (ambiguity) SKW_COMMA WHITESPACE* variadic?=Ellipsis
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     ident+=PP_ID WHITESPACE* SKW_COMMA (ambiguity) varID=PP_ID
	 *     ident+=PP_ID WHITESPACE* SKW_COMMA (ambiguity) variadic?=Ellipsis
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) IFDEF (ambiguity) ident=PP_ID
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     ident=PP_ID (ambiguity) NEWLINE group=GroupOpt
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) IFNOTDEF (ambiguity) ident=PP_ID
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) LINE (ambiguity) line=MyCode
	 */
	 ...
	 */
	protected void emit_PragmaDirective_WHITESPACETerminalRuleCall_2_a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) UNDEF (ambiguity) ident=PP_ID
	 */
