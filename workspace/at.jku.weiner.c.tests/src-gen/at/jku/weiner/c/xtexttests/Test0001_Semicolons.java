...
public class Test0001_Semicolons {
	...
	throws Exception{
		final Path path = Paths.get("res/Test0001_Semicolons.c");
	...
	throws Exception{
		...
		final ExternalDeclaration ExternalDeclaration_3_Var = (ExternalDeclaration)External_1_list.get(1);
		Assert.assertNotNull(ExternalDeclaration_3_Var);
		Assert.assertEquals(";", ExternalDeclaration_3_Var.getSemi());
		final ExternalDeclaration ExternalDeclaration_4_Var = (ExternalDeclaration)External_1_list.get(2);
		Assert.assertNotNull(ExternalDeclaration_4_Var);
		Assert.assertEquals(";", ExternalDeclaration_4_Var.getSemi());
	}
