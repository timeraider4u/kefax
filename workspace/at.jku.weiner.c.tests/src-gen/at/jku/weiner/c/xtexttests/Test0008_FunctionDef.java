...
public class Test0008_FunctionDef {
	...
	private String preprocess(final String string) {
		...
		final String blockComment = lineComment.replaceAll("(?s)/\\*.+?\\*/",
				" ");
	...
	public void checkLexerTokens() throws Exception {
		...
		final String[] expected = new String[] { "RULE_KW_VOID",
				"RULE_WHITESPACE", "RULE_ID", "RULE_LEFTPAREN", "RULE_KW_CHAR",
				"RULE_WHITESPACE", "RULE_ID", "RULE_COMMA", "RULE_WHITESPACE",
				"RULE_KW_FLOAT", "RULE_WHITESPACE", "RULE_ID", "RULE_COMMA",
				"RULE_WHITESPACE", "RULE_KW_INT", "RULE_WHITESPACE", "RULE_ID",
				"RULE_RIGHTPAREN", "RULE_WHITESPACE", "RULE_LEFTBRACE",
				"RULE_NEWLINE", "RULE_RIGHTBRACE", "RULE_NEWLINE",
				"RULE_BLOCK_COMMENT", "RULE_NEWLINE", "RULE_KW_VOID",
				"RULE_WHITESPACE", "RULE_ID", "RULE_LEFTPAREN", "RULE_ID",
				"RULE_COMMA", "RULE_WHITESPACE", "RULE_ID", "RULE_COMMA",
				"RULE_WHITESPACE", "RULE_ID", "RULE_RIGHTPAREN",
				"RULE_WHITESPACE", "RULE_LINE_COMMENT", "RULE_NEWLINE",
				"RULE_WHITESPACE", "RULE_LINE_COMMENT", "RULE_NEWLINE",
				"RULE_WHITESPACE", "RULE_KW_CHAR", "RULE_WHITESPACE",
				"RULE_ID", "RULE_SEMI", "RULE_NEWLINE", "RULE_WHITESPACE",
				"RULE_KW_FLOAT", "RULE_WHITESPACE", "RULE_ID", "RULE_SEMI",
				"RULE_NEWLINE", "RULE_WHITESPACE", "RULE_LINE_COMMENT",
				"RULE_NEWLINE", "RULE_WHITESPACE", "RULE_KW_INT",
				"RULE_WHITESPACE", "RULE_ID", "RULE_SEMI", "RULE_WHITESPACE",
				"RULE_LINE_COMMENT", "RULE_NEWLINE", "RULE_LEFTBRACE",
				"RULE_NEWLINE", "RULE_NEWLINE", "RULE_RIGHTBRACE",
				"RULE_NEWLINE", };
	...
	public void checkParserResult() throws Exception {
		...
		// 2
		final FunctionDefHead FunctionDefHead_3_Var = (FunctionDefHead) ExternalDeclaration_2_Var
				.getFunctiondefHead();
		Assert.assertNotNull(FunctionDefHead_3_Var);
		// 3
		final FunctionDeclarationSpecifiers FunctionDeclarationSpecifiers_4_Var = (FunctionDeclarationSpecifiers) FunctionDefHead_3_Var
		...
		// 5
		final Declarator Declarator_6_Var = (Declarator) FunctionDefHead_3_Var
				.getFunDeclarator();
		Assert.assertNotNull(Declarator_6_Var);
		// 6
		final DirectDeclarator DirectDeclarator_7_Var = (DirectDeclarator) Declarator_6_Var
				.getDeclarator();
		...
		// 7
		final DeclaratorSuffix DeclaratorSuffix_8_Var = (DeclaratorSuffix) DeclaratorSuffix_7_list
				.get(0);
		Assert.assertNotNull(DeclaratorSuffix_8_Var);
		// 8
		final DirectDeclaratorLastSuffix DirectDeclaratorLastSuffix_9_Var = (DirectDeclaratorLastSuffix) DeclaratorSuffix_8_Var
				.getLastSuffix();
		...
		// 9
		final ParameterTypeList ParameterTypeList_10_Var = (ParameterTypeList) ParameterTypeList_9_list
				.get(0);
		Assert.assertNotNull(ParameterTypeList_10_Var);
		// 10
		final ParameterList ParameterList_11_Var = (ParameterList) ParameterTypeList_10_Var
				.getList();
		...
		// 11
		final ParameterDeclaration ParameterDeclaration_12_Var = (ParameterDeclaration) ParameterDeclaration_11_list
				.get(0);
		Assert.assertNotNull(ParameterDeclaration_12_Var);
		// 12
		final DeclarationSpecifiers DeclarationSpecifiers_13_Var = (DeclarationSpecifiers) ParameterDeclaration_12_Var
				.getDeclSpecifiers();
		...
		// 13
		final TypeSpecifier TypeSpecifier_14_Var = (TypeSpecifier) DeclarationSpecifier_13_list
				.get(0);
		Assert.assertNotNull(TypeSpecifier_14_Var);
		Assert.assertEquals("char", TypeSpecifier_14_Var.getName());
		// 14
		final Declarator Declarator_15_Var = (Declarator) ParameterDeclaration_12_Var
				.getDeclarator();
		Assert.assertNotNull(Declarator_15_Var);
		// 15
		final DirectDeclarator DirectDeclarator_16_Var = (DirectDeclarator) Declarator_15_Var
				.getDeclarator();
		Assert.assertNotNull(DirectDeclarator_16_Var);
		Assert.assertEquals("c", DirectDeclarator_16_Var.getId());
		// 16
		final ParameterDeclaration ParameterDeclaration_17_Var = (ParameterDeclaration) ParameterDeclaration_11_list
				.get(1);
		Assert.assertNotNull(ParameterDeclaration_17_Var);
		// 17
		final DeclarationSpecifiers DeclarationSpecifiers_18_Var = (DeclarationSpecifiers) ParameterDeclaration_17_Var
				.getDeclSpecifiers();
		...
		// 18
		final TypeSpecifier TypeSpecifier_19_Var = (TypeSpecifier) DeclarationSpecifier_18_list
				.get(0);
		Assert.assertNotNull(TypeSpecifier_19_Var);
		Assert.assertEquals("float", TypeSpecifier_19_Var.getName());
		// 19
		final Declarator Declarator_20_Var = (Declarator) ParameterDeclaration_17_Var
				.getDeclarator();
		Assert.assertNotNull(Declarator_20_Var);
		// 20
		final DirectDeclarator DirectDeclarator_21_Var = (DirectDeclarator) Declarator_20_Var
				.getDeclarator();
		Assert.assertNotNull(DirectDeclarator_21_Var);
		Assert.assertEquals("f", DirectDeclarator_21_Var.getId());
		// 21
		final ParameterDeclaration ParameterDeclaration_22_Var = (ParameterDeclaration) ParameterDeclaration_11_list
				.get(2);
		Assert.assertNotNull(ParameterDeclaration_22_Var);
		// 22
		final DeclarationSpecifiers DeclarationSpecifiers_23_Var = (DeclarationSpecifiers) ParameterDeclaration_22_Var
				.getDeclSpecifiers();
		...
		// 23
		final TypeSpecifier TypeSpecifier_24_Var = (TypeSpecifier) DeclarationSpecifier_23_list
				.get(0);
		Assert.assertNotNull(TypeSpecifier_24_Var);
		Assert.assertEquals("int", TypeSpecifier_24_Var.getName());
		// 24
		final Declarator Declarator_25_Var = (Declarator) ParameterDeclaration_22_Var
				.getDeclarator();
		Assert.assertNotNull(Declarator_25_Var);
		// 25
		final DirectDeclarator DirectDeclarator_26_Var = (DirectDeclarator) Declarator_25_Var
				.getDeclarator();
		Assert.assertNotNull(DirectDeclarator_26_Var);
		Assert.assertEquals("i", DirectDeclarator_26_Var.getId());
		// 26
		final ExternalDeclaration ExternalDeclaration_27_Var = (ExternalDeclaration) External_1_list
				.get(1);
		Assert.assertNotNull(ExternalDeclaration_27_Var);
		// 27
		final FunctionDefinition FunctionDefinition_28_Var = (FunctionDefinition) ExternalDeclaration_27_Var
				.getFunctionDefinition();
		Assert.assertNotNull(FunctionDefinition_28_Var);
		// 28
		final BodyStatement BodyStatement_29_Var = (BodyStatement) FunctionDefinition_28_Var
				.getBody();
		Assert.assertNotNull(BodyStatement_29_Var);
		// 29
		final FunctionDefHead FunctionDefHead_30_Var = (FunctionDefHead) ExternalDeclaration_27_Var
				.getFunctiondefHead();
		Assert.assertNotNull(FunctionDefHead_30_Var);
		// 30
		final FunctionDeclarationSpecifiers FunctionDeclarationSpecifiers_31_Var = (FunctionDeclarationSpecifiers) FunctionDefHead_30_Var
				.getFunDeclSpecifiers();
		...
		// 31
		final TypeSpecifier TypeSpecifier_32_Var = (TypeSpecifier) DeclarationSpecifier_31_list
				.get(0);
		Assert.assertNotNull(TypeSpecifier_32_Var);
		Assert.assertEquals("void", TypeSpecifier_32_Var.getName());
		// 32
		final Declarator Declarator_33_Var = (Declarator) FunctionDefHead_30_Var
				.getFunDeclarator();
		Assert.assertNotNull(Declarator_33_Var);
		// 33
		final DirectDeclarator DirectDeclarator_34_Var = (DirectDeclarator) Declarator_33_Var
				.getDeclarator();
		...
		// 34
		final DeclaratorSuffix DeclaratorSuffix_35_Var = (DeclaratorSuffix) DeclaratorSuffix_34_list
				.get(0);
		Assert.assertNotNull(DeclaratorSuffix_35_Var);
		// 35
		final DirectDeclaratorLastSuffix DirectDeclaratorLastSuffix_36_Var = (DirectDeclaratorLastSuffix) DeclaratorSuffix_35_Var
				.getLastSuffix();
		Assert.assertNotNull(DirectDeclaratorLastSuffix_36_Var);
		// 36
		final IdentifierList IdentifierList_37_Var = (IdentifierList) DirectDeclaratorLastSuffix_36_Var
				.getIdentifierList();
		...
		// 37
		final MyIdentifier MyIdentifier_38_Var = (MyIdentifier) Id_37_list
				.get(0);
		Assert.assertNotNull(MyIdentifier_38_Var);
		Assert.assertEquals("c", MyIdentifier_38_Var.getId());
		// 38
		final MyIdentifier MyIdentifier_39_Var = (MyIdentifier) Id_37_list
				.get(1);
		Assert.assertNotNull(MyIdentifier_39_Var);
		Assert.assertEquals("f", MyIdentifier_39_Var.getId());
		// 39
		final MyIdentifier MyIdentifier_40_Var = (MyIdentifier) Id_37_list
				.get(2);
		...
		// 40
		final Declaration Declaration_41_Var = (Declaration) FunDeclaration_40_list
				.get(0);
		Assert.assertNotNull(Declaration_41_Var);
		// 41
		final DeclarationSpecifiers DeclarationSpecifiers_42_Var = (DeclarationSpecifiers) Declaration_41_Var
				.getSpecifiers();
		...
		// 42
		final TypeSpecifier TypeSpecifier_43_Var = (TypeSpecifier) DeclarationSpecifier_42_list
				.get(0);
		...
		// 43
		final InitDeclaratorList InitDeclaratorList_44_Var = (InitDeclaratorList) InitDeclaratorList_43_list
				.get(0);
		...
		// 44
		final InitDeclarator InitDeclarator_45_Var = (InitDeclarator) InitDeclarator_44_list
				.get(0);
		Assert.assertNotNull(InitDeclarator_45_Var);
		// 45
		final Declarator Declarator_46_Var = (Declarator) InitDeclarator_45_Var
				.getDeclarator();
		Assert.assertNotNull(Declarator_46_Var);
		// 46
		final DirectDeclarator DirectDeclarator_47_Var = (DirectDeclarator) Declarator_46_Var
				.getDeclarator();
		Assert.assertNotNull(DirectDeclarator_47_Var);
		Assert.assertEquals("c", DirectDeclarator_47_Var.getId());
		// 47
		final Declaration Declaration_48_Var = (Declaration) FunDeclaration_40_list
				.get(1);
		Assert.assertNotNull(Declaration_48_Var);
		// 48
		final DeclarationSpecifiers DeclarationSpecifiers_49_Var = (DeclarationSpecifiers) Declaration_48_Var
				.getSpecifiers();
		...
		// 49
		final TypeSpecifier TypeSpecifier_50_Var = (TypeSpecifier) DeclarationSpecifier_49_list
				.get(0);
		...
		// 50
		final InitDeclaratorList InitDeclaratorList_51_Var = (InitDeclaratorList) InitDeclaratorList_50_list
				.get(0);
		...
		// 51
		final InitDeclarator InitDeclarator_52_Var = (InitDeclarator) InitDeclarator_51_list
				.get(0);
		Assert.assertNotNull(InitDeclarator_52_Var);
		// 52
		final Declarator Declarator_53_Var = (Declarator) InitDeclarator_52_Var
				.getDeclarator();
		Assert.assertNotNull(Declarator_53_Var);
		// 53
		final DirectDeclarator DirectDeclarator_54_Var = (DirectDeclarator) Declarator_53_Var
				.getDeclarator();
		Assert.assertNotNull(DirectDeclarator_54_Var);
		Assert.assertEquals("f", DirectDeclarator_54_Var.getId());
		// 54
		final Declaration Declaration_55_Var = (Declaration) FunDeclaration_40_list
				.get(2);
		Assert.assertNotNull(Declaration_55_Var);
		// 55
		final DeclarationSpecifiers DeclarationSpecifiers_56_Var = (DeclarationSpecifiers) Declaration_55_Var
				.getSpecifiers();
		...
		// 56
		final TypeSpecifier TypeSpecifier_57_Var = (TypeSpecifier) DeclarationSpecifier_56_list
				.get(0);
		...
		// 57
		final InitDeclaratorList InitDeclaratorList_58_Var = (InitDeclaratorList) InitDeclaratorList_57_list
				.get(0);
		...
		// 58
		final InitDeclarator InitDeclarator_59_Var = (InitDeclarator) InitDeclarator_58_list
				.get(0);
		Assert.assertNotNull(InitDeclarator_59_Var);
		// 59
		final Declarator Declarator_60_Var = (Declarator) InitDeclarator_59_Var
				.getDeclarator();
		Assert.assertNotNull(Declarator_60_Var);
		// 60
		final DirectDeclarator DirectDeclarator_61_Var = (DirectDeclarator) Declarator_60_Var
				.getDeclarator();
		Assert.assertNotNull(DirectDeclarator_61_Var);
		Assert.assertEquals("i", DirectDeclarator_61_Var.getId());
		// 61
		final FunctionDefinition FunctionDefinition_62_Var = (FunctionDefinition) ExternalDeclaration_27_Var
				.getFunctionDefinition();
		Assert.assertNotNull(FunctionDefinition_62_Var);
		// 62
		final BodyStatement BodyStatement_63_Var = (BodyStatement) FunctionDefinition_62_Var
				.getBody();
	...
	public void testGenerator() throws Exception {
		...
		final URI uri = URI.createURI("res/Test0008_FunctionDef.c");
		...
		final String actual = this
				.getTextFromFile("bin/Test0008_FunctionDef.c");
		final String expected = this
				.getTextFromFile("res/Test0008_FunctionDef.c");
