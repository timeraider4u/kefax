...
public class Test0011_ReturnStmts {
	...
	throws Exception{
		...
		final DeclarationSpecifiers DeclarationSpecifiers_33_Var = (DeclarationSpecifiers)FunctionDefHead_32_Var.getFunDeclSpecifiers();
		...
		final DeclarationSpecifiers DeclarationSpecifiers_65_Var = (DeclarationSpecifiers)FunctionDefHead_64_Var.getFunDeclSpecifiers();
		...
		final DeclarationSpecifiers DeclarationSpecifiers_94_Var = (DeclarationSpecifiers)FunctionDefHead_93_Var.getFunDeclSpecifiers();
		...
		final DeclarationSpecifiers DeclarationSpecifiers_123_Var = (DeclarationSpecifiers)FunctionDefHead_122_Var.getFunDeclSpecifiers();
		Assert.assertNotNull(DeclarationSpecifiers_123_Var);
		final EList<? extends EObject> DeclarationSpecifier_123_list = DeclarationSpecifiers_123_Var.getDeclarationSpecifier();
