...
public class Test0011_ReturnStmts {
	...
	throws Exception{
		final String text = this.getTextFromFile("res/Test0011_ReturnStmts.c");
	...
	throws Exception{
		...
		final FunctionDefHead FunctionDefHead_32_Var = (FunctionDefHead)ExternalDeclaration_31_Var.getFunctiondefHead();
		Assert.assertNotNull(FunctionDefHead_32_Var);
		final FunctionDeclarationSpecifiers FunctionDeclarationSpecifiers_33_Var = (FunctionDeclarationSpecifiers)FunctionDefHead_32_Var.getFunDeclSpecifiers();
		Assert.assertNotNull(FunctionDeclarationSpecifiers_33_Var);
		final EList<? extends EObject> DeclarationSpecifier_33_list = FunctionDeclarationSpecifiers_33_Var.getDeclarationSpecifier();
		...
		final Declarator Declarator_35_Var = (Declarator)FunctionDefHead_32_Var.getFunDeclarator();
		...
		Assert.assertEquals("doSomething2", DirectDeclarator_36_Var.getId());
		final FunctionDefinition FunctionDefinition_37_Var = (FunctionDefinition)ExternalDeclaration_31_Var.getFunctionDefinition();
		...
		final EList<? extends EObject> Statement_39_list = BlockList_39_Var.getStatement();
		Assert.assertNotNull(Statement_39_list);
		Assert.assertEquals(1, Statement_39_list.size());
		final Statement Statement_40_Var = (Statement)Statement_39_list.get(0);
		Assert.assertNotNull(Statement_40_Var);
		final JumpStatement JumpStatement_41_Var = (JumpStatement)Statement_40_Var.getStmt();
		Assert.assertNotNull(JumpStatement_41_Var);
		final Expression Expression_42_Var = (Expression)JumpStatement_41_Var.getExpr();
		Assert.assertNotNull(Expression_42_Var);
		final EList<? extends EObject> ExprExpr_42_list = Expression_42_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_42_list);
		Assert.assertEquals(1, ExprExpr_42_list.size());
		final AssignmentExpression AssignmentExpression_43_Var = (AssignmentExpression)ExprExpr_42_list.get(0);
		...
		final LogicalAndExpression LogicalAndExpression_46_Var = (LogicalAndExpression)Expr_45_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_46_Var);
		final EList<? extends EObject> Expr_46_list = LogicalAndExpression_46_Var.getExpr();
		Assert.assertNotNull(Expr_46_list);
		Assert.assertEquals(1, Expr_46_list.size());
		final InclusiveOrExpression InclusiveOrExpression_47_Var = (InclusiveOrExpression)Expr_46_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_47_Var);
		final EList<? extends EObject> Expr_47_list = InclusiveOrExpression_47_Var.getExpr();
		Assert.assertNotNull(Expr_47_list);
		Assert.assertEquals(1, Expr_47_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_48_Var = (ExclusiveOrExpression)Expr_47_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_48_Var);
		final EList<? extends EObject> Expr_48_list = ExclusiveOrExpression_48_Var.getExpr();
		Assert.assertNotNull(Expr_48_list);
		Assert.assertEquals(1, Expr_48_list.size());
		final AndExpression AndExpression_49_Var = (AndExpression)Expr_48_list.get(0);
		Assert.assertNotNull(AndExpression_49_Var);
		final EList<? extends EObject> Expr_49_list = AndExpression_49_Var.getExpr();
		Assert.assertNotNull(Expr_49_list);
		Assert.assertEquals(1, Expr_49_list.size());
		final EqualityExpression EqualityExpression_50_Var = (EqualityExpression)Expr_49_list.get(0);
		Assert.assertNotNull(EqualityExpression_50_Var);
		final EList<? extends EObject> Expr_50_list = EqualityExpression_50_Var.getExpr();
		Assert.assertNotNull(Expr_50_list);
		Assert.assertEquals(1, Expr_50_list.size());
		final RelationalExpression RelationalExpression_51_Var = (RelationalExpression)Expr_50_list.get(0);
		Assert.assertNotNull(RelationalExpression_51_Var);
		final EList<? extends EObject> Expr_51_list = RelationalExpression_51_Var.getExpr();
		Assert.assertNotNull(Expr_51_list);
		Assert.assertEquals(1, Expr_51_list.size());
		final ShiftExpression ShiftExpression_52_Var = (ShiftExpression)Expr_51_list.get(0);
		Assert.assertNotNull(ShiftExpression_52_Var);
		final EList<? extends EObject> Expr_52_list = ShiftExpression_52_Var.getExpr();
		Assert.assertNotNull(Expr_52_list);
		Assert.assertEquals(1, Expr_52_list.size());
		final AdditiveExpression AdditiveExpression_53_Var = (AdditiveExpression)Expr_52_list.get(0);
		Assert.assertNotNull(AdditiveExpression_53_Var);
		final EList<? extends EObject> Expr_53_list = AdditiveExpression_53_Var.getExpr();
		Assert.assertNotNull(Expr_53_list);
		Assert.assertEquals(1, Expr_53_list.size());
		final MultiplicativeExpression MultiplicativeExpression_54_Var = (MultiplicativeExpression)Expr_53_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_54_Var);
		final EList<? extends EObject> Expr_54_list = MultiplicativeExpression_54_Var.getExpr();
		Assert.assertNotNull(Expr_54_list);
		Assert.assertEquals(1, Expr_54_list.size());
		final CastExpression CastExpression_55_Var = (CastExpression)Expr_54_list.get(0);
		Assert.assertNotNull(CastExpression_55_Var);
		final UnaryExpression UnaryExpression_56_Var = (UnaryExpression)CastExpression_55_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_56_Var);
		final CastExpression CastExpression_57_Var = (CastExpression)UnaryExpression_56_Var.getExpr();
		...
		Assert.assertEquals("1", Constant_61_Var.getDec());
		...
		final FunctionDefHead FunctionDefHead_64_Var = (FunctionDefHead)ExternalDeclaration_63_Var.getFunctiondefHead();
		Assert.assertNotNull(FunctionDefHead_64_Var);
		final FunctionDeclarationSpecifiers FunctionDeclarationSpecifiers_65_Var = (FunctionDeclarationSpecifiers)FunctionDefHead_64_Var.getFunDeclSpecifiers();
		Assert.assertNotNull(FunctionDeclarationSpecifiers_65_Var);
		final EList<? extends EObject> DeclarationSpecifier_65_list = FunctionDeclarationSpecifiers_65_Var.getDeclarationSpecifier();
		...
		Assert.assertEquals("double", TypeSpecifier_66_Var.getName());
		final Declarator Declarator_67_Var = (Declarator)FunctionDefHead_64_Var.getFunDeclarator();
		Assert.assertNotNull(Declarator_67_Var);
		final DirectDeclarator DirectDeclarator_68_Var = (DirectDeclarator)Declarator_67_Var.getDeclarator();
		Assert.assertNotNull(DirectDeclarator_68_Var);
		Assert.assertEquals("doSomething3", DirectDeclarator_68_Var.getId());
		final FunctionDefinition FunctionDefinition_69_Var = (FunctionDefinition)ExternalDeclaration_63_Var.getFunctionDefinition();
		Assert.assertNotNull(FunctionDefinition_69_Var);
		final BodyStatement BodyStatement_70_Var = (BodyStatement)FunctionDefinition_69_Var.getBody();
		Assert.assertNotNull(BodyStatement_70_Var);
		final EList<? extends EObject> BlockList_70_list = BodyStatement_70_Var.getBlockList();
		Assert.assertNotNull(BlockList_70_list);
		Assert.assertEquals(1, BlockList_70_list.size());
		final BlockList BlockList_71_Var = (BlockList)BlockList_70_list.get(0);
		Assert.assertNotNull(BlockList_71_Var);
		final EList<? extends EObject> Statement_71_list = BlockList_71_Var.getStatement();
		Assert.assertNotNull(Statement_71_list);
		Assert.assertEquals(1, Statement_71_list.size());
		final Statement Statement_72_Var = (Statement)Statement_71_list.get(0);
		Assert.assertNotNull(Statement_72_Var);
		final JumpStatement JumpStatement_73_Var = (JumpStatement)Statement_72_Var.getStmt();
		Assert.assertNotNull(JumpStatement_73_Var);
		final Expression Expression_74_Var = (Expression)JumpStatement_73_Var.getExpr();
		Assert.assertNotNull(Expression_74_Var);
		final EList<? extends EObject> ExprExpr_74_list = Expression_74_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_74_list);
		Assert.assertEquals(1, ExprExpr_74_list.size());
		final AssignmentExpression AssignmentExpression_75_Var = (AssignmentExpression)ExprExpr_74_list.get(0);
		...
		final FunctionDefHead FunctionDefHead_93_Var = (FunctionDefHead)ExternalDeclaration_92_Var.getFunctiondefHead();
		Assert.assertNotNull(FunctionDefHead_93_Var);
		final FunctionDeclarationSpecifiers FunctionDeclarationSpecifiers_94_Var = (FunctionDeclarationSpecifiers)FunctionDefHead_93_Var.getFunDeclSpecifiers();
		Assert.assertNotNull(FunctionDeclarationSpecifiers_94_Var);
		final EList<? extends EObject> DeclarationSpecifier_94_list = FunctionDeclarationSpecifiers_94_Var.getDeclarationSpecifier();
		...
		Assert.assertEquals("float", TypeSpecifier_95_Var.getName());
		final Declarator Declarator_96_Var = (Declarator)FunctionDefHead_93_Var.getFunDeclarator();
		Assert.assertNotNull(Declarator_96_Var);
		final DirectDeclarator DirectDeclarator_97_Var = (DirectDeclarator)Declarator_96_Var.getDeclarator();
		Assert.assertNotNull(DirectDeclarator_97_Var);
		Assert.assertEquals("doSomething4", DirectDeclarator_97_Var.getId());
		final FunctionDefinition FunctionDefinition_98_Var = (FunctionDefinition)ExternalDeclaration_92_Var.getFunctionDefinition();
		Assert.assertNotNull(FunctionDefinition_98_Var);
		final BodyStatement BodyStatement_99_Var = (BodyStatement)FunctionDefinition_98_Var.getBody();
		...
		final JumpStatement JumpStatement_102_Var = (JumpStatement)Statement_101_Var.getStmt();
		Assert.assertNotNull(JumpStatement_102_Var);
		final Expression Expression_103_Var = (Expression)JumpStatement_102_Var.getExpr();
		...
		final FunctionDefHead FunctionDefHead_122_Var = (FunctionDefHead)ExternalDeclaration_121_Var.getFunctiondefHead();
		Assert.assertNotNull(FunctionDefHead_122_Var);
		final FunctionDeclarationSpecifiers FunctionDeclarationSpecifiers_123_Var = (FunctionDeclarationSpecifiers)FunctionDefHead_122_Var.getFunDeclSpecifiers();
		Assert.assertNotNull(FunctionDeclarationSpecifiers_123_Var);
		final EList<? extends EObject> DeclarationSpecifier_123_list = FunctionDeclarationSpecifiers_123_Var.getDeclarationSpecifier();
		Assert.assertNotNull(DeclarationSpecifier_123_list);
		Assert.assertEquals(1, DeclarationSpecifier_123_list.size());
		final TypeSpecifier TypeSpecifier_124_Var = (TypeSpecifier)DeclarationSpecifier_123_list.get(0);
		Assert.assertNotNull(TypeSpecifier_124_Var);
		Assert.assertEquals("void", TypeSpecifier_124_Var.getName());
		final Declarator Declarator_125_Var = (Declarator)FunctionDefHead_122_Var.getFunDeclarator();
		Assert.assertNotNull(Declarator_125_Var);
		final DirectDeclarator DirectDeclarator_126_Var = (DirectDeclarator)Declarator_125_Var.getDeclarator();
		Assert.assertNotNull(DirectDeclarator_126_Var);
		Assert.assertEquals("doSomething5", DirectDeclarator_126_Var.getId());
		final FunctionDefinition FunctionDefinition_127_Var = (FunctionDefinition)ExternalDeclaration_121_Var.getFunctionDefinition();
		Assert.assertNotNull(FunctionDefinition_127_Var);
		final BodyStatement BodyStatement_128_Var = (BodyStatement)FunctionDefinition_127_Var.getBody();
		Assert.assertNotNull(BodyStatement_128_Var);
		final EList<? extends EObject> BlockList_128_list = BodyStatement_128_Var.getBlockList();
		Assert.assertNotNull(BlockList_128_list);
		Assert.assertEquals(1, BlockList_128_list.size());
		final BlockList BlockList_129_Var = (BlockList)BlockList_128_list.get(0);
		Assert.assertNotNull(BlockList_129_Var);
		final EList<? extends EObject> Statement_129_list = BlockList_129_Var.getStatement();
		Assert.assertNotNull(Statement_129_list);
		Assert.assertEquals(1, Statement_129_list.size());
		final Statement Statement_130_Var = (Statement)Statement_129_list.get(0);
