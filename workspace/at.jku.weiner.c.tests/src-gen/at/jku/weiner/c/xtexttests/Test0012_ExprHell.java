...
public class Test0012_ExprHell {
	...
	throws Exception{
		final String text = this.getTextFromFile("res/Test0012_ExprHell.c");
	...
	throws Exception{
		...
		final Statement Statement_31_Var = (Statement)Statement_10_list.get(1);
		Assert.assertNotNull(Statement_31_Var);
		final ExpressionStatement ExpressionStatement_32_Var = (ExpressionStatement)Statement_31_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_32_Var);
		final Expression Expression_33_Var = (Expression)ExpressionStatement_32_Var.getExpression();
		Assert.assertNotNull(Expression_33_Var);
		final EList<? extends EObject> ExprExpr_33_list = Expression_33_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_33_list);
		Assert.assertEquals(1, ExprExpr_33_list.size());
		final AssignmentExpression AssignmentExpression_34_Var = (AssignmentExpression)ExprExpr_33_list.get(0);
		Assert.assertNotNull(AssignmentExpression_34_Var);
		final ConditionalExpression ConditionalExpression_35_Var = (ConditionalExpression)AssignmentExpression_34_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_35_Var);
		final LogicalOrExpression LogicalOrExpression_36_Var = (LogicalOrExpression)ConditionalExpression_35_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_36_Var);
		final EList<? extends EObject> Expr_36_list = LogicalOrExpression_36_Var.getExpr();
		Assert.assertNotNull(Expr_36_list);
		Assert.assertEquals(1, Expr_36_list.size());
		final LogicalAndExpression LogicalAndExpression_37_Var = (LogicalAndExpression)Expr_36_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_37_Var);
		final EList<? extends EObject> Expr_37_list = LogicalAndExpression_37_Var.getExpr();
		Assert.assertNotNull(Expr_37_list);
		Assert.assertEquals(1, Expr_37_list.size());
		final InclusiveOrExpression InclusiveOrExpression_38_Var = (InclusiveOrExpression)Expr_37_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_38_Var);
		final EList<? extends EObject> Expr_38_list = InclusiveOrExpression_38_Var.getExpr();
		Assert.assertNotNull(Expr_38_list);
		Assert.assertEquals(1, Expr_38_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_39_Var = (ExclusiveOrExpression)Expr_38_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_39_Var);
		final EList<? extends EObject> Expr_39_list = ExclusiveOrExpression_39_Var.getExpr();
		Assert.assertNotNull(Expr_39_list);
		Assert.assertEquals(1, Expr_39_list.size());
		final AndExpression AndExpression_40_Var = (AndExpression)Expr_39_list.get(0);
		Assert.assertNotNull(AndExpression_40_Var);
		final EList<? extends EObject> Expr_40_list = AndExpression_40_Var.getExpr();
		Assert.assertNotNull(Expr_40_list);
		Assert.assertEquals(1, Expr_40_list.size());
		final EqualityExpression EqualityExpression_41_Var = (EqualityExpression)Expr_40_list.get(0);
		Assert.assertNotNull(EqualityExpression_41_Var);
		final EList<? extends EObject> Expr_41_list = EqualityExpression_41_Var.getExpr();
		Assert.assertNotNull(Expr_41_list);
		Assert.assertEquals(1, Expr_41_list.size());
		final RelationalExpression RelationalExpression_42_Var = (RelationalExpression)Expr_41_list.get(0);
		Assert.assertNotNull(RelationalExpression_42_Var);
		final EList<? extends EObject> Expr_42_list = RelationalExpression_42_Var.getExpr();
		Assert.assertNotNull(Expr_42_list);
		Assert.assertEquals(1, Expr_42_list.size());
		final ShiftExpression ShiftExpression_43_Var = (ShiftExpression)Expr_42_list.get(0);
		Assert.assertNotNull(ShiftExpression_43_Var);
		final EList<? extends EObject> Expr_43_list = ShiftExpression_43_Var.getExpr();
		Assert.assertNotNull(Expr_43_list);
		Assert.assertEquals(1, Expr_43_list.size());
		final AdditiveExpression AdditiveExpression_44_Var = (AdditiveExpression)Expr_43_list.get(0);
		Assert.assertNotNull(AdditiveExpression_44_Var);
		final EList<? extends EObject> Expr_44_list = AdditiveExpression_44_Var.getExpr();
		Assert.assertNotNull(Expr_44_list);
		Assert.assertEquals(1, Expr_44_list.size());
		final MultiplicativeExpression MultiplicativeExpression_45_Var = (MultiplicativeExpression)Expr_44_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_45_Var);
		final EList<? extends EObject> Expr_45_list = MultiplicativeExpression_45_Var.getExpr();
		Assert.assertNotNull(Expr_45_list);
		Assert.assertEquals(1, Expr_45_list.size());
		final CastExpression CastExpression_46_Var = (CastExpression)Expr_45_list.get(0);
		Assert.assertNotNull(CastExpression_46_Var);
		final UnaryExpression UnaryExpression_47_Var = (UnaryExpression)CastExpression_46_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_47_Var);
		final PostfixExpression PostfixExpression_48_Var = (PostfixExpression)UnaryExpression_47_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_48_Var);
		final EList<? extends EObject> Expr_48_list = PostfixExpression_48_Var.getExpr();
		Assert.assertNotNull(Expr_48_list);
		Assert.assertEquals(1, Expr_48_list.size());
		final PrimaryExpression PrimaryExpression_49_Var = (PrimaryExpression)Expr_48_list.get(0);
		Assert.assertNotNull(PrimaryExpression_49_Var);
		final Expression Expression_50_Var = (Expression)PrimaryExpression_49_Var.getExpr();
		Assert.assertNotNull(Expression_50_Var);
		final EList<? extends EObject> ExprExpr_50_list = Expression_50_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_50_list);
		Assert.assertEquals(1, ExprExpr_50_list.size());
		final AssignmentExpression AssignmentExpression_51_Var = (AssignmentExpression)ExprExpr_50_list.get(0);
		...
		Assert.assertEquals("2", Constant_67_Var.getDec());
		Assert.assertEquals(";", ExpressionStatement_32_Var.getSemi());
		final Statement Statement_68_Var = (Statement)Statement_10_list.get(2);
		Assert.assertNotNull(Statement_68_Var);
		final ExpressionStatement ExpressionStatement_69_Var = (ExpressionStatement)Statement_68_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_69_Var);
		final Expression Expression_70_Var = (Expression)ExpressionStatement_69_Var.getExpression();
		...
		final Constant Constant_87_Var = (Constant)PrimaryExpression_86_Var.getConst();
		Assert.assertNotNull(Constant_87_Var);
		Assert.assertEquals("1", Constant_87_Var.getDec());
		final CastExpression CastExpression_88_Var = (CastExpression)Expr_82_list.get(1);
		...
		Assert.assertEquals("2", Constant_92_Var.getDec());
		Assert.assertEquals("[*]", MultiplicativeExpression_82_Var.getOp().toString());
		Assert.assertEquals(";", ExpressionStatement_69_Var.getSemi());
		final Statement Statement_93_Var = (Statement)Statement_10_list.get(3);
		Assert.assertNotNull(Statement_93_Var);
		final ExpressionStatement ExpressionStatement_94_Var = (ExpressionStatement)Statement_93_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_94_Var);
		final Expression Expression_95_Var = (Expression)ExpressionStatement_94_Var.getExpression();
		Assert.assertNotNull(Expression_95_Var);
		final EList<? extends EObject> ExprExpr_95_list = Expression_95_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_95_list);
		Assert.assertEquals(1, ExprExpr_95_list.size());
		final AssignmentExpression AssignmentExpression_96_Var = (AssignmentExpression)ExprExpr_95_list.get(0);
		...
		Assert.assertEquals("1", Constant_112_Var.getDec());
		final AdditiveExpression AdditiveExpression_113_Var = (AdditiveExpression)Expr_105_list.get(1);
		...
		Assert.assertEquals("2", Constant_119_Var.getDec());
		Assert.assertEquals("[<<]", ShiftExpression_105_Var.getOp().toString());
		Assert.assertEquals(";", ExpressionStatement_94_Var.getSemi());
		final Statement Statement_120_Var = (Statement)Statement_10_list.get(4);
		Assert.assertNotNull(Statement_120_Var);
		final ExpressionStatement ExpressionStatement_121_Var = (ExpressionStatement)Statement_120_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_121_Var);
		final Expression Expression_122_Var = (Expression)ExpressionStatement_121_Var.getExpression();
		Assert.assertNotNull(Expression_122_Var);
		final EList<? extends EObject> ExprExpr_122_list = Expression_122_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_122_list);
		Assert.assertEquals(1, ExprExpr_122_list.size());
		final AssignmentExpression AssignmentExpression_123_Var = (AssignmentExpression)ExprExpr_122_list.get(0);
		Assert.assertNotNull(AssignmentExpression_123_Var);
		final ConditionalExpression ConditionalExpression_124_Var = (ConditionalExpression)AssignmentExpression_123_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_124_Var);
		final LogicalOrExpression LogicalOrExpression_125_Var = (LogicalOrExpression)ConditionalExpression_124_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_125_Var);
		final EList<? extends EObject> Expr_125_list = LogicalOrExpression_125_Var.getExpr();
		Assert.assertNotNull(Expr_125_list);
		Assert.assertEquals(1, Expr_125_list.size());
		final LogicalAndExpression LogicalAndExpression_126_Var = (LogicalAndExpression)Expr_125_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_126_Var);
		final EList<? extends EObject> Expr_126_list = LogicalAndExpression_126_Var.getExpr();
		Assert.assertNotNull(Expr_126_list);
		Assert.assertEquals(1, Expr_126_list.size());
		final InclusiveOrExpression InclusiveOrExpression_127_Var = (InclusiveOrExpression)Expr_126_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_127_Var);
		final EList<? extends EObject> Expr_127_list = InclusiveOrExpression_127_Var.getExpr();
		Assert.assertNotNull(Expr_127_list);
		Assert.assertEquals(1, Expr_127_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_128_Var = (ExclusiveOrExpression)Expr_127_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_128_Var);
		final EList<? extends EObject> Expr_128_list = ExclusiveOrExpression_128_Var.getExpr();
		Assert.assertNotNull(Expr_128_list);
		Assert.assertEquals(1, Expr_128_list.size());
		final AndExpression AndExpression_129_Var = (AndExpression)Expr_128_list.get(0);
		Assert.assertNotNull(AndExpression_129_Var);
		final EList<? extends EObject> Expr_129_list = AndExpression_129_Var.getExpr();
		Assert.assertNotNull(Expr_129_list);
		Assert.assertEquals(1, Expr_129_list.size());
		final EqualityExpression EqualityExpression_130_Var = (EqualityExpression)Expr_129_list.get(0);
		Assert.assertNotNull(EqualityExpression_130_Var);
		final EList<? extends EObject> Expr_130_list = EqualityExpression_130_Var.getExpr();
		Assert.assertNotNull(Expr_130_list);
		Assert.assertEquals(1, Expr_130_list.size());
		final RelationalExpression RelationalExpression_131_Var = (RelationalExpression)Expr_130_list.get(0);
		Assert.assertNotNull(RelationalExpression_131_Var);
		final EList<? extends EObject> Expr_131_list = RelationalExpression_131_Var.getExpr();
		Assert.assertNotNull(Expr_131_list);
		Assert.assertEquals(2, Expr_131_list.size());
		final ShiftExpression ShiftExpression_132_Var = (ShiftExpression)Expr_131_list.get(0);
		Assert.assertNotNull(ShiftExpression_132_Var);
		final EList<? extends EObject> Expr_132_list = ShiftExpression_132_Var.getExpr();
		Assert.assertNotNull(Expr_132_list);
		Assert.assertEquals(1, Expr_132_list.size());
		final AdditiveExpression AdditiveExpression_133_Var = (AdditiveExpression)Expr_132_list.get(0);
		Assert.assertNotNull(AdditiveExpression_133_Var);
		final EList<? extends EObject> Expr_133_list = AdditiveExpression_133_Var.getExpr();
		Assert.assertNotNull(Expr_133_list);
		Assert.assertEquals(1, Expr_133_list.size());
		final MultiplicativeExpression MultiplicativeExpression_134_Var = (MultiplicativeExpression)Expr_133_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_134_Var);
		final EList<? extends EObject> Expr_134_list = MultiplicativeExpression_134_Var.getExpr();
		Assert.assertNotNull(Expr_134_list);
		Assert.assertEquals(1, Expr_134_list.size());
		final CastExpression CastExpression_135_Var = (CastExpression)Expr_134_list.get(0);
		Assert.assertNotNull(CastExpression_135_Var);
		final UnaryExpression UnaryExpression_136_Var = (UnaryExpression)CastExpression_135_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_136_Var);
		final PostfixExpression PostfixExpression_137_Var = (PostfixExpression)UnaryExpression_136_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_137_Var);
		final EList<? extends EObject> Expr_137_list = PostfixExpression_137_Var.getExpr();
		Assert.assertNotNull(Expr_137_list);
		Assert.assertEquals(1, Expr_137_list.size());
		final PrimaryExpression PrimaryExpression_138_Var = (PrimaryExpression)Expr_137_list.get(0);
		Assert.assertNotNull(PrimaryExpression_138_Var);
		final Constant Constant_139_Var = (Constant)PrimaryExpression_138_Var.getConst();
		Assert.assertNotNull(Constant_139_Var);
		Assert.assertEquals("1", Constant_139_Var.getDec());
		final ShiftExpression ShiftExpression_140_Var = (ShiftExpression)Expr_131_list.get(1);
		Assert.assertNotNull(ShiftExpression_140_Var);
		final EList<? extends EObject> Expr_140_list = ShiftExpression_140_Var.getExpr();
		Assert.assertNotNull(Expr_140_list);
		Assert.assertEquals(1, Expr_140_list.size());
		final AdditiveExpression AdditiveExpression_141_Var = (AdditiveExpression)Expr_140_list.get(0);
		Assert.assertNotNull(AdditiveExpression_141_Var);
		final EList<? extends EObject> Expr_141_list = AdditiveExpression_141_Var.getExpr();
		Assert.assertNotNull(Expr_141_list);
		Assert.assertEquals(1, Expr_141_list.size());
		final MultiplicativeExpression MultiplicativeExpression_142_Var = (MultiplicativeExpression)Expr_141_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_142_Var);
		final EList<? extends EObject> Expr_142_list = MultiplicativeExpression_142_Var.getExpr();
		Assert.assertNotNull(Expr_142_list);
		Assert.assertEquals(1, Expr_142_list.size());
		final CastExpression CastExpression_143_Var = (CastExpression)Expr_142_list.get(0);
		Assert.assertNotNull(CastExpression_143_Var);
		final UnaryExpression UnaryExpression_144_Var = (UnaryExpression)CastExpression_143_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_144_Var);
		final PostfixExpression PostfixExpression_145_Var = (PostfixExpression)UnaryExpression_144_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_145_Var);
		final EList<? extends EObject> Expr_145_list = PostfixExpression_145_Var.getExpr();
		Assert.assertNotNull(Expr_145_list);
		Assert.assertEquals(1, Expr_145_list.size());
		final PrimaryExpression PrimaryExpression_146_Var = (PrimaryExpression)Expr_145_list.get(0);
		Assert.assertNotNull(PrimaryExpression_146_Var);
		final Constant Constant_147_Var = (Constant)PrimaryExpression_146_Var.getConst();
		Assert.assertNotNull(Constant_147_Var);
		Assert.assertEquals("2", Constant_147_Var.getDec());
		Assert.assertEquals("[<]", RelationalExpression_131_Var.getOp().toString());
		Assert.assertEquals(";", ExpressionStatement_121_Var.getSemi());
		final Statement Statement_148_Var = (Statement)Statement_10_list.get(5);
		...
		Assert.assertEquals("1", Constant_167_Var.getDec());
		final RelationalExpression RelationalExpression_168_Var = (RelationalExpression)Expr_158_list.get(1);
		Assert.assertNotNull(RelationalExpression_168_Var);
		final EList<? extends EObject> Expr_168_list = RelationalExpression_168_Var.getExpr();
		Assert.assertNotNull(Expr_168_list);
		Assert.assertEquals(1, Expr_168_list.size());
		final ShiftExpression ShiftExpression_169_Var = (ShiftExpression)Expr_168_list.get(0);
		Assert.assertNotNull(ShiftExpression_169_Var);
		final EList<? extends EObject> Expr_169_list = ShiftExpression_169_Var.getExpr();
		Assert.assertNotNull(Expr_169_list);
		Assert.assertEquals(1, Expr_169_list.size());
		final AdditiveExpression AdditiveExpression_170_Var = (AdditiveExpression)Expr_169_list.get(0);
		Assert.assertNotNull(AdditiveExpression_170_Var);
		final EList<? extends EObject> Expr_170_list = AdditiveExpression_170_Var.getExpr();
		Assert.assertNotNull(Expr_170_list);
		Assert.assertEquals(1, Expr_170_list.size());
		final MultiplicativeExpression MultiplicativeExpression_171_Var = (MultiplicativeExpression)Expr_170_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_171_Var);
		final EList<? extends EObject> Expr_171_list = MultiplicativeExpression_171_Var.getExpr();
		Assert.assertNotNull(Expr_171_list);
		Assert.assertEquals(1, Expr_171_list.size());
		final CastExpression CastExpression_172_Var = (CastExpression)Expr_171_list.get(0);
		Assert.assertNotNull(CastExpression_172_Var);
		final UnaryExpression UnaryExpression_173_Var = (UnaryExpression)CastExpression_172_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_173_Var);
		final PostfixExpression PostfixExpression_174_Var = (PostfixExpression)UnaryExpression_173_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_174_Var);
		final EList<? extends EObject> Expr_174_list = PostfixExpression_174_Var.getExpr();
		Assert.assertNotNull(Expr_174_list);
		Assert.assertEquals(1, Expr_174_list.size());
		final PrimaryExpression PrimaryExpression_175_Var = (PrimaryExpression)Expr_174_list.get(0);
		Assert.assertNotNull(PrimaryExpression_175_Var);
		final Constant Constant_176_Var = (Constant)PrimaryExpression_175_Var.getConst();
		Assert.assertNotNull(Constant_176_Var);
		Assert.assertEquals("2", Constant_176_Var.getDec());
		Assert.assertEquals("[==]", EqualityExpression_158_Var.getOp().toString());
		Assert.assertEquals(";", ExpressionStatement_149_Var.getSemi());
		final Statement Statement_177_Var = (Statement)Statement_10_list.get(6);
		Assert.assertNotNull(Statement_177_Var);
		final ExpressionStatement ExpressionStatement_178_Var = (ExpressionStatement)Statement_177_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_178_Var);
		final Expression Expression_179_Var = (Expression)ExpressionStatement_178_Var.getExpression();
		Assert.assertNotNull(Expression_179_Var);
		final EList<? extends EObject> ExprExpr_179_list = Expression_179_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_179_list);
		Assert.assertEquals(1, ExprExpr_179_list.size());
		final AssignmentExpression AssignmentExpression_180_Var = (AssignmentExpression)ExprExpr_179_list.get(0);
		Assert.assertNotNull(AssignmentExpression_180_Var);
		final ConditionalExpression ConditionalExpression_181_Var = (ConditionalExpression)AssignmentExpression_180_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_181_Var);
		final LogicalOrExpression LogicalOrExpression_182_Var = (LogicalOrExpression)ConditionalExpression_181_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_182_Var);
		final EList<? extends EObject> Expr_182_list = LogicalOrExpression_182_Var.getExpr();
		Assert.assertNotNull(Expr_182_list);
		Assert.assertEquals(1, Expr_182_list.size());
		final LogicalAndExpression LogicalAndExpression_183_Var = (LogicalAndExpression)Expr_182_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_183_Var);
		final EList<? extends EObject> Expr_183_list = LogicalAndExpression_183_Var.getExpr();
		Assert.assertNotNull(Expr_183_list);
		Assert.assertEquals(1, Expr_183_list.size());
		final InclusiveOrExpression InclusiveOrExpression_184_Var = (InclusiveOrExpression)Expr_183_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_184_Var);
		final EList<? extends EObject> Expr_184_list = InclusiveOrExpression_184_Var.getExpr();
		Assert.assertNotNull(Expr_184_list);
		Assert.assertEquals(1, Expr_184_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_185_Var = (ExclusiveOrExpression)Expr_184_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_185_Var);
		final EList<? extends EObject> Expr_185_list = ExclusiveOrExpression_185_Var.getExpr();
		Assert.assertNotNull(Expr_185_list);
		Assert.assertEquals(1, Expr_185_list.size());
		final AndExpression AndExpression_186_Var = (AndExpression)Expr_185_list.get(0);
		Assert.assertNotNull(AndExpression_186_Var);
		final EList<? extends EObject> Expr_186_list = AndExpression_186_Var.getExpr();
		Assert.assertNotNull(Expr_186_list);
		Assert.assertEquals(2, Expr_186_list.size());
		final EqualityExpression EqualityExpression_187_Var = (EqualityExpression)Expr_186_list.get(0);
		Assert.assertNotNull(EqualityExpression_187_Var);
		final EList<? extends EObject> Expr_187_list = EqualityExpression_187_Var.getExpr();
		Assert.assertNotNull(Expr_187_list);
		Assert.assertEquals(1, Expr_187_list.size());
		final RelationalExpression RelationalExpression_188_Var = (RelationalExpression)Expr_187_list.get(0);
		Assert.assertNotNull(RelationalExpression_188_Var);
		final EList<? extends EObject> Expr_188_list = RelationalExpression_188_Var.getExpr();
		Assert.assertNotNull(Expr_188_list);
		Assert.assertEquals(1, Expr_188_list.size());
		final ShiftExpression ShiftExpression_189_Var = (ShiftExpression)Expr_188_list.get(0);
		Assert.assertNotNull(ShiftExpression_189_Var);
		final EList<? extends EObject> Expr_189_list = ShiftExpression_189_Var.getExpr();
		Assert.assertNotNull(Expr_189_list);
		Assert.assertEquals(1, Expr_189_list.size());
		final AdditiveExpression AdditiveExpression_190_Var = (AdditiveExpression)Expr_189_list.get(0);
		Assert.assertNotNull(AdditiveExpression_190_Var);
		final EList<? extends EObject> Expr_190_list = AdditiveExpression_190_Var.getExpr();
		Assert.assertNotNull(Expr_190_list);
		Assert.assertEquals(1, Expr_190_list.size());
		final MultiplicativeExpression MultiplicativeExpression_191_Var = (MultiplicativeExpression)Expr_190_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_191_Var);
		final EList<? extends EObject> Expr_191_list = MultiplicativeExpression_191_Var.getExpr();
		Assert.assertNotNull(Expr_191_list);
		Assert.assertEquals(1, Expr_191_list.size());
		final CastExpression CastExpression_192_Var = (CastExpression)Expr_191_list.get(0);
		Assert.assertNotNull(CastExpression_192_Var);
		final UnaryExpression UnaryExpression_193_Var = (UnaryExpression)CastExpression_192_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_193_Var);
		final PostfixExpression PostfixExpression_194_Var = (PostfixExpression)UnaryExpression_193_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_194_Var);
		final EList<? extends EObject> Expr_194_list = PostfixExpression_194_Var.getExpr();
		Assert.assertNotNull(Expr_194_list);
		Assert.assertEquals(1, Expr_194_list.size());
		final PrimaryExpression PrimaryExpression_195_Var = (PrimaryExpression)Expr_194_list.get(0);
		Assert.assertNotNull(PrimaryExpression_195_Var);
		final Constant Constant_196_Var = (Constant)PrimaryExpression_195_Var.getConst();
		Assert.assertNotNull(Constant_196_Var);
		Assert.assertEquals("1", Constant_196_Var.getDec());
		final EqualityExpression EqualityExpression_197_Var = (EqualityExpression)Expr_186_list.get(1);
		...
		Assert.assertEquals("2", Constant_206_Var.getDec());
		Assert.assertEquals(";", ExpressionStatement_178_Var.getSemi());
		final Statement Statement_207_Var = (Statement)Statement_10_list.get(7);
		Assert.assertNotNull(Statement_207_Var);
		final ExpressionStatement ExpressionStatement_208_Var = (ExpressionStatement)Statement_207_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_208_Var);
		final Expression Expression_209_Var = (Expression)ExpressionStatement_208_Var.getExpression();
		Assert.assertNotNull(Expression_209_Var);
		final EList<? extends EObject> ExprExpr_209_list = Expression_209_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_209_list);
		Assert.assertEquals(1, ExprExpr_209_list.size());
		final AssignmentExpression AssignmentExpression_210_Var = (AssignmentExpression)ExprExpr_209_list.get(0);
		Assert.assertNotNull(AssignmentExpression_210_Var);
		final ConditionalExpression ConditionalExpression_211_Var = (ConditionalExpression)AssignmentExpression_210_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_211_Var);
		final LogicalOrExpression LogicalOrExpression_212_Var = (LogicalOrExpression)ConditionalExpression_211_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_212_Var);
		final EList<? extends EObject> Expr_212_list = LogicalOrExpression_212_Var.getExpr();
		Assert.assertNotNull(Expr_212_list);
		Assert.assertEquals(1, Expr_212_list.size());
		final LogicalAndExpression LogicalAndExpression_213_Var = (LogicalAndExpression)Expr_212_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_213_Var);
		final EList<? extends EObject> Expr_213_list = LogicalAndExpression_213_Var.getExpr();
		Assert.assertNotNull(Expr_213_list);
		Assert.assertEquals(1, Expr_213_list.size());
		final InclusiveOrExpression InclusiveOrExpression_214_Var = (InclusiveOrExpression)Expr_213_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_214_Var);
		final EList<? extends EObject> Expr_214_list = InclusiveOrExpression_214_Var.getExpr();
		Assert.assertNotNull(Expr_214_list);
		Assert.assertEquals(2, Expr_214_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_215_Var = (ExclusiveOrExpression)Expr_214_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_215_Var);
		final EList<? extends EObject> Expr_215_list = ExclusiveOrExpression_215_Var.getExpr();
		Assert.assertNotNull(Expr_215_list);
		Assert.assertEquals(1, Expr_215_list.size());
		final AndExpression AndExpression_216_Var = (AndExpression)Expr_215_list.get(0);
		Assert.assertNotNull(AndExpression_216_Var);
		final EList<? extends EObject> Expr_216_list = AndExpression_216_Var.getExpr();
		Assert.assertNotNull(Expr_216_list);
		Assert.assertEquals(1, Expr_216_list.size());
		final EqualityExpression EqualityExpression_217_Var = (EqualityExpression)Expr_216_list.get(0);
		Assert.assertNotNull(EqualityExpression_217_Var);
		final EList<? extends EObject> Expr_217_list = EqualityExpression_217_Var.getExpr();
		Assert.assertNotNull(Expr_217_list);
		Assert.assertEquals(1, Expr_217_list.size());
		final RelationalExpression RelationalExpression_218_Var = (RelationalExpression)Expr_217_list.get(0);
		Assert.assertNotNull(RelationalExpression_218_Var);
		final EList<? extends EObject> Expr_218_list = RelationalExpression_218_Var.getExpr();
		Assert.assertNotNull(Expr_218_list);
		Assert.assertEquals(1, Expr_218_list.size());
		final ShiftExpression ShiftExpression_219_Var = (ShiftExpression)Expr_218_list.get(0);
		Assert.assertNotNull(ShiftExpression_219_Var);
		final EList<? extends EObject> Expr_219_list = ShiftExpression_219_Var.getExpr();
		Assert.assertNotNull(Expr_219_list);
		Assert.assertEquals(1, Expr_219_list.size());
		final AdditiveExpression AdditiveExpression_220_Var = (AdditiveExpression)Expr_219_list.get(0);
		Assert.assertNotNull(AdditiveExpression_220_Var);
		final EList<? extends EObject> Expr_220_list = AdditiveExpression_220_Var.getExpr();
		Assert.assertNotNull(Expr_220_list);
		Assert.assertEquals(1, Expr_220_list.size());
		final MultiplicativeExpression MultiplicativeExpression_221_Var = (MultiplicativeExpression)Expr_220_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_221_Var);
		final EList<? extends EObject> Expr_221_list = MultiplicativeExpression_221_Var.getExpr();
		Assert.assertNotNull(Expr_221_list);
		Assert.assertEquals(1, Expr_221_list.size());
		final CastExpression CastExpression_222_Var = (CastExpression)Expr_221_list.get(0);
		Assert.assertNotNull(CastExpression_222_Var);
		final UnaryExpression UnaryExpression_223_Var = (UnaryExpression)CastExpression_222_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_223_Var);
		final PostfixExpression PostfixExpression_224_Var = (PostfixExpression)UnaryExpression_223_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_224_Var);
		final EList<? extends EObject> Expr_224_list = PostfixExpression_224_Var.getExpr();
		Assert.assertNotNull(Expr_224_list);
		Assert.assertEquals(1, Expr_224_list.size());
		final PrimaryExpression PrimaryExpression_225_Var = (PrimaryExpression)Expr_224_list.get(0);
		Assert.assertNotNull(PrimaryExpression_225_Var);
		final Constant Constant_226_Var = (Constant)PrimaryExpression_225_Var.getConst();
		Assert.assertNotNull(Constant_226_Var);
		Assert.assertEquals("1", Constant_226_Var.getDec());
		final ExclusiveOrExpression ExclusiveOrExpression_227_Var = (ExclusiveOrExpression)Expr_214_list.get(1);
		...
		Assert.assertEquals("2", Constant_238_Var.getDec());
		Assert.assertEquals(";", ExpressionStatement_208_Var.getSemi());
		final Statement Statement_239_Var = (Statement)Statement_10_list.get(8);
		Assert.assertNotNull(Statement_239_Var);
		final ExpressionStatement ExpressionStatement_240_Var = (ExpressionStatement)Statement_239_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_240_Var);
		final Expression Expression_241_Var = (Expression)ExpressionStatement_240_Var.getExpression();
		Assert.assertNotNull(Expression_241_Var);
		final EList<? extends EObject> ExprExpr_241_list = Expression_241_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_241_list);
		Assert.assertEquals(1, ExprExpr_241_list.size());
		final AssignmentExpression AssignmentExpression_242_Var = (AssignmentExpression)ExprExpr_241_list.get(0);
		Assert.assertNotNull(AssignmentExpression_242_Var);
		final ConditionalExpression ConditionalExpression_243_Var = (ConditionalExpression)AssignmentExpression_242_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_243_Var);
		final LogicalOrExpression LogicalOrExpression_244_Var = (LogicalOrExpression)ConditionalExpression_243_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_244_Var);
		final EList<? extends EObject> Expr_244_list = LogicalOrExpression_244_Var.getExpr();
		Assert.assertNotNull(Expr_244_list);
		Assert.assertEquals(1, Expr_244_list.size());
		final LogicalAndExpression LogicalAndExpression_245_Var = (LogicalAndExpression)Expr_244_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_245_Var);
		final EList<? extends EObject> Expr_245_list = LogicalAndExpression_245_Var.getExpr();
		Assert.assertNotNull(Expr_245_list);
		Assert.assertEquals(1, Expr_245_list.size());
		final InclusiveOrExpression InclusiveOrExpression_246_Var = (InclusiveOrExpression)Expr_245_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_246_Var);
		final EList<? extends EObject> Expr_246_list = InclusiveOrExpression_246_Var.getExpr();
		Assert.assertNotNull(Expr_246_list);
		Assert.assertEquals(1, Expr_246_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_247_Var = (ExclusiveOrExpression)Expr_246_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_247_Var);
		final EList<? extends EObject> Expr_247_list = ExclusiveOrExpression_247_Var.getExpr();
		Assert.assertNotNull(Expr_247_list);
		Assert.assertEquals(2, Expr_247_list.size());
		final AndExpression AndExpression_248_Var = (AndExpression)Expr_247_list.get(0);
		Assert.assertNotNull(AndExpression_248_Var);
		final EList<? extends EObject> Expr_248_list = AndExpression_248_Var.getExpr();
		Assert.assertNotNull(Expr_248_list);
		Assert.assertEquals(1, Expr_248_list.size());
		final EqualityExpression EqualityExpression_249_Var = (EqualityExpression)Expr_248_list.get(0);
		Assert.assertNotNull(EqualityExpression_249_Var);
		final EList<? extends EObject> Expr_249_list = EqualityExpression_249_Var.getExpr();
		Assert.assertNotNull(Expr_249_list);
		Assert.assertEquals(1, Expr_249_list.size());
		final RelationalExpression RelationalExpression_250_Var = (RelationalExpression)Expr_249_list.get(0);
		Assert.assertNotNull(RelationalExpression_250_Var);
		final EList<? extends EObject> Expr_250_list = RelationalExpression_250_Var.getExpr();
		Assert.assertNotNull(Expr_250_list);
		Assert.assertEquals(1, Expr_250_list.size());
		final ShiftExpression ShiftExpression_251_Var = (ShiftExpression)Expr_250_list.get(0);
		Assert.assertNotNull(ShiftExpression_251_Var);
		final EList<? extends EObject> Expr_251_list = ShiftExpression_251_Var.getExpr();
		Assert.assertNotNull(Expr_251_list);
		Assert.assertEquals(1, Expr_251_list.size());
		final AdditiveExpression AdditiveExpression_252_Var = (AdditiveExpression)Expr_251_list.get(0);
		Assert.assertNotNull(AdditiveExpression_252_Var);
		final EList<? extends EObject> Expr_252_list = AdditiveExpression_252_Var.getExpr();
		Assert.assertNotNull(Expr_252_list);
		Assert.assertEquals(1, Expr_252_list.size());
		final MultiplicativeExpression MultiplicativeExpression_253_Var = (MultiplicativeExpression)Expr_252_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_253_Var);
		final EList<? extends EObject> Expr_253_list = MultiplicativeExpression_253_Var.getExpr();
		Assert.assertNotNull(Expr_253_list);
		Assert.assertEquals(1, Expr_253_list.size());
		final CastExpression CastExpression_254_Var = (CastExpression)Expr_253_list.get(0);
		Assert.assertNotNull(CastExpression_254_Var);
		final UnaryExpression UnaryExpression_255_Var = (UnaryExpression)CastExpression_254_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_255_Var);
		final PostfixExpression PostfixExpression_256_Var = (PostfixExpression)UnaryExpression_255_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_256_Var);
		final EList<? extends EObject> Expr_256_list = PostfixExpression_256_Var.getExpr();
		Assert.assertNotNull(Expr_256_list);
		Assert.assertEquals(1, Expr_256_list.size());
		final PrimaryExpression PrimaryExpression_257_Var = (PrimaryExpression)Expr_256_list.get(0);
		Assert.assertNotNull(PrimaryExpression_257_Var);
		final Constant Constant_258_Var = (Constant)PrimaryExpression_257_Var.getConst();
		Assert.assertNotNull(Constant_258_Var);
		Assert.assertEquals("1", Constant_258_Var.getDec());
		final AndExpression AndExpression_259_Var = (AndExpression)Expr_247_list.get(1);
		...
		final Constant Constant_269_Var = (Constant)PrimaryExpression_268_Var.getConst();
		Assert.assertNotNull(Constant_269_Var);
		Assert.assertEquals("2", Constant_269_Var.getDec());
		Assert.assertEquals(";", ExpressionStatement_240_Var.getSemi());
		final Statement Statement_270_Var = (Statement)Statement_10_list.get(9);
		Assert.assertNotNull(Statement_270_Var);
		final ExpressionStatement ExpressionStatement_271_Var = (ExpressionStatement)Statement_270_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_271_Var);
		final Expression Expression_272_Var = (Expression)ExpressionStatement_271_Var.getExpression();
		Assert.assertNotNull(Expression_272_Var);
		final EList<? extends EObject> ExprExpr_272_list = Expression_272_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_272_list);
		Assert.assertEquals(1, ExprExpr_272_list.size());
		final AssignmentExpression AssignmentExpression_273_Var = (AssignmentExpression)ExprExpr_272_list.get(0);
		Assert.assertNotNull(AssignmentExpression_273_Var);
		final ConditionalExpression ConditionalExpression_274_Var = (ConditionalExpression)AssignmentExpression_273_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_274_Var);
		final LogicalOrExpression LogicalOrExpression_275_Var = (LogicalOrExpression)ConditionalExpression_274_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_275_Var);
		final EList<? extends EObject> Expr_275_list = LogicalOrExpression_275_Var.getExpr();
		Assert.assertNotNull(Expr_275_list);
		Assert.assertEquals(1, Expr_275_list.size());
		final LogicalAndExpression LogicalAndExpression_276_Var = (LogicalAndExpression)Expr_275_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_276_Var);
		final EList<? extends EObject> Expr_276_list = LogicalAndExpression_276_Var.getExpr();
		Assert.assertNotNull(Expr_276_list);
		Assert.assertEquals(2, Expr_276_list.size());
		final InclusiveOrExpression InclusiveOrExpression_277_Var = (InclusiveOrExpression)Expr_276_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_277_Var);
		final EList<? extends EObject> Expr_277_list = InclusiveOrExpression_277_Var.getExpr();
		Assert.assertNotNull(Expr_277_list);
		Assert.assertEquals(1, Expr_277_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_278_Var = (ExclusiveOrExpression)Expr_277_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_278_Var);
		final EList<? extends EObject> Expr_278_list = ExclusiveOrExpression_278_Var.getExpr();
		Assert.assertNotNull(Expr_278_list);
		Assert.assertEquals(1, Expr_278_list.size());
		final AndExpression AndExpression_279_Var = (AndExpression)Expr_278_list.get(0);
		Assert.assertNotNull(AndExpression_279_Var);
		final EList<? extends EObject> Expr_279_list = AndExpression_279_Var.getExpr();
		Assert.assertNotNull(Expr_279_list);
		Assert.assertEquals(1, Expr_279_list.size());
		final EqualityExpression EqualityExpression_280_Var = (EqualityExpression)Expr_279_list.get(0);
		Assert.assertNotNull(EqualityExpression_280_Var);
		final EList<? extends EObject> Expr_280_list = EqualityExpression_280_Var.getExpr();
		Assert.assertNotNull(Expr_280_list);
		Assert.assertEquals(1, Expr_280_list.size());
		final RelationalExpression RelationalExpression_281_Var = (RelationalExpression)Expr_280_list.get(0);
		Assert.assertNotNull(RelationalExpression_281_Var);
		final EList<? extends EObject> Expr_281_list = RelationalExpression_281_Var.getExpr();
		Assert.assertNotNull(Expr_281_list);
		Assert.assertEquals(1, Expr_281_list.size());
		final ShiftExpression ShiftExpression_282_Var = (ShiftExpression)Expr_281_list.get(0);
		Assert.assertNotNull(ShiftExpression_282_Var);
		final EList<? extends EObject> Expr_282_list = ShiftExpression_282_Var.getExpr();
		Assert.assertNotNull(Expr_282_list);
		Assert.assertEquals(1, Expr_282_list.size());
		final AdditiveExpression AdditiveExpression_283_Var = (AdditiveExpression)Expr_282_list.get(0);
		Assert.assertNotNull(AdditiveExpression_283_Var);
		final EList<? extends EObject> Expr_283_list = AdditiveExpression_283_Var.getExpr();
		Assert.assertNotNull(Expr_283_list);
		Assert.assertEquals(1, Expr_283_list.size());
		final MultiplicativeExpression MultiplicativeExpression_284_Var = (MultiplicativeExpression)Expr_283_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_284_Var);
		final EList<? extends EObject> Expr_284_list = MultiplicativeExpression_284_Var.getExpr();
		Assert.assertNotNull(Expr_284_list);
		Assert.assertEquals(1, Expr_284_list.size());
		final CastExpression CastExpression_285_Var = (CastExpression)Expr_284_list.get(0);
		Assert.assertNotNull(CastExpression_285_Var);
		final UnaryExpression UnaryExpression_286_Var = (UnaryExpression)CastExpression_285_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_286_Var);
		final PostfixExpression PostfixExpression_287_Var = (PostfixExpression)UnaryExpression_286_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_287_Var);
		final EList<? extends EObject> Expr_287_list = PostfixExpression_287_Var.getExpr();
		Assert.assertNotNull(Expr_287_list);
		Assert.assertEquals(1, Expr_287_list.size());
		final PrimaryExpression PrimaryExpression_288_Var = (PrimaryExpression)Expr_287_list.get(0);
		Assert.assertNotNull(PrimaryExpression_288_Var);
		final Constant Constant_289_Var = (Constant)PrimaryExpression_288_Var.getConst();
		Assert.assertNotNull(Constant_289_Var);
		Assert.assertEquals("1", Constant_289_Var.getDec());
		final InclusiveOrExpression InclusiveOrExpression_290_Var = (InclusiveOrExpression)Expr_276_list.get(1);
		...
		final PostfixExpression PostfixExpression_300_Var = (PostfixExpression)UnaryExpression_299_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_300_Var);
		final EList<? extends EObject> Expr_300_list = PostfixExpression_300_Var.getExpr();
		Assert.assertNotNull(Expr_300_list);
		Assert.assertEquals(1, Expr_300_list.size());
		final PrimaryExpression PrimaryExpression_301_Var = (PrimaryExpression)Expr_300_list.get(0);
		Assert.assertNotNull(PrimaryExpression_301_Var);
		final Constant Constant_302_Var = (Constant)PrimaryExpression_301_Var.getConst();
		Assert.assertNotNull(Constant_302_Var);
		Assert.assertEquals("2", Constant_302_Var.getDec());
		Assert.assertEquals(";", ExpressionStatement_271_Var.getSemi());
		final Statement Statement_303_Var = (Statement)Statement_10_list.get(10);
		Assert.assertNotNull(Statement_303_Var);
		final ExpressionStatement ExpressionStatement_304_Var = (ExpressionStatement)Statement_303_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_304_Var);
		final Expression Expression_305_Var = (Expression)ExpressionStatement_304_Var.getExpression();
		...
		final Constant Constant_322_Var = (Constant)PrimaryExpression_321_Var.getConst();
		Assert.assertNotNull(Constant_322_Var);
		Assert.assertEquals("1", Constant_322_Var.getDec());
		final LogicalAndExpression LogicalAndExpression_323_Var = (LogicalAndExpression)Expr_308_list.get(1);
		...
		Assert.assertEquals("2", Constant_336_Var.getDec());
		Assert.assertEquals(";", ExpressionStatement_304_Var.getSemi());
		final Statement Statement_337_Var = (Statement)Statement_10_list.get(11);
		...
		final Constant Constant_356_Var = (Constant)PrimaryExpression_355_Var.getConst();
		Assert.assertNotNull(Constant_356_Var);
		Assert.assertEquals("1", Constant_356_Var.getDec());
		final Expression Expression_357_Var = (Expression)ConditionalExpression_341_Var.getQExpr();
		Assert.assertNotNull(Expression_357_Var);
		final EList<? extends EObject> ExprExpr_357_list = Expression_357_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_357_list);
		Assert.assertEquals(1, ExprExpr_357_list.size());
		final AssignmentExpression AssignmentExpression_358_Var = (AssignmentExpression)ExprExpr_357_list.get(0);
		Assert.assertNotNull(AssignmentExpression_358_Var);
		final ConditionalExpression ConditionalExpression_359_Var = (ConditionalExpression)AssignmentExpression_358_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_359_Var);
		final LogicalOrExpression LogicalOrExpression_360_Var = (LogicalOrExpression)ConditionalExpression_359_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_360_Var);
		final EList<? extends EObject> Expr_360_list = LogicalOrExpression_360_Var.getExpr();
		Assert.assertNotNull(Expr_360_list);
		Assert.assertEquals(1, Expr_360_list.size());
		final LogicalAndExpression LogicalAndExpression_361_Var = (LogicalAndExpression)Expr_360_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_361_Var);
		final EList<? extends EObject> Expr_361_list = LogicalAndExpression_361_Var.getExpr();
		Assert.assertNotNull(Expr_361_list);
		Assert.assertEquals(1, Expr_361_list.size());
		final InclusiveOrExpression InclusiveOrExpression_362_Var = (InclusiveOrExpression)Expr_361_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_362_Var);
		final EList<? extends EObject> Expr_362_list = InclusiveOrExpression_362_Var.getExpr();
		Assert.assertNotNull(Expr_362_list);
		Assert.assertEquals(1, Expr_362_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_363_Var = (ExclusiveOrExpression)Expr_362_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_363_Var);
		final EList<? extends EObject> Expr_363_list = ExclusiveOrExpression_363_Var.getExpr();
		Assert.assertNotNull(Expr_363_list);
		Assert.assertEquals(1, Expr_363_list.size());
		final AndExpression AndExpression_364_Var = (AndExpression)Expr_363_list.get(0);
		Assert.assertNotNull(AndExpression_364_Var);
		final EList<? extends EObject> Expr_364_list = AndExpression_364_Var.getExpr();
		Assert.assertNotNull(Expr_364_list);
		Assert.assertEquals(1, Expr_364_list.size());
		final EqualityExpression EqualityExpression_365_Var = (EqualityExpression)Expr_364_list.get(0);
		Assert.assertNotNull(EqualityExpression_365_Var);
		final EList<? extends EObject> Expr_365_list = EqualityExpression_365_Var.getExpr();
		Assert.assertNotNull(Expr_365_list);
		Assert.assertEquals(1, Expr_365_list.size());
		final RelationalExpression RelationalExpression_366_Var = (RelationalExpression)Expr_365_list.get(0);
		Assert.assertNotNull(RelationalExpression_366_Var);
		final EList<? extends EObject> Expr_366_list = RelationalExpression_366_Var.getExpr();
		Assert.assertNotNull(Expr_366_list);
		Assert.assertEquals(1, Expr_366_list.size());
		final ShiftExpression ShiftExpression_367_Var = (ShiftExpression)Expr_366_list.get(0);
		Assert.assertNotNull(ShiftExpression_367_Var);
		final EList<? extends EObject> Expr_367_list = ShiftExpression_367_Var.getExpr();
		Assert.assertNotNull(Expr_367_list);
		Assert.assertEquals(1, Expr_367_list.size());
		final AdditiveExpression AdditiveExpression_368_Var = (AdditiveExpression)Expr_367_list.get(0);
		Assert.assertNotNull(AdditiveExpression_368_Var);
		final EList<? extends EObject> Expr_368_list = AdditiveExpression_368_Var.getExpr();
		Assert.assertNotNull(Expr_368_list);
		Assert.assertEquals(1, Expr_368_list.size());
		final MultiplicativeExpression MultiplicativeExpression_369_Var = (MultiplicativeExpression)Expr_368_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_369_Var);
		final EList<? extends EObject> Expr_369_list = MultiplicativeExpression_369_Var.getExpr();
		Assert.assertNotNull(Expr_369_list);
		Assert.assertEquals(1, Expr_369_list.size());
		final CastExpression CastExpression_370_Var = (CastExpression)Expr_369_list.get(0);
		Assert.assertNotNull(CastExpression_370_Var);
		final UnaryExpression UnaryExpression_371_Var = (UnaryExpression)CastExpression_370_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_371_Var);
		final PostfixExpression PostfixExpression_372_Var = (PostfixExpression)UnaryExpression_371_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_372_Var);
		final EList<? extends EObject> Expr_372_list = PostfixExpression_372_Var.getExpr();
		Assert.assertNotNull(Expr_372_list);
		Assert.assertEquals(1, Expr_372_list.size());
		final PrimaryExpression PrimaryExpression_373_Var = (PrimaryExpression)Expr_372_list.get(0);
		Assert.assertNotNull(PrimaryExpression_373_Var);
		final Constant Constant_374_Var = (Constant)PrimaryExpression_373_Var.getConst();
		Assert.assertNotNull(Constant_374_Var);
		Assert.assertEquals("2", Constant_374_Var.getDec());
		final ConditionalExpression ConditionalExpression_375_Var = (ConditionalExpression)ConditionalExpression_341_Var.getCExpr();
		...
		final Constant Constant_390_Var = (Constant)PrimaryExpression_389_Var.getConst();
		Assert.assertNotNull(Constant_390_Var);
		Assert.assertEquals("3", Constant_390_Var.getDec());
