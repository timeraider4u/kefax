...
public class Test0015_CastExpr {
	...
	throws Exception{
		final String text = this.getTextFromFile("res/Test0015_CastExpr.c");
	...
	throws Exception{
		...
		final CastExpression CastExpression_27_Var = (CastExpression)CastExpression_26_Var.getExpr();
		Assert.assertNotNull(CastExpression_27_Var);
		final UnaryExpression UnaryExpression_28_Var = (UnaryExpression)CastExpression_27_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_28_Var);
		final PostfixExpression PostfixExpression_29_Var = (PostfixExpression)UnaryExpression_28_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_29_Var);
		final EList<? extends EObject> Expr_29_list = PostfixExpression_29_Var.getExpr();
		Assert.assertNotNull(Expr_29_list);
		Assert.assertEquals(1, Expr_29_list.size());
		final PrimaryExpression PrimaryExpression_30_Var = (PrimaryExpression)Expr_29_list.get(0);
		Assert.assertNotNull(PrimaryExpression_30_Var);
		final Constant Constant_31_Var = (Constant)PrimaryExpression_30_Var.getConst();
		Assert.assertNotNull(Constant_31_Var);
		Assert.assertEquals("0.8", Constant_31_Var.getFloat());
		final TypeName TypeName_32_Var = (TypeName)CastExpression_26_Var.getType();
		Assert.assertNotNull(TypeName_32_Var);
		final SpecifierQualifierList SpecifierQualifierList_33_Var = (SpecifierQualifierList)TypeName_32_Var.getList();
		Assert.assertNotNull(SpecifierQualifierList_33_Var);
		final EList<? extends EObject> TypeSpecifier_33_list = SpecifierQualifierList_33_Var.getTypeSpecifier();
		Assert.assertNotNull(TypeSpecifier_33_list);
		Assert.assertEquals(1, TypeSpecifier_33_list.size());
		final TypeSpecifier TypeSpecifier_34_Var = (TypeSpecifier)TypeSpecifier_33_list.get(0);
