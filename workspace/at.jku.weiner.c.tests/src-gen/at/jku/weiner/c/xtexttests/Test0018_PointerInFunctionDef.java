...
public class Test0018_PointerInFunctionDef {
	...
	throws Exception{
		final String text = this.getTextFromFile("res/Test0018_PointerInFunctionDef.c");
	...
	throws Exception{
		...
		Assert.assertEquals("char", TypeSpecifier_20_Var.getName());
		...
		Assert.assertEquals("float", TypeSpecifier_26_Var.getName());
		...
		Assert.assertEquals("int", TypeSpecifier_31_Var.getName());
		...
		final Expression Expression_44_Var = (Expression)PrimaryExpression_43_Var.getExpr();
		Assert.assertNotNull(Expression_44_Var);
		final EList<? extends EObject> ExprExpr_44_list = Expression_44_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_44_list);
		Assert.assertEquals(1, ExprExpr_44_list.size());
		final AssignmentExpression AssignmentExpression_45_Var = (AssignmentExpression)ExprExpr_44_list.get(0);
		Assert.assertNotNull(AssignmentExpression_45_Var);
		final ConditionalExpression ConditionalExpression_46_Var = (ConditionalExpression)AssignmentExpression_45_Var.getExpr();
		...
		Assert.assertEquals("argv", PrimaryExpression_60_Var.getId());
		final EList<? extends EObject> ArrayExpr_60_list = PostfixExpression_59_Var.getArrayExpr();
		Assert.assertNotNull(ArrayExpr_60_list);
		Assert.assertEquals(1, ArrayExpr_60_list.size());
		final Expression Expression_61_Var = (Expression)ArrayExpr_60_list.get(0);
		Assert.assertNotNull(Expression_61_Var);
		final EList<? extends EObject> ExprExpr_61_list = Expression_61_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_61_list);
		Assert.assertEquals(1, ExprExpr_61_list.size());
		final AssignmentExpression AssignmentExpression_62_Var = (AssignmentExpression)ExprExpr_61_list.get(0);
		Assert.assertNotNull(AssignmentExpression_62_Var);
		final ConditionalExpression ConditionalExpression_63_Var = (ConditionalExpression)AssignmentExpression_62_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_63_Var);
		final LogicalOrExpression LogicalOrExpression_64_Var = (LogicalOrExpression)ConditionalExpression_63_Var.getExpr();
		...
		Assert.assertEquals("9", Constant_78_Var.getDec());
		final AssignmentOperator AssignmentOperator_79_Var = (AssignmentOperator)AssignmentExpression_40_Var.getOp();
		Assert.assertNotNull(AssignmentOperator_79_Var);
		Assert.assertEquals("=", AssignmentOperator_79_Var.getOp());
		final AssignmentExpression AssignmentExpression_80_Var = (AssignmentExpression)AssignmentExpression_40_Var.getAssignmentExpr();
		...
		Assert.assertEquals("argv", PrimaryExpression_95_Var.getId());
		final EList<? extends EObject> ArrayExpr_95_list = PostfixExpression_94_Var.getArrayExpr();
		Assert.assertNotNull(ArrayExpr_95_list);
		Assert.assertEquals(1, ArrayExpr_95_list.size());
		final Expression Expression_96_Var = (Expression)ArrayExpr_95_list.get(0);
		Assert.assertNotNull(Expression_96_Var);
		final EList<? extends EObject> ExprExpr_96_list = Expression_96_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_96_list);
		Assert.assertEquals(1, ExprExpr_96_list.size());
		final AssignmentExpression AssignmentExpression_97_Var = (AssignmentExpression)ExprExpr_96_list.get(0);
		Assert.assertNotNull(AssignmentExpression_97_Var);
		final ConditionalExpression ConditionalExpression_98_Var = (ConditionalExpression)AssignmentExpression_97_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_98_Var);
		final LogicalOrExpression LogicalOrExpression_99_Var = (LogicalOrExpression)ConditionalExpression_98_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_99_Var);
		final EList<? extends EObject> Expr_99_list = LogicalOrExpression_99_Var.getExpr();
		Assert.assertNotNull(Expr_99_list);
		Assert.assertEquals(1, Expr_99_list.size());
		final LogicalAndExpression LogicalAndExpression_100_Var = (LogicalAndExpression)Expr_99_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_100_Var);
		final EList<? extends EObject> Expr_100_list = LogicalAndExpression_100_Var.getExpr();
		Assert.assertNotNull(Expr_100_list);
		Assert.assertEquals(1, Expr_100_list.size());
		final InclusiveOrExpression InclusiveOrExpression_101_Var = (InclusiveOrExpression)Expr_100_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_101_Var);
		final EList<? extends EObject> Expr_101_list = InclusiveOrExpression_101_Var.getExpr();
		Assert.assertNotNull(Expr_101_list);
		Assert.assertEquals(1, Expr_101_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_102_Var = (ExclusiveOrExpression)Expr_101_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_102_Var);
		final EList<? extends EObject> Expr_102_list = ExclusiveOrExpression_102_Var.getExpr();
		Assert.assertNotNull(Expr_102_list);
		Assert.assertEquals(1, Expr_102_list.size());
		final AndExpression AndExpression_103_Var = (AndExpression)Expr_102_list.get(0);
		Assert.assertNotNull(AndExpression_103_Var);
		final EList<? extends EObject> Expr_103_list = AndExpression_103_Var.getExpr();
		Assert.assertNotNull(Expr_103_list);
		Assert.assertEquals(1, Expr_103_list.size());
		final EqualityExpression EqualityExpression_104_Var = (EqualityExpression)Expr_103_list.get(0);
		Assert.assertNotNull(EqualityExpression_104_Var);
		final EList<? extends EObject> Expr_104_list = EqualityExpression_104_Var.getExpr();
		Assert.assertNotNull(Expr_104_list);
		Assert.assertEquals(1, Expr_104_list.size());
		final RelationalExpression RelationalExpression_105_Var = (RelationalExpression)Expr_104_list.get(0);
		Assert.assertNotNull(RelationalExpression_105_Var);
		final EList<? extends EObject> Expr_105_list = RelationalExpression_105_Var.getExpr();
		Assert.assertNotNull(Expr_105_list);
		Assert.assertEquals(1, Expr_105_list.size());
		final ShiftExpression ShiftExpression_106_Var = (ShiftExpression)Expr_105_list.get(0);
		Assert.assertNotNull(ShiftExpression_106_Var);
		final EList<? extends EObject> Expr_106_list = ShiftExpression_106_Var.getExpr();
		Assert.assertNotNull(Expr_106_list);
		Assert.assertEquals(1, Expr_106_list.size());
		final AdditiveExpression AdditiveExpression_107_Var = (AdditiveExpression)Expr_106_list.get(0);
		Assert.assertNotNull(AdditiveExpression_107_Var);
		final EList<? extends EObject> Expr_107_list = AdditiveExpression_107_Var.getExpr();
		Assert.assertNotNull(Expr_107_list);
		Assert.assertEquals(1, Expr_107_list.size());
		final MultiplicativeExpression MultiplicativeExpression_108_Var = (MultiplicativeExpression)Expr_107_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_108_Var);
		final EList<? extends EObject> Expr_108_list = MultiplicativeExpression_108_Var.getExpr();
		Assert.assertNotNull(Expr_108_list);
		Assert.assertEquals(1, Expr_108_list.size());
		final CastExpression CastExpression_109_Var = (CastExpression)Expr_108_list.get(0);
		Assert.assertNotNull(CastExpression_109_Var);
		final UnaryExpression UnaryExpression_110_Var = (UnaryExpression)CastExpression_109_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_110_Var);
		final PostfixExpression PostfixExpression_111_Var = (PostfixExpression)UnaryExpression_110_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_111_Var);
		final EList<? extends EObject> Expr_111_list = PostfixExpression_111_Var.getExpr();
		Assert.assertNotNull(Expr_111_list);
		Assert.assertEquals(1, Expr_111_list.size());
		final PrimaryExpression PrimaryExpression_112_Var = (PrimaryExpression)Expr_111_list.get(0);
		Assert.assertNotNull(PrimaryExpression_112_Var);
		Assert.assertEquals("i", PrimaryExpression_112_Var.getId());
		final MultiplicativeExpression MultiplicativeExpression_113_Var = (MultiplicativeExpression)Expr_90_list.get(1);
		...
		Assert.assertEquals("0b011", Constant_118_Var.getBin());
		Assert.assertEquals("[+]", AdditiveExpression_90_Var.getOp().toString());
	}
