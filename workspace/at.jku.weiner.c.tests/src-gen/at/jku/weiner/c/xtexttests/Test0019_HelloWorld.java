...
public class Test0019_HelloWorld {
	...
	throws Exception{
		final String text = this.getTextFromFile("res/Test0019_HelloWorld.c");
	...
	throws Exception{
		...
		Assert.assertEquals("argv", DirectDeclarator_21_Var.getId());
		final Pointer Pointer_22_Var = (Pointer)Declarator_20_Var.getPointer();
		Assert.assertNotNull(Pointer_22_Var);
		Assert.assertEquals("[*, *]", Pointer_22_Var.getStar().toString());
		final FunctionDefinition FunctionDefinition_23_Var = (FunctionDefinition)ExternalDeclaration_2_Var.getFunctionDefinition();
		Assert.assertNotNull(FunctionDefinition_23_Var);
		final BodyStatement BodyStatement_24_Var = (BodyStatement)FunctionDefinition_23_Var.getBody();
		Assert.assertNotNull(BodyStatement_24_Var);
		final EList<? extends EObject> BlockList_24_list = BodyStatement_24_Var.getBlockList();
		...
		final EList<? extends EObject> Statement_25_list = BlockList_25_Var.getStatement();
		...
		final ExpressionStatement ExpressionStatement_27_Var = (ExpressionStatement)Statement_26_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_27_Var);
		final Expression Expression_28_Var = (Expression)ExpressionStatement_27_Var.getExpression();
		Assert.assertNotNull(Expression_28_Var);
		final EList<? extends EObject> ExprExpr_28_list = Expression_28_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_28_list);
		Assert.assertEquals(1, ExprExpr_28_list.size());
		final AssignmentExpression AssignmentExpression_29_Var = (AssignmentExpression)ExprExpr_28_list.get(0);
		...
		Assert.assertEquals("printf", PrimaryExpression_44_Var.getId());
		final EList<? extends EObject> ArgumentExpressionList_44_list = PostfixExpression_43_Var.getArgumentExpressionList();
		Assert.assertNotNull(ArgumentExpressionList_44_list);
		Assert.assertEquals(1, ArgumentExpressionList_44_list.size());
		final ArgumentExpressionList ArgumentExpressionList_45_Var = (ArgumentExpressionList)ArgumentExpressionList_44_list.get(0);
		Assert.assertNotNull(ArgumentExpressionList_45_Var);
		final EList<? extends EObject> Expr_45_list = ArgumentExpressionList_45_Var.getExpr();
		Assert.assertNotNull(Expr_45_list);
		Assert.assertEquals(2, Expr_45_list.size());
		final AssignmentExpression AssignmentExpression_46_Var = (AssignmentExpression)Expr_45_list.get(0);
		...
		Assert.assertEquals("\"%s\\n\"", Constant_62_Var.getStr());
		final AssignmentExpression AssignmentExpression_63_Var = (AssignmentExpression)Expr_45_list.get(1);
		Assert.assertNotNull(AssignmentExpression_63_Var);
		final ConditionalExpression ConditionalExpression_64_Var = (ConditionalExpression)AssignmentExpression_63_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_64_Var);
		final LogicalOrExpression LogicalOrExpression_65_Var = (LogicalOrExpression)ConditionalExpression_64_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_65_Var);
		final EList<? extends EObject> Expr_65_list = LogicalOrExpression_65_Var.getExpr();
		Assert.assertNotNull(Expr_65_list);
		Assert.assertEquals(1, Expr_65_list.size());
		final LogicalAndExpression LogicalAndExpression_66_Var = (LogicalAndExpression)Expr_65_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_66_Var);
		final EList<? extends EObject> Expr_66_list = LogicalAndExpression_66_Var.getExpr();
		Assert.assertNotNull(Expr_66_list);
		Assert.assertEquals(1, Expr_66_list.size());
		final InclusiveOrExpression InclusiveOrExpression_67_Var = (InclusiveOrExpression)Expr_66_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_67_Var);
		final EList<? extends EObject> Expr_67_list = InclusiveOrExpression_67_Var.getExpr();
		Assert.assertNotNull(Expr_67_list);
		Assert.assertEquals(1, Expr_67_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_68_Var = (ExclusiveOrExpression)Expr_67_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_68_Var);
		final EList<? extends EObject> Expr_68_list = ExclusiveOrExpression_68_Var.getExpr();
		Assert.assertNotNull(Expr_68_list);
		Assert.assertEquals(1, Expr_68_list.size());
		final AndExpression AndExpression_69_Var = (AndExpression)Expr_68_list.get(0);
		Assert.assertNotNull(AndExpression_69_Var);
		final EList<? extends EObject> Expr_69_list = AndExpression_69_Var.getExpr();
		Assert.assertNotNull(Expr_69_list);
		Assert.assertEquals(1, Expr_69_list.size());
		final EqualityExpression EqualityExpression_70_Var = (EqualityExpression)Expr_69_list.get(0);
		Assert.assertNotNull(EqualityExpression_70_Var);
		final EList<? extends EObject> Expr_70_list = EqualityExpression_70_Var.getExpr();
		Assert.assertNotNull(Expr_70_list);
		Assert.assertEquals(1, Expr_70_list.size());
		final RelationalExpression RelationalExpression_71_Var = (RelationalExpression)Expr_70_list.get(0);
		Assert.assertNotNull(RelationalExpression_71_Var);
		final EList<? extends EObject> Expr_71_list = RelationalExpression_71_Var.getExpr();
		Assert.assertNotNull(Expr_71_list);
		Assert.assertEquals(1, Expr_71_list.size());
		final ShiftExpression ShiftExpression_72_Var = (ShiftExpression)Expr_71_list.get(0);
		Assert.assertNotNull(ShiftExpression_72_Var);
		final EList<? extends EObject> Expr_72_list = ShiftExpression_72_Var.getExpr();
		Assert.assertNotNull(Expr_72_list);
		Assert.assertEquals(1, Expr_72_list.size());
		final AdditiveExpression AdditiveExpression_73_Var = (AdditiveExpression)Expr_72_list.get(0);
		Assert.assertNotNull(AdditiveExpression_73_Var);
		final EList<? extends EObject> Expr_73_list = AdditiveExpression_73_Var.getExpr();
		Assert.assertNotNull(Expr_73_list);
		Assert.assertEquals(1, Expr_73_list.size());
		final MultiplicativeExpression MultiplicativeExpression_74_Var = (MultiplicativeExpression)Expr_73_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_74_Var);
		final EList<? extends EObject> Expr_74_list = MultiplicativeExpression_74_Var.getExpr();
		Assert.assertNotNull(Expr_74_list);
		Assert.assertEquals(1, Expr_74_list.size());
		final CastExpression CastExpression_75_Var = (CastExpression)Expr_74_list.get(0);
		...
		final PostfixExpression PostfixExpression_77_Var = (PostfixExpression)UnaryExpression_76_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_77_Var);
		final EList<? extends EObject> Expr_77_list = PostfixExpression_77_Var.getExpr();
		Assert.assertNotNull(Expr_77_list);
		Assert.assertEquals(1, Expr_77_list.size());
		final PrimaryExpression PrimaryExpression_78_Var = (PrimaryExpression)Expr_77_list.get(0);
		Assert.assertNotNull(PrimaryExpression_78_Var);
		final Constant Constant_79_Var = (Constant)PrimaryExpression_78_Var.getConst();
		Assert.assertNotNull(Constant_79_Var);
		Assert.assertEquals("\"Hello World!\"", Constant_79_Var.getStr());
		Assert.assertEquals(";", ExpressionStatement_27_Var.getSemi());
		final Statement Statement_80_Var = (Statement)Statement_25_list.get(1);
		Assert.assertNotNull(Statement_80_Var);
		final JumpStatement JumpStatement_81_Var = (JumpStatement)Statement_80_Var.getStmt();
		Assert.assertNotNull(JumpStatement_81_Var);
		final Expression Expression_82_Var = (Expression)JumpStatement_81_Var.getExpr();
		Assert.assertNotNull(Expression_82_Var);
		final EList<? extends EObject> ExprExpr_82_list = Expression_82_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_82_list);
		Assert.assertEquals(1, ExprExpr_82_list.size());
		final AssignmentExpression AssignmentExpression_83_Var = (AssignmentExpression)ExprExpr_82_list.get(0);
		Assert.assertNotNull(AssignmentExpression_83_Var);
		final ConditionalExpression ConditionalExpression_84_Var = (ConditionalExpression)AssignmentExpression_83_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_84_Var);
		final LogicalOrExpression LogicalOrExpression_85_Var = (LogicalOrExpression)ConditionalExpression_84_Var.getExpr();
		...
		Assert.assertEquals("0", Constant_99_Var.getDec());
		Assert.assertEquals("return", JumpStatement_81_Var.getReturn());
		Assert.assertEquals(";", JumpStatement_81_Var.getSemi());
	}
