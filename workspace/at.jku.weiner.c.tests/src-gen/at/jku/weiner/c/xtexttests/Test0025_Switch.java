...
public class Test0025_Switch {
	...
	throws Exception{
		...
		final Statement Statement_42_Var = (Statement)Statement_19_list.get(1);
		Assert.assertNotNull(Statement_42_Var);
		final JumpStatement JumpStatement_43_Var = (JumpStatement)Statement_42_Var.getStmt();
		Assert.assertNotNull(JumpStatement_43_Var);
		final Expression Expression_44_Var = (Expression)JumpStatement_43_Var.getExpr();
		...
		Assert.assertEquals("return", JumpStatement_43_Var.getReturn());
		Assert.assertEquals(";", JumpStatement_43_Var.getSemi());
	}
