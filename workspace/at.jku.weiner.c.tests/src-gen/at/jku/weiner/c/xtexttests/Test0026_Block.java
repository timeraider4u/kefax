...
public class Test0026_Block {
	...
	public void checkParserResult() throws Exception {
		...
		Assert.assertEquals("my", DirectDeclarator_7_Var
		.getId());
		//7
		...
		//11
		final CompoundStatement CompoundStatement_12_Var
		 = (CompoundStatement)Statement_11_Var
		.getStmt();
		Assert.assertNotNull(CompoundStatement_12_Var
		);
		//12
		final BodyStatement BodyStatement_13_Var
		 = (BodyStatement)CompoundStatement_12_Var
		.getBody();
		Assert.assertNotNull(BodyStatement_13_Var
		);
		final EList<? extends EObject> BlockList_13_list = BodyStatement_13_Var
		.getBlockList();
		Assert.assertNotNull(BlockList_13_list);
		Assert.assertEquals(1, BlockList_13_list.size());
		//13
		final BlockList BlockList_14_Var
		 = (BlockList)BlockList_13_list.get(0);
		Assert.assertNotNull(BlockList_14_Var
		);
		final EList<? extends EObject> Statement_14_list = BlockList_14_Var
		.getStatement();
		Assert.assertNotNull(Statement_14_list);
		Assert.assertEquals(1, Statement_14_list.size());
		//14
		final Statement Statement_15_Var
		 = (Statement)Statement_14_list.get(0);
		Assert.assertNotNull(Statement_15_Var
		);
		//15
		final CompoundStatement CompoundStatement_16_Var
		 = (CompoundStatement)Statement_15_Var
		.getStmt();
		Assert.assertNotNull(CompoundStatement_16_Var
		);
		//16
		final BodyStatement BodyStatement_17_Var
		 = (BodyStatement)CompoundStatement_16_Var
		.getBody();
