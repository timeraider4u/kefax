...
public class Test0026_Block {
	...
	throws Exception{
		final String text = this.getTextFromFile("res/Test0026_Block.c");
	...
	throws Exception{
		...
		Assert.assertEquals("my", DirectDeclarator_7_Var.getId());
		...
		final CompoundStatement CompoundStatement_12_Var = (CompoundStatement)Statement_11_Var.getStmt();
