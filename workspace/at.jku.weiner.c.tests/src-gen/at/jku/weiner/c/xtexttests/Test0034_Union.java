...
public class Test0034_Union {
	...
	throws Exception{
		final String text = this.getTextFromFile("res/Test0034_Union.c");
	...
	throws Exception{
		...
		Assert.assertEquals("union", StructOrUnion_6_Var.getName());
		Assert.assertEquals("num", StructOrUnionSpecifier_5_Var.getId());
		...
		Assert.assertEquals("char", TypeSpecifier_10_Var.getName());
		...
		Assert.assertEquals("numChar", DirectDeclarator_14_Var.getId());
		...
		Assert.assertEquals("float", TypeSpecifier_17_Var.getName());
		...
		Assert.assertEquals("numFloat", DirectDeclarator_21_Var.getId());
		final ExternalDeclaration ExternalDeclaration_22_Var = (ExternalDeclaration)External_1_list.get(1);
		...
		final StructOrUnionSpecifier StructOrUnionSpecifier_25_Var = (StructOrUnionSpecifier)DeclarationSpecifier_24_list.get(0);
		Assert.assertNotNull(StructOrUnionSpecifier_25_Var);
		final StructOrUnion StructOrUnion_26_Var = (StructOrUnion)StructOrUnionSpecifier_25_Var.getType();
		Assert.assertNotNull(StructOrUnion_26_Var);
		Assert.assertEquals("union", StructOrUnion_26_Var.getName());
		Assert.assertEquals("num", StructOrUnionSpecifier_25_Var.getId());
		final EList<? extends EObject> InitDeclaratorList_26_list = Declaration_23_Var.getInitDeclaratorList();
		Assert.assertNotNull(InitDeclaratorList_26_list);
		Assert.assertEquals(1, InitDeclaratorList_26_list.size());
		final InitDeclaratorList InitDeclaratorList_27_Var = (InitDeclaratorList)InitDeclaratorList_26_list.get(0);
		Assert.assertNotNull(InitDeclaratorList_27_Var);
		final EList<? extends EObject> InitDeclarator_27_list = InitDeclaratorList_27_Var.getInitDeclarator();
		Assert.assertNotNull(InitDeclarator_27_list);
		Assert.assertEquals(1, InitDeclarator_27_list.size());
		final InitDeclarator InitDeclarator_28_Var = (InitDeclarator)InitDeclarator_27_list.get(0);
		Assert.assertNotNull(InitDeclarator_28_Var);
		final Declarator Declarator_29_Var = (Declarator)InitDeclarator_28_Var.getDeclarator();
		...
		Assert.assertEquals("number", DirectDeclarator_30_Var.getId());
		final ExternalDeclaration ExternalDeclaration_31_Var = (ExternalDeclaration)External_1_list.get(2);
		...
		Assert.assertEquals("main", DirectDeclarator_36_Var.getId());
		...
		Assert.assertEquals("void", TypeSpecifier_43_Var.getName());
		final FunctionDefinition FunctionDefinition_44_Var = (FunctionDefinition)ExternalDeclaration_31_Var.getFunctionDefinition();
		...
		final EList<? extends EObject> Declaration_46_list = BlockList_46_Var.getDeclaration();
		Assert.assertNotNull(Declaration_46_list);
		Assert.assertEquals(1, Declaration_46_list.size());
		final Declaration Declaration_47_Var = (Declaration)Declaration_46_list.get(0);
		...
		Assert.assertEquals("unsigned", TypeSpecifier_49_Var.getName());
		final TypeSpecifier TypeSpecifier_50_Var = (TypeSpecifier)DeclarationSpecifier_48_list.get(1);
		Assert.assertNotNull(TypeSpecifier_50_Var);
		Assert.assertEquals("long", TypeSpecifier_50_Var.getName());
		final EList<? extends EObject> InitDeclaratorList_50_list = Declaration_47_Var.getInitDeclaratorList();
		...
		Assert.assertEquals("size", DirectDeclarator_54_Var.getId());
		...
		final TypeName TypeName_69_Var = (TypeName)CastExpression_68_Var.getType();
		Assert.assertNotNull(TypeName_69_Var);
		final SpecifierQualifierList SpecifierQualifierList_70_Var = (SpecifierQualifierList)TypeName_69_Var.getList();
		Assert.assertNotNull(SpecifierQualifierList_70_Var);
		final EList<? extends EObject> TypeSpecifier_70_list = SpecifierQualifierList_70_Var.getTypeSpecifier();
		Assert.assertNotNull(TypeSpecifier_70_list);
		Assert.assertEquals(2, TypeSpecifier_70_list.size());
		final TypeSpecifier TypeSpecifier_71_Var = (TypeSpecifier)TypeSpecifier_70_list.get(0);
		Assert.assertNotNull(TypeSpecifier_71_Var);
		Assert.assertEquals("unsigned", TypeSpecifier_71_Var.getName());
		final TypeSpecifier TypeSpecifier_72_Var = (TypeSpecifier)TypeSpecifier_70_list.get(1);
		Assert.assertNotNull(TypeSpecifier_72_Var);
		Assert.assertEquals("long", TypeSpecifier_72_Var.getName());
		final CastExpression CastExpression_73_Var = (CastExpression)CastExpression_68_Var.getExpr();
		...
		Assert.assertEquals("sizeof", UnaryExpression_74_Var.getSizeOf());
		final UnaryExpression UnaryExpression_75_Var = (UnaryExpression)UnaryExpression_74_Var.getExpr();
		...
		final Expression Expression_78_Var = (Expression)PrimaryExpression_77_Var.getExpr();
		Assert.assertNotNull(Expression_78_Var);
		final EList<? extends EObject> ExprExpr_78_list = Expression_78_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_78_list);
		Assert.assertEquals(1, ExprExpr_78_list.size());
		final AssignmentExpression AssignmentExpression_79_Var = (AssignmentExpression)ExprExpr_78_list.get(0);
		Assert.assertNotNull(AssignmentExpression_79_Var);
		final ConditionalExpression ConditionalExpression_80_Var = (ConditionalExpression)AssignmentExpression_79_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_80_Var);
		final LogicalOrExpression LogicalOrExpression_81_Var = (LogicalOrExpression)ConditionalExpression_80_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_81_Var);
		final EList<? extends EObject> Expr_81_list = LogicalOrExpression_81_Var.getExpr();
		Assert.assertNotNull(Expr_81_list);
		Assert.assertEquals(1, Expr_81_list.size());
		final LogicalAndExpression LogicalAndExpression_82_Var = (LogicalAndExpression)Expr_81_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_82_Var);
		final EList<? extends EObject> Expr_82_list = LogicalAndExpression_82_Var.getExpr();
		Assert.assertNotNull(Expr_82_list);
		Assert.assertEquals(1, Expr_82_list.size());
		final InclusiveOrExpression InclusiveOrExpression_83_Var = (InclusiveOrExpression)Expr_82_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_83_Var);
		final EList<? extends EObject> Expr_83_list = InclusiveOrExpression_83_Var.getExpr();
		Assert.assertNotNull(Expr_83_list);
		Assert.assertEquals(1, Expr_83_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_84_Var = (ExclusiveOrExpression)Expr_83_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_84_Var);
		final EList<? extends EObject> Expr_84_list = ExclusiveOrExpression_84_Var.getExpr();
		Assert.assertNotNull(Expr_84_list);
		Assert.assertEquals(1, Expr_84_list.size());
		final AndExpression AndExpression_85_Var = (AndExpression)Expr_84_list.get(0);
		Assert.assertNotNull(AndExpression_85_Var);
		final EList<? extends EObject> Expr_85_list = AndExpression_85_Var.getExpr();
		Assert.assertNotNull(Expr_85_list);
		Assert.assertEquals(1, Expr_85_list.size());
		final EqualityExpression EqualityExpression_86_Var = (EqualityExpression)Expr_85_list.get(0);
		Assert.assertNotNull(EqualityExpression_86_Var);
		final EList<? extends EObject> Expr_86_list = EqualityExpression_86_Var.getExpr();
		Assert.assertNotNull(Expr_86_list);
		Assert.assertEquals(1, Expr_86_list.size());
		final RelationalExpression RelationalExpression_87_Var = (RelationalExpression)Expr_86_list.get(0);
		Assert.assertNotNull(RelationalExpression_87_Var);
		final EList<? extends EObject> Expr_87_list = RelationalExpression_87_Var.getExpr();
		Assert.assertNotNull(Expr_87_list);
		Assert.assertEquals(1, Expr_87_list.size());
		final ShiftExpression ShiftExpression_88_Var = (ShiftExpression)Expr_87_list.get(0);
		Assert.assertNotNull(ShiftExpression_88_Var);
		final EList<? extends EObject> Expr_88_list = ShiftExpression_88_Var.getExpr();
		Assert.assertNotNull(Expr_88_list);
		Assert.assertEquals(1, Expr_88_list.size());
		final AdditiveExpression AdditiveExpression_89_Var = (AdditiveExpression)Expr_88_list.get(0);
		Assert.assertNotNull(AdditiveExpression_89_Var);
		final EList<? extends EObject> Expr_89_list = AdditiveExpression_89_Var.getExpr();
		Assert.assertNotNull(Expr_89_list);
		Assert.assertEquals(1, Expr_89_list.size());
		final MultiplicativeExpression MultiplicativeExpression_90_Var = (MultiplicativeExpression)Expr_89_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_90_Var);
		final EList<? extends EObject> Expr_90_list = MultiplicativeExpression_90_Var.getExpr();
		Assert.assertNotNull(Expr_90_list);
		Assert.assertEquals(1, Expr_90_list.size());
		final CastExpression CastExpression_91_Var = (CastExpression)Expr_90_list.get(0);
		Assert.assertNotNull(CastExpression_91_Var);
		final UnaryExpression UnaryExpression_92_Var = (UnaryExpression)CastExpression_91_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_92_Var);
		final PostfixExpression PostfixExpression_93_Var = (PostfixExpression)UnaryExpression_92_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_93_Var);
		final EList<? extends EObject> Expr_93_list = PostfixExpression_93_Var.getExpr();
		Assert.assertNotNull(Expr_93_list);
		Assert.assertEquals(1, Expr_93_list.size());
		final PrimaryExpression PrimaryExpression_94_Var = (PrimaryExpression)Expr_93_list.get(0);
		Assert.assertNotNull(PrimaryExpression_94_Var);
		Assert.assertEquals("number", PrimaryExpression_94_Var.getId());
		final EList<? extends EObject> Statement_94_list = BlockList_46_Var.getStatement();
		Assert.assertNotNull(Statement_94_list);
		Assert.assertEquals(11, Statement_94_list.size());
		final Statement Statement_95_Var = (Statement)Statement_94_list.get(0);
		Assert.assertNotNull(Statement_95_Var);
		final ExpressionStatement ExpressionStatement_96_Var = (ExpressionStatement)Statement_95_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_96_Var);
		final Expression Expression_97_Var = (Expression)ExpressionStatement_96_Var.getExpression();
		Assert.assertNotNull(Expression_97_Var);
		final EList<? extends EObject> ExprExpr_97_list = Expression_97_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_97_list);
		Assert.assertEquals(1, ExprExpr_97_list.size());
		final AssignmentExpression AssignmentExpression_98_Var = (AssignmentExpression)ExprExpr_97_list.get(0);
		Assert.assertNotNull(AssignmentExpression_98_Var);
		final ConditionalExpression ConditionalExpression_99_Var = (ConditionalExpression)AssignmentExpression_98_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_99_Var);
		final LogicalOrExpression LogicalOrExpression_100_Var = (LogicalOrExpression)ConditionalExpression_99_Var.getExpr();
		...
		Assert.assertEquals("printf", PrimaryExpression_113_Var.getId());
		final EList<? extends EObject> ArgumentExpressionList_113_list = PostfixExpression_112_Var.getArgumentExpressionList();
		Assert.assertNotNull(ArgumentExpressionList_113_list);
		Assert.assertEquals(1, ArgumentExpressionList_113_list.size());
		final ArgumentExpressionList ArgumentExpressionList_114_Var = (ArgumentExpressionList)ArgumentExpressionList_113_list.get(0);
		Assert.assertNotNull(ArgumentExpressionList_114_Var);
		final EList<? extends EObject> Expr_114_list = ArgumentExpressionList_114_Var.getExpr();
		Assert.assertNotNull(Expr_114_list);
		Assert.assertEquals(2, Expr_114_list.size());
		final AssignmentExpression AssignmentExpression_115_Var = (AssignmentExpression)Expr_114_list.get(0);
		Assert.assertNotNull(AssignmentExpression_115_Var);
		final ConditionalExpression ConditionalExpression_116_Var = (ConditionalExpression)AssignmentExpression_115_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_116_Var);
		final LogicalOrExpression LogicalOrExpression_117_Var = (LogicalOrExpression)ConditionalExpression_116_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_117_Var);
		final EList<? extends EObject> Expr_117_list = LogicalOrExpression_117_Var.getExpr();
		Assert.assertNotNull(Expr_117_list);
		Assert.assertEquals(1, Expr_117_list.size());
		final LogicalAndExpression LogicalAndExpression_118_Var = (LogicalAndExpression)Expr_117_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_118_Var);
		final EList<? extends EObject> Expr_118_list = LogicalAndExpression_118_Var.getExpr();
		Assert.assertNotNull(Expr_118_list);
		Assert.assertEquals(1, Expr_118_list.size());
		final InclusiveOrExpression InclusiveOrExpression_119_Var = (InclusiveOrExpression)Expr_118_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_119_Var);
		final EList<? extends EObject> Expr_119_list = InclusiveOrExpression_119_Var.getExpr();
		Assert.assertNotNull(Expr_119_list);
		Assert.assertEquals(1, Expr_119_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_120_Var = (ExclusiveOrExpression)Expr_119_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_120_Var);
		final EList<? extends EObject> Expr_120_list = ExclusiveOrExpression_120_Var.getExpr();
		Assert.assertNotNull(Expr_120_list);
		Assert.assertEquals(1, Expr_120_list.size());
		final AndExpression AndExpression_121_Var = (AndExpression)Expr_120_list.get(0);
		Assert.assertNotNull(AndExpression_121_Var);
		final EList<? extends EObject> Expr_121_list = AndExpression_121_Var.getExpr();
		Assert.assertNotNull(Expr_121_list);
		Assert.assertEquals(1, Expr_121_list.size());
		final EqualityExpression EqualityExpression_122_Var = (EqualityExpression)Expr_121_list.get(0);
		Assert.assertNotNull(EqualityExpression_122_Var);
		final EList<? extends EObject> Expr_122_list = EqualityExpression_122_Var.getExpr();
		Assert.assertNotNull(Expr_122_list);
		Assert.assertEquals(1, Expr_122_list.size());
		final RelationalExpression RelationalExpression_123_Var = (RelationalExpression)Expr_122_list.get(0);
		Assert.assertNotNull(RelationalExpression_123_Var);
		final EList<? extends EObject> Expr_123_list = RelationalExpression_123_Var.getExpr();
		Assert.assertNotNull(Expr_123_list);
		Assert.assertEquals(1, Expr_123_list.size());
		final ShiftExpression ShiftExpression_124_Var = (ShiftExpression)Expr_123_list.get(0);
		Assert.assertNotNull(ShiftExpression_124_Var);
		final EList<? extends EObject> Expr_124_list = ShiftExpression_124_Var.getExpr();
		Assert.assertNotNull(Expr_124_list);
		Assert.assertEquals(1, Expr_124_list.size());
		final AdditiveExpression AdditiveExpression_125_Var = (AdditiveExpression)Expr_124_list.get(0);
		Assert.assertNotNull(AdditiveExpression_125_Var);
		final EList<? extends EObject> Expr_125_list = AdditiveExpression_125_Var.getExpr();
		Assert.assertNotNull(Expr_125_list);
		Assert.assertEquals(1, Expr_125_list.size());
		final MultiplicativeExpression MultiplicativeExpression_126_Var = (MultiplicativeExpression)Expr_125_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_126_Var);
		final EList<? extends EObject> Expr_126_list = MultiplicativeExpression_126_Var.getExpr();
		Assert.assertNotNull(Expr_126_list);
		Assert.assertEquals(1, Expr_126_list.size());
		final CastExpression CastExpression_127_Var = (CastExpression)Expr_126_list.get(0);
		Assert.assertNotNull(CastExpression_127_Var);
		final UnaryExpression UnaryExpression_128_Var = (UnaryExpression)CastExpression_127_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_128_Var);
		final PostfixExpression PostfixExpression_129_Var = (PostfixExpression)UnaryExpression_128_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_129_Var);
		final EList<? extends EObject> Expr_129_list = PostfixExpression_129_Var.getExpr();
		Assert.assertNotNull(Expr_129_list);
		Assert.assertEquals(1, Expr_129_list.size());
		final PrimaryExpression PrimaryExpression_130_Var = (PrimaryExpression)Expr_129_list.get(0);
		Assert.assertNotNull(PrimaryExpression_130_Var);
		final Constant Constant_131_Var = (Constant)PrimaryExpression_130_Var.getConst();
		Assert.assertNotNull(Constant_131_Var);
		Assert.assertEquals("\"sizeof(number)=%lu\\n\"", Constant_131_Var.getStr());
		final AssignmentExpression AssignmentExpression_132_Var = (AssignmentExpression)Expr_114_list.get(1);
		Assert.assertNotNull(AssignmentExpression_132_Var);
		final ConditionalExpression ConditionalExpression_133_Var = (ConditionalExpression)AssignmentExpression_132_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_133_Var);
		final LogicalOrExpression LogicalOrExpression_134_Var = (LogicalOrExpression)ConditionalExpression_133_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_134_Var);
		final EList<? extends EObject> Expr_134_list = LogicalOrExpression_134_Var.getExpr();
		Assert.assertNotNull(Expr_134_list);
		Assert.assertEquals(1, Expr_134_list.size());
		final LogicalAndExpression LogicalAndExpression_135_Var = (LogicalAndExpression)Expr_134_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_135_Var);
		final EList<? extends EObject> Expr_135_list = LogicalAndExpression_135_Var.getExpr();
		Assert.assertNotNull(Expr_135_list);
		Assert.assertEquals(1, Expr_135_list.size());
		final InclusiveOrExpression InclusiveOrExpression_136_Var = (InclusiveOrExpression)Expr_135_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_136_Var);
		final EList<? extends EObject> Expr_136_list = InclusiveOrExpression_136_Var.getExpr();
		Assert.assertNotNull(Expr_136_list);
		Assert.assertEquals(1, Expr_136_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_137_Var = (ExclusiveOrExpression)Expr_136_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_137_Var);
		final EList<? extends EObject> Expr_137_list = ExclusiveOrExpression_137_Var.getExpr();
		Assert.assertNotNull(Expr_137_list);
		Assert.assertEquals(1, Expr_137_list.size());
		final AndExpression AndExpression_138_Var = (AndExpression)Expr_137_list.get(0);
		Assert.assertNotNull(AndExpression_138_Var);
		final EList<? extends EObject> Expr_138_list = AndExpression_138_Var.getExpr();
		Assert.assertNotNull(Expr_138_list);
		Assert.assertEquals(1, Expr_138_list.size());
		final EqualityExpression EqualityExpression_139_Var = (EqualityExpression)Expr_138_list.get(0);
		Assert.assertNotNull(EqualityExpression_139_Var);
		final EList<? extends EObject> Expr_139_list = EqualityExpression_139_Var.getExpr();
		Assert.assertNotNull(Expr_139_list);
		Assert.assertEquals(1, Expr_139_list.size());
		final RelationalExpression RelationalExpression_140_Var = (RelationalExpression)Expr_139_list.get(0);
		Assert.assertNotNull(RelationalExpression_140_Var);
		final EList<? extends EObject> Expr_140_list = RelationalExpression_140_Var.getExpr();
		Assert.assertNotNull(Expr_140_list);
		Assert.assertEquals(1, Expr_140_list.size());
		final ShiftExpression ShiftExpression_141_Var = (ShiftExpression)Expr_140_list.get(0);
		Assert.assertNotNull(ShiftExpression_141_Var);
		final EList<? extends EObject> Expr_141_list = ShiftExpression_141_Var.getExpr();
		Assert.assertNotNull(Expr_141_list);
		Assert.assertEquals(1, Expr_141_list.size());
		final AdditiveExpression AdditiveExpression_142_Var = (AdditiveExpression)Expr_141_list.get(0);
		Assert.assertNotNull(AdditiveExpression_142_Var);
		final EList<? extends EObject> Expr_142_list = AdditiveExpression_142_Var.getExpr();
		Assert.assertNotNull(Expr_142_list);
		Assert.assertEquals(1, Expr_142_list.size());
		final MultiplicativeExpression MultiplicativeExpression_143_Var = (MultiplicativeExpression)Expr_142_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_143_Var);
		final EList<? extends EObject> Expr_143_list = MultiplicativeExpression_143_Var.getExpr();
		Assert.assertNotNull(Expr_143_list);
		Assert.assertEquals(1, Expr_143_list.size());
		final CastExpression CastExpression_144_Var = (CastExpression)Expr_143_list.get(0);
		Assert.assertNotNull(CastExpression_144_Var);
		final UnaryExpression UnaryExpression_145_Var = (UnaryExpression)CastExpression_144_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_145_Var);
		final PostfixExpression PostfixExpression_146_Var = (PostfixExpression)UnaryExpression_145_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_146_Var);
		final EList<? extends EObject> Expr_146_list = PostfixExpression_146_Var.getExpr();
		Assert.assertNotNull(Expr_146_list);
		Assert.assertEquals(1, Expr_146_list.size());
		final PrimaryExpression PrimaryExpression_147_Var = (PrimaryExpression)Expr_146_list.get(0);
		Assert.assertNotNull(PrimaryExpression_147_Var);
		Assert.assertEquals("size", PrimaryExpression_147_Var.getId());
		Assert.assertEquals(";", ExpressionStatement_96_Var.getSemi());
		final Statement Statement_148_Var = (Statement)Statement_94_list.get(1);
		Assert.assertNotNull(Statement_148_Var);
		final ExpressionStatement ExpressionStatement_149_Var = (ExpressionStatement)Statement_148_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_149_Var);
		final Expression Expression_150_Var = (Expression)ExpressionStatement_149_Var.getExpression();
		Assert.assertNotNull(Expression_150_Var);
		final EList<? extends EObject> ExprExpr_150_list = Expression_150_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_150_list);
		Assert.assertEquals(1, ExprExpr_150_list.size());
		final AssignmentExpression AssignmentExpression_151_Var = (AssignmentExpression)ExprExpr_150_list.get(0);
		...
		Assert.assertEquals("printf", PrimaryExpression_166_Var.getId());
		final EList<? extends EObject> ArgumentExpressionList_166_list = PostfixExpression_165_Var.getArgumentExpressionList();
		Assert.assertNotNull(ArgumentExpressionList_166_list);
		Assert.assertEquals(1, ArgumentExpressionList_166_list.size());
		final ArgumentExpressionList ArgumentExpressionList_167_Var = (ArgumentExpressionList)ArgumentExpressionList_166_list.get(0);
		Assert.assertNotNull(ArgumentExpressionList_167_Var);
		final EList<? extends EObject> Expr_167_list = ArgumentExpressionList_167_Var.getExpr();
		Assert.assertNotNull(Expr_167_list);
		Assert.assertEquals(2, Expr_167_list.size());
		final AssignmentExpression AssignmentExpression_168_Var = (AssignmentExpression)Expr_167_list.get(0);
		Assert.assertNotNull(AssignmentExpression_168_Var);
		final ConditionalExpression ConditionalExpression_169_Var = (ConditionalExpression)AssignmentExpression_168_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_169_Var);
		final LogicalOrExpression LogicalOrExpression_170_Var = (LogicalOrExpression)ConditionalExpression_169_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_170_Var);
		final EList<? extends EObject> Expr_170_list = LogicalOrExpression_170_Var.getExpr();
		Assert.assertNotNull(Expr_170_list);
		Assert.assertEquals(1, Expr_170_list.size());
		final LogicalAndExpression LogicalAndExpression_171_Var = (LogicalAndExpression)Expr_170_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_171_Var);
		final EList<? extends EObject> Expr_171_list = LogicalAndExpression_171_Var.getExpr();
		Assert.assertNotNull(Expr_171_list);
		Assert.assertEquals(1, Expr_171_list.size());
		final InclusiveOrExpression InclusiveOrExpression_172_Var = (InclusiveOrExpression)Expr_171_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_172_Var);
		final EList<? extends EObject> Expr_172_list = InclusiveOrExpression_172_Var.getExpr();
		Assert.assertNotNull(Expr_172_list);
		Assert.assertEquals(1, Expr_172_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_173_Var = (ExclusiveOrExpression)Expr_172_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_173_Var);
		final EList<? extends EObject> Expr_173_list = ExclusiveOrExpression_173_Var.getExpr();
		Assert.assertNotNull(Expr_173_list);
		Assert.assertEquals(1, Expr_173_list.size());
		final AndExpression AndExpression_174_Var = (AndExpression)Expr_173_list.get(0);
		Assert.assertNotNull(AndExpression_174_Var);
		final EList<? extends EObject> Expr_174_list = AndExpression_174_Var.getExpr();
		Assert.assertNotNull(Expr_174_list);
		Assert.assertEquals(1, Expr_174_list.size());
		final EqualityExpression EqualityExpression_175_Var = (EqualityExpression)Expr_174_list.get(0);
		Assert.assertNotNull(EqualityExpression_175_Var);
		final EList<? extends EObject> Expr_175_list = EqualityExpression_175_Var.getExpr();
		Assert.assertNotNull(Expr_175_list);
		Assert.assertEquals(1, Expr_175_list.size());
		final RelationalExpression RelationalExpression_176_Var = (RelationalExpression)Expr_175_list.get(0);
		Assert.assertNotNull(RelationalExpression_176_Var);
		final EList<? extends EObject> Expr_176_list = RelationalExpression_176_Var.getExpr();
		Assert.assertNotNull(Expr_176_list);
		Assert.assertEquals(1, Expr_176_list.size());
		final ShiftExpression ShiftExpression_177_Var = (ShiftExpression)Expr_176_list.get(0);
		Assert.assertNotNull(ShiftExpression_177_Var);
		final EList<? extends EObject> Expr_177_list = ShiftExpression_177_Var.getExpr();
		Assert.assertNotNull(Expr_177_list);
		Assert.assertEquals(1, Expr_177_list.size());
		final AdditiveExpression AdditiveExpression_178_Var = (AdditiveExpression)Expr_177_list.get(0);
		Assert.assertNotNull(AdditiveExpression_178_Var);
		final EList<? extends EObject> Expr_178_list = AdditiveExpression_178_Var.getExpr();
		Assert.assertNotNull(Expr_178_list);
		Assert.assertEquals(1, Expr_178_list.size());
		final MultiplicativeExpression MultiplicativeExpression_179_Var = (MultiplicativeExpression)Expr_178_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_179_Var);
		final EList<? extends EObject> Expr_179_list = MultiplicativeExpression_179_Var.getExpr();
		Assert.assertNotNull(Expr_179_list);
		Assert.assertEquals(1, Expr_179_list.size());
		final CastExpression CastExpression_180_Var = (CastExpression)Expr_179_list.get(0);
		Assert.assertNotNull(CastExpression_180_Var);
		final UnaryExpression UnaryExpression_181_Var = (UnaryExpression)CastExpression_180_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_181_Var);
		final PostfixExpression PostfixExpression_182_Var = (PostfixExpression)UnaryExpression_181_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_182_Var);
		final EList<? extends EObject> Expr_182_list = PostfixExpression_182_Var.getExpr();
		Assert.assertNotNull(Expr_182_list);
		Assert.assertEquals(1, Expr_182_list.size());
		final PrimaryExpression PrimaryExpression_183_Var = (PrimaryExpression)Expr_182_list.get(0);
		Assert.assertNotNull(PrimaryExpression_183_Var);
		final Constant Constant_184_Var = (Constant)PrimaryExpression_183_Var.getConst();
		Assert.assertNotNull(Constant_184_Var);
		Assert.assertEquals("\"sizeof(number.numChar)=%lu\\n\"", Constant_184_Var.getStr());
		final AssignmentExpression AssignmentExpression_185_Var = (AssignmentExpression)Expr_167_list.get(1);
		Assert.assertNotNull(AssignmentExpression_185_Var);
		final ConditionalExpression ConditionalExpression_186_Var = (ConditionalExpression)AssignmentExpression_185_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_186_Var);
		final LogicalOrExpression LogicalOrExpression_187_Var = (LogicalOrExpression)ConditionalExpression_186_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_187_Var);
		final EList<? extends EObject> Expr_187_list = LogicalOrExpression_187_Var.getExpr();
		Assert.assertNotNull(Expr_187_list);
		Assert.assertEquals(1, Expr_187_list.size());
		final LogicalAndExpression LogicalAndExpression_188_Var = (LogicalAndExpression)Expr_187_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_188_Var);
		final EList<? extends EObject> Expr_188_list = LogicalAndExpression_188_Var.getExpr();
		Assert.assertNotNull(Expr_188_list);
		Assert.assertEquals(1, Expr_188_list.size());
		final InclusiveOrExpression InclusiveOrExpression_189_Var = (InclusiveOrExpression)Expr_188_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_189_Var);
		final EList<? extends EObject> Expr_189_list = InclusiveOrExpression_189_Var.getExpr();
		Assert.assertNotNull(Expr_189_list);
		Assert.assertEquals(1, Expr_189_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_190_Var = (ExclusiveOrExpression)Expr_189_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_190_Var);
		final EList<? extends EObject> Expr_190_list = ExclusiveOrExpression_190_Var.getExpr();
		Assert.assertNotNull(Expr_190_list);
		Assert.assertEquals(1, Expr_190_list.size());
		final AndExpression AndExpression_191_Var = (AndExpression)Expr_190_list.get(0);
		Assert.assertNotNull(AndExpression_191_Var);
		final EList<? extends EObject> Expr_191_list = AndExpression_191_Var.getExpr();
		Assert.assertNotNull(Expr_191_list);
		Assert.assertEquals(1, Expr_191_list.size());
		final EqualityExpression EqualityExpression_192_Var = (EqualityExpression)Expr_191_list.get(0);
		Assert.assertNotNull(EqualityExpression_192_Var);
		final EList<? extends EObject> Expr_192_list = EqualityExpression_192_Var.getExpr();
		Assert.assertNotNull(Expr_192_list);
		Assert.assertEquals(1, Expr_192_list.size());
		final RelationalExpression RelationalExpression_193_Var = (RelationalExpression)Expr_192_list.get(0);
		Assert.assertNotNull(RelationalExpression_193_Var);
		final EList<? extends EObject> Expr_193_list = RelationalExpression_193_Var.getExpr();
		Assert.assertNotNull(Expr_193_list);
		Assert.assertEquals(1, Expr_193_list.size());
		final ShiftExpression ShiftExpression_194_Var = (ShiftExpression)Expr_193_list.get(0);
		Assert.assertNotNull(ShiftExpression_194_Var);
		final EList<? extends EObject> Expr_194_list = ShiftExpression_194_Var.getExpr();
		Assert.assertNotNull(Expr_194_list);
		Assert.assertEquals(1, Expr_194_list.size());
		final AdditiveExpression AdditiveExpression_195_Var = (AdditiveExpression)Expr_194_list.get(0);
		Assert.assertNotNull(AdditiveExpression_195_Var);
		final EList<? extends EObject> Expr_195_list = AdditiveExpression_195_Var.getExpr();
		Assert.assertNotNull(Expr_195_list);
		Assert.assertEquals(1, Expr_195_list.size());
		final MultiplicativeExpression MultiplicativeExpression_196_Var = (MultiplicativeExpression)Expr_195_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_196_Var);
		final EList<? extends EObject> Expr_196_list = MultiplicativeExpression_196_Var.getExpr();
		Assert.assertNotNull(Expr_196_list);
		Assert.assertEquals(1, Expr_196_list.size());
		final CastExpression CastExpression_197_Var = (CastExpression)Expr_196_list.get(0);
		Assert.assertNotNull(CastExpression_197_Var);
		final UnaryExpression UnaryExpression_198_Var = (UnaryExpression)CastExpression_197_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_198_Var);
		Assert.assertEquals("sizeof", UnaryExpression_198_Var.getSizeOf());
		final UnaryExpression UnaryExpression_199_Var = (UnaryExpression)UnaryExpression_198_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_199_Var);
		final PostfixExpression PostfixExpression_200_Var = (PostfixExpression)UnaryExpression_199_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_200_Var);
		final EList<? extends EObject> Expr_200_list = PostfixExpression_200_Var.getExpr();
		Assert.assertNotNull(Expr_200_list);
		Assert.assertEquals(1, Expr_200_list.size());
		final PrimaryExpression PrimaryExpression_201_Var = (PrimaryExpression)Expr_200_list.get(0);
		Assert.assertNotNull(PrimaryExpression_201_Var);
		final Expression Expression_202_Var = (Expression)PrimaryExpression_201_Var.getExpr();
		Assert.assertNotNull(Expression_202_Var);
		final EList<? extends EObject> ExprExpr_202_list = Expression_202_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_202_list);
		Assert.assertEquals(1, ExprExpr_202_list.size());
		final AssignmentExpression AssignmentExpression_203_Var = (AssignmentExpression)ExprExpr_202_list.get(0);
		Assert.assertNotNull(AssignmentExpression_203_Var);
		final ConditionalExpression ConditionalExpression_204_Var = (ConditionalExpression)AssignmentExpression_203_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_204_Var);
		final LogicalOrExpression LogicalOrExpression_205_Var = (LogicalOrExpression)ConditionalExpression_204_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_205_Var);
		final EList<? extends EObject> Expr_205_list = LogicalOrExpression_205_Var.getExpr();
		Assert.assertNotNull(Expr_205_list);
		Assert.assertEquals(1, Expr_205_list.size());
		final LogicalAndExpression LogicalAndExpression_206_Var = (LogicalAndExpression)Expr_205_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_206_Var);
		final EList<? extends EObject> Expr_206_list = LogicalAndExpression_206_Var.getExpr();
		Assert.assertNotNull(Expr_206_list);
		Assert.assertEquals(1, Expr_206_list.size());
		final InclusiveOrExpression InclusiveOrExpression_207_Var = (InclusiveOrExpression)Expr_206_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_207_Var);
		final EList<? extends EObject> Expr_207_list = InclusiveOrExpression_207_Var.getExpr();
		Assert.assertNotNull(Expr_207_list);
		Assert.assertEquals(1, Expr_207_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_208_Var = (ExclusiveOrExpression)Expr_207_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_208_Var);
		final EList<? extends EObject> Expr_208_list = ExclusiveOrExpression_208_Var.getExpr();
		Assert.assertNotNull(Expr_208_list);
		Assert.assertEquals(1, Expr_208_list.size());
		final AndExpression AndExpression_209_Var = (AndExpression)Expr_208_list.get(0);
		Assert.assertNotNull(AndExpression_209_Var);
		final EList<? extends EObject> Expr_209_list = AndExpression_209_Var.getExpr();
		Assert.assertNotNull(Expr_209_list);
		Assert.assertEquals(1, Expr_209_list.size());
		final EqualityExpression EqualityExpression_210_Var = (EqualityExpression)Expr_209_list.get(0);
		Assert.assertNotNull(EqualityExpression_210_Var);
		final EList<? extends EObject> Expr_210_list = EqualityExpression_210_Var.getExpr();
		Assert.assertNotNull(Expr_210_list);
		Assert.assertEquals(1, Expr_210_list.size());
		final RelationalExpression RelationalExpression_211_Var = (RelationalExpression)Expr_210_list.get(0);
		Assert.assertNotNull(RelationalExpression_211_Var);
		final EList<? extends EObject> Expr_211_list = RelationalExpression_211_Var.getExpr();
		Assert.assertNotNull(Expr_211_list);
		Assert.assertEquals(1, Expr_211_list.size());
		final ShiftExpression ShiftExpression_212_Var = (ShiftExpression)Expr_211_list.get(0);
		Assert.assertNotNull(ShiftExpression_212_Var);
		final EList<? extends EObject> Expr_212_list = ShiftExpression_212_Var.getExpr();
		Assert.assertNotNull(Expr_212_list);
		Assert.assertEquals(1, Expr_212_list.size());
		final AdditiveExpression AdditiveExpression_213_Var = (AdditiveExpression)Expr_212_list.get(0);
		Assert.assertNotNull(AdditiveExpression_213_Var);
		final EList<? extends EObject> Expr_213_list = AdditiveExpression_213_Var.getExpr();
		Assert.assertNotNull(Expr_213_list);
		Assert.assertEquals(1, Expr_213_list.size());
		final MultiplicativeExpression MultiplicativeExpression_214_Var = (MultiplicativeExpression)Expr_213_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_214_Var);
		final EList<? extends EObject> Expr_214_list = MultiplicativeExpression_214_Var.getExpr();
		Assert.assertNotNull(Expr_214_list);
		Assert.assertEquals(1, Expr_214_list.size());
		final CastExpression CastExpression_215_Var = (CastExpression)Expr_214_list.get(0);
		Assert.assertNotNull(CastExpression_215_Var);
		final UnaryExpression UnaryExpression_216_Var = (UnaryExpression)CastExpression_215_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_216_Var);
		final PostfixExpression PostfixExpression_217_Var = (PostfixExpression)UnaryExpression_216_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_217_Var);
		final EList<? extends EObject> Expr_217_list = PostfixExpression_217_Var.getExpr();
		Assert.assertNotNull(Expr_217_list);
		Assert.assertEquals(1, Expr_217_list.size());
		final PrimaryExpression PrimaryExpression_218_Var = (PrimaryExpression)Expr_217_list.get(0);
		Assert.assertNotNull(PrimaryExpression_218_Var);
		Assert.assertEquals("number", PrimaryExpression_218_Var.getId());
		Assert.assertEquals("[.]", PostfixExpression_217_Var.getDot().toString());
		Assert.assertEquals("[numChar]", PostfixExpression_217_Var.getId().toString());
		Assert.assertEquals(";", ExpressionStatement_149_Var.getSemi());
		final Statement Statement_219_Var = (Statement)Statement_94_list.get(2);
		Assert.assertNotNull(Statement_219_Var);
		final ExpressionStatement ExpressionStatement_220_Var = (ExpressionStatement)Statement_219_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_220_Var);
		final Expression Expression_221_Var = (Expression)ExpressionStatement_220_Var.getExpression();
		Assert.assertNotNull(Expression_221_Var);
		final EList<? extends EObject> ExprExpr_221_list = Expression_221_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_221_list);
		Assert.assertEquals(1, ExprExpr_221_list.size());
		final AssignmentExpression AssignmentExpression_222_Var = (AssignmentExpression)ExprExpr_221_list.get(0);
		Assert.assertNotNull(AssignmentExpression_222_Var);
		final ConditionalExpression ConditionalExpression_223_Var = (ConditionalExpression)AssignmentExpression_222_Var.getExpr();
		...
		Assert.assertEquals("printf", PrimaryExpression_237_Var.getId());
		final EList<? extends EObject> ArgumentExpressionList_237_list = PostfixExpression_236_Var.getArgumentExpressionList();
		Assert.assertNotNull(ArgumentExpressionList_237_list);
		Assert.assertEquals(1, ArgumentExpressionList_237_list.size());
		final ArgumentExpressionList ArgumentExpressionList_238_Var = (ArgumentExpressionList)ArgumentExpressionList_237_list.get(0);
		Assert.assertNotNull(ArgumentExpressionList_238_Var);
		final EList<? extends EObject> Expr_238_list = ArgumentExpressionList_238_Var.getExpr();
		Assert.assertNotNull(Expr_238_list);
		Assert.assertEquals(2, Expr_238_list.size());
		final AssignmentExpression AssignmentExpression_239_Var = (AssignmentExpression)Expr_238_list.get(0);
		Assert.assertNotNull(AssignmentExpression_239_Var);
		final ConditionalExpression ConditionalExpression_240_Var = (ConditionalExpression)AssignmentExpression_239_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_240_Var);
		final LogicalOrExpression LogicalOrExpression_241_Var = (LogicalOrExpression)ConditionalExpression_240_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_241_Var);
		final EList<? extends EObject> Expr_241_list = LogicalOrExpression_241_Var.getExpr();
		Assert.assertNotNull(Expr_241_list);
		Assert.assertEquals(1, Expr_241_list.size());
		final LogicalAndExpression LogicalAndExpression_242_Var = (LogicalAndExpression)Expr_241_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_242_Var);
		final EList<? extends EObject> Expr_242_list = LogicalAndExpression_242_Var.getExpr();
		Assert.assertNotNull(Expr_242_list);
		Assert.assertEquals(1, Expr_242_list.size());
		final InclusiveOrExpression InclusiveOrExpression_243_Var = (InclusiveOrExpression)Expr_242_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_243_Var);
		final EList<? extends EObject> Expr_243_list = InclusiveOrExpression_243_Var.getExpr();
		Assert.assertNotNull(Expr_243_list);
		Assert.assertEquals(1, Expr_243_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_244_Var = (ExclusiveOrExpression)Expr_243_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_244_Var);
		final EList<? extends EObject> Expr_244_list = ExclusiveOrExpression_244_Var.getExpr();
		Assert.assertNotNull(Expr_244_list);
		Assert.assertEquals(1, Expr_244_list.size());
		final AndExpression AndExpression_245_Var = (AndExpression)Expr_244_list.get(0);
		Assert.assertNotNull(AndExpression_245_Var);
		final EList<? extends EObject> Expr_245_list = AndExpression_245_Var.getExpr();
		Assert.assertNotNull(Expr_245_list);
		Assert.assertEquals(1, Expr_245_list.size());
		final EqualityExpression EqualityExpression_246_Var = (EqualityExpression)Expr_245_list.get(0);
		Assert.assertNotNull(EqualityExpression_246_Var);
		final EList<? extends EObject> Expr_246_list = EqualityExpression_246_Var.getExpr();
		Assert.assertNotNull(Expr_246_list);
		Assert.assertEquals(1, Expr_246_list.size());
		final RelationalExpression RelationalExpression_247_Var = (RelationalExpression)Expr_246_list.get(0);
		Assert.assertNotNull(RelationalExpression_247_Var);
		final EList<? extends EObject> Expr_247_list = RelationalExpression_247_Var.getExpr();
		Assert.assertNotNull(Expr_247_list);
		Assert.assertEquals(1, Expr_247_list.size());
		final ShiftExpression ShiftExpression_248_Var = (ShiftExpression)Expr_247_list.get(0);
		Assert.assertNotNull(ShiftExpression_248_Var);
		final EList<? extends EObject> Expr_248_list = ShiftExpression_248_Var.getExpr();
		Assert.assertNotNull(Expr_248_list);
		Assert.assertEquals(1, Expr_248_list.size());
		final AdditiveExpression AdditiveExpression_249_Var = (AdditiveExpression)Expr_248_list.get(0);
		Assert.assertNotNull(AdditiveExpression_249_Var);
		final EList<? extends EObject> Expr_249_list = AdditiveExpression_249_Var.getExpr();
		Assert.assertNotNull(Expr_249_list);
		Assert.assertEquals(1, Expr_249_list.size());
		final MultiplicativeExpression MultiplicativeExpression_250_Var = (MultiplicativeExpression)Expr_249_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_250_Var);
		final EList<? extends EObject> Expr_250_list = MultiplicativeExpression_250_Var.getExpr();
		Assert.assertNotNull(Expr_250_list);
		Assert.assertEquals(1, Expr_250_list.size());
		final CastExpression CastExpression_251_Var = (CastExpression)Expr_250_list.get(0);
		Assert.assertNotNull(CastExpression_251_Var);
		final UnaryExpression UnaryExpression_252_Var = (UnaryExpression)CastExpression_251_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_252_Var);
		final PostfixExpression PostfixExpression_253_Var = (PostfixExpression)UnaryExpression_252_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_253_Var);
		final EList<? extends EObject> Expr_253_list = PostfixExpression_253_Var.getExpr();
		Assert.assertNotNull(Expr_253_list);
		Assert.assertEquals(1, Expr_253_list.size());
		final PrimaryExpression PrimaryExpression_254_Var = (PrimaryExpression)Expr_253_list.get(0);
		Assert.assertNotNull(PrimaryExpression_254_Var);
		final Constant Constant_255_Var = (Constant)PrimaryExpression_254_Var.getConst();
		Assert.assertNotNull(Constant_255_Var);
		Assert.assertEquals("\"sizeof(float)=%lu\\n\"", Constant_255_Var.getStr());
		final AssignmentExpression AssignmentExpression_256_Var = (AssignmentExpression)Expr_238_list.get(1);
		Assert.assertNotNull(AssignmentExpression_256_Var);
		final ConditionalExpression ConditionalExpression_257_Var = (ConditionalExpression)AssignmentExpression_256_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_257_Var);
		final LogicalOrExpression LogicalOrExpression_258_Var = (LogicalOrExpression)ConditionalExpression_257_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_258_Var);
		final EList<? extends EObject> Expr_258_list = LogicalOrExpression_258_Var.getExpr();
		Assert.assertNotNull(Expr_258_list);
		Assert.assertEquals(1, Expr_258_list.size());
		final LogicalAndExpression LogicalAndExpression_259_Var = (LogicalAndExpression)Expr_258_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_259_Var);
		final EList<? extends EObject> Expr_259_list = LogicalAndExpression_259_Var.getExpr();
		Assert.assertNotNull(Expr_259_list);
		Assert.assertEquals(1, Expr_259_list.size());
		final InclusiveOrExpression InclusiveOrExpression_260_Var = (InclusiveOrExpression)Expr_259_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_260_Var);
		final EList<? extends EObject> Expr_260_list = InclusiveOrExpression_260_Var.getExpr();
		Assert.assertNotNull(Expr_260_list);
		Assert.assertEquals(1, Expr_260_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_261_Var = (ExclusiveOrExpression)Expr_260_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_261_Var);
		final EList<? extends EObject> Expr_261_list = ExclusiveOrExpression_261_Var.getExpr();
		Assert.assertNotNull(Expr_261_list);
		Assert.assertEquals(1, Expr_261_list.size());
		final AndExpression AndExpression_262_Var = (AndExpression)Expr_261_list.get(0);
		Assert.assertNotNull(AndExpression_262_Var);
		final EList<? extends EObject> Expr_262_list = AndExpression_262_Var.getExpr();
		Assert.assertNotNull(Expr_262_list);
		Assert.assertEquals(1, Expr_262_list.size());
		final EqualityExpression EqualityExpression_263_Var = (EqualityExpression)Expr_262_list.get(0);
		Assert.assertNotNull(EqualityExpression_263_Var);
		final EList<? extends EObject> Expr_263_list = EqualityExpression_263_Var.getExpr();
		Assert.assertNotNull(Expr_263_list);
		Assert.assertEquals(1, Expr_263_list.size());
		final RelationalExpression RelationalExpression_264_Var = (RelationalExpression)Expr_263_list.get(0);
		Assert.assertNotNull(RelationalExpression_264_Var);
		final EList<? extends EObject> Expr_264_list = RelationalExpression_264_Var.getExpr();
		Assert.assertNotNull(Expr_264_list);
		Assert.assertEquals(1, Expr_264_list.size());
		final ShiftExpression ShiftExpression_265_Var = (ShiftExpression)Expr_264_list.get(0);
		Assert.assertNotNull(ShiftExpression_265_Var);
		final EList<? extends EObject> Expr_265_list = ShiftExpression_265_Var.getExpr();
		Assert.assertNotNull(Expr_265_list);
		Assert.assertEquals(1, Expr_265_list.size());
		final AdditiveExpression AdditiveExpression_266_Var = (AdditiveExpression)Expr_265_list.get(0);
		Assert.assertNotNull(AdditiveExpression_266_Var);
		final EList<? extends EObject> Expr_266_list = AdditiveExpression_266_Var.getExpr();
		Assert.assertNotNull(Expr_266_list);
		Assert.assertEquals(1, Expr_266_list.size());
		final MultiplicativeExpression MultiplicativeExpression_267_Var = (MultiplicativeExpression)Expr_266_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_267_Var);
		final EList<? extends EObject> Expr_267_list = MultiplicativeExpression_267_Var.getExpr();
		Assert.assertNotNull(Expr_267_list);
		Assert.assertEquals(1, Expr_267_list.size());
		final CastExpression CastExpression_268_Var = (CastExpression)Expr_267_list.get(0);
		Assert.assertNotNull(CastExpression_268_Var);
		final UnaryExpression UnaryExpression_269_Var = (UnaryExpression)CastExpression_268_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_269_Var);
		Assert.assertEquals("sizeof", UnaryExpression_269_Var.getSizeOf());
		final TypeName TypeName_270_Var = (TypeName)UnaryExpression_269_Var.getTypeName();
		Assert.assertNotNull(TypeName_270_Var);
		final SpecifierQualifierList SpecifierQualifierList_271_Var = (SpecifierQualifierList)TypeName_270_Var.getList();
		Assert.assertNotNull(SpecifierQualifierList_271_Var);
		final EList<? extends EObject> TypeSpecifier_271_list = SpecifierQualifierList_271_Var.getTypeSpecifier();
		Assert.assertNotNull(TypeSpecifier_271_list);
		Assert.assertEquals(1, TypeSpecifier_271_list.size());
		final TypeSpecifier TypeSpecifier_272_Var = (TypeSpecifier)TypeSpecifier_271_list.get(0);
		Assert.assertNotNull(TypeSpecifier_272_Var);
		Assert.assertEquals("float", TypeSpecifier_272_Var.getName());
		Assert.assertEquals(";", ExpressionStatement_220_Var.getSemi());
		final Statement Statement_273_Var = (Statement)Statement_94_list.get(3);
		Assert.assertNotNull(Statement_273_Var);
		final ExpressionStatement ExpressionStatement_274_Var = (ExpressionStatement)Statement_273_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_274_Var);
		final Expression Expression_275_Var = (Expression)ExpressionStatement_274_Var.getExpression();
		Assert.assertNotNull(Expression_275_Var);
		final EList<? extends EObject> ExprExpr_275_list = Expression_275_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_275_list);
		Assert.assertEquals(1, ExprExpr_275_list.size());
		final AssignmentExpression AssignmentExpression_276_Var = (AssignmentExpression)ExprExpr_275_list.get(0);
		Assert.assertNotNull(AssignmentExpression_276_Var);
		final UnaryExpression UnaryExpression_277_Var = (UnaryExpression)AssignmentExpression_276_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_277_Var);
		final PostfixExpression PostfixExpression_278_Var = (PostfixExpression)UnaryExpression_277_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_278_Var);
		final EList<? extends EObject> Expr_278_list = PostfixExpression_278_Var.getExpr();
		Assert.assertNotNull(Expr_278_list);
		Assert.assertEquals(1, Expr_278_list.size());
		final PrimaryExpression PrimaryExpression_279_Var = (PrimaryExpression)Expr_278_list.get(0);
		Assert.assertNotNull(PrimaryExpression_279_Var);
		Assert.assertEquals("number", PrimaryExpression_279_Var.getId());
		Assert.assertEquals("[.]", PostfixExpression_278_Var.getDot().toString());
		Assert.assertEquals("[numChar]", PostfixExpression_278_Var.getId().toString());
		final AssignmentOperator AssignmentOperator_280_Var = (AssignmentOperator)AssignmentExpression_276_Var.getOp();
		Assert.assertNotNull(AssignmentOperator_280_Var);
		Assert.assertEquals("=", AssignmentOperator_280_Var.getOp());
		final AssignmentExpression AssignmentExpression_281_Var = (AssignmentExpression)AssignmentExpression_276_Var.getAssignmentExpr();
		Assert.assertNotNull(AssignmentExpression_281_Var);
		final ConditionalExpression ConditionalExpression_282_Var = (ConditionalExpression)AssignmentExpression_281_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_282_Var);
		final LogicalOrExpression LogicalOrExpression_283_Var = (LogicalOrExpression)ConditionalExpression_282_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_283_Var);
		final EList<? extends EObject> Expr_283_list = LogicalOrExpression_283_Var.getExpr();
		Assert.assertNotNull(Expr_283_list);
		Assert.assertEquals(1, Expr_283_list.size());
		final LogicalAndExpression LogicalAndExpression_284_Var = (LogicalAndExpression)Expr_283_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_284_Var);
		final EList<? extends EObject> Expr_284_list = LogicalAndExpression_284_Var.getExpr();
		Assert.assertNotNull(Expr_284_list);
		Assert.assertEquals(1, Expr_284_list.size());
		final InclusiveOrExpression InclusiveOrExpression_285_Var = (InclusiveOrExpression)Expr_284_list.get(0);
		...
		final Constant Constant_297_Var = (Constant)PrimaryExpression_296_Var.getConst();
		Assert.assertNotNull(Constant_297_Var);
		Assert.assertEquals("65", Constant_297_Var.getDec());
		Assert.assertEquals(";", ExpressionStatement_274_Var.getSemi());
		final Statement Statement_298_Var = (Statement)Statement_94_list.get(4);
		Assert.assertNotNull(Statement_298_Var);
		final ExpressionStatement ExpressionStatement_299_Var = (ExpressionStatement)Statement_298_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_299_Var);
		final Expression Expression_300_Var = (Expression)ExpressionStatement_299_Var.getExpression();
		Assert.assertNotNull(Expression_300_Var);
		final EList<? extends EObject> ExprExpr_300_list = Expression_300_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_300_list);
		Assert.assertEquals(1, ExprExpr_300_list.size());
		final AssignmentExpression AssignmentExpression_301_Var = (AssignmentExpression)ExprExpr_300_list.get(0);
		...
		Assert.assertEquals("printf", PrimaryExpression_316_Var.getId());
		final EList<? extends EObject> ArgumentExpressionList_316_list = PostfixExpression_315_Var.getArgumentExpressionList();
		Assert.assertNotNull(ArgumentExpressionList_316_list);
		Assert.assertEquals(1, ArgumentExpressionList_316_list.size());
		final ArgumentExpressionList ArgumentExpressionList_317_Var = (ArgumentExpressionList)ArgumentExpressionList_316_list.get(0);
		Assert.assertNotNull(ArgumentExpressionList_317_Var);
		final EList<? extends EObject> Expr_317_list = ArgumentExpressionList_317_Var.getExpr();
		Assert.assertNotNull(Expr_317_list);
		Assert.assertEquals(2, Expr_317_list.size());
		final AssignmentExpression AssignmentExpression_318_Var = (AssignmentExpression)Expr_317_list.get(0);
		Assert.assertNotNull(AssignmentExpression_318_Var);
		final ConditionalExpression ConditionalExpression_319_Var = (ConditionalExpression)AssignmentExpression_318_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_319_Var);
		final LogicalOrExpression LogicalOrExpression_320_Var = (LogicalOrExpression)ConditionalExpression_319_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_320_Var);
		final EList<? extends EObject> Expr_320_list = LogicalOrExpression_320_Var.getExpr();
		Assert.assertNotNull(Expr_320_list);
		Assert.assertEquals(1, Expr_320_list.size());
		final LogicalAndExpression LogicalAndExpression_321_Var = (LogicalAndExpression)Expr_320_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_321_Var);
		final EList<? extends EObject> Expr_321_list = LogicalAndExpression_321_Var.getExpr();
		Assert.assertNotNull(Expr_321_list);
		Assert.assertEquals(1, Expr_321_list.size());
		final InclusiveOrExpression InclusiveOrExpression_322_Var = (InclusiveOrExpression)Expr_321_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_322_Var);
		final EList<? extends EObject> Expr_322_list = InclusiveOrExpression_322_Var.getExpr();
		Assert.assertNotNull(Expr_322_list);
		Assert.assertEquals(1, Expr_322_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_323_Var = (ExclusiveOrExpression)Expr_322_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_323_Var);
		final EList<? extends EObject> Expr_323_list = ExclusiveOrExpression_323_Var.getExpr();
		Assert.assertNotNull(Expr_323_list);
		Assert.assertEquals(1, Expr_323_list.size());
		final AndExpression AndExpression_324_Var = (AndExpression)Expr_323_list.get(0);
		Assert.assertNotNull(AndExpression_324_Var);
		final EList<? extends EObject> Expr_324_list = AndExpression_324_Var.getExpr();
		Assert.assertNotNull(Expr_324_list);
		Assert.assertEquals(1, Expr_324_list.size());
		final EqualityExpression EqualityExpression_325_Var = (EqualityExpression)Expr_324_list.get(0);
		Assert.assertNotNull(EqualityExpression_325_Var);
		final EList<? extends EObject> Expr_325_list = EqualityExpression_325_Var.getExpr();
		Assert.assertNotNull(Expr_325_list);
		Assert.assertEquals(1, Expr_325_list.size());
		final RelationalExpression RelationalExpression_326_Var = (RelationalExpression)Expr_325_list.get(0);
		Assert.assertNotNull(RelationalExpression_326_Var);
		final EList<? extends EObject> Expr_326_list = RelationalExpression_326_Var.getExpr();
		Assert.assertNotNull(Expr_326_list);
		Assert.assertEquals(1, Expr_326_list.size());
		final ShiftExpression ShiftExpression_327_Var = (ShiftExpression)Expr_326_list.get(0);
		Assert.assertNotNull(ShiftExpression_327_Var);
		final EList<? extends EObject> Expr_327_list = ShiftExpression_327_Var.getExpr();
		Assert.assertNotNull(Expr_327_list);
		Assert.assertEquals(1, Expr_327_list.size());
		final AdditiveExpression AdditiveExpression_328_Var = (AdditiveExpression)Expr_327_list.get(0);
		Assert.assertNotNull(AdditiveExpression_328_Var);
		final EList<? extends EObject> Expr_328_list = AdditiveExpression_328_Var.getExpr();
		Assert.assertNotNull(Expr_328_list);
		Assert.assertEquals(1, Expr_328_list.size());
		final MultiplicativeExpression MultiplicativeExpression_329_Var = (MultiplicativeExpression)Expr_328_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_329_Var);
		final EList<? extends EObject> Expr_329_list = MultiplicativeExpression_329_Var.getExpr();
		Assert.assertNotNull(Expr_329_list);
		Assert.assertEquals(1, Expr_329_list.size());
		final CastExpression CastExpression_330_Var = (CastExpression)Expr_329_list.get(0);
		Assert.assertNotNull(CastExpression_330_Var);
		final UnaryExpression UnaryExpression_331_Var = (UnaryExpression)CastExpression_330_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_331_Var);
		final PostfixExpression PostfixExpression_332_Var = (PostfixExpression)UnaryExpression_331_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_332_Var);
		final EList<? extends EObject> Expr_332_list = PostfixExpression_332_Var.getExpr();
		Assert.assertNotNull(Expr_332_list);
		Assert.assertEquals(1, Expr_332_list.size());
		final PrimaryExpression PrimaryExpression_333_Var = (PrimaryExpression)Expr_332_list.get(0);
		Assert.assertNotNull(PrimaryExpression_333_Var);
		final Constant Constant_334_Var = (Constant)PrimaryExpression_333_Var.getConst();
		Assert.assertNotNull(Constant_334_Var);
		Assert.assertEquals("\"number.numChar(as decimal)=%d\\n\"", Constant_334_Var.getStr());
		final AssignmentExpression AssignmentExpression_335_Var = (AssignmentExpression)Expr_317_list.get(1);
		Assert.assertNotNull(AssignmentExpression_335_Var);
		final ConditionalExpression ConditionalExpression_336_Var = (ConditionalExpression)AssignmentExpression_335_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_336_Var);
		final LogicalOrExpression LogicalOrExpression_337_Var = (LogicalOrExpression)ConditionalExpression_336_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_337_Var);
		final EList<? extends EObject> Expr_337_list = LogicalOrExpression_337_Var.getExpr();
		Assert.assertNotNull(Expr_337_list);
		Assert.assertEquals(1, Expr_337_list.size());
		final LogicalAndExpression LogicalAndExpression_338_Var = (LogicalAndExpression)Expr_337_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_338_Var);
		final EList<? extends EObject> Expr_338_list = LogicalAndExpression_338_Var.getExpr();
		Assert.assertNotNull(Expr_338_list);
		Assert.assertEquals(1, Expr_338_list.size());
		final InclusiveOrExpression InclusiveOrExpression_339_Var = (InclusiveOrExpression)Expr_338_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_339_Var);
		final EList<? extends EObject> Expr_339_list = InclusiveOrExpression_339_Var.getExpr();
		Assert.assertNotNull(Expr_339_list);
		Assert.assertEquals(1, Expr_339_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_340_Var = (ExclusiveOrExpression)Expr_339_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_340_Var);
		final EList<? extends EObject> Expr_340_list = ExclusiveOrExpression_340_Var.getExpr();
		Assert.assertNotNull(Expr_340_list);
		Assert.assertEquals(1, Expr_340_list.size());
		final AndExpression AndExpression_341_Var = (AndExpression)Expr_340_list.get(0);
		Assert.assertNotNull(AndExpression_341_Var);
		final EList<? extends EObject> Expr_341_list = AndExpression_341_Var.getExpr();
		Assert.assertNotNull(Expr_341_list);
		Assert.assertEquals(1, Expr_341_list.size());
		final EqualityExpression EqualityExpression_342_Var = (EqualityExpression)Expr_341_list.get(0);
		Assert.assertNotNull(EqualityExpression_342_Var);
		final EList<? extends EObject> Expr_342_list = EqualityExpression_342_Var.getExpr();
		Assert.assertNotNull(Expr_342_list);
		Assert.assertEquals(1, Expr_342_list.size());
		final RelationalExpression RelationalExpression_343_Var = (RelationalExpression)Expr_342_list.get(0);
		Assert.assertNotNull(RelationalExpression_343_Var);
		final EList<? extends EObject> Expr_343_list = RelationalExpression_343_Var.getExpr();
		Assert.assertNotNull(Expr_343_list);
		Assert.assertEquals(1, Expr_343_list.size());
		final ShiftExpression ShiftExpression_344_Var = (ShiftExpression)Expr_343_list.get(0);
		Assert.assertNotNull(ShiftExpression_344_Var);
		final EList<? extends EObject> Expr_344_list = ShiftExpression_344_Var.getExpr();
		Assert.assertNotNull(Expr_344_list);
		Assert.assertEquals(1, Expr_344_list.size());
		final AdditiveExpression AdditiveExpression_345_Var = (AdditiveExpression)Expr_344_list.get(0);
		Assert.assertNotNull(AdditiveExpression_345_Var);
		final EList<? extends EObject> Expr_345_list = AdditiveExpression_345_Var.getExpr();
		Assert.assertNotNull(Expr_345_list);
		Assert.assertEquals(1, Expr_345_list.size());
		final MultiplicativeExpression MultiplicativeExpression_346_Var = (MultiplicativeExpression)Expr_345_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_346_Var);
		final EList<? extends EObject> Expr_346_list = MultiplicativeExpression_346_Var.getExpr();
		Assert.assertNotNull(Expr_346_list);
		Assert.assertEquals(1, Expr_346_list.size());
		final CastExpression CastExpression_347_Var = (CastExpression)Expr_346_list.get(0);
		Assert.assertNotNull(CastExpression_347_Var);
		final UnaryExpression UnaryExpression_348_Var = (UnaryExpression)CastExpression_347_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_348_Var);
		final PostfixExpression PostfixExpression_349_Var = (PostfixExpression)UnaryExpression_348_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_349_Var);
		final EList<? extends EObject> Expr_349_list = PostfixExpression_349_Var.getExpr();
		Assert.assertNotNull(Expr_349_list);
		Assert.assertEquals(1, Expr_349_list.size());
		final PrimaryExpression PrimaryExpression_350_Var = (PrimaryExpression)Expr_349_list.get(0);
		Assert.assertNotNull(PrimaryExpression_350_Var);
		Assert.assertEquals("number", PrimaryExpression_350_Var.getId());
		Assert.assertEquals("[.]", PostfixExpression_349_Var.getDot().toString());
		Assert.assertEquals("[numChar]", PostfixExpression_349_Var.getId().toString());
		Assert.assertEquals(";", ExpressionStatement_299_Var.getSemi());
		final Statement Statement_351_Var = (Statement)Statement_94_list.get(5);
		Assert.assertNotNull(Statement_351_Var);
		final ExpressionStatement ExpressionStatement_352_Var = (ExpressionStatement)Statement_351_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_352_Var);
		final Expression Expression_353_Var = (Expression)ExpressionStatement_352_Var.getExpression();
		Assert.assertNotNull(Expression_353_Var);
		final EList<? extends EObject> ExprExpr_353_list = Expression_353_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_353_list);
		Assert.assertEquals(1, ExprExpr_353_list.size());
		final AssignmentExpression AssignmentExpression_354_Var = (AssignmentExpression)ExprExpr_353_list.get(0);
		Assert.assertNotNull(AssignmentExpression_354_Var);
		final ConditionalExpression ConditionalExpression_355_Var = (ConditionalExpression)AssignmentExpression_354_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_355_Var);
		final LogicalOrExpression LogicalOrExpression_356_Var = (LogicalOrExpression)ConditionalExpression_355_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_356_Var);
		final EList<? extends EObject> Expr_356_list = LogicalOrExpression_356_Var.getExpr();
		Assert.assertNotNull(Expr_356_list);
		Assert.assertEquals(1, Expr_356_list.size());
		final LogicalAndExpression LogicalAndExpression_357_Var = (LogicalAndExpression)Expr_356_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_357_Var);
		final EList<? extends EObject> Expr_357_list = LogicalAndExpression_357_Var.getExpr();
		Assert.assertNotNull(Expr_357_list);
		Assert.assertEquals(1, Expr_357_list.size());
		final InclusiveOrExpression InclusiveOrExpression_358_Var = (InclusiveOrExpression)Expr_357_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_358_Var);
		final EList<? extends EObject> Expr_358_list = InclusiveOrExpression_358_Var.getExpr();
		Assert.assertNotNull(Expr_358_list);
		Assert.assertEquals(1, Expr_358_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_359_Var = (ExclusiveOrExpression)Expr_358_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_359_Var);
		final EList<? extends EObject> Expr_359_list = ExclusiveOrExpression_359_Var.getExpr();
		Assert.assertNotNull(Expr_359_list);
		Assert.assertEquals(1, Expr_359_list.size());
		final AndExpression AndExpression_360_Var = (AndExpression)Expr_359_list.get(0);
		Assert.assertNotNull(AndExpression_360_Var);
		final EList<? extends EObject> Expr_360_list = AndExpression_360_Var.getExpr();
		Assert.assertNotNull(Expr_360_list);
		Assert.assertEquals(1, Expr_360_list.size());
		final EqualityExpression EqualityExpression_361_Var = (EqualityExpression)Expr_360_list.get(0);
		Assert.assertNotNull(EqualityExpression_361_Var);
		final EList<? extends EObject> Expr_361_list = EqualityExpression_361_Var.getExpr();
		Assert.assertNotNull(Expr_361_list);
		Assert.assertEquals(1, Expr_361_list.size());
		final RelationalExpression RelationalExpression_362_Var = (RelationalExpression)Expr_361_list.get(0);
		Assert.assertNotNull(RelationalExpression_362_Var);
		final EList<? extends EObject> Expr_362_list = RelationalExpression_362_Var.getExpr();
		Assert.assertNotNull(Expr_362_list);
		Assert.assertEquals(1, Expr_362_list.size());
		final ShiftExpression ShiftExpression_363_Var = (ShiftExpression)Expr_362_list.get(0);
		Assert.assertNotNull(ShiftExpression_363_Var);
		final EList<? extends EObject> Expr_363_list = ShiftExpression_363_Var.getExpr();
		Assert.assertNotNull(Expr_363_list);
		Assert.assertEquals(1, Expr_363_list.size());
		final AdditiveExpression AdditiveExpression_364_Var = (AdditiveExpression)Expr_363_list.get(0);
		Assert.assertNotNull(AdditiveExpression_364_Var);
		final EList<? extends EObject> Expr_364_list = AdditiveExpression_364_Var.getExpr();
		Assert.assertNotNull(Expr_364_list);
		Assert.assertEquals(1, Expr_364_list.size());
		final MultiplicativeExpression MultiplicativeExpression_365_Var = (MultiplicativeExpression)Expr_364_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_365_Var);
		final EList<? extends EObject> Expr_365_list = MultiplicativeExpression_365_Var.getExpr();
		Assert.assertNotNull(Expr_365_list);
		Assert.assertEquals(1, Expr_365_list.size());
		final CastExpression CastExpression_366_Var = (CastExpression)Expr_365_list.get(0);
		Assert.assertNotNull(CastExpression_366_Var);
		final UnaryExpression UnaryExpression_367_Var = (UnaryExpression)CastExpression_366_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_367_Var);
		final PostfixExpression PostfixExpression_368_Var = (PostfixExpression)UnaryExpression_367_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_368_Var);
		final EList<? extends EObject> Expr_368_list = PostfixExpression_368_Var.getExpr();
		Assert.assertNotNull(Expr_368_list);
		Assert.assertEquals(1, Expr_368_list.size());
		final PrimaryExpression PrimaryExpression_369_Var = (PrimaryExpression)Expr_368_list.get(0);
		Assert.assertNotNull(PrimaryExpression_369_Var);
		Assert.assertEquals("printf", PrimaryExpression_369_Var.getId());
		final EList<? extends EObject> ArgumentExpressionList_369_list = PostfixExpression_368_Var.getArgumentExpressionList();
		Assert.assertNotNull(ArgumentExpressionList_369_list);
		Assert.assertEquals(1, ArgumentExpressionList_369_list.size());
		final ArgumentExpressionList ArgumentExpressionList_370_Var = (ArgumentExpressionList)ArgumentExpressionList_369_list.get(0);
		Assert.assertNotNull(ArgumentExpressionList_370_Var);
		final EList<? extends EObject> Expr_370_list = ArgumentExpressionList_370_Var.getExpr();
		Assert.assertNotNull(Expr_370_list);
		Assert.assertEquals(2, Expr_370_list.size());
		final AssignmentExpression AssignmentExpression_371_Var = (AssignmentExpression)Expr_370_list.get(0);
		Assert.assertNotNull(AssignmentExpression_371_Var);
		final ConditionalExpression ConditionalExpression_372_Var = (ConditionalExpression)AssignmentExpression_371_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_372_Var);
		final LogicalOrExpression LogicalOrExpression_373_Var = (LogicalOrExpression)ConditionalExpression_372_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_373_Var);
		final EList<? extends EObject> Expr_373_list = LogicalOrExpression_373_Var.getExpr();
		Assert.assertNotNull(Expr_373_list);
		Assert.assertEquals(1, Expr_373_list.size());
		final LogicalAndExpression LogicalAndExpression_374_Var = (LogicalAndExpression)Expr_373_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_374_Var);
		final EList<? extends EObject> Expr_374_list = LogicalAndExpression_374_Var.getExpr();
		Assert.assertNotNull(Expr_374_list);
		Assert.assertEquals(1, Expr_374_list.size());
		final InclusiveOrExpression InclusiveOrExpression_375_Var = (InclusiveOrExpression)Expr_374_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_375_Var);
		final EList<? extends EObject> Expr_375_list = InclusiveOrExpression_375_Var.getExpr();
		Assert.assertNotNull(Expr_375_list);
		Assert.assertEquals(1, Expr_375_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_376_Var = (ExclusiveOrExpression)Expr_375_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_376_Var);
		final EList<? extends EObject> Expr_376_list = ExclusiveOrExpression_376_Var.getExpr();
		Assert.assertNotNull(Expr_376_list);
		Assert.assertEquals(1, Expr_376_list.size());
		final AndExpression AndExpression_377_Var = (AndExpression)Expr_376_list.get(0);
		Assert.assertNotNull(AndExpression_377_Var);
		final EList<? extends EObject> Expr_377_list = AndExpression_377_Var.getExpr();
		Assert.assertNotNull(Expr_377_list);
		Assert.assertEquals(1, Expr_377_list.size());
		final EqualityExpression EqualityExpression_378_Var = (EqualityExpression)Expr_377_list.get(0);
		Assert.assertNotNull(EqualityExpression_378_Var);
		final EList<? extends EObject> Expr_378_list = EqualityExpression_378_Var.getExpr();
		Assert.assertNotNull(Expr_378_list);
		Assert.assertEquals(1, Expr_378_list.size());
		final RelationalExpression RelationalExpression_379_Var = (RelationalExpression)Expr_378_list.get(0);
		Assert.assertNotNull(RelationalExpression_379_Var);
		final EList<? extends EObject> Expr_379_list = RelationalExpression_379_Var.getExpr();
		Assert.assertNotNull(Expr_379_list);
		Assert.assertEquals(1, Expr_379_list.size());
		final ShiftExpression ShiftExpression_380_Var = (ShiftExpression)Expr_379_list.get(0);
		Assert.assertNotNull(ShiftExpression_380_Var);
		final EList<? extends EObject> Expr_380_list = ShiftExpression_380_Var.getExpr();
		Assert.assertNotNull(Expr_380_list);
		Assert.assertEquals(1, Expr_380_list.size());
		final AdditiveExpression AdditiveExpression_381_Var = (AdditiveExpression)Expr_380_list.get(0);
		Assert.assertNotNull(AdditiveExpression_381_Var);
		final EList<? extends EObject> Expr_381_list = AdditiveExpression_381_Var.getExpr();
		Assert.assertNotNull(Expr_381_list);
		Assert.assertEquals(1, Expr_381_list.size());
		final MultiplicativeExpression MultiplicativeExpression_382_Var = (MultiplicativeExpression)Expr_381_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_382_Var);
		final EList<? extends EObject> Expr_382_list = MultiplicativeExpression_382_Var.getExpr();
		Assert.assertNotNull(Expr_382_list);
		Assert.assertEquals(1, Expr_382_list.size());
		final CastExpression CastExpression_383_Var = (CastExpression)Expr_382_list.get(0);
		Assert.assertNotNull(CastExpression_383_Var);
		final UnaryExpression UnaryExpression_384_Var = (UnaryExpression)CastExpression_383_Var.getExpr();
		...
		final Constant Constant_387_Var = (Constant)PrimaryExpression_386_Var.getConst();
		Assert.assertNotNull(Constant_387_Var);
		Assert.assertEquals("\"number.numChar(as char)=%c\\n\"", Constant_387_Var.getStr());
		final AssignmentExpression AssignmentExpression_388_Var = (AssignmentExpression)Expr_370_list.get(1);
		...
		Assert.assertEquals("number", PrimaryExpression_403_Var.getId());
		Assert.assertEquals("[.]", PostfixExpression_402_Var.getDot().toString());
		Assert.assertEquals("[numChar]", PostfixExpression_402_Var.getId().toString());
		Assert.assertEquals(";", ExpressionStatement_352_Var.getSemi());
		final Statement Statement_404_Var = (Statement)Statement_94_list.get(6);
		Assert.assertNotNull(Statement_404_Var);
		final ExpressionStatement ExpressionStatement_405_Var = (ExpressionStatement)Statement_404_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_405_Var);
		final Expression Expression_406_Var = (Expression)ExpressionStatement_405_Var.getExpression();
		Assert.assertNotNull(Expression_406_Var);
		final EList<? extends EObject> ExprExpr_406_list = Expression_406_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_406_list);
		Assert.assertEquals(1, ExprExpr_406_list.size());
		final AssignmentExpression AssignmentExpression_407_Var = (AssignmentExpression)ExprExpr_406_list.get(0);
		Assert.assertNotNull(AssignmentExpression_407_Var);
		final ConditionalExpression ConditionalExpression_408_Var = (ConditionalExpression)AssignmentExpression_407_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_408_Var);
		final LogicalOrExpression LogicalOrExpression_409_Var = (LogicalOrExpression)ConditionalExpression_408_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_409_Var);
		final EList<? extends EObject> Expr_409_list = LogicalOrExpression_409_Var.getExpr();
		Assert.assertNotNull(Expr_409_list);
		Assert.assertEquals(1, Expr_409_list.size());
		final LogicalAndExpression LogicalAndExpression_410_Var = (LogicalAndExpression)Expr_409_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_410_Var);
		final EList<? extends EObject> Expr_410_list = LogicalAndExpression_410_Var.getExpr();
		Assert.assertNotNull(Expr_410_list);
		Assert.assertEquals(1, Expr_410_list.size());
		final InclusiveOrExpression InclusiveOrExpression_411_Var = (InclusiveOrExpression)Expr_410_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_411_Var);
		final EList<? extends EObject> Expr_411_list = InclusiveOrExpression_411_Var.getExpr();
		Assert.assertNotNull(Expr_411_list);
		Assert.assertEquals(1, Expr_411_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_412_Var = (ExclusiveOrExpression)Expr_411_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_412_Var);
		final EList<? extends EObject> Expr_412_list = ExclusiveOrExpression_412_Var.getExpr();
		Assert.assertNotNull(Expr_412_list);
		Assert.assertEquals(1, Expr_412_list.size());
		final AndExpression AndExpression_413_Var = (AndExpression)Expr_412_list.get(0);
		Assert.assertNotNull(AndExpression_413_Var);
		final EList<? extends EObject> Expr_413_list = AndExpression_413_Var.getExpr();
		Assert.assertNotNull(Expr_413_list);
		Assert.assertEquals(1, Expr_413_list.size());
		final EqualityExpression EqualityExpression_414_Var = (EqualityExpression)Expr_413_list.get(0);
		Assert.assertNotNull(EqualityExpression_414_Var);
		final EList<? extends EObject> Expr_414_list = EqualityExpression_414_Var.getExpr();
		Assert.assertNotNull(Expr_414_list);
		Assert.assertEquals(1, Expr_414_list.size());
		final RelationalExpression RelationalExpression_415_Var = (RelationalExpression)Expr_414_list.get(0);
		Assert.assertNotNull(RelationalExpression_415_Var);
		final EList<? extends EObject> Expr_415_list = RelationalExpression_415_Var.getExpr();
		Assert.assertNotNull(Expr_415_list);
		Assert.assertEquals(1, Expr_415_list.size());
		final ShiftExpression ShiftExpression_416_Var = (ShiftExpression)Expr_415_list.get(0);
		Assert.assertNotNull(ShiftExpression_416_Var);
		final EList<? extends EObject> Expr_416_list = ShiftExpression_416_Var.getExpr();
		Assert.assertNotNull(Expr_416_list);
		Assert.assertEquals(1, Expr_416_list.size());
		final AdditiveExpression AdditiveExpression_417_Var = (AdditiveExpression)Expr_416_list.get(0);
		Assert.assertNotNull(AdditiveExpression_417_Var);
		final EList<? extends EObject> Expr_417_list = AdditiveExpression_417_Var.getExpr();
		Assert.assertNotNull(Expr_417_list);
		Assert.assertEquals(1, Expr_417_list.size());
		final MultiplicativeExpression MultiplicativeExpression_418_Var = (MultiplicativeExpression)Expr_417_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_418_Var);
		final EList<? extends EObject> Expr_418_list = MultiplicativeExpression_418_Var.getExpr();
		Assert.assertNotNull(Expr_418_list);
		Assert.assertEquals(1, Expr_418_list.size());
		final CastExpression CastExpression_419_Var = (CastExpression)Expr_418_list.get(0);
		Assert.assertNotNull(CastExpression_419_Var);
		final UnaryExpression UnaryExpression_420_Var = (UnaryExpression)CastExpression_419_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_420_Var);
		final PostfixExpression PostfixExpression_421_Var = (PostfixExpression)UnaryExpression_420_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_421_Var);
		final EList<? extends EObject> Expr_421_list = PostfixExpression_421_Var.getExpr();
		Assert.assertNotNull(Expr_421_list);
		Assert.assertEquals(1, Expr_421_list.size());
		final PrimaryExpression PrimaryExpression_422_Var = (PrimaryExpression)Expr_421_list.get(0);
		Assert.assertNotNull(PrimaryExpression_422_Var);
		Assert.assertEquals("printf", PrimaryExpression_422_Var.getId());
		final EList<? extends EObject> ArgumentExpressionList_422_list = PostfixExpression_421_Var.getArgumentExpressionList();
		Assert.assertNotNull(ArgumentExpressionList_422_list);
		Assert.assertEquals(1, ArgumentExpressionList_422_list.size());
		final ArgumentExpressionList ArgumentExpressionList_423_Var = (ArgumentExpressionList)ArgumentExpressionList_422_list.get(0);
		Assert.assertNotNull(ArgumentExpressionList_423_Var);
		final EList<? extends EObject> Expr_423_list = ArgumentExpressionList_423_Var.getExpr();
		Assert.assertNotNull(Expr_423_list);
		Assert.assertEquals(2, Expr_423_list.size());
		final AssignmentExpression AssignmentExpression_424_Var = (AssignmentExpression)Expr_423_list.get(0);
		Assert.assertNotNull(AssignmentExpression_424_Var);
		final ConditionalExpression ConditionalExpression_425_Var = (ConditionalExpression)AssignmentExpression_424_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_425_Var);
		final LogicalOrExpression LogicalOrExpression_426_Var = (LogicalOrExpression)ConditionalExpression_425_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_426_Var);
		final EList<? extends EObject> Expr_426_list = LogicalOrExpression_426_Var.getExpr();
		Assert.assertNotNull(Expr_426_list);
		Assert.assertEquals(1, Expr_426_list.size());
		final LogicalAndExpression LogicalAndExpression_427_Var = (LogicalAndExpression)Expr_426_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_427_Var);
		final EList<? extends EObject> Expr_427_list = LogicalAndExpression_427_Var.getExpr();
		Assert.assertNotNull(Expr_427_list);
		Assert.assertEquals(1, Expr_427_list.size());
		final InclusiveOrExpression InclusiveOrExpression_428_Var = (InclusiveOrExpression)Expr_427_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_428_Var);
		final EList<? extends EObject> Expr_428_list = InclusiveOrExpression_428_Var.getExpr();
		Assert.assertNotNull(Expr_428_list);
		Assert.assertEquals(1, Expr_428_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_429_Var = (ExclusiveOrExpression)Expr_428_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_429_Var);
		final EList<? extends EObject> Expr_429_list = ExclusiveOrExpression_429_Var.getExpr();
		Assert.assertNotNull(Expr_429_list);
		Assert.assertEquals(1, Expr_429_list.size());
		final AndExpression AndExpression_430_Var = (AndExpression)Expr_429_list.get(0);
		Assert.assertNotNull(AndExpression_430_Var);
		final EList<? extends EObject> Expr_430_list = AndExpression_430_Var.getExpr();
		Assert.assertNotNull(Expr_430_list);
		Assert.assertEquals(1, Expr_430_list.size());
		final EqualityExpression EqualityExpression_431_Var = (EqualityExpression)Expr_430_list.get(0);
		Assert.assertNotNull(EqualityExpression_431_Var);
		final EList<? extends EObject> Expr_431_list = EqualityExpression_431_Var.getExpr();
		Assert.assertNotNull(Expr_431_list);
		Assert.assertEquals(1, Expr_431_list.size());
		final RelationalExpression RelationalExpression_432_Var = (RelationalExpression)Expr_431_list.get(0);
		Assert.assertNotNull(RelationalExpression_432_Var);
		final EList<? extends EObject> Expr_432_list = RelationalExpression_432_Var.getExpr();
		Assert.assertNotNull(Expr_432_list);
		Assert.assertEquals(1, Expr_432_list.size());
		final ShiftExpression ShiftExpression_433_Var = (ShiftExpression)Expr_432_list.get(0);
		Assert.assertNotNull(ShiftExpression_433_Var);
		final EList<? extends EObject> Expr_433_list = ShiftExpression_433_Var.getExpr();
		Assert.assertNotNull(Expr_433_list);
		Assert.assertEquals(1, Expr_433_list.size());
		final AdditiveExpression AdditiveExpression_434_Var = (AdditiveExpression)Expr_433_list.get(0);
		Assert.assertNotNull(AdditiveExpression_434_Var);
		final EList<? extends EObject> Expr_434_list = AdditiveExpression_434_Var.getExpr();
		Assert.assertNotNull(Expr_434_list);
		Assert.assertEquals(1, Expr_434_list.size());
		final MultiplicativeExpression MultiplicativeExpression_435_Var = (MultiplicativeExpression)Expr_434_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_435_Var);
		final EList<? extends EObject> Expr_435_list = MultiplicativeExpression_435_Var.getExpr();
		Assert.assertNotNull(Expr_435_list);
		Assert.assertEquals(1, Expr_435_list.size());
		final CastExpression CastExpression_436_Var = (CastExpression)Expr_435_list.get(0);
		Assert.assertNotNull(CastExpression_436_Var);
		final UnaryExpression UnaryExpression_437_Var = (UnaryExpression)CastExpression_436_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_437_Var);
		final PostfixExpression PostfixExpression_438_Var = (PostfixExpression)UnaryExpression_437_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_438_Var);
		final EList<? extends EObject> Expr_438_list = PostfixExpression_438_Var.getExpr();
		Assert.assertNotNull(Expr_438_list);
		Assert.assertEquals(1, Expr_438_list.size());
		final PrimaryExpression PrimaryExpression_439_Var = (PrimaryExpression)Expr_438_list.get(0);
		Assert.assertNotNull(PrimaryExpression_439_Var);
		final Constant Constant_440_Var = (Constant)PrimaryExpression_439_Var.getConst();
		Assert.assertNotNull(Constant_440_Var);
		Assert.assertEquals("\"number.numFloat=%f\\n\"", Constant_440_Var.getStr());
		final AssignmentExpression AssignmentExpression_441_Var = (AssignmentExpression)Expr_423_list.get(1);
		Assert.assertNotNull(AssignmentExpression_441_Var);
		final ConditionalExpression ConditionalExpression_442_Var = (ConditionalExpression)AssignmentExpression_441_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_442_Var);
		final LogicalOrExpression LogicalOrExpression_443_Var = (LogicalOrExpression)ConditionalExpression_442_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_443_Var);
		final EList<? extends EObject> Expr_443_list = LogicalOrExpression_443_Var.getExpr();
		Assert.assertNotNull(Expr_443_list);
		Assert.assertEquals(1, Expr_443_list.size());
		final LogicalAndExpression LogicalAndExpression_444_Var = (LogicalAndExpression)Expr_443_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_444_Var);
		final EList<? extends EObject> Expr_444_list = LogicalAndExpression_444_Var.getExpr();
		Assert.assertNotNull(Expr_444_list);
		Assert.assertEquals(1, Expr_444_list.size());
		final InclusiveOrExpression InclusiveOrExpression_445_Var = (InclusiveOrExpression)Expr_444_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_445_Var);
		final EList<? extends EObject> Expr_445_list = InclusiveOrExpression_445_Var.getExpr();
		Assert.assertNotNull(Expr_445_list);
		Assert.assertEquals(1, Expr_445_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_446_Var = (ExclusiveOrExpression)Expr_445_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_446_Var);
		final EList<? extends EObject> Expr_446_list = ExclusiveOrExpression_446_Var.getExpr();
		Assert.assertNotNull(Expr_446_list);
		Assert.assertEquals(1, Expr_446_list.size());
		final AndExpression AndExpression_447_Var = (AndExpression)Expr_446_list.get(0);
		Assert.assertNotNull(AndExpression_447_Var);
		final EList<? extends EObject> Expr_447_list = AndExpression_447_Var.getExpr();
		Assert.assertNotNull(Expr_447_list);
		Assert.assertEquals(1, Expr_447_list.size());
		final EqualityExpression EqualityExpression_448_Var = (EqualityExpression)Expr_447_list.get(0);
		Assert.assertNotNull(EqualityExpression_448_Var);
		final EList<? extends EObject> Expr_448_list = EqualityExpression_448_Var.getExpr();
		Assert.assertNotNull(Expr_448_list);
		Assert.assertEquals(1, Expr_448_list.size());
		final RelationalExpression RelationalExpression_449_Var = (RelationalExpression)Expr_448_list.get(0);
		Assert.assertNotNull(RelationalExpression_449_Var);
		final EList<? extends EObject> Expr_449_list = RelationalExpression_449_Var.getExpr();
		Assert.assertNotNull(Expr_449_list);
		Assert.assertEquals(1, Expr_449_list.size());
		final ShiftExpression ShiftExpression_450_Var = (ShiftExpression)Expr_449_list.get(0);
		Assert.assertNotNull(ShiftExpression_450_Var);
		final EList<? extends EObject> Expr_450_list = ShiftExpression_450_Var.getExpr();
		Assert.assertNotNull(Expr_450_list);
		Assert.assertEquals(1, Expr_450_list.size());
		final AdditiveExpression AdditiveExpression_451_Var = (AdditiveExpression)Expr_450_list.get(0);
		Assert.assertNotNull(AdditiveExpression_451_Var);
		final EList<? extends EObject> Expr_451_list = AdditiveExpression_451_Var.getExpr();
		Assert.assertNotNull(Expr_451_list);
		Assert.assertEquals(1, Expr_451_list.size());
		final MultiplicativeExpression MultiplicativeExpression_452_Var = (MultiplicativeExpression)Expr_451_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_452_Var);
		final EList<? extends EObject> Expr_452_list = MultiplicativeExpression_452_Var.getExpr();
		Assert.assertNotNull(Expr_452_list);
		Assert.assertEquals(1, Expr_452_list.size());
		final CastExpression CastExpression_453_Var = (CastExpression)Expr_452_list.get(0);
		Assert.assertNotNull(CastExpression_453_Var);
		final UnaryExpression UnaryExpression_454_Var = (UnaryExpression)CastExpression_453_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_454_Var);
		final PostfixExpression PostfixExpression_455_Var = (PostfixExpression)UnaryExpression_454_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_455_Var);
		final EList<? extends EObject> Expr_455_list = PostfixExpression_455_Var.getExpr();
		Assert.assertNotNull(Expr_455_list);
		Assert.assertEquals(1, Expr_455_list.size());
		final PrimaryExpression PrimaryExpression_456_Var = (PrimaryExpression)Expr_455_list.get(0);
		Assert.assertNotNull(PrimaryExpression_456_Var);
		Assert.assertEquals("number", PrimaryExpression_456_Var.getId());
		Assert.assertEquals("[.]", PostfixExpression_455_Var.getDot().toString());
		Assert.assertEquals("[numFloat]", PostfixExpression_455_Var.getId().toString());
		Assert.assertEquals(";", ExpressionStatement_405_Var.getSemi());
		final Statement Statement_457_Var = (Statement)Statement_94_list.get(7);
		Assert.assertNotNull(Statement_457_Var);
		final ExpressionStatement ExpressionStatement_458_Var = (ExpressionStatement)Statement_457_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_458_Var);
		final Expression Expression_459_Var = (Expression)ExpressionStatement_458_Var.getExpression();
		Assert.assertNotNull(Expression_459_Var);
		final EList<? extends EObject> ExprExpr_459_list = Expression_459_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_459_list);
		Assert.assertEquals(1, ExprExpr_459_list.size());
		final AssignmentExpression AssignmentExpression_460_Var = (AssignmentExpression)ExprExpr_459_list.get(0);
		Assert.assertNotNull(AssignmentExpression_460_Var);
		final UnaryExpression UnaryExpression_461_Var = (UnaryExpression)AssignmentExpression_460_Var.getExpr();
		...
		Assert.assertEquals("number", PrimaryExpression_463_Var.getId());
		Assert.assertEquals("[.]", PostfixExpression_462_Var.getDot().toString());
		Assert.assertEquals("[numFloat]", PostfixExpression_462_Var.getId().toString());
		final AssignmentOperator AssignmentOperator_464_Var = (AssignmentOperator)AssignmentExpression_460_Var.getOp();
		Assert.assertNotNull(AssignmentOperator_464_Var);
		Assert.assertEquals("=", AssignmentOperator_464_Var.getOp());
		final AssignmentExpression AssignmentExpression_465_Var = (AssignmentExpression)AssignmentExpression_460_Var.getAssignmentExpr();
		Assert.assertNotNull(AssignmentExpression_465_Var);
		final ConditionalExpression ConditionalExpression_466_Var = (ConditionalExpression)AssignmentExpression_465_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_466_Var);
		final LogicalOrExpression LogicalOrExpression_467_Var = (LogicalOrExpression)ConditionalExpression_466_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_467_Var);
		final EList<? extends EObject> Expr_467_list = LogicalOrExpression_467_Var.getExpr();
		Assert.assertNotNull(Expr_467_list);
		Assert.assertEquals(1, Expr_467_list.size());
		final LogicalAndExpression LogicalAndExpression_468_Var = (LogicalAndExpression)Expr_467_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_468_Var);
		final EList<? extends EObject> Expr_468_list = LogicalAndExpression_468_Var.getExpr();
		Assert.assertNotNull(Expr_468_list);
		Assert.assertEquals(1, Expr_468_list.size());
		final InclusiveOrExpression InclusiveOrExpression_469_Var = (InclusiveOrExpression)Expr_468_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_469_Var);
		final EList<? extends EObject> Expr_469_list = InclusiveOrExpression_469_Var.getExpr();
		Assert.assertNotNull(Expr_469_list);
		Assert.assertEquals(1, Expr_469_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_470_Var = (ExclusiveOrExpression)Expr_469_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_470_Var);
		final EList<? extends EObject> Expr_470_list = ExclusiveOrExpression_470_Var.getExpr();
		Assert.assertNotNull(Expr_470_list);
		Assert.assertEquals(1, Expr_470_list.size());
		final AndExpression AndExpression_471_Var = (AndExpression)Expr_470_list.get(0);
		Assert.assertNotNull(AndExpression_471_Var);
		final EList<? extends EObject> Expr_471_list = AndExpression_471_Var.getExpr();
		Assert.assertNotNull(Expr_471_list);
		Assert.assertEquals(1, Expr_471_list.size());
		final EqualityExpression EqualityExpression_472_Var = (EqualityExpression)Expr_471_list.get(0);
		Assert.assertNotNull(EqualityExpression_472_Var);
		final EList<? extends EObject> Expr_472_list = EqualityExpression_472_Var.getExpr();
		Assert.assertNotNull(Expr_472_list);
		Assert.assertEquals(1, Expr_472_list.size());
		final RelationalExpression RelationalExpression_473_Var = (RelationalExpression)Expr_472_list.get(0);
		Assert.assertNotNull(RelationalExpression_473_Var);
		final EList<? extends EObject> Expr_473_list = RelationalExpression_473_Var.getExpr();
		Assert.assertNotNull(Expr_473_list);
		Assert.assertEquals(1, Expr_473_list.size());
		final ShiftExpression ShiftExpression_474_Var = (ShiftExpression)Expr_473_list.get(0);
		Assert.assertNotNull(ShiftExpression_474_Var);
		final EList<? extends EObject> Expr_474_list = ShiftExpression_474_Var.getExpr();
		Assert.assertNotNull(Expr_474_list);
		Assert.assertEquals(1, Expr_474_list.size());
		final AdditiveExpression AdditiveExpression_475_Var = (AdditiveExpression)Expr_474_list.get(0);
		Assert.assertNotNull(AdditiveExpression_475_Var);
		final EList<? extends EObject> Expr_475_list = AdditiveExpression_475_Var.getExpr();
		Assert.assertNotNull(Expr_475_list);
		Assert.assertEquals(1, Expr_475_list.size());
		final MultiplicativeExpression MultiplicativeExpression_476_Var = (MultiplicativeExpression)Expr_475_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_476_Var);
		final EList<? extends EObject> Expr_476_list = MultiplicativeExpression_476_Var.getExpr();
		Assert.assertNotNull(Expr_476_list);
		Assert.assertEquals(1, Expr_476_list.size());
		final CastExpression CastExpression_477_Var = (CastExpression)Expr_476_list.get(0);
		Assert.assertNotNull(CastExpression_477_Var);
		final UnaryExpression UnaryExpression_478_Var = (UnaryExpression)CastExpression_477_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_478_Var);
		final PostfixExpression PostfixExpression_479_Var = (PostfixExpression)UnaryExpression_478_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_479_Var);
		final EList<? extends EObject> Expr_479_list = PostfixExpression_479_Var.getExpr();
		Assert.assertNotNull(Expr_479_list);
		Assert.assertEquals(1, Expr_479_list.size());
		final PrimaryExpression PrimaryExpression_480_Var = (PrimaryExpression)Expr_479_list.get(0);
		Assert.assertNotNull(PrimaryExpression_480_Var);
		final Constant Constant_481_Var = (Constant)PrimaryExpression_480_Var.getConst();
		Assert.assertNotNull(Constant_481_Var);
		Assert.assertEquals("0.56789", Constant_481_Var.getFloat());
		Assert.assertEquals(";", ExpressionStatement_458_Var.getSemi());
		final Statement Statement_482_Var = (Statement)Statement_94_list.get(8);
		Assert.assertNotNull(Statement_482_Var);
		final ExpressionStatement ExpressionStatement_483_Var = (ExpressionStatement)Statement_482_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_483_Var);
		final Expression Expression_484_Var = (Expression)ExpressionStatement_483_Var.getExpression();
		Assert.assertNotNull(Expression_484_Var);
		final EList<? extends EObject> ExprExpr_484_list = Expression_484_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_484_list);
		Assert.assertEquals(1, ExprExpr_484_list.size());
		final AssignmentExpression AssignmentExpression_485_Var = (AssignmentExpression)ExprExpr_484_list.get(0);
		Assert.assertNotNull(AssignmentExpression_485_Var);
		final ConditionalExpression ConditionalExpression_486_Var = (ConditionalExpression)AssignmentExpression_485_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_486_Var);
		final LogicalOrExpression LogicalOrExpression_487_Var = (LogicalOrExpression)ConditionalExpression_486_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_487_Var);
		final EList<? extends EObject> Expr_487_list = LogicalOrExpression_487_Var.getExpr();
		Assert.assertNotNull(Expr_487_list);
		Assert.assertEquals(1, Expr_487_list.size());
		final LogicalAndExpression LogicalAndExpression_488_Var = (LogicalAndExpression)Expr_487_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_488_Var);
		final EList<? extends EObject> Expr_488_list = LogicalAndExpression_488_Var.getExpr();
		Assert.assertNotNull(Expr_488_list);
		Assert.assertEquals(1, Expr_488_list.size());
		final InclusiveOrExpression InclusiveOrExpression_489_Var = (InclusiveOrExpression)Expr_488_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_489_Var);
		final EList<? extends EObject> Expr_489_list = InclusiveOrExpression_489_Var.getExpr();
		Assert.assertNotNull(Expr_489_list);
		Assert.assertEquals(1, Expr_489_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_490_Var = (ExclusiveOrExpression)Expr_489_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_490_Var);
		final EList<? extends EObject> Expr_490_list = ExclusiveOrExpression_490_Var.getExpr();
		Assert.assertNotNull(Expr_490_list);
		Assert.assertEquals(1, Expr_490_list.size());
		final AndExpression AndExpression_491_Var = (AndExpression)Expr_490_list.get(0);
		Assert.assertNotNull(AndExpression_491_Var);
		final EList<? extends EObject> Expr_491_list = AndExpression_491_Var.getExpr();
		Assert.assertNotNull(Expr_491_list);
		Assert.assertEquals(1, Expr_491_list.size());
		final EqualityExpression EqualityExpression_492_Var = (EqualityExpression)Expr_491_list.get(0);
		Assert.assertNotNull(EqualityExpression_492_Var);
		final EList<? extends EObject> Expr_492_list = EqualityExpression_492_Var.getExpr();
		Assert.assertNotNull(Expr_492_list);
		Assert.assertEquals(1, Expr_492_list.size());
		final RelationalExpression RelationalExpression_493_Var = (RelationalExpression)Expr_492_list.get(0);
		Assert.assertNotNull(RelationalExpression_493_Var);
		final EList<? extends EObject> Expr_493_list = RelationalExpression_493_Var.getExpr();
		Assert.assertNotNull(Expr_493_list);
		Assert.assertEquals(1, Expr_493_list.size());
		final ShiftExpression ShiftExpression_494_Var = (ShiftExpression)Expr_493_list.get(0);
		Assert.assertNotNull(ShiftExpression_494_Var);
		final EList<? extends EObject> Expr_494_list = ShiftExpression_494_Var.getExpr();
		Assert.assertNotNull(Expr_494_list);
		Assert.assertEquals(1, Expr_494_list.size());
		final AdditiveExpression AdditiveExpression_495_Var = (AdditiveExpression)Expr_494_list.get(0);
		Assert.assertNotNull(AdditiveExpression_495_Var);
		final EList<? extends EObject> Expr_495_list = AdditiveExpression_495_Var.getExpr();
		Assert.assertNotNull(Expr_495_list);
		Assert.assertEquals(1, Expr_495_list.size());
		final MultiplicativeExpression MultiplicativeExpression_496_Var = (MultiplicativeExpression)Expr_495_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_496_Var);
		final EList<? extends EObject> Expr_496_list = MultiplicativeExpression_496_Var.getExpr();
		Assert.assertNotNull(Expr_496_list);
		Assert.assertEquals(1, Expr_496_list.size());
		final CastExpression CastExpression_497_Var = (CastExpression)Expr_496_list.get(0);
		Assert.assertNotNull(CastExpression_497_Var);
		final UnaryExpression UnaryExpression_498_Var = (UnaryExpression)CastExpression_497_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_498_Var);
		final PostfixExpression PostfixExpression_499_Var = (PostfixExpression)UnaryExpression_498_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_499_Var);
		final EList<? extends EObject> Expr_499_list = PostfixExpression_499_Var.getExpr();
		Assert.assertNotNull(Expr_499_list);
		Assert.assertEquals(1, Expr_499_list.size());
		final PrimaryExpression PrimaryExpression_500_Var = (PrimaryExpression)Expr_499_list.get(0);
		Assert.assertNotNull(PrimaryExpression_500_Var);
		Assert.assertEquals("printf", PrimaryExpression_500_Var.getId());
		final EList<? extends EObject> ArgumentExpressionList_500_list = PostfixExpression_499_Var.getArgumentExpressionList();
		Assert.assertNotNull(ArgumentExpressionList_500_list);
		Assert.assertEquals(1, ArgumentExpressionList_500_list.size());
		final ArgumentExpressionList ArgumentExpressionList_501_Var = (ArgumentExpressionList)ArgumentExpressionList_500_list.get(0);
		Assert.assertNotNull(ArgumentExpressionList_501_Var);
		final EList<? extends EObject> Expr_501_list = ArgumentExpressionList_501_Var.getExpr();
		Assert.assertNotNull(Expr_501_list);
		Assert.assertEquals(2, Expr_501_list.size());
		final AssignmentExpression AssignmentExpression_502_Var = (AssignmentExpression)Expr_501_list.get(0);
		Assert.assertNotNull(AssignmentExpression_502_Var);
		final ConditionalExpression ConditionalExpression_503_Var = (ConditionalExpression)AssignmentExpression_502_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_503_Var);
		final LogicalOrExpression LogicalOrExpression_504_Var = (LogicalOrExpression)ConditionalExpression_503_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_504_Var);
		final EList<? extends EObject> Expr_504_list = LogicalOrExpression_504_Var.getExpr();
		Assert.assertNotNull(Expr_504_list);
		Assert.assertEquals(1, Expr_504_list.size());
		final LogicalAndExpression LogicalAndExpression_505_Var = (LogicalAndExpression)Expr_504_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_505_Var);
		final EList<? extends EObject> Expr_505_list = LogicalAndExpression_505_Var.getExpr();
		Assert.assertNotNull(Expr_505_list);
		Assert.assertEquals(1, Expr_505_list.size());
		final InclusiveOrExpression InclusiveOrExpression_506_Var = (InclusiveOrExpression)Expr_505_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_506_Var);
		final EList<? extends EObject> Expr_506_list = InclusiveOrExpression_506_Var.getExpr();
		Assert.assertNotNull(Expr_506_list);
		Assert.assertEquals(1, Expr_506_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_507_Var = (ExclusiveOrExpression)Expr_506_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_507_Var);
		final EList<? extends EObject> Expr_507_list = ExclusiveOrExpression_507_Var.getExpr();
		Assert.assertNotNull(Expr_507_list);
		Assert.assertEquals(1, Expr_507_list.size());
		final AndExpression AndExpression_508_Var = (AndExpression)Expr_507_list.get(0);
		Assert.assertNotNull(AndExpression_508_Var);
		final EList<? extends EObject> Expr_508_list = AndExpression_508_Var.getExpr();
		Assert.assertNotNull(Expr_508_list);
		Assert.assertEquals(1, Expr_508_list.size());
		final EqualityExpression EqualityExpression_509_Var = (EqualityExpression)Expr_508_list.get(0);
		Assert.assertNotNull(EqualityExpression_509_Var);
		final EList<? extends EObject> Expr_509_list = EqualityExpression_509_Var.getExpr();
		Assert.assertNotNull(Expr_509_list);
		Assert.assertEquals(1, Expr_509_list.size());
		final RelationalExpression RelationalExpression_510_Var = (RelationalExpression)Expr_509_list.get(0);
		Assert.assertNotNull(RelationalExpression_510_Var);
		final EList<? extends EObject> Expr_510_list = RelationalExpression_510_Var.getExpr();
		Assert.assertNotNull(Expr_510_list);
		Assert.assertEquals(1, Expr_510_list.size());
		final ShiftExpression ShiftExpression_511_Var = (ShiftExpression)Expr_510_list.get(0);
		Assert.assertNotNull(ShiftExpression_511_Var);
		final EList<? extends EObject> Expr_511_list = ShiftExpression_511_Var.getExpr();
		Assert.assertNotNull(Expr_511_list);
		Assert.assertEquals(1, Expr_511_list.size());
		final AdditiveExpression AdditiveExpression_512_Var = (AdditiveExpression)Expr_511_list.get(0);
		Assert.assertNotNull(AdditiveExpression_512_Var);
		final EList<? extends EObject> Expr_512_list = AdditiveExpression_512_Var.getExpr();
		Assert.assertNotNull(Expr_512_list);
		Assert.assertEquals(1, Expr_512_list.size());
		final MultiplicativeExpression MultiplicativeExpression_513_Var = (MultiplicativeExpression)Expr_512_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_513_Var);
		final EList<? extends EObject> Expr_513_list = MultiplicativeExpression_513_Var.getExpr();
		Assert.assertNotNull(Expr_513_list);
		Assert.assertEquals(1, Expr_513_list.size());
		final CastExpression CastExpression_514_Var = (CastExpression)Expr_513_list.get(0);
		Assert.assertNotNull(CastExpression_514_Var);
		final UnaryExpression UnaryExpression_515_Var = (UnaryExpression)CastExpression_514_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_515_Var);
		final PostfixExpression PostfixExpression_516_Var = (PostfixExpression)UnaryExpression_515_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_516_Var);
		final EList<? extends EObject> Expr_516_list = PostfixExpression_516_Var.getExpr();
		Assert.assertNotNull(Expr_516_list);
		Assert.assertEquals(1, Expr_516_list.size());
		final PrimaryExpression PrimaryExpression_517_Var = (PrimaryExpression)Expr_516_list.get(0);
		Assert.assertNotNull(PrimaryExpression_517_Var);
		final Constant Constant_518_Var = (Constant)PrimaryExpression_517_Var.getConst();
		Assert.assertNotNull(Constant_518_Var);
		Assert.assertEquals("\"number.numChar(as decimal)=%d\\n\"", Constant_518_Var.getStr());
		final AssignmentExpression AssignmentExpression_519_Var = (AssignmentExpression)Expr_501_list.get(1);
		Assert.assertNotNull(AssignmentExpression_519_Var);
		final ConditionalExpression ConditionalExpression_520_Var = (ConditionalExpression)AssignmentExpression_519_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_520_Var);
		final LogicalOrExpression LogicalOrExpression_521_Var = (LogicalOrExpression)ConditionalExpression_520_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_521_Var);
		final EList<? extends EObject> Expr_521_list = LogicalOrExpression_521_Var.getExpr();
		Assert.assertNotNull(Expr_521_list);
		Assert.assertEquals(1, Expr_521_list.size());
		final LogicalAndExpression LogicalAndExpression_522_Var = (LogicalAndExpression)Expr_521_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_522_Var);
		final EList<? extends EObject> Expr_522_list = LogicalAndExpression_522_Var.getExpr();
		Assert.assertNotNull(Expr_522_list);
		Assert.assertEquals(1, Expr_522_list.size());
		final InclusiveOrExpression InclusiveOrExpression_523_Var = (InclusiveOrExpression)Expr_522_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_523_Var);
		final EList<? extends EObject> Expr_523_list = InclusiveOrExpression_523_Var.getExpr();
		Assert.assertNotNull(Expr_523_list);
		Assert.assertEquals(1, Expr_523_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_524_Var = (ExclusiveOrExpression)Expr_523_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_524_Var);
		final EList<? extends EObject> Expr_524_list = ExclusiveOrExpression_524_Var.getExpr();
		Assert.assertNotNull(Expr_524_list);
		Assert.assertEquals(1, Expr_524_list.size());
		final AndExpression AndExpression_525_Var = (AndExpression)Expr_524_list.get(0);
		Assert.assertNotNull(AndExpression_525_Var);
		final EList<? extends EObject> Expr_525_list = AndExpression_525_Var.getExpr();
		Assert.assertNotNull(Expr_525_list);
		Assert.assertEquals(1, Expr_525_list.size());
		final EqualityExpression EqualityExpression_526_Var = (EqualityExpression)Expr_525_list.get(0);
		Assert.assertNotNull(EqualityExpression_526_Var);
		final EList<? extends EObject> Expr_526_list = EqualityExpression_526_Var.getExpr();
		Assert.assertNotNull(Expr_526_list);
		Assert.assertEquals(1, Expr_526_list.size());
		final RelationalExpression RelationalExpression_527_Var = (RelationalExpression)Expr_526_list.get(0);
		Assert.assertNotNull(RelationalExpression_527_Var);
		final EList<? extends EObject> Expr_527_list = RelationalExpression_527_Var.getExpr();
		Assert.assertNotNull(Expr_527_list);
		Assert.assertEquals(1, Expr_527_list.size());
		final ShiftExpression ShiftExpression_528_Var = (ShiftExpression)Expr_527_list.get(0);
		Assert.assertNotNull(ShiftExpression_528_Var);
		final EList<? extends EObject> Expr_528_list = ShiftExpression_528_Var.getExpr();
		Assert.assertNotNull(Expr_528_list);
		Assert.assertEquals(1, Expr_528_list.size());
		final AdditiveExpression AdditiveExpression_529_Var = (AdditiveExpression)Expr_528_list.get(0);
		Assert.assertNotNull(AdditiveExpression_529_Var);
		final EList<? extends EObject> Expr_529_list = AdditiveExpression_529_Var.getExpr();
		Assert.assertNotNull(Expr_529_list);
		Assert.assertEquals(1, Expr_529_list.size());
		final MultiplicativeExpression MultiplicativeExpression_530_Var = (MultiplicativeExpression)Expr_529_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_530_Var);
		final EList<? extends EObject> Expr_530_list = MultiplicativeExpression_530_Var.getExpr();
		Assert.assertNotNull(Expr_530_list);
		Assert.assertEquals(1, Expr_530_list.size());
		final CastExpression CastExpression_531_Var = (CastExpression)Expr_530_list.get(0);
		Assert.assertNotNull(CastExpression_531_Var);
		final UnaryExpression UnaryExpression_532_Var = (UnaryExpression)CastExpression_531_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_532_Var);
		final PostfixExpression PostfixExpression_533_Var = (PostfixExpression)UnaryExpression_532_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_533_Var);
		final EList<? extends EObject> Expr_533_list = PostfixExpression_533_Var.getExpr();
		Assert.assertNotNull(Expr_533_list);
		Assert.assertEquals(1, Expr_533_list.size());
		final PrimaryExpression PrimaryExpression_534_Var = (PrimaryExpression)Expr_533_list.get(0);
		Assert.assertNotNull(PrimaryExpression_534_Var);
		Assert.assertEquals("number", PrimaryExpression_534_Var.getId());
		Assert.assertEquals("[.]", PostfixExpression_533_Var.getDot().toString());
		Assert.assertEquals("[numChar]", PostfixExpression_533_Var.getId().toString());
		Assert.assertEquals(";", ExpressionStatement_483_Var.getSemi());
		final Statement Statement_535_Var = (Statement)Statement_94_list.get(9);
		Assert.assertNotNull(Statement_535_Var);
		final ExpressionStatement ExpressionStatement_536_Var = (ExpressionStatement)Statement_535_Var.getStmt();
		Assert.assertNotNull(ExpressionStatement_536_Var);
		final Expression Expression_537_Var = (Expression)ExpressionStatement_536_Var.getExpression();
		Assert.assertNotNull(Expression_537_Var);
		final EList<? extends EObject> ExprExpr_537_list = Expression_537_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_537_list);
		Assert.assertEquals(1, ExprExpr_537_list.size());
		final AssignmentExpression AssignmentExpression_538_Var = (AssignmentExpression)ExprExpr_537_list.get(0);
		Assert.assertNotNull(AssignmentExpression_538_Var);
		final ConditionalExpression ConditionalExpression_539_Var = (ConditionalExpression)AssignmentExpression_538_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_539_Var);
		final LogicalOrExpression LogicalOrExpression_540_Var = (LogicalOrExpression)ConditionalExpression_539_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_540_Var);
		final EList<? extends EObject> Expr_540_list = LogicalOrExpression_540_Var.getExpr();
		Assert.assertNotNull(Expr_540_list);
		Assert.assertEquals(1, Expr_540_list.size());
		final LogicalAndExpression LogicalAndExpression_541_Var = (LogicalAndExpression)Expr_540_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_541_Var);
		final EList<? extends EObject> Expr_541_list = LogicalAndExpression_541_Var.getExpr();
		Assert.assertNotNull(Expr_541_list);
		Assert.assertEquals(1, Expr_541_list.size());
		final InclusiveOrExpression InclusiveOrExpression_542_Var = (InclusiveOrExpression)Expr_541_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_542_Var);
		final EList<? extends EObject> Expr_542_list = InclusiveOrExpression_542_Var.getExpr();
		Assert.assertNotNull(Expr_542_list);
		Assert.assertEquals(1, Expr_542_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_543_Var = (ExclusiveOrExpression)Expr_542_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_543_Var);
		final EList<? extends EObject> Expr_543_list = ExclusiveOrExpression_543_Var.getExpr();
		Assert.assertNotNull(Expr_543_list);
		Assert.assertEquals(1, Expr_543_list.size());
		final AndExpression AndExpression_544_Var = (AndExpression)Expr_543_list.get(0);
		Assert.assertNotNull(AndExpression_544_Var);
		final EList<? extends EObject> Expr_544_list = AndExpression_544_Var.getExpr();
		Assert.assertNotNull(Expr_544_list);
		Assert.assertEquals(1, Expr_544_list.size());
		final EqualityExpression EqualityExpression_545_Var = (EqualityExpression)Expr_544_list.get(0);
		Assert.assertNotNull(EqualityExpression_545_Var);
		final EList<? extends EObject> Expr_545_list = EqualityExpression_545_Var.getExpr();
		Assert.assertNotNull(Expr_545_list);
		Assert.assertEquals(1, Expr_545_list.size());
		final RelationalExpression RelationalExpression_546_Var = (RelationalExpression)Expr_545_list.get(0);
		Assert.assertNotNull(RelationalExpression_546_Var);
		final EList<? extends EObject> Expr_546_list = RelationalExpression_546_Var.getExpr();
		Assert.assertNotNull(Expr_546_list);
		Assert.assertEquals(1, Expr_546_list.size());
		final ShiftExpression ShiftExpression_547_Var = (ShiftExpression)Expr_546_list.get(0);
		Assert.assertNotNull(ShiftExpression_547_Var);
		final EList<? extends EObject> Expr_547_list = ShiftExpression_547_Var.getExpr();
		Assert.assertNotNull(Expr_547_list);
		Assert.assertEquals(1, Expr_547_list.size());
		final AdditiveExpression AdditiveExpression_548_Var = (AdditiveExpression)Expr_547_list.get(0);
		Assert.assertNotNull(AdditiveExpression_548_Var);
		final EList<? extends EObject> Expr_548_list = AdditiveExpression_548_Var.getExpr();
		Assert.assertNotNull(Expr_548_list);
		Assert.assertEquals(1, Expr_548_list.size());
		final MultiplicativeExpression MultiplicativeExpression_549_Var = (MultiplicativeExpression)Expr_548_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_549_Var);
		final EList<? extends EObject> Expr_549_list = MultiplicativeExpression_549_Var.getExpr();
		Assert.assertNotNull(Expr_549_list);
		Assert.assertEquals(1, Expr_549_list.size());
		final CastExpression CastExpression_550_Var = (CastExpression)Expr_549_list.get(0);
		Assert.assertNotNull(CastExpression_550_Var);
		final UnaryExpression UnaryExpression_551_Var = (UnaryExpression)CastExpression_550_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_551_Var);
		final PostfixExpression PostfixExpression_552_Var = (PostfixExpression)UnaryExpression_551_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_552_Var);
		final EList<? extends EObject> Expr_552_list = PostfixExpression_552_Var.getExpr();
		Assert.assertNotNull(Expr_552_list);
		Assert.assertEquals(1, Expr_552_list.size());
		final PrimaryExpression PrimaryExpression_553_Var = (PrimaryExpression)Expr_552_list.get(0);
		Assert.assertNotNull(PrimaryExpression_553_Var);
		Assert.assertEquals("printf", PrimaryExpression_553_Var.getId());
		final EList<? extends EObject> ArgumentExpressionList_553_list = PostfixExpression_552_Var.getArgumentExpressionList();
		Assert.assertNotNull(ArgumentExpressionList_553_list);
		Assert.assertEquals(1, ArgumentExpressionList_553_list.size());
		final ArgumentExpressionList ArgumentExpressionList_554_Var = (ArgumentExpressionList)ArgumentExpressionList_553_list.get(0);
		Assert.assertNotNull(ArgumentExpressionList_554_Var);
		final EList<? extends EObject> Expr_554_list = ArgumentExpressionList_554_Var.getExpr();
		Assert.assertNotNull(Expr_554_list);
		Assert.assertEquals(2, Expr_554_list.size());
		final AssignmentExpression AssignmentExpression_555_Var = (AssignmentExpression)Expr_554_list.get(0);
		Assert.assertNotNull(AssignmentExpression_555_Var);
		final ConditionalExpression ConditionalExpression_556_Var = (ConditionalExpression)AssignmentExpression_555_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_556_Var);
		final LogicalOrExpression LogicalOrExpression_557_Var = (LogicalOrExpression)ConditionalExpression_556_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_557_Var);
		final EList<? extends EObject> Expr_557_list = LogicalOrExpression_557_Var.getExpr();
		Assert.assertNotNull(Expr_557_list);
		Assert.assertEquals(1, Expr_557_list.size());
		final LogicalAndExpression LogicalAndExpression_558_Var = (LogicalAndExpression)Expr_557_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_558_Var);
		final EList<? extends EObject> Expr_558_list = LogicalAndExpression_558_Var.getExpr();
		Assert.assertNotNull(Expr_558_list);
		Assert.assertEquals(1, Expr_558_list.size());
		final InclusiveOrExpression InclusiveOrExpression_559_Var = (InclusiveOrExpression)Expr_558_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_559_Var);
		final EList<? extends EObject> Expr_559_list = InclusiveOrExpression_559_Var.getExpr();
		Assert.assertNotNull(Expr_559_list);
		Assert.assertEquals(1, Expr_559_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_560_Var = (ExclusiveOrExpression)Expr_559_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_560_Var);
		final EList<? extends EObject> Expr_560_list = ExclusiveOrExpression_560_Var.getExpr();
		Assert.assertNotNull(Expr_560_list);
		Assert.assertEquals(1, Expr_560_list.size());
		final AndExpression AndExpression_561_Var = (AndExpression)Expr_560_list.get(0);
		Assert.assertNotNull(AndExpression_561_Var);
		final EList<? extends EObject> Expr_561_list = AndExpression_561_Var.getExpr();
		Assert.assertNotNull(Expr_561_list);
		Assert.assertEquals(1, Expr_561_list.size());
		final EqualityExpression EqualityExpression_562_Var = (EqualityExpression)Expr_561_list.get(0);
		Assert.assertNotNull(EqualityExpression_562_Var);
		final EList<? extends EObject> Expr_562_list = EqualityExpression_562_Var.getExpr();
		Assert.assertNotNull(Expr_562_list);
		Assert.assertEquals(1, Expr_562_list.size());
		final RelationalExpression RelationalExpression_563_Var = (RelationalExpression)Expr_562_list.get(0);
		Assert.assertNotNull(RelationalExpression_563_Var);
		final EList<? extends EObject> Expr_563_list = RelationalExpression_563_Var.getExpr();
		Assert.assertNotNull(Expr_563_list);
		Assert.assertEquals(1, Expr_563_list.size());
		final ShiftExpression ShiftExpression_564_Var = (ShiftExpression)Expr_563_list.get(0);
		Assert.assertNotNull(ShiftExpression_564_Var);
		final EList<? extends EObject> Expr_564_list = ShiftExpression_564_Var.getExpr();
		Assert.assertNotNull(Expr_564_list);
		Assert.assertEquals(1, Expr_564_list.size());
		final AdditiveExpression AdditiveExpression_565_Var = (AdditiveExpression)Expr_564_list.get(0);
		Assert.assertNotNull(AdditiveExpression_565_Var);
		final EList<? extends EObject> Expr_565_list = AdditiveExpression_565_Var.getExpr();
		Assert.assertNotNull(Expr_565_list);
		Assert.assertEquals(1, Expr_565_list.size());
		final MultiplicativeExpression MultiplicativeExpression_566_Var = (MultiplicativeExpression)Expr_565_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_566_Var);
		final EList<? extends EObject> Expr_566_list = MultiplicativeExpression_566_Var.getExpr();
		Assert.assertNotNull(Expr_566_list);
		Assert.assertEquals(1, Expr_566_list.size());
		final CastExpression CastExpression_567_Var = (CastExpression)Expr_566_list.get(0);
		Assert.assertNotNull(CastExpression_567_Var);
		final UnaryExpression UnaryExpression_568_Var = (UnaryExpression)CastExpression_567_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_568_Var);
		final PostfixExpression PostfixExpression_569_Var = (PostfixExpression)UnaryExpression_568_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_569_Var);
		final EList<? extends EObject> Expr_569_list = PostfixExpression_569_Var.getExpr();
		Assert.assertNotNull(Expr_569_list);
		Assert.assertEquals(1, Expr_569_list.size());
		final PrimaryExpression PrimaryExpression_570_Var = (PrimaryExpression)Expr_569_list.get(0);
		Assert.assertNotNull(PrimaryExpression_570_Var);
		final Constant Constant_571_Var = (Constant)PrimaryExpression_570_Var.getConst();
		Assert.assertNotNull(Constant_571_Var);
		Assert.assertEquals("\"number.numFloat=%f\\n\"", Constant_571_Var.getStr());
		final AssignmentExpression AssignmentExpression_572_Var = (AssignmentExpression)Expr_554_list.get(1);
		Assert.assertNotNull(AssignmentExpression_572_Var);
		final ConditionalExpression ConditionalExpression_573_Var = (ConditionalExpression)AssignmentExpression_572_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_573_Var);
		final LogicalOrExpression LogicalOrExpression_574_Var = (LogicalOrExpression)ConditionalExpression_573_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_574_Var);
		final EList<? extends EObject> Expr_574_list = LogicalOrExpression_574_Var.getExpr();
		Assert.assertNotNull(Expr_574_list);
		Assert.assertEquals(1, Expr_574_list.size());
		final LogicalAndExpression LogicalAndExpression_575_Var = (LogicalAndExpression)Expr_574_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_575_Var);
		final EList<? extends EObject> Expr_575_list = LogicalAndExpression_575_Var.getExpr();
		Assert.assertNotNull(Expr_575_list);
		Assert.assertEquals(1, Expr_575_list.size());
		final InclusiveOrExpression InclusiveOrExpression_576_Var = (InclusiveOrExpression)Expr_575_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_576_Var);
		final EList<? extends EObject> Expr_576_list = InclusiveOrExpression_576_Var.getExpr();
		Assert.assertNotNull(Expr_576_list);
		Assert.assertEquals(1, Expr_576_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_577_Var = (ExclusiveOrExpression)Expr_576_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_577_Var);
		final EList<? extends EObject> Expr_577_list = ExclusiveOrExpression_577_Var.getExpr();
		Assert.assertNotNull(Expr_577_list);
		Assert.assertEquals(1, Expr_577_list.size());
		final AndExpression AndExpression_578_Var = (AndExpression)Expr_577_list.get(0);
		Assert.assertNotNull(AndExpression_578_Var);
		final EList<? extends EObject> Expr_578_list = AndExpression_578_Var.getExpr();
		Assert.assertNotNull(Expr_578_list);
		Assert.assertEquals(1, Expr_578_list.size());
		final EqualityExpression EqualityExpression_579_Var = (EqualityExpression)Expr_578_list.get(0);
		Assert.assertNotNull(EqualityExpression_579_Var);
		final EList<? extends EObject> Expr_579_list = EqualityExpression_579_Var.getExpr();
		Assert.assertNotNull(Expr_579_list);
		Assert.assertEquals(1, Expr_579_list.size());
		final RelationalExpression RelationalExpression_580_Var = (RelationalExpression)Expr_579_list.get(0);
		Assert.assertNotNull(RelationalExpression_580_Var);
		final EList<? extends EObject> Expr_580_list = RelationalExpression_580_Var.getExpr();
		Assert.assertNotNull(Expr_580_list);
		Assert.assertEquals(1, Expr_580_list.size());
		final ShiftExpression ShiftExpression_581_Var = (ShiftExpression)Expr_580_list.get(0);
		Assert.assertNotNull(ShiftExpression_581_Var);
		final EList<? extends EObject> Expr_581_list = ShiftExpression_581_Var.getExpr();
		Assert.assertNotNull(Expr_581_list);
		Assert.assertEquals(1, Expr_581_list.size());
		final AdditiveExpression AdditiveExpression_582_Var = (AdditiveExpression)Expr_581_list.get(0);
		Assert.assertNotNull(AdditiveExpression_582_Var);
		final EList<? extends EObject> Expr_582_list = AdditiveExpression_582_Var.getExpr();
		Assert.assertNotNull(Expr_582_list);
		Assert.assertEquals(1, Expr_582_list.size());
		final MultiplicativeExpression MultiplicativeExpression_583_Var = (MultiplicativeExpression)Expr_582_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_583_Var);
		final EList<? extends EObject> Expr_583_list = MultiplicativeExpression_583_Var.getExpr();
		Assert.assertNotNull(Expr_583_list);
		Assert.assertEquals(1, Expr_583_list.size());
		final CastExpression CastExpression_584_Var = (CastExpression)Expr_583_list.get(0);
		Assert.assertNotNull(CastExpression_584_Var);
		final UnaryExpression UnaryExpression_585_Var = (UnaryExpression)CastExpression_584_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_585_Var);
		final PostfixExpression PostfixExpression_586_Var = (PostfixExpression)UnaryExpression_585_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_586_Var);
		final EList<? extends EObject> Expr_586_list = PostfixExpression_586_Var.getExpr();
		Assert.assertNotNull(Expr_586_list);
		Assert.assertEquals(1, Expr_586_list.size());
		final PrimaryExpression PrimaryExpression_587_Var = (PrimaryExpression)Expr_586_list.get(0);
		Assert.assertNotNull(PrimaryExpression_587_Var);
		Assert.assertEquals("number", PrimaryExpression_587_Var.getId());
		Assert.assertEquals("[.]", PostfixExpression_586_Var.getDot().toString());
		Assert.assertEquals("[numFloat]", PostfixExpression_586_Var.getId().toString());
		Assert.assertEquals(";", ExpressionStatement_536_Var.getSemi());
		final Statement Statement_588_Var = (Statement)Statement_94_list.get(10);
		Assert.assertNotNull(Statement_588_Var);
		final JumpStatement JumpStatement_589_Var = (JumpStatement)Statement_588_Var.getStmt();
		Assert.assertNotNull(JumpStatement_589_Var);
		final Expression Expression_590_Var = (Expression)JumpStatement_589_Var.getExpr();
		Assert.assertNotNull(Expression_590_Var);
		final EList<? extends EObject> ExprExpr_590_list = Expression_590_Var.getExprExpr();
		Assert.assertNotNull(ExprExpr_590_list);
		Assert.assertEquals(1, ExprExpr_590_list.size());
		final AssignmentExpression AssignmentExpression_591_Var = (AssignmentExpression)ExprExpr_590_list.get(0);
		Assert.assertNotNull(AssignmentExpression_591_Var);
		final ConditionalExpression ConditionalExpression_592_Var = (ConditionalExpression)AssignmentExpression_591_Var.getExpr();
		Assert.assertNotNull(ConditionalExpression_592_Var);
		final LogicalOrExpression LogicalOrExpression_593_Var = (LogicalOrExpression)ConditionalExpression_592_Var.getExpr();
		Assert.assertNotNull(LogicalOrExpression_593_Var);
		final EList<? extends EObject> Expr_593_list = LogicalOrExpression_593_Var.getExpr();
		Assert.assertNotNull(Expr_593_list);
		Assert.assertEquals(1, Expr_593_list.size());
		final LogicalAndExpression LogicalAndExpression_594_Var = (LogicalAndExpression)Expr_593_list.get(0);
		Assert.assertNotNull(LogicalAndExpression_594_Var);
		final EList<? extends EObject> Expr_594_list = LogicalAndExpression_594_Var.getExpr();
		Assert.assertNotNull(Expr_594_list);
		Assert.assertEquals(1, Expr_594_list.size());
		final InclusiveOrExpression InclusiveOrExpression_595_Var = (InclusiveOrExpression)Expr_594_list.get(0);
		Assert.assertNotNull(InclusiveOrExpression_595_Var);
		final EList<? extends EObject> Expr_595_list = InclusiveOrExpression_595_Var.getExpr();
		Assert.assertNotNull(Expr_595_list);
		Assert.assertEquals(1, Expr_595_list.size());
		final ExclusiveOrExpression ExclusiveOrExpression_596_Var = (ExclusiveOrExpression)Expr_595_list.get(0);
		Assert.assertNotNull(ExclusiveOrExpression_596_Var);
		final EList<? extends EObject> Expr_596_list = ExclusiveOrExpression_596_Var.getExpr();
		Assert.assertNotNull(Expr_596_list);
		Assert.assertEquals(1, Expr_596_list.size());
		final AndExpression AndExpression_597_Var = (AndExpression)Expr_596_list.get(0);
		Assert.assertNotNull(AndExpression_597_Var);
		final EList<? extends EObject> Expr_597_list = AndExpression_597_Var.getExpr();
		Assert.assertNotNull(Expr_597_list);
		Assert.assertEquals(1, Expr_597_list.size());
		final EqualityExpression EqualityExpression_598_Var = (EqualityExpression)Expr_597_list.get(0);
		Assert.assertNotNull(EqualityExpression_598_Var);
		final EList<? extends EObject> Expr_598_list = EqualityExpression_598_Var.getExpr();
		Assert.assertNotNull(Expr_598_list);
		Assert.assertEquals(1, Expr_598_list.size());
		final RelationalExpression RelationalExpression_599_Var = (RelationalExpression)Expr_598_list.get(0);
		Assert.assertNotNull(RelationalExpression_599_Var);
		final EList<? extends EObject> Expr_599_list = RelationalExpression_599_Var.getExpr();
		Assert.assertNotNull(Expr_599_list);
		Assert.assertEquals(1, Expr_599_list.size());
		final ShiftExpression ShiftExpression_600_Var = (ShiftExpression)Expr_599_list.get(0);
		Assert.assertNotNull(ShiftExpression_600_Var);
		final EList<? extends EObject> Expr_600_list = ShiftExpression_600_Var.getExpr();
		Assert.assertNotNull(Expr_600_list);
		Assert.assertEquals(1, Expr_600_list.size());
		final AdditiveExpression AdditiveExpression_601_Var = (AdditiveExpression)Expr_600_list.get(0);
		Assert.assertNotNull(AdditiveExpression_601_Var);
		final EList<? extends EObject> Expr_601_list = AdditiveExpression_601_Var.getExpr();
		Assert.assertNotNull(Expr_601_list);
		Assert.assertEquals(1, Expr_601_list.size());
		final MultiplicativeExpression MultiplicativeExpression_602_Var = (MultiplicativeExpression)Expr_601_list.get(0);
		Assert.assertNotNull(MultiplicativeExpression_602_Var);
		final EList<? extends EObject> Expr_602_list = MultiplicativeExpression_602_Var.getExpr();
		Assert.assertNotNull(Expr_602_list);
		Assert.assertEquals(1, Expr_602_list.size());
		final CastExpression CastExpression_603_Var = (CastExpression)Expr_602_list.get(0);
		Assert.assertNotNull(CastExpression_603_Var);
		final UnaryExpression UnaryExpression_604_Var = (UnaryExpression)CastExpression_603_Var.getExpr();
		Assert.assertNotNull(UnaryExpression_604_Var);
		final PostfixExpression PostfixExpression_605_Var = (PostfixExpression)UnaryExpression_604_Var.getExpr();
		Assert.assertNotNull(PostfixExpression_605_Var);
		final EList<? extends EObject> Expr_605_list = PostfixExpression_605_Var.getExpr();
		Assert.assertNotNull(Expr_605_list);
		Assert.assertEquals(1, Expr_605_list.size());
		final PrimaryExpression PrimaryExpression_606_Var = (PrimaryExpression)Expr_605_list.get(0);
		Assert.assertNotNull(PrimaryExpression_606_Var);
		final Constant Constant_607_Var = (Constant)PrimaryExpression_606_Var.getConst();
		Assert.assertNotNull(Constant_607_Var);
		Assert.assertEquals("0", Constant_607_Var.getDec());
		Assert.assertEquals("return", JumpStatement_589_Var.getReturn());
		Assert.assertEquals(";", JumpStatement_589_Var.getSemi());
	}
