...
public class Test0042_MultipleLinesPreprocessorDirective {
	...
	throws Exception{
		final String text = this.getTextFromFile("res/Test0041_MultipleLinesPreprocessorDirective.c");
	...
	throws Exception{
		...
		final Initializer Initializer_10_Var = (Initializer)InitDeclarator_7_Var.getInitializer();
		Assert.assertNotNull(Initializer_10_Var);
		final AssignmentExpression AssignmentExpression_11_Var = (AssignmentExpression)Initializer_10_Var.getExpr();
	...
	public void testGenerator() throws Exception {
		...
		Resource resource = set
			.getResource(
			URI.createURI("res/Test0041_MultipleLinesPreprocessorDirective.c"), true);
