		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPostfixExpressionAccess().getGroup_1_1_0(), "rule__PostfixExpression__Group_1_1_0__0");
					...
					put(grammarAccess.getPostfixExpressionAccess().getArrayExprAssignment_1_1_0_1(), "rule__PostfixExpression__ArrayExprAssignment_1_1_0_1");
					put(grammarAccess.getPostfixExpressionAccess().getArgumentExpressionListAssignment_1_1_1_1(), "rule__PostfixExpression__ArgumentExpressionListAssignment_1_1_1_1");
					put(grammarAccess.getPostfixExpressionAccess().getDotAssignment_1_1_2_0(), "rule__PostfixExpression__DotAssignment_1_1_2_0");
					put(grammarAccess.getPostfixExpressionAccess().getIdAssignment_1_1_2_1(), "rule__PostfixExpression__IdAssignment_1_1_2_1");
					put(grammarAccess.getPostfixExpressionAccess().getArrowAssignment_1_1_3_0(), "rule__PostfixExpression__ArrowAssignment_1_1_3_0");
					put(grammarAccess.getPostfixExpressionAccess().getIdAssignment_1_1_3_1(), "rule__PostfixExpression__IdAssignment_1_1_3_1");
					put(grammarAccess.getPostfixExpressionAccess().getPlusplusAssignment_1_1_4(), "rule__PostfixExpression__PlusplusAssignment_1_1_4");
					put(grammarAccess.getPostfixExpressionAccess().getMinusminusAssignment_1_1_5(), "rule__PostfixExpression__MinusminusAssignment_1_1_5");
