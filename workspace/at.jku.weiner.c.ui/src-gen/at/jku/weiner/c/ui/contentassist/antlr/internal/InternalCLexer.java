...
public class InternalCLexer extends Lexer {
	...
	public final void mRULE_KW_UNDERSCORE() throws RecognitionException {
		try {
			// InternalC.g:21958:29: ( '_' )
			// InternalC.g:21958:31: '_'
			{
			match('_'); 
			}
	...
	public final void mRULE_KW_AUTO() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21960:14: ( 'auto' )
			// InternalC.g:21960:16: 'auto'
			{
			match("auto"); 
	...
	public final void mRULE_KW_BREAK() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21962:15: ( 'break' )
			// InternalC.g:21962:17: 'break'
			{
			match("break"); 
	...
	public final void mRULE_KW_CASE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21964:14: ( 'case' )
			// InternalC.g:21964:16: 'case'
			{
			match("case"); 
	...
	public final void mRULE_KW_CHAR() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21966:14: ( 'char' )
			// InternalC.g:21966:16: 'char'
			{
			match("char"); 
	...
	public final void mRULE_KW_CONST() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21968:15: ( 'const' )
			// InternalC.g:21968:17: 'const'
			{
			match("const"); 
	...
	public final void mRULE_KW_CONTINUE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21970:18: ( 'continue' )
			// InternalC.g:21970:20: 'continue'
			{
			match("continue"); 
	...
	public final void mRULE_KW_DEFAULT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21972:17: ( 'default' )
			// InternalC.g:21972:19: 'default'
			{
			match("default"); 
	...
	public final void mRULE_KW_DO() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21974:12: ( 'do' )
			// InternalC.g:21974:14: 'do'
			{
			match("do"); 
	...
	public final void mRULE_KW_DOUBLE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21976:16: ( 'double' )
			// InternalC.g:21976:18: 'double'
			{
			match("double"); 
	...
	public final void mRULE_KW_ELSE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21978:14: ( 'else' )
			// InternalC.g:21978:16: 'else'
			{
			match("else"); 
	...
	public final void mRULE_KW_ENUM() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21980:14: ( 'enum' )
			// InternalC.g:21980:16: 'enum'
			{
			match("enum"); 
	...
	public final void mRULE_KW_EXTERN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21982:16: ( 'extern' )
			// InternalC.g:21982:18: 'extern'
			{
			match("extern"); 
	...
	public final void mRULE_KW_FLOAT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21984:15: ( 'float' )
			// InternalC.g:21984:17: 'float'
			{
			match("float"); 
	...
	public final void mRULE_KW_FOR() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21986:13: ( 'for' )
			// InternalC.g:21986:15: 'for'
			{
			match("for"); 
	...
	public final void mRULE_KW_GOTO() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21988:14: ( 'goto' )
			// InternalC.g:21988:16: 'goto'
			{
			match("goto"); 
	...
	public final void mRULE_KW_IF() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21990:12: ( 'if' )
			// InternalC.g:21990:14: 'if'
			{
			match("if"); 
	...
	public final void mRULE_KW_INLINE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21992:16: ( 'inline' )
			// InternalC.g:21992:18: 'inline'
			{
			match("inline"); 
	...
	public final void mRULE_KW_INT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21994:13: ( 'int' )
			// InternalC.g:21994:15: 'int'
			{
			match("int"); 
	...
	public final void mRULE_KW_LONG() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21996:14: ( 'long' )
			// InternalC.g:21996:16: 'long'
			{
			match("long"); 
	...
	public final void mRULE_KW_REGISTER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:21998:18: ( 'register' )
			// InternalC.g:21998:20: 'register'
			{
			match("register"); 
	...
	public final void mRULE_KW_RESTRICT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22000:18: ( 'restrict' )
			// InternalC.g:22000:20: 'restrict'
			{
			match("restrict"); 
	...
	public final void mRULE_KW_RETURN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22002:16: ( 'return' )
			// InternalC.g:22002:18: 'return'
			{
			match("return"); 
	...
	public final void mRULE_KW_SHORT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22004:15: ( 'short' )
			// InternalC.g:22004:17: 'short'
			{
			match("short"); 
	...
	public final void mRULE_KW_SIGNED() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22006:16: ( 'signed' )
			// InternalC.g:22006:18: 'signed'
			{
			match("signed"); 
	...
	public final void mRULE_KW_SIZEOF() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22008:16: ( 'sizeof' )
			// InternalC.g:22008:18: 'sizeof'
			{
			match("sizeof"); 
	...
	public final void mRULE_KW_STATIC() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22010:16: ( 'static' )
			// InternalC.g:22010:18: 'static'
			{
			match("static"); 
	...
	public final void mRULE_KW_STRUCT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22012:16: ( 'struct' )
			// InternalC.g:22012:18: 'struct'
			{
			match("struct"); 
	...
	public final void mRULE_KW_SWITCH() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22014:16: ( 'switch' )
			// InternalC.g:22014:18: 'switch'
			{
			match("switch"); 
	...
	public final void mRULE_KW_TYPEDEF() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22016:17: ( 'typedef' )
			// InternalC.g:22016:19: 'typedef'
			{
			match("typedef"); 
	...
	public final void mRULE_KW_UNION() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22018:15: ( 'union' )
			// InternalC.g:22018:17: 'union'
			{
			match("union"); 
	...
	public final void mRULE_KW_UNSIGNED() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22020:18: ( 'unsigned' )
			// InternalC.g:22020:20: 'unsigned'
			{
			match("unsigned"); 
	...
	public final void mRULE_KW_VOID() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22022:14: ( 'void' )
			// InternalC.g:22022:16: 'void'
			{
			match("void"); 
	...
	public final void mRULE_KW_VOLATILE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22024:18: ( 'volatile' )
			// InternalC.g:22024:20: 'volatile'
			{
			match("volatile"); 
	...
	public final void mRULE_KW_WHILE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22026:15: ( 'while' )
			// InternalC.g:22026:17: 'while'
			{
			match("while"); 
	...
	public final void mRULE_KW_ALIGNAS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22028:17: ( '_Alignas' )
			// InternalC.g:22028:19: '_Alignas'
			{
			match("_Alignas"); 
	...
	public final void mRULE_KW_ALIGNOF() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22030:17: ( '_Alignof' )
			// InternalC.g:22030:19: '_Alignof'
			{
			match("_Alignof"); 
	...
	public final void mRULE_KW_ASM1() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22032:14: ( RULE_KW_UNDERSCORE RULE_KW_UNDERSCORE 'asm' )
			// InternalC.g:22032:16: RULE_KW_UNDERSCORE RULE_KW_UNDERSCORE 'asm'
			{
			mRULE_KW_UNDERSCORE(); 
	...
	public final void mRULE_KW_ASM2() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22034:14: ( RULE_KW_ASM1 RULE_KW_UNDERSCORE RULE_KW_UNDERSCORE )
			// InternalC.g:22034:16: RULE_KW_ASM1 RULE_KW_UNDERSCORE RULE_KW_UNDERSCORE
			{
			mRULE_KW_ASM1(); 
	...
	public final void mRULE_KW_ATOMIC() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22036:16: ( '_Atomic' )
			// InternalC.g:22036:18: '_Atomic'
			{
			match("_Atomic"); 
	...
	public final void mRULE_KW_BOOL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22038:14: ( '_Bool' )
			// InternalC.g:22038:16: '_Bool'
			{
			match("_Bool"); 
	...
	public final void mRULE_KW_COMPLEX() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22040:17: ( '_Complex' )
			// InternalC.g:22040:19: '_Complex'
			{
			match("_Complex"); 
	...
	public final void mRULE_KW_GENERIC() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22042:17: ( '_Generic' )
			// InternalC.g:22042:19: '_Generic'
			{
			match("_Generic"); 
	...
	public final void mRULE_KW_IMAGINARY() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22044:19: ( '_Imaginary' )
			// InternalC.g:22044:21: '_Imaginary'
			{
			match("_Imaginary"); 
	...
	public final void mRULE_KW_NORETURN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22046:18: ( '_Noreturn' )
			// InternalC.g:22046:20: '_Noreturn'
			{
			match("_Noreturn"); 
	...
	public final void mRULE_KW_STATICASSERT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22048:22: ( '_Static_assert' )
			// InternalC.g:22048:24: '_Static_assert'
			{
	...
	public final void mRULE_KW_THREADLOCAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22050:21: ( '_Thread_local' )
			// InternalC.g:22050:23: '_Thread_local'
			{
			match("_Thread_local"); 
	...
	public final void mRULE_KW_PRAGMA() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22052:16: ( 'pragma' )
			// InternalC.g:22052:18: 'pragma'
			{
			match("pragma"); 
	...
	public final void mRULE_KW_VOLATILE2() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22054:19: ( RULE_KW_UNDERSCORE RULE_KW_UNDERSCORE RULE_KW_VOLATILE RULE_KW_UNDERSCORE RULE_KW_UNDERSCORE )
			// InternalC.g:22054:21: RULE_KW_UNDERSCORE RULE_KW_UNDERSCORE RULE_KW_VOLATILE RULE_KW_UNDERSCORE RULE_KW_UNDERSCORE
			{
			mRULE_KW_UNDERSCORE(); 
	...
	public final void mRULE_LEFTPAREN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22056:16: ( '(' )
			// InternalC.g:22056:18: '('
			{
			match('('); 
			}
	...
	public final void mRULE_RIGHTPAREN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22058:17: ( ')' )
			// InternalC.g:22058:19: ')'
			{
			match(')'); 
			}
	...
	public final void mRULE_LEFTBRACKET() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22060:18: ( '[' )
			// InternalC.g:22060:20: '['
			{
			match('['); 
			}
	...
	public final void mRULE_RIGHTBRACKET() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22062:19: ( ']' )
			// InternalC.g:22062:21: ']'
			{
			match(']'); 
			}
	...
	public final void mRULE_LEFTBRACE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22064:16: ( '{' )
			// InternalC.g:22064:18: '{'
			{
			match('{'); 
			}
	...
	public final void mRULE_RIGHTBRACE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22066:17: ( '}' )
			// InternalC.g:22066:19: '}'
			{
			match('}'); 
			}
	...
	public final void mRULE_LESS() throws RecognitionException {
		try {
			int _type = RULE_LESS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22068:11: ( '<' )
			// InternalC.g:22068:13: '<'
			{
			match('<'); 
			}
	...
	public final void mRULE_LESSEQUAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22070:16: ( RULE_LESS RULE_ASSIGN )
			// InternalC.g:22070:18: RULE_LESS RULE_ASSIGN
			{
			mRULE_LESS(); 
	...
	public final void mRULE_GREATER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22072:14: ( '>' )
			// InternalC.g:22072:16: '>'
			{
			match('>'); 
			}
	...
	public final void mRULE_GREATEREQUAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22074:19: ( RULE_GREATER RULE_ASSIGN )
			// InternalC.g:22074:21: RULE_GREATER RULE_ASSIGN
			{
			mRULE_GREATER(); 
	...
	public final void mRULE_LEFTSHIFT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22076:16: ( RULE_LESS RULE_LESS )
			// InternalC.g:22076:18: RULE_LESS RULE_LESS
			{
			mRULE_LESS(); 
	...
	public final void mRULE_RIGHTSHIFT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22078:17: ( RULE_GREATER RULE_GREATER )
			// InternalC.g:22078:19: RULE_GREATER RULE_GREATER
			{
			mRULE_GREATER(); 
	...
	public final void mRULE_PLUS() throws RecognitionException {
		try {
			int _type = RULE_PLUS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22080:11: ( '+' )
			// InternalC.g:22080:13: '+'
			{
			match('+'); 
			}
	...
	public final void mRULE_PLUSPLUS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22082:15: ( RULE_PLUS RULE_PLUS )
			// InternalC.g:22082:17: RULE_PLUS RULE_PLUS
			{
			mRULE_PLUS(); 
	...
	public final void mRULE_MINUS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22084:12: ( '-' )
			// InternalC.g:22084:14: '-'
			{
			match('-'); 
			}
	...
	public final void mRULE_MINUSMINUS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22086:17: ( RULE_MINUS RULE_MINUS )
			// InternalC.g:22086:19: RULE_MINUS RULE_MINUS
			{
			mRULE_MINUS(); 
	...
	public final void mRULE_STAR() throws RecognitionException {
		try {
			int _type = RULE_STAR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22088:11: ( '*' )
			// InternalC.g:22088:13: '*'
			{
			match('*'); 
			}
	...
	public final void mRULE_DIV() throws RecognitionException {
		try {
			int _type = RULE_DIV;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22090:10: ( '/' )
			// InternalC.g:22090:12: '/'
			{
			match('/'); 
			}
	...
	public final void mRULE_MOD() throws RecognitionException {
		try {
			int _type = RULE_MOD;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22092:10: ( '%' )
			// InternalC.g:22092:12: '%'
			{
			match('%'); 
			}
	...
	public final void mRULE_AND() throws RecognitionException {
		try {
			int _type = RULE_AND;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22094:10: ( '&' )
			// InternalC.g:22094:12: '&'
			{
			match('&'); 
			}
	...
	public final void mRULE_ANDAND() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22096:13: ( RULE_AND RULE_AND )
			// InternalC.g:22096:15: RULE_AND RULE_AND
			{
			mRULE_AND(); 
	...
	public final void mRULE_OROR() throws RecognitionException {
		try {
			int _type = RULE_OROR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22100:11: ( RULE_OR RULE_OR )
			// InternalC.g:22100:13: RULE_OR RULE_OR
			{
			mRULE_OR(); 
	...
	public final void mRULE_CARET() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22102:12: ( '^' )
			// InternalC.g:22102:14: '^'
			{
			match('^'); 
			}
	...
	public final void mRULE_NOT() throws RecognitionException {
		try {
			int _type = RULE_NOT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22104:10: ( '!' )
			// InternalC.g:22104:12: '!'
			{
			match('!'); 
			}
	...
	public final void mRULE_TILDE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22106:12: ( '~' )
			// InternalC.g:22106:14: '~'
			{
			match('~'); 
			}
	...
	public final void mRULE_QUESTION() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22108:15: ( '?' )
			// InternalC.g:22108:17: '?'
			{
			match('?'); 
			}
	...
	public final void mRULE_COLON() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22110:12: ( ':' )
			// InternalC.g:22110:14: ':'
			{
			match(':'); 
			}
	...
	public final void mRULE_SEMI() throws RecognitionException {
		try {
			int _type = RULE_SEMI;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22112:11: ( ';' )
			// InternalC.g:22112:13: ';'
			{
			match(';'); 
			}
	...
	public final void mRULE_COMMA() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22114:12: ( ',' )
			// InternalC.g:22114:14: ','
			{
			match(','); 
			}
	...
	public final void mRULE_ASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22116:13: ( '=' )
			// InternalC.g:22116:15: '='
			{
			match('='); 
			}
	...
	public final void mRULE_STARASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22118:17: ( RULE_STAR RULE_ASSIGN )
			// InternalC.g:22118:19: RULE_STAR RULE_ASSIGN
			{
			mRULE_STAR(); 
	...
	public final void mRULE_DIVASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22120:16: ( RULE_DIV RULE_ASSIGN )
			// InternalC.g:22120:18: RULE_DIV RULE_ASSIGN
			{
			mRULE_DIV(); 
	...
	public final void mRULE_MODASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22122:16: ( RULE_MOD RULE_ASSIGN )
			// InternalC.g:22122:18: RULE_MOD RULE_ASSIGN
			{
			mRULE_MOD(); 
	...
	public final void mRULE_PLUSASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22124:17: ( RULE_PLUS RULE_ASSIGN )
			// InternalC.g:22124:19: RULE_PLUS RULE_ASSIGN
			{
			mRULE_PLUS(); 
	...
	public final void mRULE_MINUSASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22126:18: ( RULE_MINUS RULE_ASSIGN )
			// InternalC.g:22126:20: RULE_MINUS RULE_ASSIGN
			{
			mRULE_MINUS(); 
	...
	public final void mRULE_LEFTSHIFTASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22128:22: ( RULE_LEFTSHIFT RULE_ASSIGN )
			// InternalC.g:22128:24: RULE_LEFTSHIFT RULE_ASSIGN
			{
			mRULE_LEFTSHIFT(); 
	...
	public final void mRULE_RIGHTSHIFTASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22130:23: ( RULE_RIGHTSHIFT RULE_ASSIGN )
			// InternalC.g:22130:25: RULE_RIGHTSHIFT RULE_ASSIGN
			{
			mRULE_RIGHTSHIFT(); 
	...
	public final void mRULE_ANDASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22132:16: ( RULE_AND RULE_ASSIGN )
			// InternalC.g:22132:18: RULE_AND RULE_ASSIGN
			{
			mRULE_AND(); 
	...
	public final void mRULE_XORASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22134:16: ( RULE_CARET RULE_ASSIGN )
			// InternalC.g:22134:18: RULE_CARET RULE_ASSIGN
			{
			mRULE_CARET(); 
	...
	public final void mRULE_ORASSIGN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22136:15: ( RULE_OR RULE_ASSIGN )
			// InternalC.g:22136:17: RULE_OR RULE_ASSIGN
			{
			mRULE_OR(); 
	...
	public final void mRULE_EQUAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22138:12: ( RULE_ASSIGN RULE_ASSIGN )
			// InternalC.g:22138:14: RULE_ASSIGN RULE_ASSIGN
			{
			mRULE_ASSIGN(); 
	...
	public final void mRULE_NOTEQUAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22140:15: ( RULE_NOT RULE_ASSIGN )
			// InternalC.g:22140:17: RULE_NOT RULE_ASSIGN
			{
			mRULE_NOT(); 
	...
	public final void mRULE_ARROW() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22142:12: ( RULE_MINUS RULE_GREATER )
			// InternalC.g:22142:14: RULE_MINUS RULE_GREATER
			{
			mRULE_MINUS(); 
	...
	public final void mRULE_DOT() throws RecognitionException {
		try {
			int _type = RULE_DOT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22144:10: ( '.' )
			// InternalC.g:22144:12: '.'
			{
			match('.'); 
			}
	...
	public final void mRULE_ELLIPSIS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22146:15: ( RULE_DOT RULE_DOT RULE_DOT )
			// InternalC.g:22146:17: RULE_DOT RULE_DOT RULE_DOT
			{
			mRULE_DOT(); 
	...
	public final void mRULE_SINGLEQUOTE() throws RecognitionException {
		try {
			// InternalC.g:22148:27: ( '\\'' )
			// InternalC.g:22148:29: '\\''
			{
			match('\''); 
			}
	...
	public final void mRULE_DOUBLEQUOTE() throws RecognitionException {
		try {
			// InternalC.g:22150:27: ( '\"' )
			// InternalC.g:22150:29: '\"'
			{
			match('\"'); 
			}
	...
	public final void mRULE_BACKSLASH() throws RecognitionException {
		try {
			// InternalC.g:22152:25: ( '\\\\' )
			// InternalC.g:22152:27: '\\\\'
			{
			match('\\'); 
			}
	...
	public final void mRULE_ID() throws RecognitionException {
		try {
			int _type = RULE_ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22154:9: ( RULE_IDENTIFIER )
			// InternalC.g:22154:11: RULE_IDENTIFIER
			{
			mRULE_IDENTIFIER(); 
	...
	public final void mRULE_IDENTIFIER() throws RecognitionException {
		try {
			// InternalC.g:22156:26: ( RULE_LETTER ( RULE_LETTER | '0' .. '9' )* )
			// InternalC.g:22156:28: RULE_LETTER ( RULE_LETTER | '0' .. '9' )*
			{
			mRULE_LETTER(); 

			// InternalC.g:22156:40: ( RULE_LETTER | '0' .. '9' )*
			loop1:
			while (true) {
				int alt1=2;
	...
	public final void mRULE_LETTER() throws RecognitionException {
		try {
			// InternalC.g:22158:22: ( ( '$' | 'A' .. 'Z' | 'a' .. 'z' | RULE_KW_UNDERSCORE ) )
			// InternalC.g:
			{
	...
	public final void mRULE_CHAR_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22160:19: ( RULE_SINGLEQUOTE ( RULE_ESCAPE_SEQUENCE |~ ( ( RULE_SINGLEQUOTE | RULE_BACKSLASH ) ) ) RULE_SINGLEQUOTE )
			// InternalC.g:22160:21: RULE_SINGLEQUOTE ( RULE_ESCAPE_SEQUENCE |~ ( ( RULE_SINGLEQUOTE | RULE_BACKSLASH ) ) ) RULE_SINGLEQUOTE
			{
			mRULE_SINGLEQUOTE(); 

			// InternalC.g:22160:38: ( RULE_ESCAPE_SEQUENCE |~ ( ( RULE_SINGLEQUOTE | RULE_BACKSLASH ) ) )
			int alt2=2;
			...
			switch (alt2) {
				case 1 :
					// InternalC.g:22160:39: RULE_ESCAPE_SEQUENCE
					{
					...
					break;
				case 2 :
					// InternalC.g:22160:60: ~ ( ( RULE_SINGLEQUOTE | RULE_BACKSLASH ) )
					{
	...
	public final void mRULE_STRING_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22162:21: ( RULE_DOUBLEQUOTE ( RULE_ESCAPE_SEQUENCE |~ ( ( RULE_BACKSLASH | RULE_DOUBLEQUOTE ) ) )* RULE_DOUBLEQUOTE )
			// InternalC.g:22162:23: RULE_DOUBLEQUOTE ( RULE_ESCAPE_SEQUENCE |~ ( ( RULE_BACKSLASH | RULE_DOUBLEQUOTE ) ) )* RULE_DOUBLEQUOTE
			{
			mRULE_DOUBLEQUOTE(); 

			// InternalC.g:22162:40: ( RULE_ESCAPE_SEQUENCE |~ ( ( RULE_BACKSLASH | RULE_DOUBLEQUOTE ) ) )*
			loop3:
			while (true) {
				int alt3=3;
				...
				switch (alt3) {
				case 1 :
					// InternalC.g:22162:41: RULE_ESCAPE_SEQUENCE
					{
					mRULE_ESCAPE_SEQUENCE(); 
					...
					break;
				case 2 :
					// InternalC.g:22162:62: ~ ( ( RULE_BACKSLASH | RULE_DOUBLEQUOTE ) )
					{
					if ( (input.LA(1) >= '\u0000' && input.LA(1) <= '!')||(input.LA(1) >= '#' && input.LA(1) <= '[')||(input.LA(1) >= ']' && input.LA(1) <= '\uFFFF') ) {
						input.consume();
					}
	...
	public final void mRULE_HEX_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22164:18: ( '0' ( 'x' | 'X' ) ( RULE_HEX_DIGIT )+ ( RULE_INTEGER_TYPE_SUFFIX )? )
			// InternalC.g:22164:20: '0' ( 'x' | 'X' ) ( RULE_HEX_DIGIT )+ ( RULE_INTEGER_TYPE_SUFFIX )?
			{
			match('0'); 
			...
			// InternalC.g:22164:34: ( RULE_HEX_DIGIT )+
			int cnt4=0;
			loop4:
			while (true) {
				int alt4=2;
			...
			// InternalC.g:22164:50: ( RULE_INTEGER_TYPE_SUFFIX )?
			int alt5=2;
	...
	public final void mRULE_DECIMAL_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22166:22: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( RULE_INTEGER_TYPE_SUFFIX )? )
			// InternalC.g:22166:24: ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( RULE_INTEGER_TYPE_SUFFIX )?
			{
			// InternalC.g:22166:24: ( '0' | '1' .. '9' ( '0' .. '9' )* )
			int alt7=2;
			...
			switch (alt7) {
				case 1 :
					// InternalC.g:22166:25: '0'
					{
					match('0'); 
					}
					break;
				case 2 :
					// InternalC.g:22166:29: '1' .. '9' ( '0' .. '9' )*
					{
					matchRange('1','9'); 
					// InternalC.g:22166:38: ( '0' .. '9' )*
					loop6:
					while (true) {
						int alt6=2;
			...
			// InternalC.g:22166:51: ( RULE_INTEGER_TYPE_SUFFIX )?
			int alt8=2;
	...
	public final void mRULE_OCTAL_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22168:20: ( '0' ( '0' .. '7' )+ ( RULE_INTEGER_TYPE_SUFFIX )? )
			// InternalC.g:22168:22: '0' ( '0' .. '7' )+ ( RULE_INTEGER_TYPE_SUFFIX )?
			{
			match('0'); 
			// InternalC.g:22168:26: ( '0' .. '7' )+
			int cnt9=0;
			loop9:
			while (true) {
				int alt9=2;
			...
			// InternalC.g:22168:38: ( RULE_INTEGER_TYPE_SUFFIX )?
			int alt10=2;
	...
	public final void mRULE_BIN_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22170:18: ( ( '0b' | '0B' ) ( '0' .. '1' )+ )
			// InternalC.g:22170:20: ( '0b' | '0B' ) ( '0' .. '1' )+
			{
			// InternalC.g:22170:20: ( '0b' | '0B' )
			int alt11=2;
	...
	public final void mRULE_HEX_DIGIT() throws RecognitionException {
		try {
			// InternalC.g:22172:25: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
			// InternalC.g:
			{
			if ( (input.LA(1) >= '0' && input.LA(1) <= '9')||(input.LA(1) >= 'A' && input.LA(1) <= 'F')||(input.LA(1) >= 'a' && input.LA(1) <= 'f') ) {
				input.consume();
	...
	public final void mRULE_INTEGER_TYPE_SUFFIX() throws RecognitionException {
		try {
			// InternalC.g:22174:35: ( ( ( 'u' | 'U' )? ( 'l' | 'L' ) | ( 'u' | 'U' ) ( 'l' | 'L' )? ) )
			// InternalC.g:22174:37: ( ( 'u' | 'U' )? ( 'l' | 'L' ) | ( 'u' | 'U' ) ( 'l' | 'L' )? )
			{
			// InternalC.g:22174:37: ( ( 'u' | 'U' )? ( 'l' | 'L' ) | ( 'u' | 'U' ) ( 'l' | 'L' )? )
			int alt15=2;
			...
			switch (alt15) {
				case 1 :
					// InternalC.g:22174:38: ( 'u' | 'U' )? ( 'l' | 'L' )
					{
					// InternalC.g:22174:38: ( 'u' | 'U' )?
					int alt13=2;
	...
	public final void mRULE_FLOAT_LITERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22176:20: ( ( ( '0' .. '9' )+ RULE_DOT ( '0' .. '9' )* ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | RULE_DOT ( '0' .. '9' )+ ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ RULE_EXPONENT ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ ( RULE_EXPONENT )? RULE_FLOAT_TYPE_SUFFIX ) )
			// InternalC.g:22176:22: ( ( '0' .. '9' )+ RULE_DOT ( '0' .. '9' )* ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | RULE_DOT ( '0' .. '9' )+ ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ RULE_EXPONENT ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ ( RULE_EXPONENT )? RULE_FLOAT_TYPE_SUFFIX )
			{
			// InternalC.g:22176:22: ( ( '0' .. '9' )+ RULE_DOT ( '0' .. '9' )* ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | RULE_DOT ( '0' .. '9' )+ ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ RULE_EXPONENT ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ ( RULE_EXPONENT )? RULE_FLOAT_TYPE_SUFFIX )
			int alt27=4;
			...
			switch (alt27) {
				case 1 :
					// InternalC.g:22176:23: ( '0' .. '9' )+ RULE_DOT ( '0' .. '9' )* ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )?
					{
					// InternalC.g:22176:23: ( '0' .. '9' )+
					int cnt16=0;
					loop16:
					while (true) {
						int alt16=2;
					...
					// InternalC.g:22176:56: ( RULE_EXPONENT )?
					int alt18=2;
					...
					// InternalC.g:22176:71: ( RULE_FLOAT_TYPE_SUFFIX )?
					int alt19=2;
					...
					break;
				case 2 :
					// InternalC.g:22176:95: RULE_DOT ( '0' .. '9' )+ ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )?
					{
					mRULE_DOT(); 

					// InternalC.g:22176:104: ( '0' .. '9' )+
					int cnt20=0;
					loop20:
					while (true) {
						int alt20=2;
					...
					// InternalC.g:22176:116: ( RULE_EXPONENT )?
					int alt21=2;
					...
					// InternalC.g:22176:131: ( RULE_FLOAT_TYPE_SUFFIX )?
					int alt22=2;
					...
					break;
				case 3 :
					// InternalC.g:22176:155: ( '0' .. '9' )+ RULE_EXPONENT ( RULE_FLOAT_TYPE_SUFFIX )?
					{
					// InternalC.g:22176:155: ( '0' .. '9' )+
					int cnt23=0;
					loop23:
					while (true) {
						int alt23=2;
					...
					// InternalC.g:22176:181: ( RULE_FLOAT_TYPE_SUFFIX )?
					int alt24=2;
					...
					break;
				case 4 :
					// InternalC.g:22176:205: ( '0' .. '9' )+ ( RULE_EXPONENT )? RULE_FLOAT_TYPE_SUFFIX
					{
					// InternalC.g:22176:205: ( '0' .. '9' )+
					int cnt25=0;
					loop25:
					while (true) {
						int alt25=2;
					...
					// InternalC.g:22176:217: ( RULE_EXPONENT )?
					int alt26=2;
	...
	public final void mRULE_EXPONENT() throws RecognitionException {
		try {
			// InternalC.g:22178:24: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
			// InternalC.g:22178:26: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
			{
	...
	public final void mRULE_ESCAPE_SEQUENCE() throws RecognitionException {
		try {
			// InternalC.g:22182:31: ( ( RULE_BACKSLASH ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | RULE_SINGLEQUOTE | RULE_BACKSLASH ) | RULE_OCTAL_ESCAPE ) )
			// InternalC.g:22182:33: ( RULE_BACKSLASH ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | RULE_SINGLEQUOTE | RULE_BACKSLASH ) | RULE_OCTAL_ESCAPE )
			{
			// InternalC.g:22182:33: ( RULE_BACKSLASH ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | RULE_SINGLEQUOTE | RULE_BACKSLASH ) | RULE_OCTAL_ESCAPE )
			int alt30=2;
			...
			switch (alt30) {
				case 1 :
					// InternalC.g:22182:34: RULE_BACKSLASH ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | RULE_SINGLEQUOTE | RULE_BACKSLASH )
					{
					mRULE_BACKSLASH(); 
					...
					break;
				case 2 :
					// InternalC.g:22182:107: RULE_OCTAL_ESCAPE
					{
					mRULE_OCTAL_ESCAPE(); 
	...
	public final void mRULE_OCTAL_ESCAPE() throws RecognitionException {
		try {
			// InternalC.g:22184:28: ( ( RULE_BACKSLASH '0' .. '3' '0' .. '7' '0' .. '7' | RULE_BACKSLASH '0' .. '7' '0' .. '7' | RULE_BACKSLASH '0' .. '7' ) )
			// InternalC.g:22184:30: ( RULE_BACKSLASH '0' .. '3' '0' .. '7' '0' .. '7' | RULE_BACKSLASH '0' .. '7' '0' .. '7' | RULE_BACKSLASH '0' .. '7' )
			{
			// InternalC.g:22184:30: ( RULE_BACKSLASH '0' .. '3' '0' .. '7' '0' .. '7' | RULE_BACKSLASH '0' .. '7' '0' .. '7' | RULE_BACKSLASH '0' .. '7' )
			int alt31=3;
			...
			switch (alt31) {
				case 1 :
					// InternalC.g:22184:31: RULE_BACKSLASH '0' .. '3' '0' .. '7' '0' .. '7'
					{
					mRULE_BACKSLASH(); 
					...
					break;
				case 2 :
					// InternalC.g:22184:73: RULE_BACKSLASH '0' .. '7' '0' .. '7'
					{
					mRULE_BACKSLASH(); 
					...
					break;
				case 3 :
					// InternalC.g:22184:106: RULE_BACKSLASH '0' .. '7'
					{
					mRULE_BACKSLASH(); 
	...
	public final void mRULE_UNICODE_ESCAPE() throws RecognitionException {
		try {
			// InternalC.g:22186:30: ( RULE_BACKSLASH 'u' RULE_HEX_DIGIT RULE_HEX_DIGIT RULE_HEX_DIGIT RULE_HEX_DIGIT )
			// InternalC.g:22186:32: RULE_BACKSLASH 'u' RULE_HEX_DIGIT RULE_HEX_DIGIT RULE_HEX_DIGIT RULE_HEX_DIGIT
			{
			mRULE_BACKSLASH(); 
	...
	public final void mRULE_LINEDIRECTIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22188:20: ( '#' (~ ( RULE_NEWLINE ) | RULE_BACKSLASH RULE_NEWLINE )* )
			// InternalC.g:22188:22: '#' (~ ( RULE_NEWLINE ) | RULE_BACKSLASH RULE_NEWLINE )*
			{
			match('#'); 
			// InternalC.g:22188:26: (~ ( RULE_NEWLINE ) | RULE_BACKSLASH RULE_NEWLINE )*
			loop32:
			while (true) {
				int alt32=3;
				...
				switch (alt32) {
				case 1 :
					// InternalC.g:22188:27: ~ ( RULE_NEWLINE )
					{
					...
					break;
				case 2 :
					// InternalC.g:22188:43: RULE_BACKSLASH RULE_NEWLINE
					{
					mRULE_BACKSLASH(); 
	...
	public final void mRULE_WHITESPACE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22190:17: ( ( ' ' | '\\t' )+ )
			// InternalC.g:22190:19: ( ' ' | '\\t' )+
			{
			// InternalC.g:22190:19: ( ' ' | '\\t' )+
			int cnt33=0;
			loop33:
	...
	public final void mRULE_BLOCK_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22192:20: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// InternalC.g:22192:22: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// InternalC.g:22192:27: ( options {greedy=false; } : . )*
			loop34:
			while (true) {
				int alt34=2;
	...
	public final void mRULE_LINE_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalC.g:22194:19: ( '//' (~ ( RULE_NEWLINE ) )* )
			// InternalC.g:22194:21: '//' (~ ( RULE_NEWLINE ) )*
			{
			match("//"); 

			// InternalC.g:22194:26: (~ ( RULE_NEWLINE ) )*
			loop35:
			while (true) {
				int alt35=2;
	...
	protected class DFA27 extends DFA {
		...
		public String getDescription() {
			return "22176:22: ( ( '0' .. '9' )+ RULE_DOT ( '0' .. '9' )* ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | RULE_DOT ( '0' .. '9' )+ ( RULE_EXPONENT )? ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ RULE_EXPONENT ( RULE_FLOAT_TYPE_SUFFIX )? | ( '0' .. '9' )+ ( RULE_EXPONENT )? RULE_FLOAT_TYPE_SUFFIX )";
		}
	}
