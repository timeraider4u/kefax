 ...
 *   <li>{@link at.jku.weiner.c.c.DeclaratorSuffix#getExpr <em>Expr</em>}</li>
...
public interface DeclaratorSuffix extends EObject
{
   ...
   * @see at.jku.weiner.c.c.CPackage#getDeclaratorSuffix_Static()
   * @model
   * @generated
   */
  String getStatic();
  ...
  /**
   * Sets the value of the '{@link at.jku.weiner.c.c.DeclaratorSuffix#getStatic <em>Static</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see at.jku.weiner.c.c.CPackage#getDeclaratorSuffix_TypeQualifierList()
  ...
  /**
   * Sets the value of the '{@link at.jku.weiner.c.c.DeclaratorSuffix#getTypeQualifierList <em>Type Qualifier List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see at.jku.weiner.c.c.CPackage#getDeclaratorSuffix_Expr()
   * @model containment="true"
   * @generated
   */
  Expression getExpr();
  ...
  /**
   * Sets the value of the '{@link at.jku.weiner.c.c.DeclaratorSuffix#getExpr <em>Expr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setStar(String)
   * @see at.jku.weiner.c.c.CPackage#getDeclaratorSuffix_Star()
   * @model
   * @generated
   */
  String getStar();
  ...
  /**
   * Sets the value of the '{@link at.jku.weiner.c.c.DeclaratorSuffix#getStar <em>Star</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
