 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.c.DirectDeclarator#getId <em>Id</em>}</li>
 *   <li>{@link at.jku.weiner.c.c.DirectDeclarator#getDeclarator <em>Declarator</em>}</li>
 *   <li>{@link at.jku.weiner.c.c.DirectDeclarator#getDeclaratorSuffix <em>Declarator Suffix</em>}</li>
 * </ul>
 * </p>
 *
 * @see at.jku.weiner.c.c.CPackage#getDirectDeclarator()
 * @model
 * @generated
 */
public interface DirectDeclarator extends EObject
{
   ...
   * @see #setId(String)
   * @see at.jku.weiner.c.c.CPackage#getDirectDeclarator_Id()
   * @model
   * @generated
   */
  String getId();
  ...
  /**
   * Sets the value of the '{@link at.jku.weiner.c.c.DirectDeclarator#getId <em>Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see at.jku.weiner.c.c.CPackage#getDirectDeclarator_Declarator()
  ...
  /**
   * Sets the value of the '{@link at.jku.weiner.c.c.DirectDeclarator#getDeclarator <em>Declarator</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link at.jku.weiner.c.c.DeclaratorSuffix}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see at.jku.weiner.c.c.CPackage#getDirectDeclarator_DeclaratorSuffix()
   * @model containment="true"
   * @generated
   */
