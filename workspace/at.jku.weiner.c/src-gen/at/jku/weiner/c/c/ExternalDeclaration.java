...
public interface ExternalDeclaration extends EObject
{
   ...
   * @see at.jku.weiner.c.c.CPackage#getExternalDeclaration_FunctiondefHead()
  ...
  /**
   * Sets the value of the '{@link at.jku.weiner.c.c.ExternalDeclaration#getFunctiondefHead <em>Functiondef Head</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see at.jku.weiner.c.c.CPackage#getExternalDeclaration_FunctionDefinition()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link at.jku.weiner.c.c.ExternalDeclaration#getFunctionDefinition <em>Function Definition</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see at.jku.weiner.c.c.CPackage#getExternalDeclaration_Declaration()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link at.jku.weiner.c.c.ExternalDeclaration#getDeclaration <em>Declaration</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setSemi(String)
   * @see at.jku.weiner.c.c.CPackage#getExternalDeclaration_Semi()
   * @model
   * @generated
   */
  String getSemi();
  ...
  /**
   * Sets the value of the '{@link at.jku.weiner.c.c.ExternalDeclaration#getSemi <em>Semi</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
