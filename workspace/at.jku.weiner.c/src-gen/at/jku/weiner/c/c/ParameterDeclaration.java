...
public interface ParameterDeclaration extends EObject
{
   ...
   * @see at.jku.weiner.c.c.CPackage#getParameterDeclaration_DeclSpecifiers()
  ...
  /**
   * Sets the value of the '{@link at.jku.weiner.c.c.ParameterDeclaration#getDeclSpecifiers <em>Decl Specifiers</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see at.jku.weiner.c.c.CPackage#getParameterDeclaration_Declarator()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link at.jku.weiner.c.c.ParameterDeclaration#getDeclarator <em>Declarator</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
