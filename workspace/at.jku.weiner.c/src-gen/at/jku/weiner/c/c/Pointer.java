 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.c.c.Pointer#getStar <em>Star</em>}</li>
 *   <li>{@link at.jku.weiner.c.c.Pointer#getCaret <em>Caret</em>}</li>
 *   <li>{@link at.jku.weiner.c.c.Pointer#getTypeQualifierList <em>Type Qualifier List</em>}</li>
 * </ul>
 *
 * @see at.jku.weiner.c.c.CPackage#getPointer()
 * @model
 * @generated
 */
public interface Pointer extends EObject
{
   ...
   * @see at.jku.weiner.c.c.CPackage#getPointer_Star()
   * @model unique="false"
   * @generated
   */
   ...
   * @see at.jku.weiner.c.c.CPackage#getPointer_Caret()
   * @model unique="false"
   * @generated
   */
   ...
   * The list contents are of type {@link at.jku.weiner.c.c.TypeQualifierList}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see at.jku.weiner.c.c.CPackage#getPointer_TypeQualifierList()
