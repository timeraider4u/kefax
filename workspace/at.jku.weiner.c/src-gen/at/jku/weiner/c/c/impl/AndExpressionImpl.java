 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.c.impl.AndExpressionImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AndExpressionImpl extends ExpressionImpl implements AndExpression
{
  ...
  {
    return CPackage.Literals.AND_EXPRESSION;
  }
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, CPackage.AND_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CPackage.AND_EXPRESSION__EXPR:
