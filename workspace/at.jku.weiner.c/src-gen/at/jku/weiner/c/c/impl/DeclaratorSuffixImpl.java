 ...
 *   <li>{@link at.jku.weiner.c.c.impl.DeclaratorSuffixImpl#getExpr <em>Expr</em>}</li>
...
public class DeclaratorSuffixImpl extends MinimalEObjectImpl.Container implements DeclaratorSuffix
{
  ...
  public void setStatic(String newStatic)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPackage.DECLARATOR_SUFFIX__STATIC, oldStatic, static_));
  }
  ...
  public NotificationChain basicSetTypeQualifierList(TypeQualifierList newTypeQualifierList, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPackage.DECLARATOR_SUFFIX__TYPE_QUALIFIER_LIST, oldTypeQualifierList, newTypeQualifierList);
  ...
  public void setTypeQualifierList(TypeQualifierList newTypeQualifierList)
  {
    if (newTypeQualifierList != typeQualifierList)
    {
      ...
      if (typeQualifierList != null)
        msgs = ((InternalEObject)typeQualifierList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CPackage.DECLARATOR_SUFFIX__TYPE_QUALIFIER_LIST, null, msgs);
      if (newTypeQualifierList != null)
        msgs = ((InternalEObject)newTypeQualifierList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CPackage.DECLARATOR_SUFFIX__TYPE_QUALIFIER_LIST, null, msgs);
      msgs = basicSetTypeQualifierList(newTypeQualifierList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPackage.DECLARATOR_SUFFIX__TYPE_QUALIFIER_LIST, newTypeQualifierList, newTypeQualifierList));
  }
  ...
  public NotificationChain basicSetExpr(Expression newExpr, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPackage.DECLARATOR_SUFFIX__EXPR, oldExpr, newExpr);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExpr(Expression newExpr)
  {
    if (newExpr != expr)
    {
      NotificationChain msgs = null;
      if (expr != null)
        msgs = ((InternalEObject)expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CPackage.DECLARATOR_SUFFIX__EXPR, null, msgs);
      if (newExpr != null)
        msgs = ((InternalEObject)newExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CPackage.DECLARATOR_SUFFIX__EXPR, null, msgs);
      msgs = basicSetExpr(newExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPackage.DECLARATOR_SUFFIX__EXPR, newExpr, newExpr));
  }
  ...
  public void setStar(String newStar)
  {
    ...
    star = newStar;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPackage.DECLARATOR_SUFFIX__STAR, oldStar, star));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CPackage.DECLARATOR_SUFFIX__TYPE_QUALIFIER_LIST:
        return basicSetTypeQualifierList(null, msgs);
      case CPackage.DECLARATOR_SUFFIX__EXPR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CPackage.DECLARATOR_SUFFIX__STATIC:
        return getStatic();
      case CPackage.DECLARATOR_SUFFIX__TYPE_QUALIFIER_LIST:
        return getTypeQualifierList();
      case CPackage.DECLARATOR_SUFFIX__EXPR:
        return getExpr();
      case CPackage.DECLARATOR_SUFFIX__STAR:
        return getStar();
      case CPackage.DECLARATOR_SUFFIX__LAST_SUFFIX:
