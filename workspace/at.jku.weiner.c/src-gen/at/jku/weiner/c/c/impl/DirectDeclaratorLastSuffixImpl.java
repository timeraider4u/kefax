...
public class DirectDeclaratorLastSuffixImpl extends MinimalEObjectImpl.Container implements DirectDeclaratorLastSuffix
{
  ...
  {
    return CPackage.Literals.DIRECT_DECLARATOR_LAST_SUFFIX;
  }
  ...
  public EList<ParameterTypeList> getParameterTypeList()
  {
    ...
    {
      parameterTypeList = new EObjectContainmentEList<ParameterTypeList>(ParameterTypeList.class, this, CPackage.DIRECT_DECLARATOR_LAST_SUFFIX__PARAMETER_TYPE_LIST);
    }
  ...
  public NotificationChain basicSetIdentifierList(IdentifierList newIdentifierList, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPackage.DIRECT_DECLARATOR_LAST_SUFFIX__IDENTIFIER_LIST, oldIdentifierList, newIdentifierList);
  ...
  public void setIdentifierList(IdentifierList newIdentifierList)
  {
    if (newIdentifierList != identifierList)
    {
      ...
      if (identifierList != null)
        msgs = ((InternalEObject)identifierList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CPackage.DIRECT_DECLARATOR_LAST_SUFFIX__IDENTIFIER_LIST, null, msgs);
      if (newIdentifierList != null)
        msgs = ((InternalEObject)newIdentifierList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CPackage.DIRECT_DECLARATOR_LAST_SUFFIX__IDENTIFIER_LIST, null, msgs);
      msgs = basicSetIdentifierList(newIdentifierList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPackage.DIRECT_DECLARATOR_LAST_SUFFIX__IDENTIFIER_LIST, newIdentifierList, newIdentifierList));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CPackage.DIRECT_DECLARATOR_LAST_SUFFIX__PARAMETER_TYPE_LIST:
        return ((InternalEList<?>)getParameterTypeList()).basicRemove(otherEnd, msgs);
      case CPackage.DIRECT_DECLARATOR_LAST_SUFFIX__IDENTIFIER_LIST:
