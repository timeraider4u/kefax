 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.c.c.impl.EqualityExpressionImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link at.jku.weiner.c.c.impl.EqualityExpressionImpl#getOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EqualityExpressionImpl extends ExpressionImpl implements EqualityExpression
{
  ...
  {
    return CPackage.Literals.EQUALITY_EXPRESSION;
  }
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, CPackage.EQUALITY_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public EList<String> getOp()
  {
    if (op == null)
    {
      op = new EDataTypeEList<String>(String.class, this, CPackage.EQUALITY_EXPRESSION__OP);
    }
    return op;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CPackage.EQUALITY_EXPRESSION__EXPR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CPackage.EQUALITY_EXPRESSION__EXPR:
        return getExpr();
      case CPackage.EQUALITY_EXPRESSION__OP:
        return getOp();
    }
