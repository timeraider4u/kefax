 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.c.impl.ExclusiveOrExpressionImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExclusiveOrExpressionImpl extends ExpressionImpl implements ExclusiveOrExpression
{
  ...
  {
    return CPackage.Literals.EXCLUSIVE_OR_EXPRESSION;
  }
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, CPackage.EXCLUSIVE_OR_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CPackage.EXCLUSIVE_OR_EXPRESSION__EXPR:
