 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.c.impl.InclusiveOrExpressionImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InclusiveOrExpressionImpl extends ExpressionImpl implements InclusiveOrExpression
{
  ...
  {
    return CPackage.Literals.INCLUSIVE_OR_EXPRESSION;
  }
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, CPackage.INCLUSIVE_OR_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CPackage.INCLUSIVE_OR_EXPRESSION__EXPR:
