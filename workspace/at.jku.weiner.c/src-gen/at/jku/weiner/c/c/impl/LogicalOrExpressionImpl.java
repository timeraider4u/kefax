 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.c.impl.LogicalOrExpressionImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LogicalOrExpressionImpl extends ExpressionImpl implements LogicalOrExpression
{
  ...
  {
    return CPackage.Literals.LOGICAL_OR_EXPRESSION;
  }
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, CPackage.LOGICAL_OR_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CPackage.LOGICAL_OR_EXPRESSION__EXPR:
