 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.c.impl.MultiplicativeExpressionImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link at.jku.weiner.c.c.impl.MultiplicativeExpressionImpl#getOp <em>Op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MultiplicativeExpressionImpl extends ExpressionImpl implements MultiplicativeExpression
{
  ...
  {
    return CPackage.Literals.MULTIPLICATIVE_EXPRESSION;
  }
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, CPackage.MULTIPLICATIVE_EXPRESSION__EXPR);
    }
    return expr;
  }
  ...
  public EList<String> getOp()
  {
    if (op == null)
    {
      op = new EDataTypeEList<String>(String.class, this, CPackage.MULTIPLICATIVE_EXPRESSION__OP);
    }
    return op;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CPackage.MULTIPLICATIVE_EXPRESSION__EXPR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CPackage.MULTIPLICATIVE_EXPRESSION__EXPR:
        return getExpr();
      case CPackage.MULTIPLICATIVE_EXPRESSION__OP:
        return getOp();
    }
