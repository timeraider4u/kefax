 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.c.c.impl.ParameterDeclarationImpl#getDeclSpecifiers <em>Decl Specifiers</em>}</li>
 *   <li>{@link at.jku.weiner.c.c.impl.ParameterDeclarationImpl#getDeclarator <em>Declarator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterDeclarationImpl extends MinimalEObjectImpl.Container implements ParameterDeclaration
{
  ...
  {
    return CPackage.Literals.PARAMETER_DECLARATION;
  }
  ...
  public NotificationChain basicSetDeclSpecifiers(DeclarationSpecifiers newDeclSpecifiers, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPackage.PARAMETER_DECLARATION__DECL_SPECIFIERS, oldDeclSpecifiers, newDeclSpecifiers);
  ...
  public void setDeclSpecifiers(DeclarationSpecifiers newDeclSpecifiers)
  {
    if (newDeclSpecifiers != declSpecifiers)
    {
      ...
      if (declSpecifiers != null)
        msgs = ((InternalEObject)declSpecifiers).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CPackage.PARAMETER_DECLARATION__DECL_SPECIFIERS, null, msgs);
      if (newDeclSpecifiers != null)
        msgs = ((InternalEObject)newDeclSpecifiers).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CPackage.PARAMETER_DECLARATION__DECL_SPECIFIERS, null, msgs);
      msgs = basicSetDeclSpecifiers(newDeclSpecifiers, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPackage.PARAMETER_DECLARATION__DECL_SPECIFIERS, newDeclSpecifiers, newDeclSpecifiers));
  }
  ...
  public NotificationChain basicSetDeclarator(Declarator newDeclarator, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPackage.PARAMETER_DECLARATION__DECLARATOR, oldDeclarator, newDeclarator);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDeclarator(Declarator newDeclarator)
  {
    if (newDeclarator != declarator)
    {
      NotificationChain msgs = null;
      if (declarator != null)
        msgs = ((InternalEObject)declarator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CPackage.PARAMETER_DECLARATION__DECLARATOR, null, msgs);
      if (newDeclarator != null)
        msgs = ((InternalEObject)newDeclarator).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CPackage.PARAMETER_DECLARATION__DECLARATOR, null, msgs);
      msgs = basicSetDeclarator(newDeclarator, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPackage.PARAMETER_DECLARATION__DECLARATOR, newDeclarator, newDeclarator));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CPackage.PARAMETER_DECLARATION__DECL_SPECIFIERS:
        return basicSetDeclSpecifiers(null, msgs);
      case CPackage.PARAMETER_DECLARATION__DECLARATOR:
