 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.c.impl.PostfixExpressionSuffixArgumentImpl#getArgumentExpressionList <em>Argument Expression List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PostfixExpressionSuffixArgumentImpl extends PostfixExpressionSuffixImpl implements PostfixExpressionSuffixArgument
{
  ...
  {
    return CPackage.Literals.POSTFIX_EXPRESSION_SUFFIX_ARGUMENT;
  }
  ...
  public NotificationChain basicSetArgumentExpressionList(ArgumentExpressionList newArgumentExpressionList, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPackage.POSTFIX_EXPRESSION_SUFFIX_ARGUMENT__ARGUMENT_EXPRESSION_LIST, oldArgumentExpressionList, newArgumentExpressionList);
  ...
  public void setArgumentExpressionList(ArgumentExpressionList newArgumentExpressionList)
  {
    if (newArgumentExpressionList != argumentExpressionList)
    {
      ...
      if (argumentExpressionList != null)
        msgs = ((InternalEObject)argumentExpressionList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CPackage.POSTFIX_EXPRESSION_SUFFIX_ARGUMENT__ARGUMENT_EXPRESSION_LIST, null, msgs);
      if (newArgumentExpressionList != null)
        msgs = ((InternalEObject)newArgumentExpressionList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CPackage.POSTFIX_EXPRESSION_SUFFIX_ARGUMENT__ARGUMENT_EXPRESSION_LIST, null, msgs);
      msgs = basicSetArgumentExpressionList(newArgumentExpressionList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPackage.POSTFIX_EXPRESSION_SUFFIX_ARGUMENT__ARGUMENT_EXPRESSION_LIST, newArgumentExpressionList, newArgumentExpressionList));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CPackage.POSTFIX_EXPRESSION_SUFFIX_ARGUMENT__ARGUMENT_EXPRESSION_LIST:
