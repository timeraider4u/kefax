 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.c.impl.StructDeclaratorImpl#getDeclarator <em>Declarator</em>}</li>
 *   <li>{@link at.jku.weiner.c.c.impl.StructDeclaratorImpl#getConstExpr <em>Const Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StructDeclaratorImpl extends MinimalEObjectImpl.Container implements StructDeclarator
{
  ...
  {
    return CPackage.Literals.STRUCT_DECLARATOR;
  }
  ...
  public NotificationChain basicSetDeclarator(Declarator newDeclarator, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPackage.STRUCT_DECLARATOR__DECLARATOR, oldDeclarator, newDeclarator);
  ...
  public void setDeclarator(Declarator newDeclarator)
  {
    if (newDeclarator != declarator)
    {
      ...
      if (declarator != null)
        msgs = ((InternalEObject)declarator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CPackage.STRUCT_DECLARATOR__DECLARATOR, null, msgs);
      if (newDeclarator != null)
        msgs = ((InternalEObject)newDeclarator).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CPackage.STRUCT_DECLARATOR__DECLARATOR, null, msgs);
      msgs = basicSetDeclarator(newDeclarator, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPackage.STRUCT_DECLARATOR__DECLARATOR, newDeclarator, newDeclarator));
  }
  ...
  public EList<Expression> getConstExpr()
  {
    if (constExpr == null)
    {
      constExpr = new EObjectContainmentEList<Expression>(Expression.class, this, CPackage.STRUCT_DECLARATOR__CONST_EXPR);
    }
    return constExpr;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CPackage.STRUCT_DECLARATOR__DECLARATOR:
        return basicSetDeclarator(null, msgs);
      case CPackage.STRUCT_DECLARATOR__CONST_EXPR:
