 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.c.c.impl.TypeNameImpl#getList <em>List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeNameImpl extends MinimalEObjectImpl.Container implements TypeName
{
  ...
  {
    return CPackage.Literals.TYPE_NAME;
  }
  ...
  public NotificationChain basicSetList(SpecifierQualifierList newList, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPackage.TYPE_NAME__LIST, oldList, newList);
  ...
  public void setList(SpecifierQualifierList newList)
  {
    if (newList != list)
    {
      ...
      if (list != null)
        msgs = ((InternalEObject)list).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CPackage.TYPE_NAME__LIST, null, msgs);
      if (newList != null)
        msgs = ((InternalEObject)newList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CPackage.TYPE_NAME__LIST, null, msgs);
      msgs = basicSetList(newList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPackage.TYPE_NAME__LIST, newList, newList));
  }
