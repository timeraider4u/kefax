...
public class TypeSpecifierImpl extends MinimalEObjectImpl.Container implements TypeSpecifier
{
  ...
  {
    return CPackage.Literals.TYPE_SPECIFIER;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPackage.TYPE_SPECIFIER__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetType(TypedefName newType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CPackage.TYPE_SPECIFIER__TYPE, oldType, newType);
  ...
  public void setType(TypedefName newType)
  {
    if (newType != type)
    {
      ...
      if (type != null)
        msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CPackage.TYPE_SPECIFIER__TYPE, null, msgs);
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CPackage.TYPE_SPECIFIER__TYPE, null, msgs);
      msgs = basicSetType(newType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPackage.TYPE_SPECIFIER__TYPE, newType, newType));
  }
