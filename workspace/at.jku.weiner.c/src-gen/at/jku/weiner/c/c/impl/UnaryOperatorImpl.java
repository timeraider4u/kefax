 ...
 * <ul>
 *   <li>{@link at.jku.weiner.c.c.impl.UnaryOperatorImpl#getOp <em>Op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnaryOperatorImpl extends MinimalEObjectImpl.Container implements UnaryOperator
{
  ...
  {
    return CPackage.Literals.UNARY_OPERATOR;
  }
  ...
  public void setOp(String newOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPackage.UNARY_OPERATOR__OP, oldOp, op));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CPackage.UNARY_OPERATOR__OP:
        return getOp();
    }
