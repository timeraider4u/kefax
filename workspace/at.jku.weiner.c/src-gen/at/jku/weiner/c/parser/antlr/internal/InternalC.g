		...
		lv_type_1_0=ruleStructOrUnion		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"type",
        		lv_type_1_0, 
        		"at.jku.weiner.c.C.StructOrUnion");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_structDeclList_4_0=ruleStructDeclarationList		{
	        if ($current==null) {
       		...
       		set(
        		...
        		"at.jku.weiner.c.C.StructDeclarationList");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_structDeclaration_0_0=ruleStructDeclaration		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"at.jku.weiner.c.C.StructDeclaration");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_structDeclarationList_1_0=ruleStructDeclaratorList		{
	        if ($current==null) {
       		...
       		set(
        		...
        		"at.jku.weiner.c.C.StructDeclaratorList");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_structDeclarator_0_0=ruleStructDeclarator		{
	        if ($current==null) {
       		...
       		add(
        		...
        		"at.jku.weiner.c.C.StructDeclarator");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_enumList_3_0=ruleEnumeratorList		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"enumList",
        		lv_enumList_3_0, 
        		"at.jku.weiner.c.C.EnumeratorList");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_list_3_0=ruleInitializerList		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"list",
        		lv_list_3_0, 
        		"at.jku.weiner.c.C.InitializerList");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_asmLine_6_0=ruleAsmLineWithColon		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"asmLine",
        		lv_asmLine_6_0, 
        		"at.jku.weiner.c.C.AsmLineWithColon");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_asmLine_7_0=ruleAsmLineWithComma		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"asmLine",
        		lv_asmLine_7_0, 
        		"at.jku.weiner.c.C.AsmLineWithComma");
	        afterParserOrEnumRuleCall();
	    }
