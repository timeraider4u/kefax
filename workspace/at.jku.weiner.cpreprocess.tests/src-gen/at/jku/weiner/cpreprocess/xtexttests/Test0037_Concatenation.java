...
public class Test0037_Concatenation {
	@Inject
	...
	public void checkParserResult() throws Exception {
		...
		.getId().toString());
		Assert.assertEquals("x ## BAR", DefineFunctionLikeMacro_4_Var
		.getString());
		//5
		...
		Assert.assertEquals("FOO(foo)", Code_6_Var
		.getCode());
	}
	...
	public void testGenerator() throws Exception {
		...
		try {
			final Method method = clazz.getMethod("setFileName",
					String.class);
			if (method != null) {
				method.invoke(this.generator, "Test0037_Concatenation.c.i");
			}
		...
		final String actual = this.getTextFromFile("bin/Test0037_Concatenation.c.i");
		final String expected = this.getTextFromFile(
			"expected/Test0037_Concatenation.c"
			);
