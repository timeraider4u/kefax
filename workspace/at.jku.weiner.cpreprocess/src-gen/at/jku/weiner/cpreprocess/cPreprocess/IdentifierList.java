 ...
 * <ul>
 *   <li>{@link at.jku.weiner.cpreprocess.cPreprocess.IdentifierList#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @see at.jku.weiner.cpreprocess.cPreprocess.CPreprocessPackage#getIdentifierList()
 * @model
 * @generated
 */
public interface IdentifierList extends EObject
{
   ...
   * @see at.jku.weiner.cpreprocess.cPreprocess.CPreprocessPackage#getIdentifierList_Id()
   * @model unique="false"
   * @generated
   */
  EList<String> getId();
