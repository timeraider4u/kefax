 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.cpreprocess.cPreprocess.impl.IncludeDirectiveImpl#getString <em>String</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IncludeDirectiveImpl extends MinimalEObjectImpl.Container implements IncludeDirective
{
  ...
  {
    return CPreprocessPackage.Literals.INCLUDE_DIRECTIVE;
  }
  ...
  public void setString(String newString)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPreprocessPackage.INCLUDE_DIRECTIVE__STRING, oldString, string));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CPreprocessPackage.INCLUDE_DIRECTIVE__STRING:
        return getString();
    }
