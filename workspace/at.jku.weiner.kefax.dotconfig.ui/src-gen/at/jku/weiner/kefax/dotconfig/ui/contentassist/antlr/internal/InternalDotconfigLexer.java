...
public class InternalDotconfigLexer extends Lexer {
    ...
    public final void mRULE_NLI() throws RecognitionException {
        try {
            ...
            // InternalDotconfig.g:938:10: ( '\\n' )
            // InternalDotconfig.g:938:12: '\\n'
            {
            match('\n'); 
    ...
    public final void mRULE_WSS() throws RecognitionException {
        try {
            int _type = RULE_WSS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:940:10: ( ( ' ' | '\\t' )+ )
            // InternalDotconfig.g:940:12: ( ' ' | '\\t' )+
            {
            // InternalDotconfig.g:940:12: ( ' ' | '\\t' )+
            int cnt1=0;
            loop1:
    ...
    public final void mRULE_EQ() throws RecognitionException {
        try {
            int _type = RULE_EQ;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:942:9: ( '=' )
            // InternalDotconfig.g:942:11: '='
            {
            match('='); 
    ...
    public final void mRULE_LOGIC_SYM() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:944:16: ( ( 'y' | 'n' | 'm' ) )
            // InternalDotconfig.g:944:18: ( 'y' | 'n' | 'm' )
            {
    ...
    public final void mRULE_S_HEX() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:946:12: ( '0' ( 'x' | 'X' ) ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )+ )
            // InternalDotconfig.g:946:14: '0' ( 'x' | 'X' ) ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )+
            {
            match('0'); 
            ...
            // InternalDotconfig.g:946:28: ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_S_INT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:948:12: ( ( '-' )? ( '0' .. '9' )+ )
            // InternalDotconfig.g:948:14: ( '-' )? ( '0' .. '9' )+
            {
            // InternalDotconfig.g:948:14: ( '-' )?
            int alt3=2;
            ...
            // InternalDotconfig.g:948:19: ( '0' .. '9' )+
            int cnt4=0;
            loop4:
            do {
                int alt4=2;
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalDotconfig.g:948:20: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_SYMBOL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:950:13: ( ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' )+ )
            // InternalDotconfig.g:950:15: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' )+
            {
            // InternalDotconfig.g:950:15: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:952:13: ( ( '\"' RULE_STR_D '\"' | '\\'' RULE_STR_S '\\'' ) )
            // InternalDotconfig.g:952:15: ( '\"' RULE_STR_D '\"' | '\\'' RULE_STR_S '\\'' )
            {
            // InternalDotconfig.g:952:15: ( '\"' RULE_STR_D '\"' | '\\'' RULE_STR_S '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalDotconfig.g:952:16: '\"' RULE_STR_D '\"'
                    {
                    match('\"'); 
                    mRULE_STR_D(); 
                    match('\"'); 
                    ...
                    break;
                case 2 :
                    // InternalDotconfig.g:952:35: '\\'' RULE_STR_S '\\''
                    {
                    match('\''); 
                    mRULE_STR_S(); 
                    match('\''); 
    ...
    public final void mRULE_STR_D() throws RecognitionException {
        try {
            // InternalDotconfig.g:954:21: ( ( RULE_ESC | ~ ( ( '\\\\' | '\"' ) ) )* )
            // InternalDotconfig.g:954:23: ( RULE_ESC | ~ ( ( '\\\\' | '\"' ) ) )*
            {
            // InternalDotconfig.g:954:23: ( RULE_ESC | ~ ( ( '\\\\' | '\"' ) ) )*
            loop7:
            do {
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalDotconfig.g:954:24: RULE_ESC
            	    {
            	    mRULE_ESC(); 
    ...
    public final void mRULE_STR_S() throws RecognitionException {
        try {
            // InternalDotconfig.g:956:21: ( ( RULE_ESC | ~ ( ( '\\\\' | '\\'' ) ) )* )
            // InternalDotconfig.g:956:23: ( RULE_ESC | ~ ( ( '\\\\' | '\\'' ) ) )*
            {
            // InternalDotconfig.g:956:23: ( RULE_ESC | ~ ( ( '\\\\' | '\\'' ) ) )*
            loop8:
            do {
                ...
                switch (alt8) {
            	case 1 :
            	    // InternalDotconfig.g:956:24: RULE_ESC
            	    {
            	    mRULE_ESC(); 
    ...
    public final void mRULE_ESC() throws RecognitionException {
        try {
            // InternalDotconfig.g:958:19: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) )
            // InternalDotconfig.g:958:21: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
            {
            match('\\'); 
    ...
    public final void mRULE_SL_COMMENT_NOT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:960:21: ( '# ' RULE_SYMBOL ' is not set' )
            // InternalDotconfig.g:960:23: '# ' RULE_SYMBOL ' is not set'
            {
            match("# "); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:962:17: ( '#' (~ ( '\\n' ) )* )
            // InternalDotconfig.g:962:19: '#' (~ ( '\\n' ) )*
            {
            match('#'); 
            // InternalDotconfig.g:962:23: (~ ( '\\n' ) )*
            loop9:
            do {
                int alt9=2;
