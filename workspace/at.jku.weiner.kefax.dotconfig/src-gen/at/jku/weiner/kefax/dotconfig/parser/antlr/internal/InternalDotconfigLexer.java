...
public class InternalDotconfigLexer extends Lexer {
    ...
    public final void mRULE_NLI() throws RecognitionException {
        try {
            ...
            // InternalDotconfig.g:436:10: ( '\\n' )
            // InternalDotconfig.g:436:12: '\\n'
            {
            match('\n'); 
    ...
    public final void mRULE_WSS() throws RecognitionException {
        try {
            int _type = RULE_WSS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:438:10: ( ( ' ' | '\\t' )+ )
            // InternalDotconfig.g:438:12: ( ' ' | '\\t' )+
            {
            // InternalDotconfig.g:438:12: ( ' ' | '\\t' )+
            int cnt1=0;
            loop1:
    ...
    public final void mRULE_EQ() throws RecognitionException {
        try {
            int _type = RULE_EQ;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:440:9: ( '=' )
            // InternalDotconfig.g:440:11: '='
            {
            match('='); 
    ...
    public final void mRULE_LOGIC_SYM() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:442:16: ( ( 'y' | 'n' | 'm' ) )
            // InternalDotconfig.g:442:18: ( 'y' | 'n' | 'm' )
            {
    ...
    public final void mRULE_S_HEX() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:444:12: ( '0' ( 'x' | 'X' ) ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )+ )
            // InternalDotconfig.g:444:14: '0' ( 'x' | 'X' ) ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )+
            {
            match('0'); 
            ...
            // InternalDotconfig.g:444:28: ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_S_INT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:446:12: ( ( '-' )? ( '0' .. '9' )+ )
            // InternalDotconfig.g:446:14: ( '-' )? ( '0' .. '9' )+
            {
            // InternalDotconfig.g:446:14: ( '-' )?
            int alt3=2;
            ...
            // InternalDotconfig.g:446:19: ( '0' .. '9' )+
            int cnt4=0;
            loop4:
            do {
                int alt4=2;
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalDotconfig.g:446:20: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_SYMBOL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:448:13: ( ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' )+ )
            // InternalDotconfig.g:448:15: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' )+
            {
            // InternalDotconfig.g:448:15: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '_' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:450:13: ( ( '\"' RULE_STR_D '\"' | '\\'' RULE_STR_S '\\'' ) )
            // InternalDotconfig.g:450:15: ( '\"' RULE_STR_D '\"' | '\\'' RULE_STR_S '\\'' )
            {
            // InternalDotconfig.g:450:15: ( '\"' RULE_STR_D '\"' | '\\'' RULE_STR_S '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalDotconfig.g:450:16: '\"' RULE_STR_D '\"'
                    {
                    match('\"'); 
                    mRULE_STR_D(); 
                    match('\"'); 
                    ...
                    break;
                case 2 :
                    // InternalDotconfig.g:450:35: '\\'' RULE_STR_S '\\''
                    {
                    match('\''); 
                    mRULE_STR_S(); 
                    match('\''); 
    ...
    public final void mRULE_STR_D() throws RecognitionException {
        try {
            // InternalDotconfig.g:452:21: ( ( RULE_ESC | ~ ( ( '\\\\' | '\"' ) ) )* )
            // InternalDotconfig.g:452:23: ( RULE_ESC | ~ ( ( '\\\\' | '\"' ) ) )*
            {
            // InternalDotconfig.g:452:23: ( RULE_ESC | ~ ( ( '\\\\' | '\"' ) ) )*
            loop7:
            do {
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalDotconfig.g:452:24: RULE_ESC
            	    {
            	    mRULE_ESC(); 
    ...
    public final void mRULE_STR_S() throws RecognitionException {
        try {
            // InternalDotconfig.g:454:21: ( ( RULE_ESC | ~ ( ( '\\\\' | '\\'' ) ) )* )
            // InternalDotconfig.g:454:23: ( RULE_ESC | ~ ( ( '\\\\' | '\\'' ) ) )*
            {
            // InternalDotconfig.g:454:23: ( RULE_ESC | ~ ( ( '\\\\' | '\\'' ) ) )*
            loop8:
            do {
                ...
                switch (alt8) {
            	case 1 :
            	    // InternalDotconfig.g:454:24: RULE_ESC
            	    {
            	    mRULE_ESC(); 
    ...
    public final void mRULE_ESC() throws RecognitionException {
        try {
            // InternalDotconfig.g:456:19: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) )
            // InternalDotconfig.g:456:21: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
            {
            match('\\'); 
    ...
    public final void mRULE_SL_COMMENT_NOT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:458:21: ( '# ' RULE_SYMBOL ' is not set' )
            // InternalDotconfig.g:458:23: '# ' RULE_SYMBOL ' is not set'
            {
            match("# "); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDotconfig.g:460:17: ( '#' (~ ( '\\n' ) )* )
            // InternalDotconfig.g:460:19: '#' (~ ( '\\n' ) )*
            {
            match('#'); 
            // InternalDotconfig.g:460:23: (~ ( '\\n' ) )*
            loop9:
            do {
                int alt9=2;
    ...
    public void mTokens() throws RecognitionException {
        // InternalDotconfig.g:1:8: ( RULE_NLI | RULE_WSS | RULE_EQ | RULE_LOGIC_SYM | RULE_S_HEX | RULE_S_INT | RULE_SYMBOL | RULE_STRING | RULE_SL_COMMENT_NOT | RULE_SL_COMMENT )
        int alt10=10;
        alt10 = dfa10.predict(input);
        switch (alt10) {
            case 1 :
                // InternalDotconfig.g:1:10: RULE_NLI
                {
                mRULE_NLI(); 
                ...
                break;
            case 2 :
                // InternalDotconfig.g:1:19: RULE_WSS
                {
                mRULE_WSS(); 
                ...
                break;
            case 3 :
                // InternalDotconfig.g:1:28: RULE_EQ
                {
                mRULE_EQ(); 
                ...
                break;
            case 4 :
                // InternalDotconfig.g:1:36: RULE_LOGIC_SYM
                {
                mRULE_LOGIC_SYM(); 
                ...
                break;
            case 5 :
                // InternalDotconfig.g:1:51: RULE_S_HEX
                {
                mRULE_S_HEX(); 
                ...
                break;
            case 6 :
                // InternalDotconfig.g:1:62: RULE_S_INT
                {
                mRULE_S_INT(); 
                ...
                break;
            case 7 :
                // InternalDotconfig.g:1:73: RULE_SYMBOL
                {
                mRULE_SYMBOL(); 
                ...
                break;
            case 8 :
                // InternalDotconfig.g:1:85: RULE_STRING
                {
                mRULE_STRING(); 
                ...
                break;
            case 9 :
                // InternalDotconfig.g:1:97: RULE_SL_COMMENT_NOT
                {
                ...
                break;
            case 10 :
                // InternalDotconfig.g:1:117: RULE_SL_COMMENT
                {
                mRULE_SL_COMMENT(); 
