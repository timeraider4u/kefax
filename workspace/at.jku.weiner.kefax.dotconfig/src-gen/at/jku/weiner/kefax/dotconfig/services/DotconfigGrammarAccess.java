 ...
 */
package at.jku.weiner.kefax.dotconfig.services;
...
public class DotconfigGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class DotConfigModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.DotConfigModel");
	...
	public class ConfigElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.Config");
	...
	public class ValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.value");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EolElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.Eol");
	...
	public DotconfigGrammarAccess(GrammarProvider grammarProvider) {
		...
		this.tNLI = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.NLI");
		this.tWSS = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.WSS");
		this.tEQ = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.EQ");
		this.tLOGIC_SYM = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.LOGIC_SYM");
		this.tS_HEX = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.S_HEX");
		this.tS_INT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.S_INT");
		this.tSYMBOL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.SYMBOL");
		this.tSTRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.STRING");
		this.tSTR_D = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.STR_D");
		this.tSTR_S = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.STR_S");
		this.tESC = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.ESC");
		this.tSL_COMMENT_NOT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.SL_COMMENT_NOT");
		this.tSL_COMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.dotconfig.Dotconfig.SL_COMMENT");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("at.jku.weiner.kefax.dotconfig.Dotconfig".equals(grammar.getName())) {
				return grammar;
			}
