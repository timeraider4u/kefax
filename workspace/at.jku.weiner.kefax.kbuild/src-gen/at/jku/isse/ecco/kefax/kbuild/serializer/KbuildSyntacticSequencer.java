...
public class KbuildSyntacticSequencer extends AbstractSyntacticSequencer {
	 ...
	 *     (rule start) TAB* (ambiguity) EQ TAB* (BACKSLASH Eol TAB*)? values+=Value
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) (PLUS | DPOINT) EQ TAB* (BACKSLASH Eol TAB*)? values+=Value
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) EQ (ambiguity) (BACKSLASH Eol TAB*)? values+=Value
	 *     (rule start) TAB* (PLUS | DPOINT) EQ (ambiguity) (BACKSLASH Eol TAB*)? values+=Value
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     values+=Value BACKSLASH Eol (ambiguity) values+=Value
	 */
	 ...
	 *     (rule start) EQ TAB* (ambiguity) values+=Value
	 *     (rule start) TAB* (PLUS | DPOINT) EQ TAB* (ambiguity) values+=Value
	 */
