...
class XtextTestParsingTest0001{
	...
	def void loadModel() {
		...
		val String actual = this.getTextFromFile("bin/at/jku/weiner/c/preprocess/xtexttests/Test0001_Semicolons.java");
		Assert.assertNotNull(actual);
		val String expect = this.getTextFromFile("expected/Test0001_Semicolons.java");
