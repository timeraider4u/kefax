...
class XtextTestParsingTest0002{
	...
	@Test 
	def void loadModel() {
		val file = "res/Test0002_Emftest.xtexttest";
		...
		val String actual = this.getTextFromFile("bin/org/eclipse/modisco/cdt/discoverer/tests/basic/" 
			+ "emftests/Test0002_Emftest.java");
		Assert.assertNotNull(actual);
		val String expect = this.getTextFromFile("expected/Test0002_Emftest.java");
