...
class XtextTestParsingTest0003{
	...
	@Test 
	def void loadModel() {
		val file = "res/Test0003_Semicolons.xtexttest";
		...
		val String actual = this.getTextFromFile("bin/at/jku/weiner/c/preprocess/xtexttests/Test0003_Semicolons.java");
		Assert.assertNotNull(actual);
		val String expect = this.getTextFromFile("expected/Test0003_Semicolons.java");
