...
class XtextTestParsingTest0004{
	...
	@Test 
	def void loadModel() {
		val file = "res/Test0004_Emftest.xtexttest";
		...
		val String actual = this.getTextFromFile("bin/org/eclipse/modisco/cdt/discoverer/tests/basic/" 
			+ "emftests/Test0004_Emftest.java");
		Assert.assertNotNull(actual);
		val String expect = this.getTextFromFile("expected/Test0004_Emftest.java");
