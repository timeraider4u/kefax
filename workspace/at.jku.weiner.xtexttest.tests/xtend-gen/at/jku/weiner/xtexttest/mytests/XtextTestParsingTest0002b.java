...
public class XtextTestParsingTest0002b {
  @Inject
  ...
  public void loadModel() {
    try {
      final String file = "res/Test0002b_Emftest.xtexttest";
      ...
      final String actual = this.getTextFromFile(
        ("bin/org/eclipse/modisco/cdt/discoverer/tests/basic/" + "emftests/Test0002b_Emftest.java"));
      Assert.assertNotNull(actual);
      final String expect = this.getTextFromFile("expected/Test0002b_Emftest.java");
