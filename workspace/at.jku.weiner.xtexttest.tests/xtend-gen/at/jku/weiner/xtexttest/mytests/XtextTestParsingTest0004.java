...
public class XtextTestParsingTest0004 {
  @Inject
  ...
  public void loadModel() {
    try {
      final String file = "res/Test0004_Emftest.xtexttest";
      ...
      this.generator.setFileName("Test0004_Emftest.java");
      this.generator.doGenerate(resource, this.fileAccessSystem);
      final String actual = this.getTextFromFile(
        ("bin/org/eclipse/modisco/cdt/discoverer/tests/basic/" + "emftests/Test0004_Emftest.java"));
      Assert.assertNotNull(actual);
      final String expect = this.getTextFromFile("expected/Test0004_Emftest.java");
