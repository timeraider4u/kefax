 ...
 * </p>
 * <ul>
 *   <li>{@link at.jku.weiner.xtexttest.xtextTest.impl.BeforeImpl#getCodeCall <em>Code Call</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BeforeImpl extends MinimalEObjectImpl.Container implements Before
{
  ...
  public NotificationChain basicSetCodeCall(CodeCall newCodeCall, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XtextTestPackage.BEFORE__CODE_CALL, oldCodeCall, newCodeCall);
  ...
  public void setCodeCall(CodeCall newCodeCall)
  {
    if (newCodeCall != codeCall)
    {
      ...
      if (codeCall != null)
        msgs = ((InternalEObject)codeCall).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XtextTestPackage.BEFORE__CODE_CALL, null, msgs);
      if (newCodeCall != null)
        msgs = ((InternalEObject)newCodeCall).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XtextTestPackage.BEFORE__CODE_CALL, null, msgs);
      msgs = basicSetCodeCall(newCodeCall, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextTestPackage.BEFORE__CODE_CALL, newCodeCall, newCodeCall));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XtextTestPackage.BEFORE__CODE_CALL:
