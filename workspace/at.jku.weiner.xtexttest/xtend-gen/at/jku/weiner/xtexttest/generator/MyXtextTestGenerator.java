...
public class MyXtextTestGenerator {
  ...
  private int timeOut = MyXtextTestGenerator.TIMEOUT;
  
  @Accessors
  private String fileName;
  
  public void doGenerate(final Resource resource, final IFileSystemAccess fsa, final Model model) {
    XtextTest _xtextTest = model.getXtextTest();
    this.test = _xtextTest;
    ...
    boolean _equals = (_timeOut == 0);
    if (_equals) {
      this.timeOut = MyXtextTestGenerator.TIMEOUT;
    } else {
      int _timeOut_1 = this.test.getTimeOut();
      int _multiply = (_timeOut_1 * 1000);
      this.timeOut = _multiply;
    }
    final CharSequence outputForJava = this.outputJava();
    String _package = this.test.getPackage();
    String _replace = _package.replace(".", "/");
    String _plus = (_replace + "/");
    String _plus_1 = (_plus + MyXtextTestGenerator.PKG_PREFIX);
    ...
    Class<? extends Class> _class = MyXtextTestGenerator.class.getClass();
    String _fileName = this.getFileName();
    String _plus_5 = ("generate file=\'" + _fileName);
    String _plus_6 = (_plus_5 + "\'");
    MyLog.trace(_class, _plus_6);
  ...
  public CharSequence outputHeader() {
    ...
    _builder.append(".");
    _builder.append(MyXtextTestGenerator.PKG_PREFIX, "");
    _builder.append(";");
    _builder.newLineIfNotEmpty();
    _builder.newLine();
  ...
  public String outputClass() {
    ...
    _builder.newLine();
    {
      ...
      if (_notEquals) {
        ...
        String _outputParams = this.outputParams(_params);
        _builder.append(_outputParams, "\t\t");
        _builder.append(");");
        _builder.newLineIfNotEmpty();
      }
    }
    ...
    _builder.newLine();
    {
      ...
      if (_notEquals_1) {
        ...
        String _outputParams_1 = this.outputParams(_params_1);
        _builder.append(_outputParams_1, "\t\t");
        _builder.append(");");
        _builder.newLineIfNotEmpty();
      }
    }
  ...
  public CharSequence tokensJUnitTest() {
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      if (_notEquals) {
        ...
        String _outputFor = this.outputFor(_tokens_2);
  ...
  public String outputFor(final EList<MyTokens> list) {
    boolean isFirst = true;
    final StringBuffer result = new StringBuffer("");
    for (int i = 0; (i < list.size()); i++) {
      {
        final MyTokens token = list.get(i);
        final String tVal = token.getToken();
        int j = 0;
        do {
          {
            boolean _notEquals = (!Objects.equal(tVal, null));
            if (_notEquals) {
              result.append("\"RULE_");
              result.append(tVal);
              result.append("\"");
            }
            final String sVal = token.getString();
            boolean _notEquals_1 = (!Objects.equal(sVal, null));
            if (_notEquals_1) {
              result.append("\"");
              result.append(sVal);
              result.append("\"");
  ...
  public String outputParams(final EList<String> list) {
