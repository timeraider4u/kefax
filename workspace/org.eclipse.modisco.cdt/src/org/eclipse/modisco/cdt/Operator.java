 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.modisco.cdt.CdtPackage#getOperator()
 * @model
 * @generated
 */
public enum Operator implements Enumerator {
	 ...
	 * @ordered
	 */
	MINUS(1, "minus", "minus"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	PLUS(2, "plus", "plus"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	ASSIGN(3, "assign", "assign"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	public static final int ASSIGN_VALUE = 3;
