...
public class Scanner {
	...
	static {
		...
		for (int i = 9; i <= 9; ++i) start.set(i, 2);
		for (int i = 34; i <= 34; ++i) start.set(i, 3);
		for (int i = 10; i <= 10; ++i) start.set(i, 4);
		for (int i = 33; i <= 33; ++i) start.set(i, 15);
		start.set(45, 5); 
		start.set(61, 16); 
		start.set(38, 17); 
		start.set(124, 19); 
		start.set(Buffer.EOF, -1);
		literals.put("config", new Integer(5));
		literals.put("bool", new Integer(6));
		literals.put("int", new Integer(7));
		literals.put("hex", new Integer(8));
		literals.put("tristate", new Integer(9));
		literals.put("string", new Integer(10));
		literals.put("def_bool", new Integer(11));
		literals.put("def_tristate", new Integer(12));
		literals.put("help", new Integer(13));
		literals.put("depends", new Integer(15));
		literals.put("on", new Integer(16));
		literals.put("prompt", new Integer(18));
		literals.put("if", new Integer(19));
		literals.put("default", new Integer(20));
		literals.put("y", new Integer(21));
		literals.put("m", new Integer(22));
		literals.put("n", new Integer(23));
		literals.put("select", new Integer(24));
		literals.put("range", new Integer(25));
		literals.put("option", new Integer(26));
		literals.put("env", new Integer(27));
		literals.put("source", new Integer(31));
		literals.put("menu", new Integer(32));
		literals.put("endmenu", new Integer(33));
	...
	Token NextToken() {
		...
		loop: for (;;) {
			switch (state) {
				...
				case 7:
					if (ch == 'h') {AddCh(); state = 8; break;}
					else {state = 0; break;}
				case 8:
					if (ch == 'e') {AddCh(); state = 9; break;}
					else {state = 0; break;}
				case 9:
					if (ch == 'l') {AddCh(); state = 10; break;}
					else {state = 0; break;}
				case 10:
	...
	// otherwise changes within the signature of the methods will result in Syntax Highlighting not working properly anymore.

	// get the offset of the next Token
	public int getPeekTokenOffset () { return pt.pos; }
	
	// get the String value of the Token
	public String getPeekTokenVal () { return pt.val; }
	
	// get the Kind value of the Token
	public int getPeekTokenKind () { return pt.kind; }
