 ...
 */
package at.jku.weiner.kefax.kbuild.services;
...
public class KbuildGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.Model");
	...
	public class BuildEntryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.BuildEntry");
		...
		//	| {Ifndef} IFNDEF
		//	name=SYMBOL
		//	Eol (value=Object_Y | value=Object_M) Eol
		//	ENDIF
		//	| {HostProgram} name=SYMBOL
		//	variable=Variable?
		//	value=AssignExtra inner=Assign?
		//	| {Object} (value=Object_Y | value=Object_M) | {Target} target=Values
		//	DPOINT (SEMICOLON
		//	| values+=Values (Eol TAB+
		//	values+=Values)*) | {MyVariable} name=SYMBOL
		//	variable=Variable?
		//	value=Assign;
		@Override public ParserRule getRule() { return rule; }
	...
	public class EntryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.Entry");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//Entry:
		//	{Entry} OBJ_START variable=Variable
		//	value=AssignExtra;
		@Override public ParserRule getRule() { return rule; }
	...
	public class IfElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.If");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//If:
		//	BRACE_START (Variable COMMA (Y | M) | shell=ShellCmd COMMA?) BRACE_END
		//	Eol TAB* (value=Object_Y | value=Object_M | value=Entry | value=ShellCmd) Eol (ELSE
		//	Eol TAB* (elsevalue=Object_Y | elsevalue=Object_M) Eol)?
		//	ENDIF;
		@Override public ParserRule getRule() { return rule; }
	...
	public class Object_YElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.Object_Y");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class Object_MElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.Object_M");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AssignElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.Assign");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AssignExtraElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.AssignExtra");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ValuesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.Values");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final RuleCall cItemsValueParserRuleCall_1_0 = (RuleCall)cItemsAssignment_1.eContents().get(0);
		private final Group cGroup_2 = (Group)cGroup.eContents().get(2);
		...
		private final Assignment cItemsAssignment_2_3 = (Assignment)cGroup_2.eContents().get(3);
		private final RuleCall cItemsValueParserRuleCall_2_3_0 = (RuleCall)cItemsAssignment_2_3.eContents().get(0);
		
		//Values:
		//	(BACKSLASH Eol TAB*)?
		//	items+=Value+ (BACKSLASH Eol TAB* items+=Value+)*;
		@Override public ParserRule getRule() { return rule; }
		
		//(BACKSLASH Eol TAB*)? items+=Value+ (BACKSLASH Eol TAB* items+=Value+)*
		public Group getGroup() { return cGroup; }
		...
		//Value
		public RuleCall getItemsValueParserRuleCall_1_0() { return cItemsValueParserRuleCall_1_0; }
		...
		//items+=Value+
		public Assignment getItemsAssignment_2_3() { return cItemsAssignment_2_3; }
		
		//Value
		public RuleCall getItemsValueParserRuleCall_2_3_0() { return cItemsValueParserRuleCall_2_3_0; }
	}
	public class ValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.Value");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
	...
	public class VariableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.Variable");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
	...
	public class ShellCmdElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.ShellCmd");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
	...
	public class ShellPartElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.ShellPart");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//ShellPart:
		//	{ShellPart} (val=VarSlashSym | cmd=ShellCmd | STRING
	...
	public class VarSlashSymElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.VarSlashSym");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EolElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.Eol");
	...
	public KbuildGrammarAccess(GrammarProvider grammarProvider) {
		...
		this.tNLI = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.NLI");
		this.tTAB = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.TAB");
		this.tWSS = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.WSS");
		this.tSL_COMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.SL_COMMENT");
		this.tOBJ_START = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.OBJ_START");
		this.tOBJ_Y = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.OBJ_Y");
		this.tOBJ_M = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.OBJ_M");
		this.tIFEQ = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.IFEQ");
		this.tIFNEQ = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.IFNEQ");
		this.tIFNDEF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.IFNDEF");
		this.tELSE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.ELSE");
		this.tENDIF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.ENDIF");
		this.tY = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.Y");
		this.tM = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.M");
		this.tOBJ_FILE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.OBJ_FILE");
		this.tINCLUDE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.INCLUDE");
		this.tSYMBOL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.SYMBOL");
		this.tSHELL_CHAR = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.SHELL_CHAR");
		this.tDOLLAR = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.DOLLAR");
		this.tBRACE_START = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.BRACE_START");
		this.tBRACE_END = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.BRACE_END");
		this.tQUOTE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.QUOTE");
		this.tPLUS = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.PLUS");
		this.tDPOINT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.DPOINT");
		this.tEQ = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.EQ");
		this.tSLASH = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.SLASH");
		this.tBACKSLASH = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.BACKSLASH");
		this.tCOMMA = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.COMMA");
		this.tSEMICOLON = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.SEMICOLON");
		this.tSTR_ESC = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.STR_ESC");
		this.tSTRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "at.jku.weiner.kefax.kbuild.Kbuild.STRING");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("at.jku.weiner.kefax.kbuild.Kbuild".equals(grammar.getName())) {
				return grammar;
			}
